# REQ-AUTH-IMPL-004 — PATs são escopados, hash-only e revogáveis
...
PATs são escopados, hash-only e revogáveis

## Rastreabilidade

- **Épicos:** `EPIC-008`, `EPIC-009`, `EPIC-010`, `EPIC-011`, `EPIC-041`
- **Evidência ou teste canônico:** `test_req_auth_impl_004`
