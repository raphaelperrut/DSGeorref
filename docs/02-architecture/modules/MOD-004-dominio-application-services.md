# MOD-004 — Domínio + Application Services

- **Componente arquitetural:** `COMP-004`
- **Camada:** `Núcleo de domínio e processamento`
- **Domínios de entrega:** `FND`, `PLT`, `DAT`, `JOB`
...
- Fornece `orquestra ProcessingPlan` para `geo`.
- Fornece `execução síncrona` para `direct`.
- Fornece `work units` para `workers`.
- Fornece `UoW/system of record` para `postgres`.
- Fornece `ArtifactSets/inputs` para `filesystem`.
...
- **Épicos vinculados:** `EPIC-001`, `EPIC-002`, `EPIC-003`, `EPIC-004`, `EPIC-005`, `EPIC-006`, `EPIC-007`, `EPIC-008`, `EPIC-009`, `EPIC-010`, `EPIC-011`, `EPIC-012`, `EPIC-013`, `EPIC-014`, `EPIC-015`, `EPIC-016`, `EPIC-017`, `EPIC-018`, `EPIC-019`, `EPIC-049`, `EPIC-061`, `EPIC-065`, `EPIC-066`, `EPIC-067`, `EPIC-068`, `EPIC-069`, `EPIC-071`, `EPIC-073`, `EPIC-074`, `EPIC-082`, `EPIC-086`, `EPIC-090`, `EPIC-091`, `EPIC-092`, `EPIC-104`, `EPIC-105`, `EPIC-110`
- **Histórias vinculadas:** 217
