# MOD-009 — Workers duráveis

- **Componente arquitetural:** `COMP-009`
- **Camada:** `Execução e orquestração`
- **Domínios de entrega:** `JOB`
- **ADRs owners:** `ADR-036`
...
- Fornece `ack/redelivery` para `broker`.
- Fornece `estado/checkpoints/outbox` para `postgres`.
...
- **Épicos vinculados:** `EPIC-014`, `EPIC-015`, `EPIC-016`, `EPIC-017`, `EPIC-018`, `EPIC-019`, `EPIC-065`, `EPIC-066`, `EPIC-067`, `EPIC-068`, `EPIC-069`, `EPIC-104`
- **Histórias vinculadas:** 84
