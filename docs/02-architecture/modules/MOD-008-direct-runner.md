# MOD-008 — Direct Runner

- **Componente arquitetural:** `COMP-008`
- **Camada:** `Execução e orquestração`
- **Domínios de entrega:** `JOB`, `CLI`
...
- **Épicos vinculados:** `EPIC-014`, `EPIC-015`, `EPIC-016`, `EPIC-017`, `EPIC-018`, `EPIC-019`, `EPIC-020`, `EPIC-065`, `EPIC-066`, `EPIC-067`, `EPIC-068`, `EPIC-069`, `EPIC-104`
- **Histórias vinculadas:** 89
