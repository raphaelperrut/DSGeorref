# ADR-029 — Federação OIDC e vínculo de identidade
...
- OIDC é opcional e não remove contas locais.
- Identidade federada é vinculada por issuer + subject e linking explícito.
- Autorização continua pertencendo à aplicação e não é delegada ao IdP.
- Mudança de issuer, subject ou vínculo é auditada e revogável.
...
- **Requisitos owned:** `REQ-AUTH-IMPL-005`, `REQ-ID-001`, `REQ-ID-002`
