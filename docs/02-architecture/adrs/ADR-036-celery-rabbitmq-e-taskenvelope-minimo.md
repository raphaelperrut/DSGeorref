# ADR-036 — Celery, RabbitMQ e TaskEnvelope mínimo
...
- Celery/RabbitMQ é transporte assíncrono; PostgreSQL permanece autoritativo.
- TaskEnvelope contém apenas IDs, revisions, idempotency, resource class e trace context.
- Raster bytes, secrets e objetos Python serializados são proibidos nas mensagens.
- A topologia usa poucas filas duráveis por classe e quarantine explícita.
...
- **Requisitos owned:** `REQ-RMQ-001`, `REQ-RMQ-003`
- **Épicos relacionados:** `EPIC-040`, `EPIC-098`, `EPIC-103`
