# ADR-030 — PATs, autorização central e scopes
...
- PATs são opacos, prefixados, armazenados por hash, escopados, expirados e revogáveis.
- Autorização é centralizada em application service e política versionada.
- Rotas, UI, CLI e workers não reinterpretam roles, projeto ou operação.
- Decisão de acesso é testável e auditável por principal, recurso e ação.
...
- **Requisitos owned:** `REQ-AIE-009`, `REQ-SMO-004`
- **Épicos relacionados:** `EPIC-005`, `EPIC-014`, `EPIC-022`, `EPIC-024`, `EPIC-028`, `EPIC-034`, `EPIC-039`, `EPIC-041`, `EPIC-050`, `EPIC-069`, `EPIC-075`
