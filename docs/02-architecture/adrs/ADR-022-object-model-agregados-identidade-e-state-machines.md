# ADR-022 — Object Model: aggregates, identidade e state machines
...
- **Bounded Contexts:** `BC-003` — Projetos, Workspace e Assets, `BC-004` — Plano de Processamento e Workflow, `BC-012` — Resultados, Diagnósticos e Exportação, `BC-013` — Artifacts, Proveniência e Lifecycle
...
- Project, Asset, ProcessingPlan, Job, Attempt, ResultSnapshot, CorrectionSet e ArtifactSet possuem identidade e ownership explícitos.
- Aggregates não atravessam bounded contexts; integração usa DTOs, eventos e IDs.
- Estados persistidos são enums/constraints versionados e transições são validadas por state machines.
- Entidades de domínio não dependem de ORM, HTTP, broker ou filesystem.
...
- **Requisitos owned:** `REQ-PRJ-002`, `REQ-PRJ-003`, `REQ-PRJ-004`, `REQ-PRJ-005`, `REQ-PRJ-006`, `REQ-PRJ-007`, `REQ-PRJ-008`, `REQ-PRJ-009`, `REQ-PRJ-010`
- **Épicos relacionados:** `EPIC-002`, `EPIC-110`
