# ADR-020 — Transactional outbox e consumidores idempotentes
...
- Efeitos externos e eventos são registrados em outbox na mesma transação do estado autoritativo.
- Dispatcher publica somente registros elegíveis e checkpointados.
- Consumidores deduplicam por identidade/versionamento e toleram redelivery.
- Falha de publicação não desfaz o commit do domínio e é reconciliável.
...
- **Requisitos owned:** `REQ-DBSCHEMA-009`, `REQ-WORKER-007`
- **Épicos relacionados:** `EPIC-002`, `EPIC-012`, `EPIC-014`, `EPIC-039`
