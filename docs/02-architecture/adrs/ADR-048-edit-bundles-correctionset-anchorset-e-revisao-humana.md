# ADR-048 — Edit Bundles: CorrectionSet, AnchorSet e revisão humana
...
- **Bounded Contexts:** `BC-011` — Revisão e Correção, `BC-012` — Resultados, Diagnósticos e Exportação
...
- Edições humanas são representadas por CorrectionSet ou AnchorSet imutável e versionado.
- Aplicar edição cria nova Attempt e revalidação completa; resultado anterior permanece imutável.
- Fila de revisão é priorizada, explicável e não bloqueia a conclusão automática do lote.
- GCPs possuem lifecycle, provenance, incerteza e exports tipados.
...
`ADR-023`, `ADR-025`, `ADR-045`, `ADR-046`
...
- **Requisitos owned:** `REQ-ANC-008`, `REQ-GCP-001`, `REQ-GCP-002`, `REQ-REV-003`, `REQ-REV-004`
- **Épicos relacionados:** `EPIC-024`, `EPIC-037`, `EPIC-049`, `EPIC-052`, `EPIC-062`, `EPIC-063`, `EPIC-064`, `EPIC-066`, `EPIC-100`
...
Este boundary é concretizado por `SPEC-002`. Texto, schemas, exemplos e validadores dessas especificações são obrigatórios. Divergência bloqueia implementação e exige reconciliação pelo Arquiteto.
