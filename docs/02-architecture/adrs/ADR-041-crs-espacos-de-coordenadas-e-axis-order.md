# ADR-041 — CRS, espaços de coordenadas e axis order
...
- **Bounded Contexts:** `BC-006` — Georreferenciamento, `BC-007` — Verificação Geométrica e Qualidade, `BC-008` — Mosaico Relativo
...
- O domínio distingue pixel, origem, referência, working metric CRS, target CRS e display CRS.
- Toda coordenada fora de espaço fechado declara CRS, axis order, unidade e precisão.
- Transformações usam pyproj com always_xy na boundary e dupla precisão.
- CRS ausente, ambíguo, incompatível ou implausível falha fechado.
...
- **Requisitos owned:** `REQ-CRS-001`, `REQ-CRS-002`, `REQ-CRS-003`, `REQ-CRS-004`, `REQ-CRS-005`, `REQ-DBSCHEMA-005`, `REQ-NATIVE-002`
- **Épicos relacionados:** `EPIC-002`, `EPIC-004`, `EPIC-012`, `EPIC-021`, `EPIC-022`, `EPIC-024`, `EPIC-026`, `EPIC-058`, `EPIC-063`, `EPIC-093`, `EPIC-096`
