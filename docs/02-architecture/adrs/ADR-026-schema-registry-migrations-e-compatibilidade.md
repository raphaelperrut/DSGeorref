# ADR-026 — Schema registry, migrations e compatibilidade
...
- **Bounded Contexts:** `BC-013` — Artifacts, Proveniência e Lifecycle, `BC-015` — Release, Instalação e Supply Chain
...
- Schemas públicos e persistentes pertencem a registry versionado com janela explícita de compatibilidade.
- Banco evolui por migrations expand-migrate-contract, idempotentes, checkpointadas e verificáveis.
- Artifacts imutáveis usam readers/adapters versionados; rematerialização preserva lineage.
- Compatibility matrix cobre aplicação, banco, mensagens, workers, artifacts, ModelPacks e stack nativa.
...
- **Requisitos owned:** `REQ-DBSCHEMA-010`, `REQ-EPIC-012`, `REQ-SCM-002`, `REQ-UPG-002`
- **Épicos relacionados:** `EPIC-005`, `EPIC-012`, `EPIC-013`, `EPIC-106`, `EPIC-107`
