# ADR-015 — CLI, Direct Runner e núcleo compartilhado

- **Status:** `Accepted`
- **Baseline:** `SAR v2.8 — Fase E`
- **Aprovador:** `Project Owner`
- **Owner normativo:** `ADR-015`
...
- CLI e Direct Runner invocam os mesmos application services e contratos usados pela API e workers.
- Não existe implementação alternativa de caso de uso por superfície.
- Saídas, exit codes, Problem Details e idempotência são consistentes com a boundary HTTP.
- Execução síncrona é limitada por budgets e pode promover para job durável sem mudar semântica.
...
- **Requisitos owned:** `REQ-FS1-009`, `REQ-RUN-001`
- **Épicos relacionados:** `EPIC-002`, `EPIC-004`, `EPIC-005`, `EPIC-012`, `EPIC-014`, `EPIC-020`, `EPIC-021`, `EPIC-022`, `EPIC-023`, `EPIC-024`, `EPIC-026`, `EPIC-031`
