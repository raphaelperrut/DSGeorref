# ADR-005 — Layout context-first e direção de dependências
...
- Packages são context-first e layer-second: domain, application, adapters e contracts.
- Dependências apontam para dentro; adapters dependem de ports e application services, nunca o inverso.
- Packages por épico, issue, sprint ou agente e módulos genéricos utils/common/helpers/misc são proibidos.
- Imports circulares e regras de negócio em API, CLI, UI ou workers bloqueiam o CI.
...
- **Requisitos owned:** `REQ-RUN-003`, `REQ-RUNTIME-003`
- **Épicos relacionados:** `EPIC-002`, `EPIC-004`, `EPIC-012`, `EPIC-031`
