# ADR-007 — Write scopes, lanes paralelas e isolamento de mudança
...
- Toda tarefa declara allow_paths e deny_paths derivados de catálogo versionado.
- Lanes com write scopes sobrepostos são serializadas ou recompostas antes da execução.
- Agentes não modificam contratos compartilhados ou ADRs fora de uma issue de decisão aprovada.
- Handoffs registram arquivos alterados, testes, evidências, limitações e impacto em contratos.
...
- **Requisitos owned:** `REQ-GOV-004`
- **Épicos relacionados:** `EPIC-005`, `EPIC-091`
