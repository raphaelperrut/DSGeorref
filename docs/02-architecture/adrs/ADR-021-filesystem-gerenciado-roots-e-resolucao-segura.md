# ADR-021 — Filesystem gerenciado, roots e resolução segura
...
- Binários residem em roots gerenciados separados por função e durabilidade.
- Locators são relativos e opacos; paths absolutos de host não atravessam o domínio ou a API.
- Resolução é resistente a symlink escape, TOCTOU e root escape, com UID/GID dedicado e capability probe.
- Serving exige autorização e offload controlado.
...
- **Requisitos owned:** `REQ-RUNTIME-006`
- **Épicos relacionados:** `EPIC-004`, `EPIC-011`
