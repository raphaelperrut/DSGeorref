# ADR-045 — Estimação geométrica, homografia e seleção de GCPs
...
- Homografia projetiva é o modelo geométrico final canônico.
- USAC_MAGSAC é o estimador primário; RANSAC alternativo exige seleção explícita e benchmark.
- Correspondências são normalizadas, robustamente filtradas e avaliadas em múltiplos espaços.
- GCPs finais equilibram qualidade, cobertura, diversidade e conditioning.
...
- **Requisitos owned:** `REQ-ANC-002`, `REQ-CLASSICPROFILE-008`, `REQ-EST-001`, `REQ-FS1-006`, `REQ-RUN-005`, `REQ-RUNTIME-004`
- **Épicos relacionados:** `EPIC-002`, `EPIC-004`, `EPIC-005`, `EPIC-012`, `EPIC-014`, `EPIC-020`, `EPIC-021`, `EPIC-022`, `EPIC-023`, `EPIC-024`, `EPIC-026`, `EPIC-028`, `EPIC-031`, `EPIC-051`, `EPIC-078`, `EPIC-099`
