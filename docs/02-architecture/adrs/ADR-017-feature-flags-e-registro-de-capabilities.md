# ADR-017 — Feature flags e registro de capabilities
...
- **Bounded Contexts:** `BC-001` — Governança de Engenharia e Entrega, `BC-009` — Recuperação Assistida por IA e Governança de Modelos
...
- Feature flags e capabilities são locais, versionadas, auditáveis e fail-closed.
- Flags não substituem autorização, contrato, compatibilidade ou gate científico.
- Capabilities declaram requisitos de hardware, dados, profiles, licenças e estado de promoção.
- Capacidade experimental permanece isolada e desabilitada em profiles operacionais.
...
- **Requisitos owned:** `REQ-AI-001`, `REQ-RUN-010`, `REQ-RUNTIME-010`
- **Épicos relacionados:** `EPIC-002`, `EPIC-004`, `EPIC-011`, `EPIC-012`, `EPIC-031`, `EPIC-039`, `EPIC-050`
