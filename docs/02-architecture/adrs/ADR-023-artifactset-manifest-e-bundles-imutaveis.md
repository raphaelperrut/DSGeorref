# ADR-023 — ArtifactSet, manifest e bundles imutáveis
...
- ArtifactSet é bundle de diretório imutável com manifest raiz, checksums, lineage, versões, parâmetros, CRS e identidade dos inputs.
- Originais, attempts, CorrectionSets, AnchorSets e snapshots são imutáveis; edição cria nova versão.
- O manifest é validado por JSON Schema e é a unidade canônica de portabilidade e verificação.
- Artifact parcial nunca se torna vigente.
...
- **Requisitos owned:** `REQ-ART-003`, `REQ-ARTLAYOUT-003`, `REQ-ARTLAYOUT-007`, `REQ-ARTLAYOUT-009`, `REQ-ARTLAYOUT-010`, `REQ-FS1-008`
- **Épicos relacionados:** `EPIC-004`, `EPIC-005`, `EPIC-012`, `EPIC-014`, `EPIC-020`, `EPIC-021`, `EPIC-022`, `EPIC-023`, `EPIC-024`, `EPIC-026`, `EPIC-031`, `EPIC-039`, `EPIC-041`, `EPIC-046`, `EPIC-078`
