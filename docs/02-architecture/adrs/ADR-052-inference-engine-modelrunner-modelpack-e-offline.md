# ADR-052 — Inference Engine, ModelRunner, ModelPack e offline
...
- **Bounded Contexts:** `BC-009` — Recuperação Assistida por IA e Governança de Modelos, `BC-013` — Artifacts, Proveniência e Lifecycle, `BC-015` — Release, Instalação e Supply Chain
...
- Todo modelo executa por ModelRunner versionado com inputs/outputs, precision, device, determinism e budgets.
- Pesos são ModelPacks assinados, pinados, licenciados, opt-in e importáveis offline.
- Download implícito é proibido; egress é governado e o core permanece operacional sem modelos opcionais.
- Inference-first com modelos pré-treinados é a baseline; fine-tuning é iniciativa separada.
...
`ADR-009`, `ADR-023`, `ADR-032`, `ADR-051`
...
- **Requisitos owned:** `REQ-AI-005`, `REQ-AI-006`, `REQ-AI-009`, `REQ-AI-012`, `REQ-AIE-008`, `REQ-OFF-001`
- **Épicos relacionados:** `EPIC-005`, `EPIC-014`, `EPIC-022`, `EPIC-024`, `EPIC-026`, `EPIC-028`, `EPIC-039`, `EPIC-041`, `EPIC-049`, `EPIC-050`, `EPIC-058`, `EPIC-080`, `EPIC-083`
