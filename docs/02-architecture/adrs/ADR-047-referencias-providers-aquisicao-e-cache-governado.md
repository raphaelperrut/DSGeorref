# ADR-047 — Referências, providers, aquisição e cache governado
...
- **Bounded Contexts:** `BC-005` — Descoberta e Aquisição de Referências
...
- Providers implementam gateway por capabilities e contratos versionados.
- Busca é guiada, bounded, espaciotemporal e usa somente fontes gratuitas/autorizadas.
- Acquisition é governada pelo ProcessingPlan, licenças, budgets e egress policy.
- Cache é content-addressed, deduplicado, license-aware e preserva provenance.
...
- **Requisitos owned:** `REQ-CAC-001`, `REQ-DIS-001`, `REQ-DIS-002`, `REQ-SRC-001`, `REQ-SRC-002`, `REQ-SRC-003`, `REQ-SRC-004`, `REQ-SRC-005`
- **Épicos relacionados:** `EPIC-019`, `EPIC-027`, `EPIC-029`, `EPIC-033`, `EPIC-041`, `EPIC-049`, `EPIC-054`, `EPIC-055`, `EPIC-058`, `EPIC-059`, `EPIC-060`, `EPIC-061`
