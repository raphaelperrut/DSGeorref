# ADR-057 — Release train, publicação e gates de distribuição
...
- **Bounded Contexts:** `BC-015` — Release, Instalação e Supply Chain, `BC-001` — Governança de Engenharia e Entrega
...
- O release train progride por private alpha, public beta e 1.0 com gates explícitos.
- Release candidate reúne locks, SBOM, assinaturas, migrations, compatibility matrix, evidence e rollback.
- Publicação é bloqueada por falha de segurança, licença, restore, compatibilidade ou gate científico.
- Mudança de canal ou visibilidade não altera a semântica dos artifacts promovidos.
...
`ADR-026`, `ADR-033`, `ADR-034`, `ADR-035`, `ADR-056`
...
- **Requisitos owned:** `REQ-DEL-002`, `REQ-FRZ-001`, `REQ-FRZ-002`, `REQ-FRZ-003`, `REQ-FRZ-004`, `REQ-PUB-002`
- **Épicos relacionados:** `EPIC-001`, `EPIC-005`, `EPIC-007`, `EPIC-086`, `EPIC-087`, `EPIC-091`, `EPIC-092`
...
Este boundary é concretizado por `SPEC-001`. Texto, schemas, exemplos e validadores dessas especificações são obrigatórios. Divergência bloqueia implementação e exige reconciliação pelo Arquiteto.
