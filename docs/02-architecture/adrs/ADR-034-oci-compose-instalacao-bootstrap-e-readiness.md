# ADR-034 — OCI/Compose, instalação, bootstrap e readiness
...
- **Bounded Contexts:** `BC-015` — Release, Instalação e Supply Chain, `BC-014` — Operações, Auditoria e Suporte
...
- Imagens OCI e Compose são o método oficial inicial de instalação single-instance.
- InstallationPlan é declarativo, idempotente e checkpointado.
- Readiness valida banco, broker, roots, migrations, ABI, capabilities e configuração.
- Canary sintético ponta a ponta integra o evidence set de instalação.
...
`ADR-002`, `ADR-009`, `ADR-032`, `ADR-033`
...
- **Requisitos owned:** `REQ-CRS-007`, `REQ-INS-002`, `REQ-INS-003`, `REQ-INS-004`, `REQ-WORKER-010`
- **Épicos relacionados:** `EPIC-002`, `EPIC-005`, `EPIC-008`, `EPIC-014`, `EPIC-039`, `EPIC-058`, `EPIC-075`, `EPIC-076`, `EPIC-080`, `EPIC-096`, `EPIC-108`
