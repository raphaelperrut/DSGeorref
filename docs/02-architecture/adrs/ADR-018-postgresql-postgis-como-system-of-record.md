# ADR-018 — PostgreSQL/PostGIS como system of record
...
- PostgreSQL/PostGIS é a fonte autoritativa de projetos, assets, planos, jobs, attempts, estados, geometrias, auditoria, lineage e referências.
- Broker, logs, frontend e filesystem não substituem o estado relacional.
- Geometrias consultáveis e relações espaciais são persistidas com SRID e constraints explícitos.
- Binários pesados permanecem fora do banco e são referenciados por IDs lógicos.
...
- **Requisitos owned:** `REQ-BKP-001`, `REQ-EPIC-015`, `REQ-TOOL-004`, `REQ-TOOL-007`, `REQ-WORKER-005`
- **Épicos relacionados:** `EPIC-002`, `EPIC-005`, `EPIC-012`, `EPIC-013`, `EPIC-014`, `EPIC-015`, `EPIC-016`, `EPIC-028`, `EPIC-039`, `EPIC-049`, `EPIC-071`
