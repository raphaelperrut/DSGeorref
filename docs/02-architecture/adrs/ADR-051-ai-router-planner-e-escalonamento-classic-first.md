# ADR-051 — AI Router, planner e escalonamento classic-first
...
- **Bounded Contexts:** `BC-009` — Recuperação Assistida por IA e Governança de Modelos, `BC-007` — Verificação Geométrica e Qualidade
...
- IA é capability governada e nunca fonte de aceitação final.
- AI Router avalia falha clássica tipada, preconditions, budgets, evidence e capability profile.
- Escalonamento neural só ocorre após baseline clássica checkpointada e elegível.
- Toda solução neural passa pelo mesmo SGV independente e não recebe threshold privilegiado.
...
- **Requisitos owned:** `REQ-AI-007`, `REQ-AI-011`, `REQ-AIE-001`, `REQ-AIE-004`, `REQ-AIE-006`
- **Épicos relacionados:** `EPIC-005`, `EPIC-006`, `EPIC-014`, `EPIC-022`, `EPIC-024`, `EPIC-028`, `EPIC-029`, `EPIC-033`, `EPIC-039`, `EPIC-041`, `EPIC-050`
