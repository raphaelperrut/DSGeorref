# ADR-019 — Schemas físicos, UUIDv7, escopo e concorrência
...
- **Bounded Contexts:** `BC-003` — Projetos, Workspace e Assets, `BC-013` — Artifacts, Proveniência e Lifecycle
...
- Schemas PostgreSQL são separados por responsabilidade e owner context.
- IDs lógicos são UUIDv7 gerados pela aplicação; tempo usa timestamptz.
- Escopo de projeto é imposto por constraints e autorização central.
- Concorrência usa revisão otimista ou locks explícitos; JSONB é limitado a boundaries versionadas.
...
- **Requisitos owned:** `REQ-DBSCHEMA-001`, `REQ-DBSCHEMA-002`, `REQ-DBSCHEMA-004`, `REQ-DBSCHEMA-006`, `REQ-DBSCHEMA-007`, `REQ-DBSCHEMA-008`
- **Épicos relacionados:** `EPIC-004`, `EPIC-012`, `EPIC-013`, `EPIC-014`, `EPIC-026`
