# ADR-001 — Topologia do repositório, monorepo e workspaces
...
- O código, contratos, documentação, infraestrutura e evidências residem em um único monorepo versionado.
- Python e frontend usam workspaces independentes, locks commitados e uma fachada de comandos estável pelo Makefile.
- Dependências entre packages são explícitas; geração de código e artifacts derivados nunca criam uma segunda fonte normativa.
- Alterar para múltiplos repositórios exige nova ADR e plano de compatibilidade dos contratos.
...
- **Requisitos owned:** `REQ-DEV-001`, `REQ-TOOL-002`, `REQ-TOOL-005`, `REQ-TOOL-010`
- **Épicos relacionados:** `EPIC-001`, `EPIC-002`, `EPIC-003`, `EPIC-004`, `EPIC-012`, `EPIC-043`, `EPIC-092`
