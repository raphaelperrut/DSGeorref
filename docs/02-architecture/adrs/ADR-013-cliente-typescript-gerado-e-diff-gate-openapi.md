# ADR-013 — Cliente TypeScript gerado e diff gate OpenAPI
...
- O cliente TypeScript é gerado exclusivamente do OpenAPI commitado.
- Diff semântico detecta breaking changes antes da integração.
- Código manual não duplica DTOs, enums ou wrappers gerados.
- Frontend e testes de contrato usam o mesmo artifact de geração.
...
- **Requisitos owned:** `REQ-EPIC-031`, `REQ-RUN-008`
