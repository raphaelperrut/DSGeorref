# STORY-0291 / ISSUE-0401 — Implementar o núcleo algorítmico: extração opcional de metadados marginais com confiança, revisão e lineage
...
- **TaskEnvelope:** `.codex/tasks/TASK-0291.json`

## História de usuário

Como operador geoespacial, preciso implementar o núcleo algorítmico para “extração opcional de metadados marginais com confiança, revisão e lineage”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar o núcleo algorítmico para a capacidade **extração opcional de metadados marginais com confiança, revisão e lineage**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-048` e o TaskEnvelope `TASK-0291`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0401-01, AC-ISSUE-0401-02, AC-ISSUE-0401-03, AC-ISSUE-0401-04`
