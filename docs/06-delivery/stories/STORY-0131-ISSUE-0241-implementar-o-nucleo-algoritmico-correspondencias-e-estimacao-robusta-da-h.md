# STORY-0131 / ISSUE-0241 — Implementar o núcleo algorítmico: correspondências e estimação robusta da homografia projetiva validadas
...
- **TaskEnvelope:** `.codex/tasks/TASK-0131.json`

## História de usuário

Como operador geoespacial, preciso implementar o núcleo algorítmico para “correspondências e estimação robusta da homografia projetiva validadas”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar o núcleo algorítmico para a capacidade **correspondências e estimação robusta da homografia projetiva validadas**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-023` e o TaskEnvelope `TASK-0131`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0241-01, AC-ISSUE-0241-02, AC-ISSUE-0241-03, AC-ISSUE-0241-04`
