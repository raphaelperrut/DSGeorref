# STORY-0639 / ISSUE-0749 — Auditar evidência científica e final: Relatórios, visualização e exports do mosaico relativo
...
- **TaskEnvelope:** `.codex/tasks/TASK-0639.json`

## História de usuário

Como operador geoespacial, preciso auditar evidência científica e final para “Relatórios, visualização e exports do mosaico relativo”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar evidência científica e final para a capacidade **Relatórios, visualização e exports do mosaico relativo**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/relatorios-visualizacao-e-exports-do-mosaico-relativo/**`
## Fora de escopo
...
- `test_epic_102_aceite_happy_path`
- `test_epic_102_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-102` e o TaskEnvelope `TASK-0639`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0749-01, AC-ISSUE-0749-02, AC-ISSUE-0749-03, AC-ISSUE-0749-04`
