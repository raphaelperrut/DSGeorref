# STORY-0578 / ISSUE-0688 — Preparar corpus, fixtures e representação tipada: Registry e transformações de CRS
...
- **TaskEnvelope:** `.codex/tasks/TASK-0578.json`

## História de usuário

Como operador geoespacial, preciso preparar corpus, fixtures e representação tipada para “Registry e transformações de CRS”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Preparar corpus, fixtures e representação tipada para a capacidade **Registry e transformações de CRS**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-094` e o TaskEnvelope `TASK-0578`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0688-01, AC-ISSUE-0688-02, AC-ISSUE-0688-03, AC-ISSUE-0688-04`
