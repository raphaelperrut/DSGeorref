# STORY-0445 / ISSUE-0555 — Definir modelo, invariantes e contratos de dados: BackupSet coordenado, manifests, checksums, watermark e policies de inclusão
...
- **TaskEnvelope:** `.codex/tasks/TASK-0445.json`

## História de usuário

Como operador geoespacial, preciso definir modelo, invariantes e contratos de dados para “BackupSet coordenado, manifests, checksums, watermark e policies de inclusão”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir modelo, invariantes e contratos de dados para a capacidade **BackupSet coordenado, manifests, checksums, watermark e policies de inclusão**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/artifact_provenance/dat/backupset-coordenado-manifests-checksums-watermark-e-p/**`
- `docs/02-architecture/design-reviews/backupset-coordenado-manifests-checksums-watermark-e-p/**`
## Fora de escopo
...
- [ ] Os requisitos REQ-SCM-004, REQ-UPG-001 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-071` e o TaskEnvelope `TASK-0445`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0555-01, AC-ISSUE-0555-02, AC-ISSUE-0555-03, AC-ISSUE-0555-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-035`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-016`, `ADR-018`, `ADR-025`, `ADR-035`
