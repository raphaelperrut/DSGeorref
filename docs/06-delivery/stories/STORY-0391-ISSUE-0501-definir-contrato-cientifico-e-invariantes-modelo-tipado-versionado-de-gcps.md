# STORY-0391 / ISSUE-0501 — Definir contrato científico e invariantes: modelo tipado/versionado de GCPs, lifecycle, proveniência e round-trip dos exports
...
- **TaskEnvelope:** `.codex/tasks/TASK-0391.json`

## História de usuário

Como operador geoespacial, preciso definir contrato científico e invariantes para “modelo tipado/versionado de GCPs, lifecycle, proveniência e round-trip dos exports”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir contrato científico e invariantes para a capacidade **modelo tipado/versionado de GCPs, lifecycle, proveniência e round-trip dos exports**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/review_correction/geo/modelo-tipado-versionado-de-gcps-lifecycle-provenienci/**`
- `docs/02-architecture/design-reviews/modelo-tipado-versionado-de-gcps-lifecycle-provenienci/**`
## Fora de escopo
...
- [ ] Os requisitos REQ-CRS-001, REQ-GCP-002 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-063` e o TaskEnvelope `TASK-0391`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0501-01, AC-ISSUE-0501-02, AC-ISSUE-0501-03, AC-ISSUE-0501-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-041`, `ADR-048`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-041`, `ADR-048`
