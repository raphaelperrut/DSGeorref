# STORY-0711 / ISSUE-0821 — Slice 4/4 — Materializar a fundação executável: migrations, CI, secret/dependency scan e telemetria mínima [REQ-SGVCAL, REQ-SRG, REQ-SRP, REQ-SUP, REQ-TOOL, REQ-UPG]
...
- **TaskEnvelope:** `.codex/tasks/TASK-0711.json`
...
- `tools/governance/migrations-ci-secret-dependency-scan-e-telemetria-mini/sgvcal-srg-srp-parte-4/**`
- `docs/03-engineering/contexts/engineering_governance/migrations-ci-secret-dependency-scan-e-telemetria-mini/sgvcal-srg-srp-parte-4/**`
## Fora de escopo
...
`REQ-SGVCAL-008`, `REQ-SGVCAL-009`, `REQ-SGVCAL-010`, `REQ-SRG-002`, `REQ-SRP-002`, `REQ-SUP-001`, `REQ-TOOL-006`, `REQ-TOOL-007`, `REQ-TOOL-009`, `REQ-UPG-003`
...
- [ ] Cada requisito do slice possui evidência explícita: REQ-SGVCAL-008, REQ-SGVCAL-009, REQ-SGVCAL-010, REQ-SRG-002, REQ-SRP-002, REQ-SUP-001, REQ-TOOL-006, REQ-TOOL-007, REQ-TOOL-009, REQ-UPG-003.
...
- `test_release_sbom_signature_provenance_immutable_pins`
- `test_ruff_mypy_gate`
- `test_pytest_real_services`
- `test_frontend_strict_and_browser`
...
Leia `AGENTS.md`, o papel `.codex/roles/ROLE-003-tech-lead.md`, esta história e `TASK-0711`. Trabalhe somente nos paths permitidos, entregue apenas este slice e interrompa diante de qualquer condição de parada.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0821-01, AC-ISSUE-0821-02, AC-ISSUE-0821-03, AC-ISSUE-0821-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-014`, `ADR-018`, `ADR-024`, `ADR-035`, `ADR-037`, `ADR-046`, `ADR-053`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-014`, `ADR-018`, `ADR-023`, `ADR-024`, `ADR-026`, `ADR-035`, `ADR-037`, `ADR-046`, `ADR-051`, `ADR-052`, `ADR-053`, `ADR-055`
