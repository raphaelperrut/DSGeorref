# STORY-0018 / ISSUE-0128 — Automatizar validações e controles: OpenAPI, cliente TypeScript e contratos CLI/jobs/eventos/artefatos/ProcessingPlan/QualityReport/FailureDiagnostic versionados
...
- **TaskEnvelope:** `.codex/tasks/TASK-0018.json`

## História de usuário

Como mantenedor de engenharia, preciso automatizar validações e controles para “OpenAPI, cliente TypeScript e contratos CLI/jobs/eventos/artefatos/ProcessingPlan/QualityReport/FailureDiagnostic versionados”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Automatizar validações e controles para a capacidade **OpenAPI, cliente TypeScript e contratos CLI/jobs/eventos/artefatos/ProcessingPlan/QualityReport/FailureDiagnostic versionados**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/fnd/openapi-cliente-typescript-e-contratos-cli-jobs-evento/**`
- `tools/quality/contexts/engineering_governance/openapi-cliente-typescript-e-contratos-cli-jobs-evento/**`
- `.github/workflows/openapi-cliente-typescript-e-contratos-cli-jobs-evento.yaml`
## Fora de escopo
...
- [ ] O resultado de “OpenAPI, cliente TypeScript e contratos CLI/jobs/eventos/artefatos/ProcessingPlan/QualityReport/FailureDiagnostic versionados” é observável por contrato, interface, artifact ou evidência executável.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-004` e o TaskEnvelope `TASK-0018`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0128-01, AC-ISSUE-0128-02, AC-ISSUE-0128-03, AC-ISSUE-0128-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-010`, `ADR-011`, `ADR-013`, `ADR-014`, `ADR-015`, `ADR-021`, `ADR-023`, `ADR-033`, `ADR-034`, `ADR-055`
