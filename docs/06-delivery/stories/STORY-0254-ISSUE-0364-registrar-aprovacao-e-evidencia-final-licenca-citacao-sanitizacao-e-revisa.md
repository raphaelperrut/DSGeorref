# STORY-0254 / ISSUE-0364 — Registrar aprovação e evidência final: licença, citação, sanitização e revisão externa concluídas
...
- **TaskEnvelope:** `.codex/tasks/TASK-0254.json`

## História de usuário

Como mantenedor do projeto, preciso registrar aprovação e evidência final para “licença, citação, sanitização e revisão externa concluídas”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Registrar aprovação e evidência final para a capacidade **licença, citação, sanitização e revisão externa concluídas**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/licenca-citacao-sanitizacao-e-revisao-externa-concluid/**`
## Fora de escopo
...
- `test_epic_042_aceite_happy_path`
- `test_epic_042_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-042` e o TaskEnvelope `TASK-0254`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0364-01, AC-ISSUE-0364-02, AC-ISSUE-0364-03, AC-ISSUE-0364-04`
