# STORY-0415 / ISSUE-0525 — Automatizar testes de resiliência, retry e recuperação: checkpoints canônicos, manifests de compatibilidade, retomada e lifecycle de intermediários
...
- **TaskEnvelope:** `.codex/tasks/TASK-0415.json`

## História de usuário

Como operador geoespacial, preciso automatizar testes de resiliência, retry e recuperação para “checkpoints canônicos, manifests de compatibilidade, retomada e lifecycle de intermediários”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Automatizar testes de resiliência, retry e recuperação para a capacidade **checkpoints canônicos, manifests de compatibilidade, retomada e lifecycle de intermediários**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/job/checkpoints-canonicos-manifests-de-compatibilidade-ret/**`
- `tools/quality/contexts/job_orchestration/checkpoints-canonicos-manifests-de-compatibilidade-ret/**`
- `.github/workflows/checkpoints-canonicos-manifests-de-compatibilidade-ret.yaml`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-066` e o TaskEnvelope `TASK-0415`. Trabalhe somente nos paths permitidos. Entregue o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0525-01, AC-ISSUE-0525-02, AC-ISSUE-0525-03, AC-ISSUE-0525-04`
