# STORY-0340 / ISSUE-0450 — Integrar ao ProcessingPlan e pipeline: recuperação progressiva de vizinhos com candidate budget, telemetria de recall e retry ampliado explícito
...
- **TaskEnvelope:** `.codex/tasks/TASK-0340.json`

## História de usuário

Como operador geoespacial, preciso integrar ao processingplan e pipeline para “recuperação progressiva de vizinhos com candidate budget, telemetria de recall e retry ampliado explícito”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Integrar ao ProcessingPlan e pipeline para a capacidade **recuperação progressiva de vizinhos com candidate budget, telemetria de recall e retry ampliado explícito**, com saída versionada, testes e evidência no commit candidato.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0450-01, AC-ISSUE-0450-02, AC-ISSUE-0450-03, AC-ISSUE-0450-04`
