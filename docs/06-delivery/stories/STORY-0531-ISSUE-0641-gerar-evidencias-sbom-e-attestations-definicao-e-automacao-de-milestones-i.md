# STORY-0531 / ISSUE-0641 — Gerar evidências, SBOM e attestations: definição e automação de milestones internal/alpha/beta/1.0, evidências e gate de abertura do repositório
...
- **TaskEnvelope:** `.codex/tasks/TASK-0531.json`

## História de usuário

Como responsável por release, preciso gerar evidências, sbom e attestations para “definição e automação de milestones internal/alpha/beta/1.0, evidências e gate de abertura do repositório”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Gerar evidências, SBOM e attestations para a capacidade **definição e automação de milestones internal/alpha/beta/1.0, evidências e gate de abertura do repositório**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/release_installation/adapters/security/definicao-e-automacao-de-milestones-internal-alpha-bet/**`
- `tests/security/contexts/release_installation/definicao-e-automacao-de-milestones-internal-alpha-bet/**`
## Fora de escopo
...
- [ ] SBOM, assinatura, provenance e checksums vinculam a release aos fontes e builds.

## Testes obrigatórios

- `test_epic_085_evidencia`
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0641-01, AC-ISSUE-0641-02, AC-ISSUE-0641-03, AC-ISSUE-0641-04`
