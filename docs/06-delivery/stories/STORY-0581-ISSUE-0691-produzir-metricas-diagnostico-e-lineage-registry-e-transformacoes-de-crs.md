# STORY-0581 / ISSUE-0691 — Produzir métricas, diagnóstico e lineage: Registry e transformações de CRS
...
- **TaskEnvelope:** `.codex/tasks/TASK-0581.json`

## História de usuário

Como operador geoespacial, preciso produzir métricas, diagnóstico e lineage para “Registry e transformações de CRS”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Produzir métricas, diagnóstico e lineage para a capacidade **Registry e transformações de CRS**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/geo/dsgeorref_geo/contexts/georeferencing/registry-e-transformacoes-de-crs/**`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-094` e o TaskEnvelope `TASK-0581`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0691-01, AC-ISSUE-0691-02, AC-ISSUE-0691-03, AC-ISSUE-0691-04`
