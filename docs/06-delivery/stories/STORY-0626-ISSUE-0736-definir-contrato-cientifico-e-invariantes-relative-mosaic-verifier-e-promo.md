# STORY-0626 / ISSUE-0736 — Definir contrato científico e invariantes: Relative Mosaic Verifier e promotion lifecycle
...
- **TaskEnvelope:** `.codex/tasks/TASK-0626.json`

## História de usuário

Como operador geoespacial, preciso definir contrato científico e invariantes para “Relative Mosaic Verifier e promotion lifecycle”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir contrato científico e invariantes para a capacidade **Relative Mosaic Verifier e promotion lifecycle**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/relative_mosaic/geo/relative-mosaic-verifier-e-promotion-lifecycle/**`
- `docs/02-architecture/design-reviews/relative-mosaic-verifier-e-promotion-lifecycle/**`
## Fora de escopo
...
- [ ] Os requisitos REQ-RMV-001 possuem evidência explícita no commit candidato.
...
- `test_relative_mosaic_quality_profile_independent_hard_and_reviewable_gates`
- `test_epic_101_contrato`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-101` e o TaskEnvelope `TASK-0626`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0736-01, AC-ISSUE-0736-02, AC-ISSUE-0736-03, AC-ISSUE-0736-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-050`
- **Conflito:** `Nenhum`
