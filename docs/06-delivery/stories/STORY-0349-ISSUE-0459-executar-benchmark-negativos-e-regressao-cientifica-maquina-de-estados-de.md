# STORY-0349 / ISSUE-0459 — Executar benchmark, negativos e regressão científica: máquina de estados de arestas, evidência direta, lineage e SGV independente da imagem dependente
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0349.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “máquina de estados de arestas, evidência direta, lineage e SGV independente da imagem dependente”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **máquina de estados de arestas, evidência direta, lineage e SGV independente da imagem dependente**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/maquina-de-estados-de-arestas-evidencia-direta-lineage/**`
- `tools/quality/contexts/reference_discovery/maquina-de-estados-de-arestas-evidencia-direta-lineage/**`
- `.github/workflows/maquina-de-estados-de-arestas-evidencia-direta-lineage.yaml`
## Fora de escopo
...
`STORY-0345`, `STORY-0346`, `STORY-0347`, `STORY-0348`

## Critérios de aceitação

- [ ] O resultado de “máquina de estados de arestas, evidência direta, lineage e SGV independente da imagem dependente” é observável por contrato, interface, artifact ou evidência executável.
- [ ] Os requisitos REQ-REF-002 possuem evidência explícita no commit candidato.
...
- `test_direct_edge_evidence_and_independent_dependent_sgv`
- `test_epic_056_benchmark_happy_path`
- `test_epic_056_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-056` e o TaskEnvelope `TASK-0349`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0459-01, AC-ISSUE-0459-02, AC-ISSUE-0459-03, AC-ISSUE-0459-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-040`
- **Conflito:** `Nenhum`
