# STORY-0559 / ISSUE-0669 — Validar evidência e realizar auditoria final: Issue Forms, templates e taxonomia de tipos com validação de campos obrigatórios
...
- **TaskEnvelope:** `.codex/tasks/TASK-0559.json`

## História de usuário

Como mantenedor de engenharia, preciso validar evidência e realizar auditoria final para “Issue Forms, templates e taxonomia de tipos com validação de campos obrigatórios”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Validar evidência e realizar auditoria final para a capacidade **Issue Forms, templates e taxonomia de tipos com validação de campos obrigatórios**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/issue-forms-templates-e-taxonomia-de-tipos-com-validac/**`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-090` e o TaskEnvelope `TASK-0559`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0669-01, AC-ISSUE-0669-02, AC-ISSUE-0669-03, AC-ISSUE-0669-04`
