# STORY-0099 / ISSUE-0209 — Expor comandos, progresso e reconciliação: batch hierárquico, chunking, backpressure, checkpoints e retomada para lotes usuais de 40–300 imagens
...
- **TaskEnvelope:** `.codex/tasks/TASK-0099.json`

## História de usuário

Como operador geoespacial, preciso expor comandos, progresso e reconciliação para “batch hierárquico, chunking, backpressure, checkpoints e retomada para lotes usuais de 40–300 imagens”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Expor comandos, progresso e reconciliação para a capacidade **batch hierárquico, chunking, backpressure, checkpoints e retomada para lotes usuais de 40–300 imagens**, com saída versionada, testes e evidência no commit candidato.
...
`REQ-BEX-001`, `REQ-EPIC-062`, `REQ-SCH-002`, `REQ-SCL-001`
...
- [ ] Os requisitos REQ-BEX-001, REQ-EPIC-062, REQ-SCH-002, REQ-SCL-001 possuem evidência explícita no commit candidato.
...
- `test_hierarchical_dag_chunk_limits_backpressure_leases_and_safe_boundaries`
- `test_batches_40_100_300_memory_checkpoint_backpressure`
- `test_epic_018_superficie`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-018` e o TaskEnvelope `TASK-0099`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0209-01, AC-ISSUE-0209-02, AC-ISSUE-0209-03, AC-ISSUE-0209-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-002`, `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-016`, `ADR-039`, `ADR-053`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-002`, `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-012`, `ADR-016`, `ADR-018`, `ADR-019`, `ADR-039`, `ADR-053`
