# STORY-0631 / ISSUE-0741 — Executar benchmark, negativos e regressão científica: Relative Mosaic Verifier e promotion lifecycle
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0631.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “Relative Mosaic Verifier e promotion lifecycle”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **Relative Mosaic Verifier e promotion lifecycle**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/relative-mosaic-verifier-e-promotion-lifecycle/**`
- `tools/quality/contexts/relative_mosaic/relative-mosaic-verifier-e-promotion-lifecycle/**`
- `.github/workflows/relative-mosaic-verifier-e-promotion-lifecycle.yaml`
## Fora de escopo
...
`STORY-0627`, `STORY-0628`, `STORY-0629`, `STORY-0630`

## Critérios de aceitação

- [ ] O resultado de “Relative Mosaic Verifier e promotion lifecycle” é observável por contrato, interface, artifact ou evidência executável.
...
- `test_epic_101_benchmark_happy_path`
- `test_epic_101_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-101` e o TaskEnvelope `TASK-0631`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0741-01, AC-ISSUE-0741-02, AC-ISSUE-0741-03, AC-ISSUE-0741-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-050`
