# STORY-0200 / ISSUE-0310 — Integrar mapa, fluxo e estados de erro: assistente guiado, recomendação explicável, consentimentos e modo avançado
...
- **TaskEnvelope:** `.codex/tasks/TASK-0200.json`

## História de usuário

Como operador geoespacial, preciso integrar mapa, fluxo e estados de erro para “assistente guiado, recomendação explicável, consentimentos e modo avançado”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Integrar mapa, fluxo e estados de erro para a capacidade **assistente guiado, recomendação explicável, consentimentos e modo avançado**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-005-frontend.md`, este documento, o épico `EPIC-033` e o TaskEnvelope `TASK-0200`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0310-01, AC-ISSUE-0310-02, AC-ISSUE-0310-03, AC-ISSUE-0310-04`
