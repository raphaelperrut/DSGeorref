# STORY-0210 / ISSUE-0320 — Definir contratos de correção e nova tentativa: workflow de revisão com gates revisáveis, hard gates imutáveis, checklist e auditoria
...
- **TaskEnvelope:** `.codex/tasks/TASK-0210.json`

## História de usuário

Como revisor geoespacial, preciso definir contratos de correção e nova tentativa para “workflow de revisão com gates revisáveis, hard gates imutáveis, checklist e auditoria”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir contratos de correção e nova tentativa para a capacidade **workflow de revisão com gates revisáveis, hard gates imutáveis, checklist e auditoria**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/review_correction/rev/workflow-de-revisao-com-gates-revisaveis-hard-gates-im/**`
- `docs/02-architecture/design-reviews/workflow-de-revisao-com-gates-revisaveis-hard-gates-im/**`
## Fora de escopo
...
- [ ] Os requisitos REQ-EPIC-035 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-035` e o TaskEnvelope `TASK-0210`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0320-01, AC-ISSUE-0320-02, AC-ISSUE-0320-03, AC-ISSUE-0320-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-046`
- **Conflito:** `Nenhum`
