# STORY-0502 / ISSUE-0612 — Executar testes negativos e ofensivos: lockfiles, pins por digest/SHA, scanners, SBOM, assinatura OCI, attestations e verificador de release
...
- **TaskEnvelope:** `.codex/tasks/TASK-0502.json`

## História de usuário

Como administrador de segurança, preciso executar testes negativos e ofensivos para “lockfiles, pins por digest/SHA, scanners, SBOM, assinatura OCI, attestations e verificador de release”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar testes negativos e ofensivos para a capacidade **lockfiles, pins por digest/SHA, scanners, SBOM, assinatura OCI, attestations e verificador de release**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/release_installation/adapters/security/lockfiles-pins-por-digest-sha-scanners-sbom-assinatura/**`
- `tests/security/contexts/release_installation/lockfiles-pins-por-digest-sha-scanners-sbom-assinatura/**`
## Fora de escopo
...
- [ ] Casos de abuso e bypass são automatizados e falham o gate quando reproduzidos.

## Testes obrigatórios

- `test_epic_080_ofensivo_happy_path`
- `test_epic_080_ofensivo_negative_paths`
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0612-01, AC-ISSUE-0612-02, AC-ISSUE-0612-03, AC-ISSUE-0612-04`
