# STORY-0611 / ISSUE-0721 — Auditar evidência científica e final: Mosaico relativo de recuperação
...
- **TaskEnvelope:** `.codex/tasks/TASK-0611.json`

## História de usuário

Como operador geoespacial, preciso auditar evidência científica e final para “Mosaico relativo de recuperação”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar evidência científica e final para a capacidade **Mosaico relativo de recuperação**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/mosaico-relativo-de-recuperacao/**`
## Fora de escopo
...
- `test_epic_098_aceite_happy_path`
- `test_epic_098_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-098` e o TaskEnvelope `TASK-0611`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0721-01, AC-ISSUE-0721-02, AC-ISSUE-0721-03, AC-ISSUE-0721-04`
