# STORY-0152 / ISSUE-0262 — Implementar o núcleo algorítmico: artefatos e lineage
...
- **TaskEnvelope:** `.codex/tasks/TASK-0152.json`

## História de usuário

Como operador geoespacial, preciso implementar o núcleo algorítmico para “artefatos e lineage”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar o núcleo algorítmico para a capacidade **artefatos e lineage**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/geo/dsgeorref_geo/contexts/artifact_provenance/artefatos-e-lineage/**`
## Fora de escopo
...
`REQ-FS1-006`, `REQ-NATIVE-001`, `REQ-NATIVE-004`
...
- [ ] Os requisitos REQ-FS1-006, REQ-NATIVE-001, REQ-NATIVE-004 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-026` e o TaskEnvelope `TASK-0152`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0262-01, AC-ISSUE-0262-02, AC-ISSUE-0262-03, AC-ISSUE-0262-04`
