# STORY-0046 / ISSUE-0156 — Definir política, estados e contratos: autorização por projeto, operação, artefato e caminho
...
- **TaskEnvelope:** `.codex/tasks/TASK-0046.json`

## História de usuário

Como administrador da instância, preciso definir política, estados e contratos para “autorização por projeto, operação, artefato e caminho”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir política, estados e contratos para a capacidade **autorização por projeto, operação, artefato e caminho**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/identity_access/plt/autorizacao-por-projeto-operacao-artefato-e-caminho/**`
- `docs/02-architecture/design-reviews/autorizacao-por-projeto-operacao-artefato-e-caminho/**`
## Fora de escopo
...
- [ ] Os requisitos REQ-AUTH-IMPL-007 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-010` e o TaskEnvelope `TASK-0046`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0156-01, AC-ISSUE-0156-02, AC-ISSUE-0156-03, AC-ISSUE-0156-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-031`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-014`, `ADR-016`, `ADR-031`, `ADR-055`
