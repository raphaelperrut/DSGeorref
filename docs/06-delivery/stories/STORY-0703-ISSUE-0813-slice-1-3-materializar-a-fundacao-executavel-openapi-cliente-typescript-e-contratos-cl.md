# STORY-0703 / ISSUE-0813 — Slice 1/3 — Materializar a fundação executável: OpenAPI, cliente TypeScript e contratos CLI/jobs/eventos/artefatos/ProcessingPlan/QualityReport/FailureDiagnostic versionados [REQ-ARTLAYOUT, REQ-DBSCHEMA, REQ-FS1]
...
- **TaskEnvelope:** `.codex/tasks/TASK-0703.json`
...
- `tools/governance/openapi-cliente-typescript-e-contratos-cli-jobs-evento/artlayout-dbschema-fs1-parte-1/**`
- `docs/03-engineering/contexts/engineering_governance/openapi-cliente-typescript-e-contratos-cli-jobs-evento/artlayout-dbschema-fs1-parte-1/**`
## Fora de escopo
...
`REQ-ARTLAYOUT-010`, `REQ-DBSCHEMA-002`, `REQ-DBSCHEMA-004`, `REQ-FS1-002`, `REQ-FS1-003`, `REQ-FS1-005`, `REQ-FS1-007`, `REQ-FS1-008`, `REQ-FS1-009`, `REQ-FS1-010`
...
- [ ] Cada requisito do slice possui evidência explícita: REQ-ARTLAYOUT-010, REQ-DBSCHEMA-002, REQ-DBSCHEMA-004, REQ-FS1-002, REQ-FS1-003, REQ-FS1-005, REQ-FS1-007, REQ-FS1-008, REQ-FS1-009, REQ-FS1-010.
...
Leia `AGENTS.md`, o papel `.codex/roles/ROLE-003-tech-lead.md`, esta história e `TASK-0703`. Trabalhe somente nos paths permitidos, entregue apenas este slice e interrompa diante de qualquer condição de parada.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0813-01, AC-ISSUE-0813-02, AC-ISSUE-0813-03, AC-ISSUE-0813-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-015`, `ADR-019`, `ADR-023`, `ADR-040`, `ADR-044`, `ADR-046`, `ADR-055`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-013`, `ADR-014`, `ADR-015`, `ADR-019`, `ADR-021`, `ADR-023`, `ADR-040`, `ADR-044`, `ADR-046`, `ADR-055`
