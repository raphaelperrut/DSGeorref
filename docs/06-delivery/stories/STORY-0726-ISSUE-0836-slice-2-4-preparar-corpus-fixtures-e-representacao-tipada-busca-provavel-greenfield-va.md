# STORY-0726 / ISSUE-0836 — Slice 2/4 — Preparar corpus, fixtures e representação tipada: busca provável greenfield validada [REQ-CLASSICPROFILE, REQ-FS1, REQ-NATIVE]
...
- **TaskEnvelope:** `.codex/tasks/TASK-0726.json`
...
- `src/geo/dsgeorref_geo/contexts/reference_discovery/busca-provavel-greenfield-validada/classicprofile-fs1-native-parte-2/**`
## Fora de escopo
...
`REQ-CLASSICPROFILE-007`, `REQ-CLASSICPROFILE-009`, `REQ-FS1-002`, `REQ-FS1-003`, `REQ-FS1-008`, `REQ-FS1-009`, `REQ-FS1-010`, `REQ-NATIVE-003`, `REQ-NATIVE-005`, `REQ-NATIVE-006`
...
- [ ] Cada requisito do slice possui evidência explícita: REQ-CLASSICPROFILE-007, REQ-CLASSICPROFILE-009, REQ-FS1-002, REQ-FS1-003, REQ-FS1-008, REQ-FS1-009, REQ-FS1-010, REQ-NATIVE-003, REQ-NATIVE-005, REQ-NATIVE-006.
...
Leia `AGENTS.md`, o papel `.codex/roles/ROLE-007-geoprocessamento.md`, esta história e `TASK-0726`. Trabalhe somente nos paths permitidos, entregue apenas este slice e interrompa diante de qualquer condição de parada.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0836-01, AC-ISSUE-0836-02, AC-ISSUE-0836-03, AC-ISSUE-0836-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-015`, `ADR-023`, `ADR-040`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-044`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-015`, `ADR-023`, `ADR-025`, `ADR-040`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-044`, `ADR-045`, `ADR-046`, `ADR-055`
