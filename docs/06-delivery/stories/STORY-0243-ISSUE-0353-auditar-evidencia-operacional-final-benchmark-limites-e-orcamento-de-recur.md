# STORY-0243 / ISSUE-0353 — Auditar evidência operacional final: benchmark, limites e orçamento de recursos
...
- **TaskEnvelope:** `.codex/tasks/TASK-0243.json`

## História de usuário

Como administrador da instância, preciso auditar evidência operacional final para “benchmark, limites e orçamento de recursos”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar evidência operacional final para a capacidade **benchmark, limites e orçamento de recursos**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/benchmark-limites-e-orcamento-de-recursos/**`
## Fora de escopo
...
- `test_epic_040_aceite_happy_path`
- `test_epic_040_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-040` e o TaskEnvelope `TASK-0243`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0353-01, AC-ISSUE-0353-02, AC-ISSUE-0353-03, AC-ISSUE-0353-04`
