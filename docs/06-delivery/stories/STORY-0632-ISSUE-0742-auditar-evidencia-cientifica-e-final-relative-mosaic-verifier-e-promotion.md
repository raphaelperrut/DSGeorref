# STORY-0632 / ISSUE-0742 — Auditar evidência científica e final: Relative Mosaic Verifier e promotion lifecycle
...
- **TaskEnvelope:** `.codex/tasks/TASK-0632.json`

## História de usuário

Como operador geoespacial, preciso auditar evidência científica e final para “Relative Mosaic Verifier e promotion lifecycle”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar evidência científica e final para a capacidade **Relative Mosaic Verifier e promotion lifecycle**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/relative-mosaic-verifier-e-promotion-lifecycle/**`
## Fora de escopo
...
- `test_epic_101_aceite_happy_path`
- `test_epic_101_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-101` e o TaskEnvelope `TASK-0632`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0742-01, AC-ISSUE-0742-02, AC-ISSUE-0742-03, AC-ISSUE-0742-04`
