# STORY-0012 / ISSUE-0122 — Materializar a fundação executável: monorepo greenfield com CLI/API/Web mínimos e checks reproduzíveis
...
- **TaskEnvelope:** `.codex/tasks/TASK-0012.json`

## História de usuário

Como mantenedor de engenharia, preciso materializar a fundação executável para “monorepo greenfield com CLI/API/Web mínimos e checks reproduzíveis”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Materializar a fundação executável para a capacidade **monorepo greenfield com CLI/API/Web mínimos e checks reproduzíveis**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tools/governance/monorepo-greenfield-com-cli-api-web-minimos-e-checks-r/**`
- `docs/03-engineering/contexts/engineering_governance/monorepo-greenfield-com-cli-api-web-minimos-e-checks-r/**`
## Fora de escopo
...
- [ ] Os requisitos REQ-DEL-001, REQ-DEV-001 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-003-tech-lead.md`, este documento, o épico `EPIC-003` e o TaskEnvelope `TASK-0012`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0122-01, AC-ISSUE-0122-02, AC-ISSUE-0122-03, AC-ISSUE-0122-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-001`, `ADR-003`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-014`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-001`, `ADR-003`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-014`
