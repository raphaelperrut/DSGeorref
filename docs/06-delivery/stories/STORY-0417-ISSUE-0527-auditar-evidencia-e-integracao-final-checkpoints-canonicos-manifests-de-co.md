# STORY-0417 / ISSUE-0527 — Auditar evidência e integração final: checkpoints canônicos, manifests de compatibilidade, retomada e lifecycle de intermediários
...
- **TaskEnvelope:** `.codex/tasks/TASK-0417.json`

## História de usuário

Como operador geoespacial, preciso auditar evidência e integração final para “checkpoints canônicos, manifests de compatibilidade, retomada e lifecycle de intermediários”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar evidência e integração final para a capacidade **checkpoints canônicos, manifests de compatibilidade, retomada e lifecycle de intermediários**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/checkpoints-canonicos-manifests-de-compatibilidade-ret/**`
## Fora de escopo
...
- `test_epic_066_aceite_happy_path`
- `test_epic_066_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-066` e o TaskEnvelope `TASK-0417`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0527-01, AC-ISSUE-0527-02, AC-ISSUE-0527-03, AC-ISSUE-0527-04`
