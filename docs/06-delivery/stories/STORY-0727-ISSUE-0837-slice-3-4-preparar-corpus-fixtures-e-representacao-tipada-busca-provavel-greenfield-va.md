# STORY-0727 / ISSUE-0837 — Slice 3/4 — Preparar corpus, fixtures e representação tipada: busca provável greenfield validada [REQ-NATIVE, REQ-SGVCAL]
...
- **TaskEnvelope:** `.codex/tasks/TASK-0727.json`
...
- `src/geo/dsgeorref_geo/contexts/reference_discovery/busca-provavel-greenfield-validada/native-sgvcal-parte-3/**`
## Fora de escopo
...
`REQ-NATIVE-007`, `REQ-NATIVE-008`, `REQ-NATIVE-009`, `REQ-NATIVE-010`, `REQ-SGVCAL-002`, `REQ-SGVCAL-003`, `REQ-SGVCAL-004`, `REQ-SGVCAL-005`, `REQ-SGVCAL-006`, `REQ-SGVCAL-009`
...
- [ ] Cada requisito do slice possui evidência explícita: REQ-NATIVE-007, REQ-NATIVE-008, REQ-NATIVE-009, REQ-NATIVE-010, REQ-SGVCAL-002, REQ-SGVCAL-003, REQ-SGVCAL-004, REQ-SGVCAL-005, REQ-SGVCAL-006, REQ-SGVCAL-009.
...
Leia `AGENTS.md`, o papel `.codex/roles/ROLE-007-geoprocessamento.md`, esta história e `TASK-0727`. Trabalhe somente nos paths permitidos, entregue apenas este slice e interrompa diante de qualquer condição de parada.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0837-01, AC-ISSUE-0837-02, AC-ISSUE-0837-03, AC-ISSUE-0837-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-046`
- **Conflito:** `Nenhum`
