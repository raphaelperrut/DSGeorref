# STORY-0183 / ISSUE-0293 — Executar benchmark, negativos e regressão científica: taxonomia versionada de falhas, evidências, remediações seguras e contratos de resultado por imagem
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0183.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “taxonomia versionada de falhas, evidências, remediações seguras e contratos de resultado por imagem”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **taxonomia versionada de falhas, evidências, remediações seguras e contratos de resultado por imagem**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/taxonomia-versionada-de-falhas-evidencias-remediacoes/**`
- `tools/quality/contexts/results_reporting/taxonomia-versionada-de-falhas-evidencias-remediacoes/**`
- `.github/workflows/taxonomia-versionada-de-falhas-evidencias-remediacoes.yaml`
## Fora de escopo
...
`STORY-0179`, `STORY-0180`, `STORY-0181`, `STORY-0182`

## Critérios de aceitação

- [ ] O resultado de “taxonomia versionada de falhas, evidências, remediações seguras e contratos de resultado por imagem” é observável por contrato, interface, artifact ou evidência executável.
...
- `test_epic_030_benchmark_happy_path`
- `test_epic_030_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-030` e o TaskEnvelope `TASK-0183`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0293-01, AC-ISSUE-0293-02, AC-ISSUE-0293-03, AC-ISSUE-0293-04`
...
- **Resultado:** `PASS`
- **Risk tier:** `HIGH`
- **Controles aplicáveis:** `CTO-001, CTO-003, CTO-004, CTO-005, CTO-006, CTO-007, CTO-008, CTO-010, CTO-011, CTO-012, CTO-013, CTO-015`
