# STORY-0586 / ISSUE-0696 — Implementar o núcleo algorítmico: Validade raster explícita
...
- **TaskEnvelope:** `.codex/tasks/TASK-0586.json`

## História de usuário

Como operador geoespacial, preciso implementar o núcleo algorítmico para “Validade raster explícita”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar o núcleo algorítmico para a capacidade **Validade raster explícita**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-095` e o TaskEnvelope `TASK-0586`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0696-01, AC-ISSUE-0696-02, AC-ISSUE-0696-03, AC-ISSUE-0696-04`
