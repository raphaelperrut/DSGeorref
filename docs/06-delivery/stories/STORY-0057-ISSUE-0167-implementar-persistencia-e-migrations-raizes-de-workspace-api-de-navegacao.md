# STORY-0057 / ISSUE-0167 — Consolidar slices e liberar integração: raízes de workspace, API de navegação segura, catálogo, hashes e lineage
...
- **TaskEnvelope:** `.codex/tasks/TASK-0057.json`

## História de usuário

Como operador geoespacial, preciso implementar persistência e migrations para “raízes de workspace, API de navegação segura, catálogo, hashes e lineage”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.
...
- `src/backend/dsgeorref/contexts/project_workspace/application/raizes-de-workspace-api-de-navegacao-segura-catalogo-h/consolidacao/**`
- `src/backend/dsgeorref/contexts/project_workspace/adapters/raizes-de-workspace-api-de-navegacao-segura-catalogo-h/consolidacao/**`
## Fora de escopo
...
`STORY-0718`, `STORY-0719`, `STORY-0720`
...
- `test_story_0057_slice_consolidation`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-012` e o TaskEnvelope `TASK-0057`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0167-01, AC-ISSUE-0167-02, AC-ISSUE-0167-03, AC-ISSUE-0167-04`
