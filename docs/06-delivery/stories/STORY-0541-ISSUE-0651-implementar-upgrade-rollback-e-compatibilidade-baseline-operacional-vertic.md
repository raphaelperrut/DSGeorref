# STORY-0541 / ISSUE-0651 — Implementar upgrade, rollback e compatibilidade: baseline operacional vertical privado com escopo da DELIVERY_PLAN e evidências do corpus controlado
...
- **TaskEnvelope:** `.codex/tasks/TASK-0541.json`

## História de usuário

Como responsável por release, preciso implementar upgrade, rollback e compatibilidade para “baseline operacional vertical privado com escopo da DELIVERY_PLAN e evidências do corpus controlado”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar upgrade, rollback e compatibilidade para a capacidade **baseline operacional vertical privado com escopo da DELIVERY_PLAN e evidências do corpus controlado**, com saída versionada, testes e evidência no commit candidato.
...
- `test_epic_087_upgrade_roundtrip`
- `test_epic_087_upgrade_recovery`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-087` e o TaskEnvelope `TASK-0541`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0651-01, AC-ISSUE-0651-02, AC-ISSUE-0651-03, AC-ISSUE-0651-04`
