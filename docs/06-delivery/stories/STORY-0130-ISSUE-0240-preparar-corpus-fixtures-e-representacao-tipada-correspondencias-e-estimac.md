# STORY-0130 / ISSUE-0240 — Preparar corpus, fixtures e representação tipada: correspondências e estimação robusta da homografia projetiva validadas
...
- **TaskEnvelope:** `.codex/tasks/TASK-0130.json`

## História de usuário

Como operador geoespacial, preciso preparar corpus, fixtures e representação tipada para “correspondências e estimação robusta da homografia projetiva validadas”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Preparar corpus, fixtures e representação tipada para a capacidade **correspondências e estimação robusta da homografia projetiva validadas**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/geo/dsgeorref_geo/contexts/georeferencing/correspondencias-e-estimacao-robusta-da-homografia-pro/**`
## Fora de escopo
...
`REQ-FS1-002`, `REQ-FS1-003`, `REQ-FS1-008`, `REQ-FS1-009`, `REQ-FS1-010`, `REQ-SDR-001`
...
- [ ] Os requisitos REQ-FS1-002, REQ-FS1-003, REQ-FS1-008, REQ-FS1-009, REQ-FS1-010, REQ-SDR-001 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-023` e o TaskEnvelope `TASK-0130`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0240-01, AC-ISSUE-0240-02, AC-ISSUE-0240-03, AC-ISSUE-0240-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-015`, `ADR-023`, `ADR-040`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-044`, `ADR-053`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-015`, `ADR-023`, `ADR-040`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-044`, `ADR-045`, `ADR-046`, `ADR-053`, `ADR-055`
