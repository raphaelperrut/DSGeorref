# STORY-0594 / ISSUE-0704 — Integrar ao ProcessingPlan e pipeline: Seletor e validador de CRS
...
- **TaskEnvelope:** `.codex/tasks/TASK-0594.json`

## História de usuário

Como operador geoespacial, preciso integrar ao processingplan e pipeline para “Seletor e validador de CRS”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Integrar ao ProcessingPlan e pipeline para a capacidade **Seletor e validador de CRS**, com saída versionada, testes e evidência no commit candidato.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0704-01, AC-ISSUE-0704-02, AC-ISSUE-0704-03, AC-ISSUE-0704-04`
