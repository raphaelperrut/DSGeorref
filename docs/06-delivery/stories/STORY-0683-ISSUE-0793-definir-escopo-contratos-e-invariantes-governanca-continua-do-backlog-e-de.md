# STORY-0683 / ISSUE-0793 — Definir escopo, contratos e invariantes: governança contínua do backlog e decomposição de épicos em histórias implementáveis
...
- **TaskEnvelope:** `.codex/tasks/TASK-0683.json`

## História de usuário

Como mantenedor de engenharia, preciso definir escopo, contratos e invariantes para “governança contínua do backlog e decomposição de épicos em histórias implementáveis”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir escopo, contratos e invariantes para a capacidade **governança contínua do backlog e decomposição de épicos em histórias implementáveis**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/engineering_governance/fnd/governanca-continua-do-backlog-e-decomposicao-de-epico/**`
- `docs/02-architecture/design-reviews/governanca-continua-do-backlog-e-decomposicao-de-epico/**`
## Fora de escopo
...
`REQ-ISM-004`, `REQ-ISS-002`, `REQ-PLN-009`, `REQ-PRJ-004`, `REQ-SPRINT-001-004`
...
- [ ] O resultado de “governança contínua do backlog e decomposição de épicos em histórias implementáveis” é observável por contrato, interface, artifact ou evidência executável.
- [ ] Os requisitos REQ-ISM-004, REQ-ISS-002, REQ-PLN-009, REQ-PRJ-004, REQ-SPRINT-001-004 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-110` e o TaskEnvelope `TASK-0683`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0793-01, AC-ISSUE-0793-02, AC-ISSUE-0793-03, AC-ISSUE-0793-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-022`, `ADR-038`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-012`, `ADR-016`, `ADR-022`, `ADR-038`
