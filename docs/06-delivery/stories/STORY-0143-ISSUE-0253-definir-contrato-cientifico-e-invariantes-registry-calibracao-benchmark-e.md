# STORY-0143 / ISSUE-0253 — Definir contrato científico e invariantes: registry, calibração, benchmark e lifecycle de QualityProfiles oficiais/customizados
...
- **TaskEnvelope:** `.codex/tasks/TASK-0143.json`

## História de usuário

Como operador geoespacial, preciso definir contrato científico e invariantes para “registry, calibração, benchmark e lifecycle de QualityProfiles oficiais/customizados”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir contrato científico e invariantes para a capacidade **registry, calibração, benchmark e lifecycle de QualityProfiles oficiais/customizados**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/geometric_quality/geo/registry-calibracao-benchmark-e-lifecycle-de-qualitypr/**`
- `docs/02-architecture/design-reviews/registry-calibracao-benchmark-e-lifecycle-de-qualitypr/**`
## Fora de escopo
...
- [ ] Os requisitos REQ-QUAL-004 possuem evidência explícita no commit candidato.
...
- `test_quality_profile_immutable_version_hash_calibration_clone`
- `test_epic_025_contrato`
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0253-01, AC-ISSUE-0253-02, AC-ISSUE-0253-03, AC-ISSUE-0253-04`
