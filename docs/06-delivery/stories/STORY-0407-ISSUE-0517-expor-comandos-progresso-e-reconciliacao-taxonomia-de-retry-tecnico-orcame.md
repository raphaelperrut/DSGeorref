# STORY-0407 / ISSUE-0517 — Expor comandos, progresso e reconciliação: taxonomia de retry técnico, orçamento, backoff, idempotência e PlanVariants algorítmicos
...
- **TaskEnvelope:** `.codex/tasks/TASK-0407.json`

## História de usuário

Como operador geoespacial, preciso expor comandos, progresso e reconciliação para “taxonomia de retry técnico, orçamento, backoff, idempotência e PlanVariants algorítmicos”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Expor comandos, progresso e reconciliação para a capacidade **taxonomia de retry técnico, orçamento, backoff, idempotência e PlanVariants algorítmicos**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-065` e o TaskEnvelope `TASK-0407`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0517-01, AC-ISSUE-0517-02, AC-ISSUE-0517-03, AC-ISSUE-0517-04`
