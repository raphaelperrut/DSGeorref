# STORY-0261 / ISSUE-0371 — Definir contrato científico e invariantes: OutputProfile, COG canônico, preservação de resolução e validação da grade
...
- **TaskEnvelope:** `.codex/tasks/TASK-0261.json`

## História de usuário

Como operador geoespacial, preciso definir contrato científico e invariantes para “OutputProfile, COG canônico, preservação de resolução e validação da grade”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir contrato científico e invariantes para a capacidade **OutputProfile, COG canônico, preservação de resolução e validação da grade**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/georeferencing/geo/outputprofile-cog-canonico-preservacao-de-resolucao-e/**`
- `docs/02-architecture/design-reviews/outputprofile-cog-canonico-preservacao-de-resolucao-e/**`
## Fora de escopo
...
`REQ-ART-002`, `REQ-CRS-006`, `REQ-OUT-001`
...
- [ ] Os requisitos REQ-ART-002, REQ-CRS-006, REQ-OUT-001 possuem evidência explícita no commit candidato.
...
- `test_original_immutable_cog_validation`
- `test_technical_canonical_output_and_optional_web_derivative_lineage`
- `test_native_resolution_policy_resampling_ratio`
- `test_epic_044_contrato`
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0371-01, AC-ISSUE-0371-02, AC-ISSUE-0371-03, AC-ISSUE-0371-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-025`, `ADR-042`
- **Conflito:** `Nenhum`
