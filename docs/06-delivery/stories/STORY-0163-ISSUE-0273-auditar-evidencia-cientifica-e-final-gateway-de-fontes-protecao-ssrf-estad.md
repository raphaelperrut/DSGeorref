# STORY-0163 / ISSUE-0273 — Auditar evidência científica e final: gateway de fontes, proteção SSRF, estados de disponibilidade e bloqueio de compra
...
- **TaskEnvelope:** `.codex/tasks/TASK-0163.json`

## História de usuário

Como operador geoespacial, preciso auditar evidência científica e final para “gateway de fontes, proteção SSRF, estados de disponibilidade e bloqueio de compra”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar evidência científica e final para a capacidade **gateway de fontes, proteção SSRF, estados de disponibilidade e bloqueio de compra**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/gateway-de-fontes-protecao-ssrf-estados-de-disponibili/**`
## Fora de escopo
...
- `test_epic_027_aceite_happy_path`
- `test_epic_027_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-027` e o TaskEnvelope `TASK-0163`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0273-01, AC-ISSUE-0273-02, AC-ISSUE-0273-03, AC-ISSUE-0273-04`
