# STORY-0092 / ISSUE-0202 — Expor comandos, progresso e reconciliação: REST, SSE e polling de reconciliação com contratos versionados
...
- **TaskEnvelope:** `.codex/tasks/TASK-0092.json`

## História de usuário

Como operador geoespacial, preciso expor comandos, progresso e reconciliação para “REST, SSE e polling de reconciliação com contratos versionados”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Expor comandos, progresso e reconciliação para a capacidade **REST, SSE e polling de reconciliação com contratos versionados**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-017` e o TaskEnvelope `TASK-0092`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0202-01, AC-ISSUE-0202-02, AC-ISSUE-0202-03, AC-ISSUE-0202-04`
