# STORY-0451 / ISSUE-0561 — Definir SLO, runbook e controles operacionais: restore drills isolados, evidências, RPO/RTO e runbook executável
...
- **TaskEnvelope:** `.codex/tasks/TASK-0451.json`

## História de usuário

Como administrador da instância, preciso definir slo, runbook e controles operacionais para “restore drills isolados, evidências, RPO/RTO e runbook executável”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir SLO, runbook e controles operacionais para a capacidade **restore drills isolados, evidências, RPO/RTO e runbook executável**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/ops/contexts/operations_audit/restore-drills-isolados-evidencias-rpo-rto-e-runbook-e/**`
- `tools/quality/contexts/operations_audit/restore-drills-isolados-evidencias-rpo-rto-e-runbook-e/**`
- `.github/workflows/restore-drills-isolados-evidencias-rpo-rto-e-runbook-e.yaml`
## Fora de escopo
...
`REQ-SCM-004`, `REQ-UPG-001`, `REQ-UPG-004`
...
`STORY-0450`, `STORY-0237`

## Critérios de aceitação

- [ ] O resultado de “restore drills isolados, evidências, RPO/RTO e runbook executável” é observável por contrato, interface, artifact ou evidência executável.
- [ ] Os requisitos REQ-SCM-004, REQ-UPG-001, REQ-UPG-004 possuem evidência explícita no commit candidato.
...
- `test_upgrade_rollback_compatibility_matrix_downgrade_blockers_forward_fix_and_restore`
- `test_orchestrated_upgrade_preflight_migrations_rollback_restore`
- `test_phase_aware_recovery_writer_blocking_forward_fix_compatible_rollback_and_validated_restore`
- `test_epic_072_contrato`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-072` e o TaskEnvelope `TASK-0451`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0561-01, AC-ISSUE-0561-02, AC-ISSUE-0561-03, AC-ISSUE-0561-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-010`, `ADR-011`, `ADR-033`, `ADR-034`, `ADR-035`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-010`, `ADR-011`, `ADR-025`, `ADR-027`, `ADR-033`, `ADR-034`, `ADR-035`
