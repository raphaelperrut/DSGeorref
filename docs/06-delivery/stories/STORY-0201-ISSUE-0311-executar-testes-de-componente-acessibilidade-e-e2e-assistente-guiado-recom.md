# STORY-0201 / ISSUE-0311 — Executar testes de componente, acessibilidade e E2E: assistente guiado, recomendação explicável, consentimentos e modo avançado
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0201.json`

## História de usuário

Como operador geoespacial, preciso executar testes de componente, acessibilidade e e2e para “assistente guiado, recomendação explicável, consentimentos e modo avançado”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar testes de componente, acessibilidade e E2E para a capacidade **assistente guiado, recomendação explicável, consentimentos e modo avançado**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/web/assistente-guiado-recomendacao-explicavel-consentiment/**`
- `tools/quality/contexts/operator_experience/assistente-guiado-recomendacao-explicavel-consentiment/**`
- `.github/workflows/assistente-guiado-recomendacao-explicavel-consentiment.yaml`
## Fora de escopo
...
`STORY-0198`, `STORY-0199`, `STORY-0200`

## Critérios de aceitação

- [ ] O resultado de “assistente guiado, recomendação explicável, consentimentos e modo avançado” é observável por contrato, interface, artifact ou evidência executável.
...
- `test_epic_033_validacao_happy_path`
- `test_epic_033_validacao_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-033` e o TaskEnvelope `TASK-0201`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0311-01, AC-ISSUE-0311-02, AC-ISSUE-0311-03, AC-ISSUE-0311-04`
