# STORY-0749 / ISSUE-0859 — Slice 3/3 — Definir políticas e contratos fail-closed: threat model validado, scanning e testes ofensivos [REQ-AUTH-IMPL, REQ-EPIC, REQ-FS, REQ-SRC]
...
- **TaskEnvelope:** `.codex/tasks/TASK-0749.json`
...
- `contracts/contexts/operations_audit/sec/threat-model-validado-scanning-e-testes-ofensivos/auth-impl-epic-fs-parte-3/**`
- `docs/02-architecture/design-reviews/threat-model-validado-scanning-e-testes-ofensivos/auth-impl-epic-fs-parte-3/**`
## Fora de escopo
...
`REQ-AUTH-IMPL-010`, `REQ-EPIC-041`, `REQ-FS-001`, `REQ-SRC-002`, `REQ-SRC-003`
...
- [ ] Cada requisito do slice possui evidência explícita: REQ-AUTH-IMPL-010, REQ-EPIC-041, REQ-FS-001, REQ-SRC-002, REQ-SRC-003.
...
Leia `AGENTS.md`, o papel `.codex/roles/ROLE-002-arquiteto.md`, esta história e `TASK-0749`. Trabalhe somente nos paths permitidos, entregue apenas este slice e interrompa diante de qualquer condição de parada.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0859-01, AC-ISSUE-0859-02, AC-ISSUE-0859-03, AC-ISSUE-0859-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-002`, `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-014`, `ADR-031`, `ADR-047`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-002`, `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-014`, `ADR-031`, `ADR-047`
