# STORY-0164 / ISSUE-0274 — Definir contrato científico e invariantes: benchmarks por período, sensor e perfil de qualidade
...
- **TaskEnvelope:** `.codex/tasks/TASK-0164.json`

## História de usuário

Como operador geoespacial, preciso definir contrato científico e invariantes para “benchmarks por período, sensor e perfil de qualidade”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir contrato científico e invariantes para a capacidade **benchmarks por período, sensor e perfil de qualidade**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/geometric_quality/geo/benchmarks-por-periodo-sensor-e-perfil-de-qualidade/**`
- `docs/02-architecture/design-reviews/benchmarks-por-periodo-sensor-e-perfil-de-qualidade/**`
## Fora de escopo
...
`REQ-AIE-001`, `REQ-AIE-005`, `REQ-CLASSICPROFILE-004`, `REQ-SDR-002`, `REQ-SGVCAL-007`, `REQ-SRG-001`
...
- [ ] Os requisitos REQ-AIE-001, REQ-AIE-005, REQ-CLASSICPROFILE-004, REQ-SDR-002, REQ-SGVCAL-007, REQ-SRG-001 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-028` e o TaskEnvelope `TASK-0164`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0274-01, AC-ISSUE-0274-02, AC-ISSUE-0274-03, AC-ISSUE-0274-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-002`, `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-038`, `ADR-044`, `ADR-051`, `ADR-053`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-002`, `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-038`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-044`, `ADR-045`, `ADR-046`, `ADR-051`, `ADR-052`, `ADR-053`
