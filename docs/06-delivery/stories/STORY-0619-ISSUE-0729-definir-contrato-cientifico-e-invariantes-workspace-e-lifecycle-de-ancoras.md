# STORY-0619 / ISSUE-0729 — Definir contrato científico e invariantes: Workspace e lifecycle de âncoras
...
- **TaskEnvelope:** `.codex/tasks/TASK-0619.json`

## História de usuário

Como operador geoespacial, preciso definir contrato científico e invariantes para “Workspace e lifecycle de âncoras”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir contrato científico e invariantes para a capacidade **Workspace e lifecycle de âncoras**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/relative_mosaic/geo/workspace-e-lifecycle-de-ancoras/**`
- `docs/02-architecture/design-reviews/workspace-e-lifecycle-de-ancoras/**`
## Fora de escopo
...
- [ ] Os requisitos REQ-ANC-008 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-100` e o TaskEnvelope `TASK-0619`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0729-01, AC-ISSUE-0729-02, AC-ISSUE-0729-03, AC-ISSUE-0729-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-048`, `ADR-049`
