# STORY-0267 / ISSUE-0377 — Auditar evidência científica e final: OutputProfile, COG canônico, preservação de resolução e validação da grade
...
- **TaskEnvelope:** `.codex/tasks/TASK-0267.json`

## História de usuário

Como operador geoespacial, preciso auditar evidência científica e final para “OutputProfile, COG canônico, preservação de resolução e validação da grade”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar evidência científica e final para a capacidade **OutputProfile, COG canônico, preservação de resolução e validação da grade**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/outputprofile-cog-canonico-preservacao-de-resolucao-e/**`
## Fora de escopo
...
- `test_epic_044_aceite_happy_path`
- `test_epic_044_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-044` e o TaskEnvelope `TASK-0267`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0377-01, AC-ISSUE-0377-02, AC-ISSUE-0377-03, AC-ISSUE-0377-04`
