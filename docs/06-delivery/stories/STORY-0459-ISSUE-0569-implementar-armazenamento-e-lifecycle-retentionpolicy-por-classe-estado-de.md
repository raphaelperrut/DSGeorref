# STORY-0459 / ISSUE-0569 — Implementar armazenamento e lifecycle: RetentionPolicy por classe/estado/dependência, holds e preview de impacto
...
- **TaskEnvelope:** `.codex/tasks/TASK-0459.json`

## História de usuário

Como operador geoespacial, preciso implementar armazenamento e lifecycle para “RetentionPolicy por classe/estado/dependência, holds e preview de impacto”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar armazenamento e lifecycle para a capacidade **RetentionPolicy por classe/estado/dependência, holds e preview de impacto**, com saída versionada, testes e evidência no commit candidato.
...
- `test_epic_073_armazenamento_roundtrip`
- `test_epic_073_armazenamento_recovery`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-073` e o TaskEnvelope `TASK-0459`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0569-01, AC-ISSUE-0569-02, AC-ISSUE-0569-03, AC-ISSUE-0569-04`
