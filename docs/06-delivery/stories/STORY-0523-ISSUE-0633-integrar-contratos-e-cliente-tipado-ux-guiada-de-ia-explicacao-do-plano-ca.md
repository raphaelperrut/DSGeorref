# STORY-0523 / ISSUE-0633 — Integrar contratos e cliente tipado: UX guiada de IA, explicação do plano, capacidades instaladas/bloqueadas e laboratório separado
...
- **TaskEnvelope:** `.codex/tasks/TASK-0523.json`

## História de usuário

Como operador geoespacial, preciso integrar contratos e cliente tipado para “UX guiada de IA, explicação do plano, capacidades instaladas/bloqueadas e laboratório separado”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Integrar contratos e cliente tipado para a capacidade **UX guiada de IA, explicação do plano, capacidades instaladas/bloqueadas e laboratório separado**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-005-frontend.md`, este documento, o épico `EPIC-084` e o TaskEnvelope `TASK-0523`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0633-01, AC-ISSUE-0633-02, AC-ISSUE-0633-03, AC-ISSUE-0633-04`
