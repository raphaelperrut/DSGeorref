# STORY-0542 / ISSUE-0652 — Gerar evidências, SBOM e attestations: baseline operacional vertical privado com escopo da DELIVERY_PLAN e evidências do corpus controlado
...
- **TaskEnvelope:** `.codex/tasks/TASK-0542.json`

## História de usuário

Como responsável por release, preciso gerar evidências, sbom e attestations para “baseline operacional vertical privado com escopo da DELIVERY_PLAN e evidências do corpus controlado”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Gerar evidências, SBOM e attestations para a capacidade **baseline operacional vertical privado com escopo da DELIVERY_PLAN e evidências do corpus controlado**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/release_installation/adapters/security/baseline-operacional-vertical-privado-com-escopo-da-de/**`
- `tests/security/contexts/release_installation/baseline-operacional-vertical-privado-com-escopo-da-de/**`
## Fora de escopo
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0652-01, AC-ISSUE-0652-02, AC-ISSUE-0652-03, AC-ISSUE-0652-04`
