# STORY-0036 / ISSUE-0146 — Definir política, estados e contratos: contas locais, bootstrap único, sessões, tokens e adapter OIDC
...
- **TaskEnvelope:** `.codex/tasks/TASK-0036.json`

## História de usuário

Como administrador da instância, preciso definir política, estados e contratos para “contas locais, bootstrap único, sessões, tokens e adapter OIDC”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir política, estados e contratos para a capacidade **contas locais, bootstrap único, sessões, tokens e adapter OIDC**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/identity_access/plt/contas-locais-bootstrap-unico-sessoes-tokens-e-adapter/**`
- `docs/02-architecture/design-reviews/contas-locais-bootstrap-unico-sessoes-tokens-e-adapter/**`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-008` e o TaskEnvelope `TASK-0036`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0146-01, AC-ISSUE-0146-02, AC-ISSUE-0146-03, AC-ISSUE-0146-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-014`, `ADR-016`, `ADR-031`
