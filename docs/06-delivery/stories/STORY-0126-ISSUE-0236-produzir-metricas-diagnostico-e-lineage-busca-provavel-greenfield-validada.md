# STORY-0126 / ISSUE-0236 — Produzir métricas, diagnóstico e lineage: busca provável greenfield validada
...
- **TaskEnvelope:** `.codex/tasks/TASK-0126.json`

## História de usuário

Como operador geoespacial, preciso produzir métricas, diagnóstico e lineage para “busca provável greenfield validada”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Produzir métricas, diagnóstico e lineage para a capacidade **busca provável greenfield validada**, com saída versionada, testes e evidência no commit candidato.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0236-01, AC-ISSUE-0236-02, AC-ISSUE-0236-03, AC-ISSUE-0236-04`
