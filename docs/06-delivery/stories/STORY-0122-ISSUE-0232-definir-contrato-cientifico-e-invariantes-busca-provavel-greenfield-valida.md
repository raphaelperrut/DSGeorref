# STORY-0122 / ISSUE-0232 — Definir contrato científico e invariantes: busca provável greenfield validada
...
- **TaskEnvelope:** `.codex/tasks/TASK-0122.json`

## História de usuário

Como operador geoespacial, preciso definir contrato científico e invariantes para “busca provável greenfield validada”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir contrato científico e invariantes para a capacidade **busca provável greenfield validada**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/reference_discovery/geo/busca-provavel-greenfield-validada/**`
- `docs/02-architecture/design-reviews/busca-provavel-greenfield-validada/**`
## Fora de escopo
...
`REQ-AIE-001`, `REQ-AIE-005`, `REQ-CLASSICPROFILE-004`, `REQ-FS1-001`, `REQ-FS1-004`, `REQ-NATIVE-002`, `REQ-SGVCAL-007`
...
- [ ] Os requisitos REQ-AIE-001, REQ-AIE-005, REQ-CLASSICPROFILE-004, REQ-FS1-001, REQ-FS1-004, REQ-NATIVE-002 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-022` e o TaskEnvelope `TASK-0122`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0232-01, AC-ISSUE-0232-02, AC-ISSUE-0232-03, AC-ISSUE-0232-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-002`, `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-038`, `ADR-041`, `ADR-044`, `ADR-051`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-002`, `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-015`, `ADR-038`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-044`, `ADR-045`, `ADR-046`, `ADR-051`, `ADR-052`, `ADR-053`
