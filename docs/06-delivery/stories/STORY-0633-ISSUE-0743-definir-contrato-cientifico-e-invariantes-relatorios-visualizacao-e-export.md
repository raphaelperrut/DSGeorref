# STORY-0633 / ISSUE-0743 — Definir contrato científico e invariantes: Relatórios, visualização e exports do mosaico relativo
...
- **TaskEnvelope:** `.codex/tasks/TASK-0633.json`

## História de usuário

Como operador geoespacial, preciso definir contrato científico e invariantes para “Relatórios, visualização e exports do mosaico relativo”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir contrato científico e invariantes para a capacidade **Relatórios, visualização e exports do mosaico relativo**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/relative_mosaic/geo/relatorios-visualizacao-e-exports-do-mosaico-relativo/**`
- `docs/02-architecture/design-reviews/relatorios-visualizacao-e-exports-do-mosaico-relativo/**`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-102` e o TaskEnvelope `TASK-0633`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0743-01, AC-ISSUE-0743-02, AC-ISSUE-0743-03, AC-ISSUE-0743-04`
