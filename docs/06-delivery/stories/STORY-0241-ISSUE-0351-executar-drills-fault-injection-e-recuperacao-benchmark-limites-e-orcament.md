# STORY-0241 / ISSUE-0351 — Executar drills, fault injection e recuperação: benchmark, limites e orçamento de recursos
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0241.json`

## História de usuário

Como administrador da instância, preciso executar drills, fault injection e recuperação para “benchmark, limites e orçamento de recursos”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar drills, fault injection e recuperação para a capacidade **benchmark, limites e orçamento de recursos**, com saída versionada, testes e evidência no commit candidato.
...
- `test_epic_040_falhas_happy_path`
- `test_epic_040_falhas_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-040` e o TaskEnvelope `TASK-0241`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0351-01, AC-ISSUE-0351-02, AC-ISSUE-0351-03, AC-ISSUE-0351-04`
