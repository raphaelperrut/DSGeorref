# STORY-0222 / ISSUE-0332 — Implementar geração e exportação: persistência e exportação escalável de resultados por imagem/lote, geometrias, manifestos e checksums
...
- **TaskEnvelope:** `.codex/tasks/TASK-0222.json`

## História de usuário

Como revisor e auditor, preciso implementar geração e exportação para “persistência e exportação escalável de resultados por imagem/lote, geometrias, manifestos e checksums”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar geração e exportação para a capacidade **persistência e exportação escalável de resultados por imagem/lote, geometrias, manifestos e checksums**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/results_reporting/application/persistencia-e-exportacao-escalavel-de-resultados-por/**`
- `src/backend/dsgeorref/contexts/results_reporting/adapters/persistencia-e-exportacao-escalavel-de-resultados-por/**`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-037` e o TaskEnvelope `TASK-0222`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0332-01, AC-ISSUE-0332-02, AC-ISSUE-0332-03, AC-ISSUE-0332-04`
