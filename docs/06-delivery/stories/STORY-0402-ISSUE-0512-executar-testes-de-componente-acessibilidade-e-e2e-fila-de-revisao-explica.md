# STORY-0402 / ISSUE-0512 — Executar testes de componente, acessibilidade e E2E: fila de revisão explicável, filtros, priorização, impacto em descendentes e operações em lote permitidas
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0402.json`

## História de usuário

Como operador geoespacial, preciso executar testes de componente, acessibilidade e e2e para “fila de revisão explicável, filtros, priorização, impacto em descendentes e operações em lote permitidas”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar testes de componente, acessibilidade e E2E para a capacidade **fila de revisão explicável, filtros, priorização, impacto em descendentes e operações em lote permitidas**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/web/fila-de-revisao-explicavel-filtros-priorizacao-impacto/**`
- `tools/quality/contexts/review_correction/fila-de-revisao-explicavel-filtros-priorizacao-impacto/**`
- `.github/workflows/fila-de-revisao-explicavel-filtros-priorizacao-impacto.yaml`
## Fora de escopo
...
`STORY-0399`, `STORY-0400`, `STORY-0401`

## Critérios de aceitação

- [ ] O resultado de “fila de revisão explicável, filtros, priorização, impacto em descendentes e operações em lote permitidas” é observável por contrato, interface, artifact ou evidência executável.
...
- `test_epic_064_validacao_happy_path`
- `test_epic_064_validacao_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-064` e o TaskEnvelope `TASK-0402`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0512-01, AC-ISSUE-0512-02, AC-ISSUE-0512-03, AC-ISSUE-0512-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-014`
...
- **Resultado:** `PASS`
- **Risk tier:** `MEDIUM`
- **Controles aplicáveis:** `CTO-003, CTO-004, CTO-006, CTO-012, CTO-013, CTO-014, CTO-015`
