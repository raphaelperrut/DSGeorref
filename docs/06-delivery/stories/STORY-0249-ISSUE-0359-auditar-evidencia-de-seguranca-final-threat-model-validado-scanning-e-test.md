# STORY-0249 / ISSUE-0359 — Auditar evidência de segurança final: threat model validado, scanning e testes ofensivos
...
- **TaskEnvelope:** `.codex/tasks/TASK-0249.json`

## História de usuário

Como administrador de segurança, preciso auditar evidência de segurança final para “threat model validado, scanning e testes ofensivos”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar evidência de segurança final para a capacidade **threat model validado, scanning e testes ofensivos**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/threat-model-validado-scanning-e-testes-ofensivos/**`
## Fora de escopo
...
- `test_epic_041_aceite_happy_path`
- `test_epic_041_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-041` e o TaskEnvelope `TASK-0249`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0359-01, AC-ISSUE-0359-02, AC-ISSUE-0359-03, AC-ISSUE-0359-04`
