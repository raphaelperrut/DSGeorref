# STORY-0677 / ISSUE-0787 — Auditar release candidata final: Instalador, bootstrap, readiness e suporte diagnóstico
...
- **TaskEnvelope:** `.codex/tasks/TASK-0677.json`

## História de usuário

Como responsável por release, preciso auditar release candidata final para “Instalador, bootstrap, readiness e suporte diagnóstico”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar release candidata final para a capacidade **Instalador, bootstrap, readiness e suporte diagnóstico**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/instalador-bootstrap-readiness-e-suporte-diagnostico/**`
## Fora de escopo
...
- `test_epic_108_aceite_happy_path`
- `test_epic_108_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-108` e o TaskEnvelope `TASK-0677`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0787-01, AC-ISSUE-0787-02, AC-ISSUE-0787-03, AC-ISSUE-0787-04`
