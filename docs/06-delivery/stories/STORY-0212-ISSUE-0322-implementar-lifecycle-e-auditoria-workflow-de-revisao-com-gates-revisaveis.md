# STORY-0212 / ISSUE-0322 — Implementar lifecycle e auditoria: workflow de revisão com gates revisáveis, hard gates imutáveis, checklist e auditoria
...
- **TaskEnvelope:** `.codex/tasks/TASK-0212.json`

## História de usuário

Como revisor geoespacial, preciso implementar lifecycle e auditoria para “workflow de revisão com gates revisáveis, hard gates imutáveis, checklist e auditoria”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar lifecycle e auditoria para a capacidade **workflow de revisão com gates revisáveis, hard gates imutáveis, checklist e auditoria**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/review_correction/application/workflow-de-revisao-com-gates-revisaveis-hard-gates-im/**`
- `src/backend/dsgeorref/contexts/review_correction/adapters/workflow-de-revisao-com-gates-revisaveis-hard-gates-im/**`
## Fora de escopo
...
- [ ] O resultado de “workflow de revisão com gates revisáveis, hard gates imutáveis, checklist e auditoria” é observável por contrato, interface, artifact ou evidência executável.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-035` e o TaskEnvelope `TASK-0212`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0322-01, AC-ISSUE-0322-02, AC-ISSUE-0322-03, AC-ISSUE-0322-04`
