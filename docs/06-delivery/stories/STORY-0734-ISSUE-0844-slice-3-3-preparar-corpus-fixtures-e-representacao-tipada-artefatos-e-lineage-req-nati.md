# STORY-0734 / ISSUE-0844 — Slice 3/3 — Preparar corpus, fixtures e representação tipada: artefatos e lineage [REQ-NATIVE]
...
- **TaskEnvelope:** `.codex/tasks/TASK-0734.json`
...
- `src/geo/dsgeorref_geo/contexts/artifact_provenance/artefatos-e-lineage/native-parte-3/**`
## Fora de escopo
...
`REQ-NATIVE-007`, `REQ-NATIVE-008`, `REQ-NATIVE-009`, `REQ-NATIVE-010`
...
- [ ] Cada requisito do slice possui evidência explícita: REQ-NATIVE-007, REQ-NATIVE-008, REQ-NATIVE-009, REQ-NATIVE-010.
...
Leia `AGENTS.md`, o papel `.codex/roles/ROLE-007-geoprocessamento.md`, esta história e `TASK-0734`. Trabalhe somente nos paths permitidos, entregue apenas este slice e interrompa diante de qualquer condição de parada.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0844-01, AC-ISSUE-0844-02, AC-ISSUE-0844-03, AC-ISSUE-0844-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-023`, `ADR-024`, `ADR-025`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-044`, `ADR-045`, `ADR-046`, `ADR-055`
