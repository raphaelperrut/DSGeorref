# STORY-0418 / ISSUE-0528 — Definir estados, envelopes e invariantes: cancelamento cooperativo, supervisão de subprocessos, contenção e reconciliação
...
- **TaskEnvelope:** `.codex/tasks/TASK-0418.json`

## História de usuário

Como operador geoespacial, preciso definir estados, envelopes e invariantes para “cancelamento cooperativo, supervisão de subprocessos, contenção e reconciliação”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir estados, envelopes e invariantes para a capacidade **cancelamento cooperativo, supervisão de subprocessos, contenção e reconciliação**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/job_orchestration/job/cancelamento-cooperativo-supervisao-de-subprocessos-co/**`
- `docs/02-architecture/design-reviews/cancelamento-cooperativo-supervisao-de-subprocessos-co/**`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-067` e o TaskEnvelope `TASK-0418`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0528-01, AC-ISSUE-0528-02, AC-ISSUE-0528-03, AC-ISSUE-0528-04`
