# STORY-0328 / ISSUE-0438 — Executar benchmark, negativos e regressão científica: grafo de referências verificadas, componentes desconectados, invalidação e retry por componente
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0328.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “grafo de referências verificadas, componentes desconectados, invalidação e retry por componente”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **grafo de referências verificadas, componentes desconectados, invalidação e retry por componente**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/grafo-de-referencias-verificadas-componentes-desconect/**`
- `tools/quality/contexts/reference_discovery/grafo-de-referencias-verificadas-componentes-desconect/**`
- `.github/workflows/grafo-de-referencias-verificadas-componentes-desconect.yaml`
## Fora de escopo
...
`STORY-0324`, `STORY-0325`, `STORY-0326`, `STORY-0327`
...
- `test_epic_053_benchmark_happy_path`
- `test_epic_053_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-053` e o TaskEnvelope `TASK-0328`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0438-01, AC-ISSUE-0438-02, AC-ISSUE-0438-03, AC-ISSUE-0438-04`
