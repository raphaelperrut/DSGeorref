# STORY-0323 / ISSUE-0433 — Definir contrato científico e invariantes: grafo de referências verificadas, componentes desconectados, invalidação e retry por componente
...
- **TaskEnvelope:** `.codex/tasks/TASK-0323.json`

## História de usuário

Como operador geoespacial, preciso definir contrato científico e invariantes para “grafo de referências verificadas, componentes desconectados, invalidação e retry por componente”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir contrato científico e invariantes para a capacidade **grafo de referências verificadas, componentes desconectados, invalidação e retry por componente**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/reference_discovery/geo/grafo-de-referencias-verificadas-componentes-desconect/**`
- `docs/02-architecture/design-reviews/grafo-de-referencias-verificadas-componentes-desconect/**`
## Fora de escopo
...
`STORY-0128`, `STORY-0135`, `STORY-0142`, `STORY-0322`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-053` e o TaskEnvelope `TASK-0323`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0433-01, AC-ISSUE-0433-02, AC-ISSUE-0433-03, AC-ISSUE-0433-04`
