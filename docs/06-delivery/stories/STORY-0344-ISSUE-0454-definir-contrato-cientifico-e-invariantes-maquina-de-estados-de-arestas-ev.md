# STORY-0344 / ISSUE-0454 — Definir contrato científico e invariantes: máquina de estados de arestas, evidência direta, lineage e SGV independente da imagem dependente
...
- **TaskEnvelope:** `.codex/tasks/TASK-0344.json`

## História de usuário

Como operador geoespacial, preciso definir contrato científico e invariantes para “máquina de estados de arestas, evidência direta, lineage e SGV independente da imagem dependente”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir contrato científico e invariantes para a capacidade **máquina de estados de arestas, evidência direta, lineage e SGV independente da imagem dependente**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/reference_discovery/geo/maquina-de-estados-de-arestas-evidencia-direta-lineage/**`
- `docs/02-architecture/design-reviews/maquina-de-estados-de-arestas-evidencia-direta-lineage/**`
## Fora de escopo
...
`STORY-0135`, `STORY-0142`, `STORY-0322`, `STORY-0329`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-056` e o TaskEnvelope `TASK-0344`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0454-01, AC-ISSUE-0454-02, AC-ISSUE-0454-03, AC-ISSUE-0454-04`
