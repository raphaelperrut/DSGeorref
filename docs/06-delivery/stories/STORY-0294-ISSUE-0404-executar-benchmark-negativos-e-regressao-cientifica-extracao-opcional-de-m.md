# STORY-0294 / ISSUE-0404 — Executar benchmark, negativos e regressão científica: extração opcional de metadados marginais com confiança, revisão e lineage
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0294.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “extração opcional de metadados marginais com confiança, revisão e lineage”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **extração opcional de metadados marginais com confiança, revisão e lineage**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/extracao-opcional-de-metadados-marginais-com-confianca/**`
- `tools/quality/contexts/georeferencing/extracao-opcional-de-metadados-marginais-com-confianca/**`
- `.github/workflows/extracao-opcional-de-metadados-marginais-com-confianca.yaml`
## Fora de escopo
...
`STORY-0290`, `STORY-0291`, `STORY-0292`, `STORY-0293`

## Critérios de aceitação

- [ ] O resultado de “extração opcional de metadados marginais com confiança, revisão e lineage” é observável por contrato, interface, artifact ou evidência executável.
...
- `test_epic_048_benchmark_happy_path`
- `test_epic_048_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-048` e o TaskEnvelope `TASK-0294`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0404-01, AC-ISSUE-0404-02, AC-ISSUE-0404-03, AC-ISSUE-0404-04`
