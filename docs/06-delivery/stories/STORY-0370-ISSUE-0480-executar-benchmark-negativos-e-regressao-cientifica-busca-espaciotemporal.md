# STORY-0370 / ISSUE-0480 — Executar benchmark, negativos e regressão científica: busca espaciotemporal guiada, ranking explicável, incerteza e expansão limitada por orçamento
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0370.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “busca espaciotemporal guiada, ranking explicável, incerteza e expansão limitada por orçamento”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **busca espaciotemporal guiada, ranking explicável, incerteza e expansão limitada por orçamento**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/busca-espaciotemporal-guiada-ranking-explicavel-incert/**`
- `tools/quality/contexts/reference_discovery/busca-espaciotemporal-guiada-ranking-explicavel-incert/**`
- `.github/workflows/busca-espaciotemporal-guiada-ranking-explicavel-incert.yaml`
## Fora de escopo
...
`STORY-0366`, `STORY-0367`, `STORY-0368`, `STORY-0369`
...
- `test_epic_059_benchmark_happy_path`
- `test_epic_059_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-059` e o TaskEnvelope `TASK-0370`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0480-01, AC-ISSUE-0480-02, AC-ISSUE-0480-03, AC-ISSUE-0480-04`
