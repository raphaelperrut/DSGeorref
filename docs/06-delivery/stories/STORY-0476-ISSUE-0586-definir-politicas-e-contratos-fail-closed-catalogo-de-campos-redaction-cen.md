# STORY-0476 / ISSUE-0586 — Definir políticas e contratos fail-closed: catálogo de campos, redaction centralizada, testes de vazamento e bundles de suporte sanitizados
...
- **TaskEnvelope:** `.codex/tasks/TASK-0476.json`

## História de usuário

Como administrador de segurança, preciso definir políticas e contratos fail-closed para “catálogo de campos, redaction centralizada, testes de vazamento e bundles de suporte sanitizados”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir políticas e contratos fail-closed para a capacidade **catálogo de campos, redaction centralizada, testes de vazamento e bundles de suporte sanitizados**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/operations_audit/sec/catalogo-de-campos-redaction-centralizada-testes-de-va/**`
- `docs/02-architecture/design-reviews/catalogo-de-campos-redaction-centralizada-testes-de-va/**`
## Fora de escopo
...
- [ ] Os requisitos REQ-SRP-004 possuem evidência explícita no commit candidato.
...
- `test_signed_redacted_retained_scheduler_reproduction_bundle_limits`
- `test_epic_076_contrato`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-076` e o TaskEnvelope `TASK-0476`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0586-01, AC-ISSUE-0586-02, AC-ISSUE-0586-03, AC-ISSUE-0586-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-053`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-016`, `ADR-053`
