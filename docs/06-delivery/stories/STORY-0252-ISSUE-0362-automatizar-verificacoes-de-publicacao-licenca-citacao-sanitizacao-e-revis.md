# STORY-0252 / ISSUE-0362 — Automatizar verificações de publicação: licença, citação, sanitização e revisão externa concluídas
...
- **TaskEnvelope:** `.codex/tasks/TASK-0252.json`

## História de usuário

Como mantenedor do projeto, preciso automatizar verificações de publicação para “licença, citação, sanitização e revisão externa concluídas”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Automatizar verificações de publicação para a capacidade **licença, citação, sanitização e revisão externa concluídas**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/pub/licenca-citacao-sanitizacao-e-revisao-externa-concluid/**`
- `tools/quality/contexts/release_installation/licenca-citacao-sanitizacao-e-revisao-externa-concluid/**`
- `.github/workflows/licenca-citacao-sanitizacao-e-revisao-externa-concluid.yaml`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-042` e o TaskEnvelope `TASK-0252`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0362-01, AC-ISSUE-0362-02, AC-ISSUE-0362-03, AC-ISSUE-0362-04`
