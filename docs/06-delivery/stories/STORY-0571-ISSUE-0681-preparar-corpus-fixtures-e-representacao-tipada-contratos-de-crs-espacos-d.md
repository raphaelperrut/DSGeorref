# STORY-0571 / ISSUE-0681 — Preparar corpus, fixtures e representação tipada: contratos de CRS, espaços de coordenadas, ordem de eixos, precisão/unidades e validade raster
...
- **TaskEnvelope:** `.codex/tasks/TASK-0571.json`

## História de usuário

Como operador geoespacial, preciso preparar corpus, fixtures e representação tipada para “contratos de CRS, espaços de coordenadas, ordem de eixos, precisão/unidades e validade raster”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Preparar corpus, fixtures e representação tipada para a capacidade **contratos de CRS, espaços de coordenadas, ordem de eixos, precisão/unidades e validade raster**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/geo/dsgeorref_geo/contexts/georeferencing/contratos-de-crs-espacos-de-coordenadas-ordem-de-eixos/**`
## Fora de escopo
...
- [ ] Os requisitos REQ-CRS-003, REQ-RAS-001 possuem evidência explícita no commit candidato.
...
- `test_units_precision_tolerance_and_no_premature_rounding`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-093` e o TaskEnvelope `TASK-0571`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0681-01, AC-ISSUE-0681-02, AC-ISSUE-0681-03, AC-ISSUE-0681-04`
