# STORY-0170 / ISSUE-0280 — Auditar evidência científica e final: benchmarks por período, sensor e perfil de qualidade
...
- **TaskEnvelope:** `.codex/tasks/TASK-0170.json`

## História de usuário

Como operador geoespacial, preciso auditar evidência científica e final para “benchmarks por período, sensor e perfil de qualidade”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar evidência científica e final para a capacidade **benchmarks por período, sensor e perfil de qualidade**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/benchmarks-por-periodo-sensor-e-perfil-de-qualidade/**`
## Fora de escopo
...
- `test_epic_028_aceite_happy_path`
- `test_epic_028_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-028` e o TaskEnvelope `TASK-0170`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0280-01, AC-ISSUE-0280-02, AC-ISSUE-0280-03, AC-ISSUE-0280-04`
