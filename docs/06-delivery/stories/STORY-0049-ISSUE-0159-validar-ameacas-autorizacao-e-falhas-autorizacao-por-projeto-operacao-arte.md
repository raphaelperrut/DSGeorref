# STORY-0049 / ISSUE-0159 — Validar ameaças, autorização e falhas: autorização por projeto, operação, artefato e caminho
...
- **TaskEnvelope:** `.codex/tasks/TASK-0049.json`

## História de usuário

Como administrador da instância, preciso validar ameaças, autorização e falhas para “autorização por projeto, operação, artefato e caminho”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Validar ameaças, autorização e falhas para a capacidade **autorização por projeto, operação, artefato e caminho**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/identity_access/adapters/security/autorizacao-por-projeto-operacao-artefato-e-caminho/**`
- `tests/security/contexts/identity_access/autorizacao-por-projeto-operacao-artefato-e-caminho/**`
## Fora de escopo
...
`STORY-0047`, `STORY-0048`

## Critérios de aceitação

- [ ] O resultado de “autorização por projeto, operação, artefato e caminho” é observável por contrato, interface, artifact ou evidência executável.
...
- `test_epic_010_seguranca_happy_path`
- `test_epic_010_seguranca_negative_paths`
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0159-01, AC-ISSUE-0159-02, AC-ISSUE-0159-03, AC-ISSUE-0159-04`
- **Base de requisitos:** `DERIVED_CONTROL`
- **ADRs governantes:** `ADR-003`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-030`, `ADR-031`, `ADR-032`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-030`, `ADR-031`, `ADR-032`, `ADR-055`
