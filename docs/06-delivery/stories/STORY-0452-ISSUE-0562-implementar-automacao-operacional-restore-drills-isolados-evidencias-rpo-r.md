# STORY-0452 / ISSUE-0562 — Implementar automação operacional: restore drills isolados, evidências, RPO/RTO e runbook executável
...
- **TaskEnvelope:** `.codex/tasks/TASK-0452.json`

## História de usuário

Como administrador da instância, preciso implementar automação operacional para “restore drills isolados, evidências, RPO/RTO e runbook executável”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar automação operacional para a capacidade **restore drills isolados, evidências, RPO/RTO e runbook executável**, com saída versionada, testes e evidência no commit candidato.
...
- [ ] Os requisitos REQ-EPIC-039 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-072` e o TaskEnvelope `TASK-0452`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0562-01, AC-ISSUE-0562-02, AC-ISSUE-0562-03, AC-ISSUE-0562-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-027`, `ADR-033`, `ADR-034`
- **Conflito:** `Nenhum`
