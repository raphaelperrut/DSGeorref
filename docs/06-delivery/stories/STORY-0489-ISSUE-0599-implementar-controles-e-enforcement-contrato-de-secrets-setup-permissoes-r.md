# STORY-0489 / ISSUE-0599 — Implementar controles e enforcement: contrato de secrets, setup, permissões, rotação, recuperação e adapters opcionais de vault
...
- **TaskEnvelope:** `.codex/tasks/TASK-0489.json`

## História de usuário

Como administrador de segurança, preciso implementar controles e enforcement para “contrato de secrets, setup, permissões, rotação, recuperação e adapters opcionais de vault”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar controles e enforcement para a capacidade **contrato de secrets, setup, permissões, rotação, recuperação e adapters opcionais de vault**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/operations_audit/application/contrato-de-secrets-setup-permissoes-rotacao-recuperac/**`
- `src/backend/dsgeorref/contexts/operations_audit/adapters/contrato-de-secrets-setup-permissoes-rotacao-recuperac/**`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-078` e o TaskEnvelope `TASK-0489`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0599-01, AC-ISSUE-0599-02, AC-ISSUE-0599-03, AC-ISSUE-0599-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-016`, `ADR-018`, `ADR-019`, `ADR-023`, `ADR-024`
