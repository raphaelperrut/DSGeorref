# STORY-0120 / ISSUE-0230 — Executar benchmark, negativos e regressão científica: corpus versionado com décadas e condições distintas
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0120.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “corpus versionado com décadas e condições distintas”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **corpus versionado com décadas e condições distintas**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/corpus-versionado-com-decadas-e-condicoes-distintas/**`
- `tools/quality/contexts/geometric_quality/corpus-versionado-com-decadas-e-condicoes-distintas/**`
- `.github/workflows/corpus-versionado-com-decadas-e-condicoes-distintas.yaml`
## Fora de escopo
...
`STORY-0116`, `STORY-0117`, `STORY-0118`, `STORY-0119`
...
- `test_epic_021_benchmark_happy_path`
- `test_epic_021_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-021` e o TaskEnvelope `TASK-0120`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0230-01, AC-ISSUE-0230-02, AC-ISSUE-0230-03, AC-ISSUE-0230-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-046`, `ADR-055`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-044`, `ADR-045`, `ADR-046`, `ADR-055`
