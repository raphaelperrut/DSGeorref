# STORY-0628 / ISSUE-0738 — Implementar o núcleo algorítmico: Relative Mosaic Verifier e promotion lifecycle
...
- **TaskEnvelope:** `.codex/tasks/TASK-0628.json`

## História de usuário

Como operador geoespacial, preciso implementar o núcleo algorítmico para “Relative Mosaic Verifier e promotion lifecycle”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar o núcleo algorítmico para a capacidade **Relative Mosaic Verifier e promotion lifecycle**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-101` e o TaskEnvelope `TASK-0628`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0738-01, AC-ISSUE-0738-02, AC-ISSUE-0738-03, AC-ISSUE-0738-04`
