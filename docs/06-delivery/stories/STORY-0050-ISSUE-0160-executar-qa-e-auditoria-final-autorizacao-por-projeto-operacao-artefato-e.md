# STORY-0050 / ISSUE-0160 — Executar QA e auditoria final: autorização por projeto, operação, artefato e caminho
...
- **TaskEnvelope:** `.codex/tasks/TASK-0050.json`

## História de usuário

Como administrador da instância, preciso executar qa e auditoria final para “autorização por projeto, operação, artefato e caminho”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar QA e auditoria final para a capacidade **autorização por projeto, operação, artefato e caminho**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/autorizacao-por-projeto-operacao-artefato-e-caminho/**`
## Fora de escopo
...
- `test_epic_010_aceite_happy_path`
- `test_epic_010_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-010` e o TaskEnvelope `TASK-0050`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0160-01, AC-ISSUE-0160-02, AC-ISSUE-0160-03, AC-ISSUE-0160-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-055`
