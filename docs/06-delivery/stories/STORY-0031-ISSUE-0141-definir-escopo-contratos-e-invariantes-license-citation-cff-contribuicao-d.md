# STORY-0031 / ISSUE-0141 — Definir escopo, contratos e invariantes: LICENSE, CITATION.cff, contribuição, DCO/CLA e gate de publicação definidos
...
- **TaskEnvelope:** `.codex/tasks/TASK-0031.json`

## História de usuário

Como mantenedor de engenharia, preciso definir escopo, contratos e invariantes para “LICENSE, CITATION.cff, contribuição, DCO/CLA e gate de publicação definidos”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir escopo, contratos e invariantes para a capacidade **LICENSE, CITATION.cff, contribuição, DCO/CLA e gate de publicação definidos**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/engineering_governance/fnd/license-citation-cff-contribuicao-dco-cla-e-gate-de-pu/**`
- `docs/02-architecture/design-reviews/license-citation-cff-contribuicao-dco-cla-e-gate-de-pu/**`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-007` e o TaskEnvelope `TASK-0031`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0141-01, AC-ISSUE-0141-02, AC-ISSUE-0141-03, AC-ISSUE-0141-04`
