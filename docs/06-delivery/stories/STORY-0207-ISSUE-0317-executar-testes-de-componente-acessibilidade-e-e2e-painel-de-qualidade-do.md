# STORY-0207 / ISSUE-0317 — Executar testes de componente, acessibilidade e E2E: painel de qualidade do lote, busca server-side, filtros salvos, triagem, deformação e retry/revisão de subconjuntos
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0207.json`

## História de usuário

Como operador geoespacial, preciso executar testes de componente, acessibilidade e e2e para “painel de qualidade do lote, busca server-side, filtros salvos, triagem, deformação e retry/revisão de subconjuntos”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar testes de componente, acessibilidade e E2E para a capacidade **painel de qualidade do lote, busca server-side, filtros salvos, triagem, deformação e retry/revisão de subconjuntos**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/web/painel-de-qualidade-do-lote-busca-server-side-filtros/**`
- `tools/quality/contexts/operator_experience/painel-de-qualidade-do-lote-busca-server-side-filtros/**`
- `.github/workflows/painel-de-qualidade-do-lote-busca-server-side-filtros.yaml`
## Fora de escopo
...
`STORY-0204`, `STORY-0205`, `STORY-0206`
...
- `test_epic_034_validacao_happy_path`
- `test_epic_034_validacao_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-034` e o TaskEnvelope `TASK-0207`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0317-01, AC-ISSUE-0317-02, AC-ISSUE-0317-03, AC-ISSUE-0317-04`
