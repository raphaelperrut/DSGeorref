# STORY-0156 / ISSUE-0266 — Auditar evidência científica e final: artefatos e lineage
...
- **TaskEnvelope:** `.codex/tasks/TASK-0156.json`

## História de usuário

Como operador geoespacial, preciso auditar evidência científica e final para “artefatos e lineage”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar evidência científica e final para a capacidade **artefatos e lineage**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/artefatos-e-lineage/**`
## Fora de escopo
...
- `test_epic_026_aceite_happy_path`
- `test_epic_026_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-026` e o TaskEnvelope `TASK-0156`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0266-01, AC-ISSUE-0266-02, AC-ISSUE-0266-03, AC-ISSUE-0266-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-023`, `ADR-024`, `ADR-025`, `ADR-055`
