# STORY-0214 / ISSUE-0324 — Auditar rastreabilidade e evidência final: workflow de revisão com gates revisáveis, hard gates imutáveis, checklist e auditoria
...
- **TaskEnvelope:** `.codex/tasks/TASK-0214.json`

## História de usuário

Como revisor geoespacial, preciso auditar rastreabilidade e evidência final para “workflow de revisão com gates revisáveis, hard gates imutáveis, checklist e auditoria”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar rastreabilidade e evidência final para a capacidade **workflow de revisão com gates revisáveis, hard gates imutáveis, checklist e auditoria**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/workflow-de-revisao-com-gates-revisaveis-hard-gates-im/**`
## Fora de escopo
...
- `test_epic_035_aceite_happy_path`
- `test_epic_035_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-035` e o TaskEnvelope `TASK-0214`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0324-01, AC-ISSUE-0324-02, AC-ISSUE-0324-03, AC-ISSUE-0324-04`
