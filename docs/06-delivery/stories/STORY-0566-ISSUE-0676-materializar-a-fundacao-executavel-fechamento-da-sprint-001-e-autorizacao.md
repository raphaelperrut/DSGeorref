# STORY-0566 / ISSUE-0676 — Materializar a fundação executável: fechamento da SPRINT-001 e autorização da primeira fatia funcional
...
- **TaskEnvelope:** `.codex/tasks/TASK-0566.json`

## História de usuário

Como mantenedor de engenharia, preciso materializar a fundação executável para “fechamento da SPRINT-001 e autorização da primeira fatia funcional”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Materializar a fundação executável para a capacidade **fechamento da SPRINT-001 e autorização da primeira fatia funcional**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tools/governance/fechamento-da-sprint-001-e-autorizacao-da-primeira-fat/**`
- `docs/03-engineering/contexts/engineering_governance/fechamento-da-sprint-001-e-autorizacao-da-primeira-fat/**`
## Fora de escopo
...
`REQ-DEV-001`, `REQ-FRZ-001`, `REQ-FRZ-002`, `REQ-FRZ-003`, `REQ-FRZ-004`, `REQ-GOV-005`, `REQ-TST-001`
...
- [ ] Os requisitos REQ-DEV-001, REQ-FRZ-001, REQ-FRZ-002, REQ-FRZ-003, REQ-FRZ-004, REQ-GOV-005 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-003-tech-lead.md`, este documento, o épico `EPIC-092` e o TaskEnvelope `TASK-0566`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0676-01, AC-ISSUE-0676-02, AC-ISSUE-0676-03, AC-ISSUE-0676-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-001`, `ADR-003`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-053`, `ADR-057`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-001`, `ADR-003`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-053`, `ADR-057`
