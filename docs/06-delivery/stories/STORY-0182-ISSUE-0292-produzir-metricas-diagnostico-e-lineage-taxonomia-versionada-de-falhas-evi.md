# STORY-0182 / ISSUE-0292 — Produzir métricas, diagnóstico e lineage: taxonomia versionada de falhas, evidências, remediações seguras e contratos de resultado por imagem
...
- **TaskEnvelope:** `.codex/tasks/TASK-0182.json`

## História de usuário

Como operador geoespacial, preciso produzir métricas, diagnóstico e lineage para “taxonomia versionada de falhas, evidências, remediações seguras e contratos de resultado por imagem”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Produzir métricas, diagnóstico e lineage para a capacidade **taxonomia versionada de falhas, evidências, remediações seguras e contratos de resultado por imagem**, com saída versionada, testes e evidência no commit candidato.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0292-01, AC-ISSUE-0292-02, AC-ISSUE-0292-03, AC-ISSUE-0292-04`
