# STORY-0663 / ISSUE-0773 — Gerar evidências, SBOM e attestations: Migrations compatíveis, upgrade e downgrade seguro
...
- **TaskEnvelope:** `.codex/tasks/TASK-0663.json`

## História de usuário

Como responsável por release, preciso gerar evidências, sbom e attestations para “Migrations compatíveis, upgrade e downgrade seguro”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Gerar evidências, SBOM e attestations para a capacidade **Migrations compatíveis, upgrade e downgrade seguro**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/release_installation/adapters/security/migrations-compativeis-upgrade-e-downgrade-seguro/**`
- `tests/security/contexts/release_installation/migrations-compativeis-upgrade-e-downgrade-seguro/**`
## Fora de escopo
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0773-01, AC-ISSUE-0773-02, AC-ISSUE-0773-03, AC-ISSUE-0773-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-026`, `ADR-030`, `ADR-031`, `ADR-032`
