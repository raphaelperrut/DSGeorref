# STORY-0280 / ISSUE-0390 — Executar benchmark, negativos e regressão científica: ArtifactSet imutável, staging e publicação atômica
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0280.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “ArtifactSet imutável, staging e publicação atômica”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **ArtifactSet imutável, staging e publicação atômica**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/artifactset-imutavel-staging-e-publicacao-atomica/**`
- `tools/quality/contexts/artifact_provenance/artifactset-imutavel-staging-e-publicacao-atomica/**`
- `.github/workflows/artifactset-imutavel-staging-e-publicacao-atomica.yaml`
## Fora de escopo
...
`STORY-0276`, `STORY-0277`, `STORY-0278`, `STORY-0279`

## Critérios de aceitação

- [ ] O resultado de “ArtifactSet imutável, staging e publicação atômica” é observável por contrato, interface, artifact ou evidência executável.
- [ ] Os requisitos REQ-ART-003 possuem evidência explícita no commit candidato.
...
- `test_epic_046_benchmark_happy_path`
- `test_epic_046_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-046` e o TaskEnvelope `TASK-0280`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0390-01, AC-ISSUE-0390-02, AC-ISSUE-0390-03, AC-ISSUE-0390-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-023`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-023`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-049`
