# STORY-0026 / ISSUE-0136 — Definir escopo, contratos e invariantes: catálogo de conhecimento técnico e decomposição das capacidades de processamento
...
- **TaskEnvelope:** `.codex/tasks/TASK-0026.json`

## História de usuário

Como mantenedor de engenharia, preciso definir escopo, contratos e invariantes para “catálogo de conhecimento técnico e decomposição das capacidades de processamento”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir escopo, contratos e invariantes para a capacidade **catálogo de conhecimento técnico e decomposição das capacidades de processamento**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/engineering_governance/fnd/catalogo-de-conhecimento-tecnico-e-decomposicao-das-ca/**`
- `docs/02-architecture/design-reviews/catalogo-de-conhecimento-tecnico-e-decomposicao-das-ca/**`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-006` e o TaskEnvelope `TASK-0026`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0136-01, AC-ISSUE-0136-02, AC-ISSUE-0136-03, AC-ISSUE-0136-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`
