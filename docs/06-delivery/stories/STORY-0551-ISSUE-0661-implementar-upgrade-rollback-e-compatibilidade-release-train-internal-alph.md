# STORY-0551 / ISSUE-0661 — Implementar upgrade, rollback e compatibilidade: release train internal/alpha/beta/1.0, automação de evidências e gate de abertura pública
...
- **TaskEnvelope:** `.codex/tasks/TASK-0551.json`

## História de usuário

Como responsável por release, preciso implementar upgrade, rollback e compatibilidade para “release train internal/alpha/beta/1.0, automação de evidências e gate de abertura pública”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar upgrade, rollback e compatibilidade para a capacidade **release train internal/alpha/beta/1.0, automação de evidências e gate de abertura pública**, com saída versionada, testes e evidência no commit candidato.
...
- `test_epic_089_upgrade_roundtrip`
- `test_epic_089_upgrade_recovery`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-089` e o TaskEnvelope `TASK-0551`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0661-01, AC-ISSUE-0661-02, AC-ISSUE-0661-03, AC-ISSUE-0661-04`
