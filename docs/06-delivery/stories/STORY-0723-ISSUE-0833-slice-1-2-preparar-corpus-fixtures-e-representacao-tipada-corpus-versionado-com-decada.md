# STORY-0723 / ISSUE-0833 — Slice 1/2 — Preparar corpus, fixtures e representação tipada: corpus versionado com décadas e condições distintas [REQ-EPIC, REQ-FS1, REQ-NATIVE]
...
- **TaskEnvelope:** `.codex/tasks/TASK-0723.json`

## História de usuário

Como executor especializado, preciso entregar este slice limitado de requisitos para que a capacidade de **corpus versionado com décadas e condições distintas** avance sem mudança ampla ou inferência não documentada.
...
- `src/geo/dsgeorref_geo/contexts/geometric_quality/corpus-versionado-com-decadas-e-condicoes-distintas/requirements-epic-fs1-native-parte-1/**`
## Fora de escopo
...
`REQ-EPIC-021`, `REQ-FS1-002`, `REQ-FS1-003`, `REQ-FS1-008`, `REQ-FS1-009`, `REQ-FS1-010`, `REQ-NATIVE-003`, `REQ-NATIVE-005`, `REQ-NATIVE-006`, `REQ-NATIVE-007`
...
- [ ] Cada requisito do slice possui evidência explícita: REQ-EPIC-021, REQ-FS1-002, REQ-FS1-003, REQ-FS1-008, REQ-FS1-009, REQ-FS1-010, REQ-NATIVE-003, REQ-NATIVE-005, REQ-NATIVE-006, REQ-NATIVE-007.
...
Leia `AGENTS.md`, o papel `.codex/roles/ROLE-007-geoprocessamento.md`, esta história e `TASK-0723`. Trabalhe somente nos paths permitidos, entregue apenas este slice e interrompa diante de qualquer condição de parada.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0833-01, AC-ISSUE-0833-02, AC-ISSUE-0833-03, AC-ISSUE-0833-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-015`, `ADR-023`, `ADR-040`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-044`, `ADR-055`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-015`, `ADR-023`, `ADR-040`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-044`, `ADR-045`, `ADR-046`, `ADR-055`
