# STORY-0356 / ISSUE-0466 — Executar benchmark, negativos e regressão científica: resultados por componente, sucesso parcial explícito, retry por subconjunto e UX de componentes não resolvidos
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0356.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “resultados por componente, sucesso parcial explícito, retry por subconjunto e UX de componentes não resolvidos”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **resultados por componente, sucesso parcial explícito, retry por subconjunto e UX de componentes não resolvidos**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/resultados-por-componente-sucesso-parcial-explicito-re/**`
- `tools/quality/contexts/results_reporting/resultados-por-componente-sucesso-parcial-explicito-re/**`
- `.github/workflows/resultados-por-componente-sucesso-parcial-explicito-re.yaml`
## Fora de escopo
...
`STORY-0352`, `STORY-0353`, `STORY-0354`, `STORY-0355`

## Critérios de aceitação

- [ ] O resultado de “resultados por componente, sucesso parcial explícito, retry por subconjunto e UX de componentes não resolvidos” é observável por contrato, interface, artifact ou evidência executável.
...
- `test_epic_057_benchmark_happy_path`
- `test_epic_057_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-057` e o TaskEnvelope `TASK-0356`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0466-01, AC-ISSUE-0466-02, AC-ISSUE-0466-03, AC-ISSUE-0466-04`
