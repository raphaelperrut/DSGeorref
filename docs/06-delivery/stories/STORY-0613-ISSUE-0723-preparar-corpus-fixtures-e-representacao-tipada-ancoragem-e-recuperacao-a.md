# STORY-0613 / ISSUE-0723 — Preparar corpus, fixtures e representação tipada: Ancoragem e recuperação a partir do mosaico relativo
...
- **TaskEnvelope:** `.codex/tasks/TASK-0613.json`

## História de usuário

Como operador geoespacial, preciso preparar corpus, fixtures e representação tipada para “Ancoragem e recuperação a partir do mosaico relativo”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Preparar corpus, fixtures e representação tipada para a capacidade **Ancoragem e recuperação a partir do mosaico relativo**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/geo/dsgeorref_geo/contexts/relative_mosaic/ancoragem-e-recuperacao-a-partir-do-mosaico-relativo/**`
## Fora de escopo
...
- [ ] Os requisitos REQ-ANC-004, REQ-RMV-004 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-099` e o TaskEnvelope `TASK-0613`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0723-01, AC-ISSUE-0723-02, AC-ISSUE-0723-03, AC-ISSUE-0723-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-049`, `ADR-050`
- **Conflito:** `Nenhum`
