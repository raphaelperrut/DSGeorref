# STORY-0720 / ISSUE-0830 — Slice 3/3 — Implementar persistência e migrations: raízes de workspace, API de navegação segura, catálogo, hashes e lineage [REQ-UPG]
...
- **TaskEnvelope:** `.codex/tasks/TASK-0720.json`
...
- `src/backend/dsgeorref/contexts/project_workspace/application/raizes-de-workspace-api-de-navegacao-segura-catalogo-h/upg-parte-3/**`
- `src/backend/dsgeorref/contexts/project_workspace/adapters/raizes-de-workspace-api-de-navegacao-segura-catalogo-h/upg-parte-3/**`
## Fora de escopo
...
- [ ] Cada requisito do slice possui evidência explícita: REQ-UPG-002.
...
Leia `AGENTS.md`, o papel `.codex/roles/ROLE-004-backend.md`, esta história e `TASK-0720`. Trabalhe somente nos paths permitidos, entregue apenas este slice e interrompa diante de qualquer condição de parada.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0830-01, AC-ISSUE-0830-02, AC-ISSUE-0830-03, AC-ISSUE-0830-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-016`, `ADR-026`
- **Conflito:** `Nenhum`
