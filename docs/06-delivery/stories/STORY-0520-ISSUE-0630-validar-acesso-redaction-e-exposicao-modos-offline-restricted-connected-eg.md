# STORY-0520 / ISSUE-0630 — Validar acesso, redaction e exposição: modos offline/restricted/connected, egress enforcement, mirrors e testes air-gapped
...
- **TaskEnvelope:** `.codex/tasks/TASK-0520.json`

## História de usuário

Como administrador da instância, preciso validar acesso, redaction e exposição para “modos offline/restricted/connected, egress enforcement, mirrors e testes air-gapped”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Validar acesso, redaction e exposição para a capacidade **modos offline/restricted/connected, egress enforcement, mirrors e testes air-gapped**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/operations_audit/adapters/security/modos-offline-restricted-connected-egress-enforcement/**`
- `tests/security/contexts/operations_audit/modos-offline-restricted-connected-egress-enforcement/**`
## Fora de escopo
...
`STORY-0517`, `STORY-0518`, `STORY-0519`
...
- `test_epic_083_seguranca_happy_path`
- `test_epic_083_seguranca_negative_paths`
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0630-01, AC-ISSUE-0630-02, AC-ISSUE-0630-03, AC-ISSUE-0630-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-030`, `ADR-031`, `ADR-032`
