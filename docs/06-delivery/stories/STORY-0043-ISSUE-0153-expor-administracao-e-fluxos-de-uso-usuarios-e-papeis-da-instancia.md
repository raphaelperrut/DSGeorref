# STORY-0043 / ISSUE-0153 — Expor administração e fluxos de uso: usuários e papéis da instância
...
- **TaskEnvelope:** `.codex/tasks/TASK-0043.json`

## História de usuário

Como administrador da instância, preciso expor administração e fluxos de uso para “usuários e papéis da instância”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Expor administração e fluxos de uso para a capacidade **usuários e papéis da instância**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/frontend/src/contexts/identity_access/features/usuarios-e-papeis-da-instancia/**`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-005-frontend.md`, este documento, o épico `EPIC-009` e o TaskEnvelope `TASK-0043`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0153-01, AC-ISSUE-0153-02, AC-ISSUE-0153-03, AC-ISSUE-0153-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-014`, `ADR-016`
