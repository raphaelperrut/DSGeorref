# STORY-0104 / ISSUE-0214 — Implementar modelo e application services: Resource Governor, admission control e orçamento adaptativo de RAM/CPU/GPU/disco
...
- **TaskEnvelope:** `.codex/tasks/TASK-0104.json`

## História de usuário

Como operador geoespacial, preciso implementar modelo e application services para “Resource Governor, admission control e orçamento adaptativo de RAM/CPU/GPU/disco”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar modelo e application services para a capacidade **Resource Governor, admission control e orçamento adaptativo de RAM/CPU/GPU/disco**, com saída versionada, testes e evidência no commit candidato.
...
`REQ-BEX-002`, `REQ-BEX-004`, `REQ-BEX-006`, `REQ-BEX-010`, `REQ-MAT-001`, `REQ-MOS-004`
...
- [ ] Os requisitos REQ-BEX-002, REQ-BEX-004, REQ-BEX-006, REQ-BEX-010, REQ-MAT-001, REQ-MOS-004 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-019` e o TaskEnvelope `TASK-0104`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0214-01, AC-ISSUE-0214-02, AC-ISSUE-0214-03, AC-ISSUE-0214-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-012`, `ADR-016`, `ADR-038`, `ADR-039`, `ADR-044`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-012`, `ADR-016`, `ADR-018`, `ADR-019`, `ADR-038`, `ADR-039`, `ADR-044`
