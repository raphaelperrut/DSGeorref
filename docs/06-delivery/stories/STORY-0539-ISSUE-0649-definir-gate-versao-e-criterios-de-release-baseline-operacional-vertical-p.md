# STORY-0539 / ISSUE-0649 — Definir gate, versão e critérios de release: baseline operacional vertical privado com escopo da DELIVERY_PLAN e evidências do corpus controlado
...
- **TaskEnvelope:** `.codex/tasks/TASK-0539.json`

## História de usuário

Como responsável por release, preciso definir gate, versão e critérios de release para “baseline operacional vertical privado com escopo da DELIVERY_PLAN e evidências do corpus controlado”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir gate, versão e critérios de release para a capacidade **baseline operacional vertical privado com escopo da DELIVERY_PLAN e evidências do corpus controlado**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/release_installation/application/baseline-operacional-vertical-privado-com-escopo-da-de/**`
## Fora de escopo
...
`STORY-0538`, `STORY-0061`, `STORY-0102`, `STORY-0142`, `STORY-0267`, `STORY-0225`, `STORY-0208`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-003-tech-lead.md`, este documento, o épico `EPIC-087` e o TaskEnvelope `TASK-0539`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0649-01, AC-ISSUE-0649-02, AC-ISSUE-0649-03, AC-ISSUE-0649-04`
...
|---|---|---|
| Dependências | 7 predecessores explícitos | PASS |
