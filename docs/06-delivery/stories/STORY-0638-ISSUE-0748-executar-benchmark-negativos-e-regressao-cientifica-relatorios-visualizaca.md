# STORY-0638 / ISSUE-0748 — Executar benchmark, negativos e regressão científica: Relatórios, visualização e exports do mosaico relativo
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0638.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “Relatórios, visualização e exports do mosaico relativo”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **Relatórios, visualização e exports do mosaico relativo**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/relatorios-visualizacao-e-exports-do-mosaico-relativo/**`
- `tools/quality/contexts/relative_mosaic/relatorios-visualizacao-e-exports-do-mosaico-relativo/**`
- `.github/workflows/relatorios-visualizacao-e-exports-do-mosaico-relativo.yaml`
## Fora de escopo
...
`STORY-0634`, `STORY-0635`, `STORY-0636`, `STORY-0637`

## Critérios de aceitação

- [ ] O resultado de “Relatórios, visualização e exports do mosaico relativo” é observável por contrato, interface, artifact ou evidência executável.
...
- `test_epic_102_benchmark_happy_path`
- `test_epic_102_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-102` e o TaskEnvelope `TASK-0638`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0748-01, AC-ISSUE-0748-02, AC-ISSUE-0748-03, AC-ISSUE-0748-04`
