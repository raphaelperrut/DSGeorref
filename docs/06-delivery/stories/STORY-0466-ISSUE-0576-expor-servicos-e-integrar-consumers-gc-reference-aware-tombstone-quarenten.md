# STORY-0466 / ISSUE-0576 — Expor serviços e integrar consumers: GC reference-aware, tombstone, quarentena, período de graça e reconciliação
...
- **TaskEnvelope:** `.codex/tasks/TASK-0466.json`

## História de usuário

Como operador geoespacial, preciso expor serviços e integrar consumers para “GC reference-aware, tombstone, quarentena, período de graça e reconciliação”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Expor serviços e integrar consumers para a capacidade **GC reference-aware, tombstone, quarentena, período de graça e reconciliação**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-074` e o TaskEnvelope `TASK-0466`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0576-01, AC-ISSUE-0576-02, AC-ISSUE-0576-03, AC-ISSUE-0576-04`
