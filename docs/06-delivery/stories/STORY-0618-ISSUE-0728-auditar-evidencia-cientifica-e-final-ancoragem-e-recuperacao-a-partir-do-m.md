# STORY-0618 / ISSUE-0728 — Auditar evidência científica e final: Ancoragem e recuperação a partir do mosaico relativo
...
- **TaskEnvelope:** `.codex/tasks/TASK-0618.json`

## História de usuário

Como operador geoespacial, preciso auditar evidência científica e final para “Ancoragem e recuperação a partir do mosaico relativo”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar evidência científica e final para a capacidade **Ancoragem e recuperação a partir do mosaico relativo**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/ancoragem-e-recuperacao-a-partir-do-mosaico-relativo/**`
## Fora de escopo
...
- `test_epic_099_aceite_happy_path`
- `test_epic_099_aceite_negative_paths`
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0728-01, AC-ISSUE-0728-02, AC-ISSUE-0728-03, AC-ISSUE-0728-04`
