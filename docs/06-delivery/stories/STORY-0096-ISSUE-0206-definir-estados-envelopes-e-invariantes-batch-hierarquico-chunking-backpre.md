# STORY-0096 / ISSUE-0206 — Definir estados, envelopes e invariantes: batch hierárquico, chunking, backpressure, checkpoints e retomada para lotes usuais de 40–300 imagens
...
- **TaskEnvelope:** `.codex/tasks/TASK-0096.json`

## História de usuário

Como operador geoespacial, preciso definir estados, envelopes e invariantes para “batch hierárquico, chunking, backpressure, checkpoints e retomada para lotes usuais de 40–300 imagens”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir estados, envelopes e invariantes para a capacidade **batch hierárquico, chunking, backpressure, checkpoints e retomada para lotes usuais de 40–300 imagens**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/job_orchestration/job/batch-hierarquico-chunking-backpressure-checkpoints-e/**`
- `docs/02-architecture/design-reviews/batch-hierarquico-chunking-backpressure-checkpoints-e/**`
## Fora de escopo
...
`REQ-BEX-003`, `REQ-BEX-005`, `REQ-EPIC-017`
...
`STORY-0081`, `STORY-0088`, `STORY-0061`
...
- [ ] Os requisitos REQ-BEX-003, REQ-BEX-005, REQ-EPIC-017 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-018` e o TaskEnvelope `TASK-0096`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0206-01, AC-ISSUE-0206-02, AC-ISSUE-0206-03, AC-ISSUE-0206-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-038`, `ADR-046`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-012`, `ADR-016`, `ADR-038`, `ADR-046`
