# STORY-0351 / ISSUE-0461 — Definir contrato científico e invariantes: resultados por componente, sucesso parcial explícito, retry por subconjunto e UX de componentes não resolvidos
...
- **TaskEnvelope:** `.codex/tasks/TASK-0351.json`

## História de usuário

Como operador geoespacial, preciso definir contrato científico e invariantes para “resultados por componente, sucesso parcial explícito, retry por subconjunto e UX de componentes não resolvidos”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir contrato científico e invariantes para a capacidade **resultados por componente, sucesso parcial explícito, retry por subconjunto e UX de componentes não resolvidos**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/results_reporting/geo/resultados-por-componente-sucesso-parcial-explicito-re/**`
- `docs/02-architecture/design-reviews/resultados-por-componente-sucesso-parcial-explicito-re/**`
## Fora de escopo
...
`STORY-0329`, `STORY-0350`, `STORY-0184`
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0461-01, AC-ISSUE-0461-02, AC-ISSUE-0461-03, AC-ISSUE-0461-04`
