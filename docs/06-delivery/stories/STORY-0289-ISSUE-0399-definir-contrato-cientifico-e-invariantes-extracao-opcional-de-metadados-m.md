# STORY-0289 / ISSUE-0399 — Definir contrato científico e invariantes: extração opcional de metadados marginais com confiança, revisão e lineage
...
- **TaskEnvelope:** `.codex/tasks/TASK-0289.json`

## História de usuário

Como operador geoespacial, preciso definir contrato científico e invariantes para “extração opcional de metadados marginais com confiança, revisão e lineage”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir contrato científico e invariantes para a capacidade **extração opcional de metadados marginais com confiança, revisão e lineage**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/georeferencing/geo/extracao-opcional-de-metadados-marginais-com-confianca/**`
- `docs/02-architecture/design-reviews/extracao-opcional-de-metadados-marginais-com-confianca/**`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-048` e o TaskEnvelope `TASK-0289`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0399-01, AC-ISSUE-0399-02, AC-ISSUE-0399-03, AC-ISSUE-0399-04`
