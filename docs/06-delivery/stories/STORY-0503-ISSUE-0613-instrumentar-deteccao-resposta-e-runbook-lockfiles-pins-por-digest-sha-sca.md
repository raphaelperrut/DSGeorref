# STORY-0503 / ISSUE-0613 — Instrumentar detecção, resposta e runbook: lockfiles, pins por digest/SHA, scanners, SBOM, assinatura OCI, attestations e verificador de release
...
- **TaskEnvelope:** `.codex/tasks/TASK-0503.json`

## História de usuário

Como administrador de segurança, preciso instrumentar detecção, resposta e runbook para “lockfiles, pins por digest/SHA, scanners, SBOM, assinatura OCI, attestations e verificador de release”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Instrumentar detecção, resposta e runbook para a capacidade **lockfiles, pins por digest/SHA, scanners, SBOM, assinatura OCI, attestations e verificador de release**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/sec/lockfiles-pins-por-digest-sha-scanners-sbom-assinatura/**`
- `tools/quality/contexts/release_installation/lockfiles-pins-por-digest-sha-scanners-sbom-assinatura/**`
- `.github/workflows/lockfiles-pins-por-digest-sha-scanners-sbom-assinatura.yaml`
## Fora de escopo
...
`STORY-0500`, `STORY-0501`, `STORY-0502`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-080` e o TaskEnvelope `TASK-0503`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0613-01, AC-ISSUE-0613-02, AC-ISSUE-0613-03, AC-ISSUE-0613-04`
