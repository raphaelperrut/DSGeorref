# STORY-0553 / ISSUE-0663 — Executar instalação limpa e rehearsal: release train internal/alpha/beta/1.0, automação de evidências e gate de abertura pública
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0553.json`

## História de usuário

Como responsável por release, preciso executar instalação limpa e rehearsal para “release train internal/alpha/beta/1.0, automação de evidências e gate de abertura pública”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar instalação limpa e rehearsal para a capacidade **release train internal/alpha/beta/1.0, automação de evidências e gate de abertura pública**, com saída versionada, testes e evidência no commit candidato.
...
`STORY-0550`, `STORY-0551`, `STORY-0552`
...
- `test_epic_089_ensaio_happy_path`
- `test_epic_089_ensaio_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-089` e o TaskEnvelope `TASK-0553`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0663-01, AC-ISSUE-0663-02, AC-ISSUE-0663-03, AC-ISSUE-0663-04`
