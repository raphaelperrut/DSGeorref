# STORY-0649 / ISSUE-0759 — Implementar runner, worker ou scheduler: Snapshots, replay e bundles do scheduler
...
- **TaskEnvelope:** `.codex/tasks/TASK-0649.json`

## História de usuário

Como operador geoespacial, preciso implementar runner, worker ou scheduler para “Snapshots, replay e bundles do scheduler”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar runner, worker ou scheduler para a capacidade **Snapshots, replay e bundles do scheduler**, com saída versionada, testes e evidência no commit candidato.
...
- [ ] Os requisitos REQ-SRP-002 possuem evidência explícita no commit candidato.
...
- `test_offline_scheduler_decision_replay_without_scientific_workload_or_providers`
- `test_epic_104_execucao`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-104` e o TaskEnvelope `TASK-0649`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0759-01, AC-ISSUE-0759-02, AC-ISSUE-0759-03, AC-ISSUE-0759-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-016`, `ADR-037`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-016`, `ADR-018`, `ADR-019`, `ADR-037`
