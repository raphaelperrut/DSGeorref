# STORY-0565 / ISSUE-0675 — Definir escopo, contratos e invariantes: fechamento da SPRINT-001 e autorização da primeira fatia funcional
...
- **TaskEnvelope:** `.codex/tasks/TASK-0565.json`

## História de usuário

Como mantenedor de engenharia, preciso definir escopo, contratos e invariantes para “fechamento da SPRINT-001 e autorização da primeira fatia funcional”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir escopo, contratos e invariantes para a capacidade **fechamento da SPRINT-001 e autorização da primeira fatia funcional**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/engineering_governance/fnd/fechamento-da-sprint-001-e-autorizacao-da-primeira-fat/**`
- `docs/02-architecture/design-reviews/fechamento-da-sprint-001-e-autorizacao-da-primeira-fat/**`
## Fora de escopo
...
`STORY-0010`, `STORY-0015`, `STORY-0020`, `STORY-0025`, `STORY-0538`
...
- [ ] Os requisitos REQ-EPIC-001 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-092` e o TaskEnvelope `TASK-0565`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0675-01, AC-ISSUE-0675-02, AC-ISSUE-0675-03, AC-ISSUE-0675-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-002`, `ADR-003`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-002`, `ADR-003`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`
