# STORY-0045 / ISSUE-0155 — Executar QA e auditoria final: usuários e papéis da instância
...
- **TaskEnvelope:** `.codex/tasks/TASK-0045.json`

## História de usuário

Como administrador da instância, preciso executar qa e auditoria final para “usuários e papéis da instância”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar QA e auditoria final para a capacidade **usuários e papéis da instância**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/usuarios-e-papeis-da-instancia/**`
## Fora de escopo
...
- `test_epic_009_aceite_happy_path`
- `test_epic_009_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-009` e o TaskEnvelope `TASK-0045`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0155-01, AC-ISSUE-0155-02, AC-ISSUE-0155-03, AC-ISSUE-0155-04`
