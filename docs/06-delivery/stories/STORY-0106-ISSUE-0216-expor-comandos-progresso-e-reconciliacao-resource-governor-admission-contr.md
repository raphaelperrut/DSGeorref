# STORY-0106 / ISSUE-0216 — Expor comandos, progresso e reconciliação: Resource Governor, admission control e orçamento adaptativo de RAM/CPU/GPU/disco
...
- **TaskEnvelope:** `.codex/tasks/TASK-0106.json`

## História de usuário

Como operador geoespacial, preciso expor comandos, progresso e reconciliação para “Resource Governor, admission control e orçamento adaptativo de RAM/CPU/GPU/disco”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Expor comandos, progresso e reconciliação para a capacidade **Resource Governor, admission control e orçamento adaptativo de RAM/CPU/GPU/disco**, com saída versionada, testes e evidência no commit candidato.
...
- [ ] Os requisitos REQ-BEX-001, REQ-SCL-001 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-019` e o TaskEnvelope `TASK-0106`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0216-01, AC-ISSUE-0216-02, AC-ISSUE-0216-03, AC-ISSUE-0216-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-016`, `ADR-039`, `ADR-053`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-012`, `ADR-016`, `ADR-018`, `ADR-019`, `ADR-039`, `ADR-053`
