# STORY-0485 / ISSUE-0595 — Validar acesso, redaction e exposição: budgets de cardinalidade, sampling, retenção por sinal e dashboards de perda/overhead
...
- **TaskEnvelope:** `.codex/tasks/TASK-0485.json`

## História de usuário

Como administrador da instância, preciso validar acesso, redaction e exposição para “budgets de cardinalidade, sampling, retenção por sinal e dashboards de perda/overhead”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Validar acesso, redaction e exposição para a capacidade **budgets de cardinalidade, sampling, retenção por sinal e dashboards de perda/overhead**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/operations_audit/adapters/security/budgets-de-cardinalidade-sampling-retencao-por-sinal-e/**`
- `tests/security/contexts/operations_audit/budgets-de-cardinalidade-sampling-retencao-por-sinal-e/**`
## Fora de escopo
...
`STORY-0482`, `STORY-0483`, `STORY-0484`
...
- `test_epic_077_seguranca_happy_path`
- `test_epic_077_seguranca_negative_paths`
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0595-01, AC-ISSUE-0595-02, AC-ISSUE-0595-03, AC-ISSUE-0595-04`
