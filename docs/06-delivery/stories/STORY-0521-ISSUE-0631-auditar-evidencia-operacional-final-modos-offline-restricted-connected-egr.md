# STORY-0521 / ISSUE-0631 — Auditar evidência operacional final: modos offline/restricted/connected, egress enforcement, mirrors e testes air-gapped
...
- **TaskEnvelope:** `.codex/tasks/TASK-0521.json`

## História de usuário

Como administrador da instância, preciso auditar evidência operacional final para “modos offline/restricted/connected, egress enforcement, mirrors e testes air-gapped”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar evidência operacional final para a capacidade **modos offline/restricted/connected, egress enforcement, mirrors e testes air-gapped**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/modos-offline-restricted-connected-egress-enforcement/**`
## Fora de escopo
...
- `test_epic_083_aceite_happy_path`
- `test_epic_083_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-083` e o TaskEnvelope `TASK-0521`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0631-01, AC-ISSUE-0631-02, AC-ISSUE-0631-03, AC-ISSUE-0631-04`
