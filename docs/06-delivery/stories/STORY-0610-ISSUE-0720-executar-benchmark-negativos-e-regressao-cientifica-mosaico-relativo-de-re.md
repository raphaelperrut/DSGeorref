# STORY-0610 / ISSUE-0720 — Executar benchmark, negativos e regressão científica: Mosaico relativo de recuperação
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0610.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “Mosaico relativo de recuperação”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **Mosaico relativo de recuperação**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/mosaico-relativo-de-recuperacao/**`
- `tools/quality/contexts/relative_mosaic/mosaico-relativo-de-recuperacao/**`
- `.github/workflows/mosaico-relativo-de-recuperacao.yaml`
## Fora de escopo
...
`STORY-0606`, `STORY-0607`, `STORY-0608`, `STORY-0609`

## Critérios de aceitação

- [ ] O resultado de “Mosaico relativo de recuperação” é observável por contrato, interface, artifact ou evidência executável.
- [ ] Os requisitos REQ-MOS-005 possuem evidência explícita no commit candidato.
...
- `test_leave_one_out_non_circular_reference_and_independent_sgv`
- `test_epic_098_benchmark_happy_path`
- `test_epic_098_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-098` e o TaskEnvelope `TASK-0610`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0720-01, AC-ISSUE-0720-02, AC-ISSUE-0720-03, AC-ISSUE-0720-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-044`, `ADR-049`, `ADR-050`
...
- **Relatório da sprint:** `docs/07-assurance/phase-f/SPRINT-007-REVIEW.md`
