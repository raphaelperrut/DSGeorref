# STORY-0394 / ISSUE-0504 — Integrar ao ProcessingPlan e pipeline: modelo tipado/versionado de GCPs, lifecycle, proveniência e round-trip dos exports
...
- **TaskEnvelope:** `.codex/tasks/TASK-0394.json`

## História de usuário

Como operador geoespacial, preciso integrar ao processingplan e pipeline para “modelo tipado/versionado de GCPs, lifecycle, proveniência e round-trip dos exports”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Integrar ao ProcessingPlan e pipeline para a capacidade **modelo tipado/versionado de GCPs, lifecycle, proveniência e round-trip dos exports**, com saída versionada, testes e evidência no commit candidato.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0504-01, AC-ISSUE-0504-02, AC-ISSUE-0504-03, AC-ISSUE-0504-04`
