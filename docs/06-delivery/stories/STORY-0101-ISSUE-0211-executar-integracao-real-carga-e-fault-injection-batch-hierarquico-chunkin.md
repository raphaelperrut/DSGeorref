# STORY-0101 / ISSUE-0211 — Executar integração real, carga e fault injection: batch hierárquico, chunking, backpressure, checkpoints e retomada para lotes usuais de 40–300 imagens
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0101.json`

## História de usuário

Como operador geoespacial, preciso executar integração real, carga e fault injection para “batch hierárquico, chunking, backpressure, checkpoints e retomada para lotes usuais de 40–300 imagens”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar integração real, carga e fault injection para a capacidade **batch hierárquico, chunking, backpressure, checkpoints e retomada para lotes usuais de 40–300 imagens**, com saída versionada, testes e evidência no commit candidato.
...
`STORY-0097`, `STORY-0098`, `STORY-0099`, `STORY-0100`
...
- `test_epic_018_validacao_happy_path`
- `test_epic_018_validacao_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-018` e o TaskEnvelope `TASK-0101`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0211-01, AC-ISSUE-0211-02, AC-ISSUE-0211-03, AC-ISSUE-0211-04`
