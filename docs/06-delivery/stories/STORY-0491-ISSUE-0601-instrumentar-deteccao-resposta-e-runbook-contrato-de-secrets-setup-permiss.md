# STORY-0491 / ISSUE-0601 — Instrumentar detecção, resposta e runbook: contrato de secrets, setup, permissões, rotação, recuperação e adapters opcionais de vault
...
- **TaskEnvelope:** `.codex/tasks/TASK-0491.json`

## História de usuário

Como administrador de segurança, preciso instrumentar detecção, resposta e runbook para “contrato de secrets, setup, permissões, rotação, recuperação e adapters opcionais de vault”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Instrumentar detecção, resposta e runbook para a capacidade **contrato de secrets, setup, permissões, rotação, recuperação e adapters opcionais de vault**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/sec/contrato-de-secrets-setup-permissoes-rotacao-recuperac/**`
- `tools/quality/contexts/operations_audit/contrato-de-secrets-setup-permissoes-rotacao-recuperac/**`
- `.github/workflows/contrato-de-secrets-setup-permissoes-rotacao-recuperac.yaml`
## Fora de escopo
...
`STORY-0488`, `STORY-0489`, `STORY-0490`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-078` e o TaskEnvelope `TASK-0491`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0601-01, AC-ISSUE-0601-02, AC-ISSUE-0601-03, AC-ISSUE-0601-04`
