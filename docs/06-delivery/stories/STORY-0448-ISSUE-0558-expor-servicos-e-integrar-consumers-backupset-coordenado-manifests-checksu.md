# STORY-0448 / ISSUE-0558 — Expor serviços e integrar consumers: BackupSet coordenado, manifests, checksums, watermark e policies de inclusão
...
- **TaskEnvelope:** `.codex/tasks/TASK-0448.json`

## História de usuário

Como operador geoespacial, preciso expor serviços e integrar consumers para “BackupSet coordenado, manifests, checksums, watermark e policies de inclusão”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Expor serviços e integrar consumers para a capacidade **BackupSet coordenado, manifests, checksums, watermark e policies de inclusão**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-071` e o TaskEnvelope `TASK-0448`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0558-01, AC-ISSUE-0558-02, AC-ISSUE-0558-03, AC-ISSUE-0558-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-016`, `ADR-018`, `ADR-019`, `ADR-025`
