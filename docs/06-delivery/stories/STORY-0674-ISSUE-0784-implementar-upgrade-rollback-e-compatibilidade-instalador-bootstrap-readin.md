# STORY-0674 / ISSUE-0784 — Implementar upgrade, rollback e compatibilidade: Instalador, bootstrap, readiness e suporte diagnóstico
...
- **TaskEnvelope:** `.codex/tasks/TASK-0674.json`

## História de usuário

Como responsável por release, preciso implementar upgrade, rollback e compatibilidade para “Instalador, bootstrap, readiness e suporte diagnóstico”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar upgrade, rollback e compatibilidade para a capacidade **Instalador, bootstrap, readiness e suporte diagnóstico**, com saída versionada, testes e evidência no commit candidato.
...
- `test_epic_108_upgrade_roundtrip`
- `test_epic_108_upgrade_recovery`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-108` e o TaskEnvelope `TASK-0674`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0784-01, AC-ISSUE-0784-02, AC-ISSUE-0784-03, AC-ISSUE-0784-04`
