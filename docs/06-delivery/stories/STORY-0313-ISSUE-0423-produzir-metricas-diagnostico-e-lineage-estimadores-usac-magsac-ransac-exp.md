# STORY-0313 / ISSUE-0423 — Produzir métricas, diagnóstico e lineage: estimadores USAC_MAGSAC/RANSAC explícitos, calibração, proveniência e testes de compatibilidade
...
- **TaskEnvelope:** `.codex/tasks/TASK-0313.json`

## História de usuário

Como operador geoespacial, preciso produzir métricas, diagnóstico e lineage para “estimadores USAC_MAGSAC/RANSAC explícitos, calibração, proveniência e testes de compatibilidade”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Produzir métricas, diagnóstico e lineage para a capacidade **estimadores USAC_MAGSAC/RANSAC explícitos, calibração, proveniência e testes de compatibilidade**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-051` e o TaskEnvelope `TASK-0313`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0423-01, AC-ISSUE-0423-02, AC-ISSUE-0423-03, AC-ISSUE-0423-04`
