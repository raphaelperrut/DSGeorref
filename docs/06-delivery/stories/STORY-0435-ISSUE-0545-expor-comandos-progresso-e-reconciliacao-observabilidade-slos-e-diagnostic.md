# STORY-0435 / ISSUE-0545 — Expor comandos, progresso e reconciliação: Observabilidade, SLOs e diagnóstico do scheduler
...
- **TaskEnvelope:** `.codex/tasks/TASK-0435.json`

## História de usuário

Como operador geoespacial, preciso expor comandos, progresso e reconciliação para “Observabilidade, SLOs e diagnóstico do scheduler”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Expor comandos, progresso e reconciliação para a capacidade **Observabilidade, SLOs e diagnóstico do scheduler**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-069` e o TaskEnvelope `TASK-0435`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0545-01, AC-ISSUE-0545-02, AC-ISSUE-0545-03, AC-ISSUE-0545-04`
