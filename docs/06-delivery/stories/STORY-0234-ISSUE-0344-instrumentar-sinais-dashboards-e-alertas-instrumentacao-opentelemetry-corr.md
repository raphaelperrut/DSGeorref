# STORY-0234 / ISSUE-0344 — Instrumentar sinais, dashboards e alertas: instrumentação OpenTelemetry, correlation IDs, métricas, dashboards e alertas para API, RabbitMQ e workers
...
- **TaskEnvelope:** `.codex/tasks/TASK-0234.json`

## História de usuário

Como administrador da instância, preciso instrumentar sinais, dashboards e alertas para “instrumentação OpenTelemetry, correlation IDs, métricas, dashboards e alertas para API, RabbitMQ e workers”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Instrumentar sinais, dashboards e alertas para a capacidade **instrumentação OpenTelemetry, correlation IDs, métricas, dashboards e alertas para API, RabbitMQ e workers**, com saída versionada, testes e evidência no commit candidato.
...
`REQ-EPIC-018`, `REQ-OBS-001`, `REQ-WORKER-002`, `REQ-WORKER-004`, `REQ-WORKER-005`, `REQ-WORKER-006`, `REQ-WORKER-007`, `REQ-WORKER-008`, `REQ-WORKER-009`
...
- [ ] Os requisitos REQ-EPIC-018, REQ-OBS-001, REQ-WORKER-002, REQ-WORKER-004, REQ-WORKER-005, REQ-WORKER-006 possuem evidência explícita no commit candidato.
- [ ] Estados de erro e caminhos fail-closed aplicáveis são testados, sem fallback silencioso.
- [ ] Métricas, logs e traces usam cardinalidade bounded e correlation IDs.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-039` e o TaskEnvelope `TASK-0234`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0344-01, AC-ISSUE-0344-02, AC-ISSUE-0344-03, AC-ISSUE-0344-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-010`, `ADR-011`, `ADR-012`, `ADR-018`, `ADR-020`, `ADR-033`, `ADR-034`, `ADR-037`, `ADR-038`, `ADR-054`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-010`, `ADR-011`, `ADR-012`, `ADR-018`, `ADR-020`, `ADR-033`, `ADR-034`, `ADR-037`, `ADR-038`, `ADR-054`
