# STORY-0622 / ISSUE-0732 — Integrar ao ProcessingPlan e pipeline: Workspace e lifecycle de âncoras
...
- **TaskEnvelope:** `.codex/tasks/TASK-0622.json`

## História de usuário

Como operador geoespacial, preciso integrar ao processingplan e pipeline para “Workspace e lifecycle de âncoras”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Integrar ao ProcessingPlan e pipeline para a capacidade **Workspace e lifecycle de âncoras**, com saída versionada, testes e evidência no commit candidato.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0732-01, AC-ISSUE-0732-02, AC-ISSUE-0732-03, AC-ISSUE-0732-04`
