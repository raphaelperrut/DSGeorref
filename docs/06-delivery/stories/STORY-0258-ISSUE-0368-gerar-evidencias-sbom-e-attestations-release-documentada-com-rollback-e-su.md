# STORY-0258 / ISSUE-0368 — Gerar evidências, SBOM e attestations: release documentada com rollback e suporte
...
- **TaskEnvelope:** `.codex/tasks/TASK-0258.json`

## História de usuário

Como responsável por release, preciso gerar evidências, sbom e attestations para “release documentada com rollback e suporte”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Gerar evidências, SBOM e attestations para a capacidade **release documentada com rollback e suporte**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/release_installation/adapters/security/release-documentada-com-rollback-e-suporte/**`
- `tests/security/contexts/release_installation/release-documentada-com-rollback-e-suporte/**`
## Fora de escopo
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0368-01, AC-ISSUE-0368-02, AC-ISSUE-0368-03, AC-ISSUE-0368-04`
