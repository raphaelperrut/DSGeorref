# STORY-0080 / ISSUE-0190 — Executar integração real, carga e fault injection: runner direto e Celery/RabbitMQ sobre o mesmo núcleo
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0080.json`

## História de usuário

Como operador geoespacial, preciso executar integração real, carga e fault injection para “runner direto e Celery/RabbitMQ sobre o mesmo núcleo”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar integração real, carga e fault injection para a capacidade **runner direto e Celery/RabbitMQ sobre o mesmo núcleo**, com saída versionada, testes e evidência no commit candidato.
...
`STORY-0076`, `STORY-0077`, `STORY-0078`, `STORY-0079`
...
- `test_epic_015_validacao_happy_path`
- `test_epic_015_validacao_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-015` e o TaskEnvelope `TASK-0080`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0190-01, AC-ISSUE-0190-02, AC-ISSUE-0190-03, AC-ISSUE-0190-04`
