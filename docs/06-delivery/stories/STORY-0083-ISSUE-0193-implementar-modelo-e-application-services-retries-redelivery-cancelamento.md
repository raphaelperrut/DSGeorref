# STORY-0083 / ISSUE-0193 — Implementar modelo e application services: retries, redelivery, cancelamento, retomada e idempotência
...
- **TaskEnvelope:** `.codex/tasks/TASK-0083.json`

## História de usuário

Como operador geoespacial, preciso implementar modelo e application services para “retries, redelivery, cancelamento, retomada e idempotência”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar modelo e application services para a capacidade **retries, redelivery, cancelamento, retomada e idempotência**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-016` e o TaskEnvelope `TASK-0083`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0193-01, AC-ISSUE-0193-02, AC-ISSUE-0193-03, AC-ISSUE-0193-04`
