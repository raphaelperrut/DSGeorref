# STORY-0360 / ISSUE-0470 — Implementar o núcleo algorítmico: gateway por capacidades, adapters STAC/API oficial, testes de contrato, allowlist, SSRF/egress e estados de licença/disponibilidade
...
- **TaskEnvelope:** `.codex/tasks/TASK-0360.json`

## História de usuário

Como operador geoespacial, preciso implementar o núcleo algorítmico para “gateway por capacidades, adapters STAC/API oficial, testes de contrato, allowlist, SSRF/egress e estados de licença/disponibilidade”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar o núcleo algorítmico para a capacidade **gateway por capacidades, adapters STAC/API oficial, testes de contrato, allowlist, SSRF/egress e estados de licença/disponibilidade**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/geo/dsgeorref_geo/contexts/reference_discovery/gateway-por-capacidades-adapters-stac-api-oficial-test/**`
## Fora de escopo
...
- [ ] Os requisitos REQ-ANC-001 possuem evidência explícita no commit candidato.
...
- `test_distributed_external_anchor_sources_provenance_uncertainty_and_coverage`
- `test_epic_058_algoritmo`
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0470-01, AC-ISSUE-0470-02, AC-ISSUE-0470-03, AC-ISSUE-0470-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-049`
- **Conflito:** `Nenhum`
