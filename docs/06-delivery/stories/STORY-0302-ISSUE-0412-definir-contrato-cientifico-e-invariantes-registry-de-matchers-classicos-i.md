# STORY-0302 / ISSUE-0412 — Definir contrato científico e invariantes: registry de matchers clássicos/IA, escalonamento explicável, licenças, manifests e benchmark
...
- **TaskEnvelope:** `.codex/tasks/TASK-0302.json`

## História de usuário

Como operador geoespacial, preciso definir contrato científico e invariantes para “registry de matchers clássicos/IA, escalonamento explicável, licenças, manifests e benchmark”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir contrato científico e invariantes para a capacidade **registry de matchers clássicos/IA, escalonamento explicável, licenças, manifests e benchmark**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/ai_recovery/geo/registry-de-matchers-classicos-ia-escalonamento-explic/**`
- `docs/02-architecture/design-reviews/registry-de-matchers-classicos-ia-escalonamento-explic/**`
## Fora de escopo
...
`REQ-AI-005`, `REQ-AIE-001`, `REQ-AIE-005`, `REQ-SDR-002`
...
`STORY-0121`, `STORY-0288`, `STORY-0020`
...
- [ ] Os requisitos REQ-AI-005, REQ-AIE-001, REQ-AIE-005, REQ-SDR-002 possuem evidência explícita no commit candidato.
...
- `test_tiered_cpu_gpu_runner_numerical_decision_and_artifact_equivalence`
- `test_epic_050_contrato`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-050` e o TaskEnvelope `TASK-0302`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0412-01, AC-ISSUE-0412-02, AC-ISSUE-0412-03, AC-ISSUE-0412-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-038`, `ADR-051`, `ADR-052`, `ADR-053`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-017`, `ADR-038`, `ADR-051`, `ADR-052`, `ADR-053`, `ADR-055`
