# STORY-0453 / ISSUE-0563 — Instrumentar sinais, dashboards e alertas: restore drills isolados, evidências, RPO/RTO e runbook executável
...
- **TaskEnvelope:** `.codex/tasks/TASK-0453.json`

## História de usuário

Como administrador da instância, preciso instrumentar sinais, dashboards e alertas para “restore drills isolados, evidências, RPO/RTO e runbook executável”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Instrumentar sinais, dashboards e alertas para a capacidade **restore drills isolados, evidências, RPO/RTO e runbook executável**, com saída versionada, testes e evidência no commit candidato.
...
- [ ] Os requisitos REQ-BKP-002 possuem evidência explícita no commit candidato.
...
- `test_isolated_restore_drill_integrity_rpo_rto`
- `test_epic_072_observabilidade`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-072` e o TaskEnvelope `TASK-0453`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0563-01, AC-ISSUE-0563-02, AC-ISSUE-0563-03, AC-ISSUE-0563-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-025`, `ADR-033`, `ADR-034`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-010`, `ADR-011`, `ADR-025`, `ADR-027`, `ADR-033`, `ADR-034`
