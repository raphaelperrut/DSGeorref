# STORY-0151 / ISSUE-0261 — Consolidar slices e liberar integração: artefatos e lineage
...
- **TaskEnvelope:** `.codex/tasks/TASK-0151.json`

## História de usuário

Como operador geoespacial, preciso preparar corpus, fixtures e representação tipada para “artefatos e lineage”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.
...
- `src/geo/dsgeorref_geo/contexts/artifact_provenance/artefatos-e-lineage/consolidacao/**`
## Fora de escopo
...
`STORY-0732`, `STORY-0733`, `STORY-0734`
...
- `test_story_0151_slice_consolidation`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-026` e o TaskEnvelope `TASK-0151`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0261-01, AC-ISSUE-0261-02, AC-ISSUE-0261-03, AC-ISSUE-0261-04`
