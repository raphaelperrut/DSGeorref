# STORY-0597 / ISSUE-0707 — Auditar evidência científica e final: Seletor e validador de CRS
...
- **TaskEnvelope:** `.codex/tasks/TASK-0597.json`

## História de usuário

Como operador geoespacial, preciso auditar evidência científica e final para “Seletor e validador de CRS”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar evidência científica e final para a capacidade **Seletor e validador de CRS**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/seletor-e-validador-de-crs/**`
## Fora de escopo
...
- `test_epic_096_aceite_happy_path`
- `test_epic_096_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-096` e o TaskEnvelope `TASK-0597`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0707-01, AC-ISSUE-0707-02, AC-ISSUE-0707-03, AC-ISSUE-0707-04`
