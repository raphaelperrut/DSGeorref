# STORY-0064 / ISSUE-0174 — Implementar armazenamento e lifecycle: backup/restore consistente entre banco e arquivos
...
- **TaskEnvelope:** `.codex/tasks/TASK-0064.json`

## História de usuário

Como operador geoespacial, preciso implementar armazenamento e lifecycle para “backup/restore consistente entre banco e arquivos”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar armazenamento e lifecycle para a capacidade **backup/restore consistente entre banco e arquivos**, com saída versionada, testes e evidência no commit candidato.
...
- `test_epic_013_armazenamento_roundtrip`
- `test_epic_013_armazenamento_recovery`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-013` e o TaskEnvelope `TASK-0064`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0174-01, AC-ISSUE-0174-02, AC-ISSUE-0174-03, AC-ISSUE-0174-04`
