# STORY-0446 / ISSUE-0556 — Implementar persistência e migrations: BackupSet coordenado, manifests, checksums, watermark e policies de inclusão
...
- **TaskEnvelope:** `.codex/tasks/TASK-0446.json`

## História de usuário

Como operador geoespacial, preciso implementar persistência e migrations para “BackupSet coordenado, manifests, checksums, watermark e policies de inclusão”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar persistência e migrations para a capacidade **BackupSet coordenado, manifests, checksums, watermark e policies de inclusão**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/artifact_provenance/application/backupset-coordenado-manifests-checksums-watermark-e-p/**`
- `src/backend/dsgeorref/contexts/artifact_provenance/adapters/backupset-coordenado-manifests-checksums-watermark-e-p/**`
## Fora de escopo
...
- [ ] Os requisitos REQ-BKP-001 possuem evidência explícita no commit candidato.
...
- `test_epic_071_persistencia_roundtrip`
- `test_epic_071_persistencia_recovery`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-071` e o TaskEnvelope `TASK-0446`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0556-01, AC-ISSUE-0556-02, AC-ISSUE-0556-03, AC-ISSUE-0556-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-016`, `ADR-018`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-016`, `ADR-018`, `ADR-019`, `ADR-025`
