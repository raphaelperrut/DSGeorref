# STORY-0547 / ISSUE-0657 — Executar avaliação e comparação: namespace experimental/labs, registry separado, ModelPacks isolados e bloqueio técnico de ArtifactSet aceito
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0547.json`

## História de usuário

Como mantenedor científico, preciso executar avaliação e comparação para “namespace experimental/labs, registry separado, ModelPacks isolados e bloqueio técnico de ArtifactSet aceito”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar avaliação e comparação para a capacidade **namespace experimental/labs, registry separado, ModelPacks isolados e bloqueio técnico de ArtifactSet aceito**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/lab/namespace-experimental-labs-registry-separado-modelpac/**`
- `tools/quality/contexts/ai_recovery/namespace-experimental-labs-registry-separado-modelpac/**`
- `.github/workflows/namespace-experimental-labs-registry-separado-modelpac.yaml`
## Fora de escopo
...
- `test_epic_088_benchmark_happy_path`
- `test_epic_088_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-088` e o TaskEnvelope `TASK-0547`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0657-01, AC-ISSUE-0657-02, AC-ISSUE-0657-03, AC-ISSUE-0657-04`
