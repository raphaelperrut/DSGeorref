# STORY-0532 / ISSUE-0642 — Executar instalação limpa e rehearsal: definição e automação de milestones internal/alpha/beta/1.0, evidências e gate de abertura do repositório
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0532.json`

## História de usuário

Como responsável por release, preciso executar instalação limpa e rehearsal para “definição e automação de milestones internal/alpha/beta/1.0, evidências e gate de abertura do repositório”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar instalação limpa e rehearsal para a capacidade **definição e automação de milestones internal/alpha/beta/1.0, evidências e gate de abertura do repositório**, com saída versionada, testes e evidência no commit candidato.
...
`STORY-0529`, `STORY-0530`, `STORY-0531`
...
- `test_epic_085_ensaio_happy_path`
- `test_epic_085_ensaio_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-085` e o TaskEnvelope `TASK-0532`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0642-01, AC-ISSUE-0642-02, AC-ISSUE-0642-03, AC-ISSUE-0642-04`
