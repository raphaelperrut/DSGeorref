# STORY-0086 / ISSUE-0196 — Automatizar testes de resiliência, retry e recuperação: retries, redelivery, cancelamento, retomada e idempotência
...
- **TaskEnvelope:** `.codex/tasks/TASK-0086.json`

## História de usuário

Como operador geoespacial, preciso automatizar testes de resiliência, retry e recuperação para “retries, redelivery, cancelamento, retomada e idempotência”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Automatizar testes de resiliência, retry e recuperação para a capacidade **retries, redelivery, cancelamento, retomada e idempotência**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/job/retries-redelivery-cancelamento-retomada-e-idempotenci/**`
- `tools/quality/contexts/job_orchestration/retries-redelivery-cancelamento-retomada-e-idempotenci/**`
- `.github/workflows/retries-redelivery-cancelamento-retomada-e-idempotenci.yaml`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-016` e o TaskEnvelope `TASK-0086`. Trabalhe somente nos paths permitidos. Entregue o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0196-01, AC-ISSUE-0196-02, AC-ISSUE-0196-03, AC-ISSUE-0196-04`
