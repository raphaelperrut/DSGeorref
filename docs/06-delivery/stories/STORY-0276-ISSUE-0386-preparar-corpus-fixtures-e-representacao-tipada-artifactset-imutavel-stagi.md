# STORY-0276 / ISSUE-0386 — Preparar corpus, fixtures e representação tipada: ArtifactSet imutável, staging e publicação atômica
...
- **TaskEnvelope:** `.codex/tasks/TASK-0276.json`

## História de usuário

Como operador geoespacial, preciso preparar corpus, fixtures e representação tipada para “ArtifactSet imutável, staging e publicação atômica”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Preparar corpus, fixtures e representação tipada para a capacidade **ArtifactSet imutável, staging e publicação atômica**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/geo/dsgeorref_geo/contexts/artifact_provenance/artifactset-imutavel-staging-e-publicacao-atomica/**`
## Fora de escopo
...
`REQ-AI-017`, `REQ-ANC-004`, `REQ-RAS-005`
...
- [ ] Os requisitos REQ-AI-017, REQ-ANC-004, REQ-RAS-005 possuem evidência explícita no commit candidato.
...
- `test_partial_anchor_states_subcomponents_and_immutable_artifacts`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-046` e o TaskEnvelope `TASK-0276`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0386-01, AC-ISSUE-0386-02, AC-ISSUE-0386-03, AC-ISSUE-0386-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-040`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-049`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-023`, `ADR-040`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-049`
