# STORY-0065 / ISSUE-0175 — Expor serviços e integrar consumers: backup/restore consistente entre banco e arquivos
...
- **TaskEnvelope:** `.codex/tasks/TASK-0065.json`

## História de usuário

Como operador geoespacial, preciso expor serviços e integrar consumers para “backup/restore consistente entre banco e arquivos”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Expor serviços e integrar consumers para a capacidade **backup/restore consistente entre banco e arquivos**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-013` e o TaskEnvelope `TASK-0065`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0175-01, AC-ISSUE-0175-02, AC-ISSUE-0175-03, AC-ISSUE-0175-04`
