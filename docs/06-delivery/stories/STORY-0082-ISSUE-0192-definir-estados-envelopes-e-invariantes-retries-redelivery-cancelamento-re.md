# STORY-0082 / ISSUE-0192 — Definir estados, envelopes e invariantes: retries, redelivery, cancelamento, retomada e idempotência
...
- **TaskEnvelope:** `.codex/tasks/TASK-0082.json`

## História de usuário

Como operador geoespacial, preciso definir estados, envelopes e invariantes para “retries, redelivery, cancelamento, retomada e idempotência”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir estados, envelopes e invariantes para a capacidade **retries, redelivery, cancelamento, retomada e idempotência**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/job_orchestration/job/retries-redelivery-cancelamento-retomada-e-idempotenci/**`
- `docs/02-architecture/design-reviews/retries-redelivery-cancelamento-retomada-e-idempotenci/**`
## Fora de escopo
...
- [ ] Os requisitos REQ-EPIC-015, REQ-EPIC-016 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-016` e o TaskEnvelope `TASK-0082`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0192-01, AC-ISSUE-0192-02, AC-ISSUE-0192-03, AC-ISSUE-0192-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-018`, `ADR-038`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-016`, `ADR-018`, `ADR-038`
