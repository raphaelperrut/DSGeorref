# STORY-0251 / ISSUE-0361 — Materializar notices, citação e manifests: licença, citação, sanitização e revisão externa concluídas
...
- **TaskEnvelope:** `.codex/tasks/TASK-0251.json`

## História de usuário

Como mantenedor do projeto, preciso materializar notices, citação e manifests para “licença, citação, sanitização e revisão externa concluídas”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Materializar notices, citação e manifests para a capacidade **licença, citação, sanitização e revisão externa concluídas**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/release_installation/application/licenca-citacao-sanitizacao-e-revisao-externa-concluid/**`
## Fora de escopo
...
`REQ-CIT-001`, `REQ-EPIC-042`, `REQ-EPIC-043`, `REQ-OSS-001`, `REQ-PUB-004`
...
- [ ] O resultado de “licença, citação, sanitização e revisão externa concluídas” é observável por contrato, interface, artifact ou evidência executável.
- [ ] Os requisitos REQ-CIT-001, REQ-EPIC-042, REQ-EPIC-043, REQ-OSS-001, REQ-PUB-004 possuem evidência explícita no commit candidato.
- [ ] Estados de erro e caminhos fail-closed aplicáveis são testados, sem fallback silencioso.
- [ ] Notices, rights manifests, citação e inventário de terceiros são completos e verificáveis.

## Testes obrigatórios

- `citation_cff_validation`
...
- `license_and_dependency_inventory`
- `test_epic_042_artefatos`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-003-tech-lead.md`, este documento, o épico `EPIC-042` e o TaskEnvelope `TASK-0251`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0361-01, AC-ISSUE-0361-02, AC-ISSUE-0361-03, AC-ISSUE-0361-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-002`, `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-016`, `ADR-037`, `ADR-056`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-002`, `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-016`, `ADR-037`, `ADR-056`
...
- **Resultado:** `PASS`
- **Risk tier:** `HIGH`
- **Controles aplicáveis:** `CTO-001, CTO-003, CTO-004, CTO-005, CTO-006, CTO-008, CTO-009, CTO-010, CTO-012, CTO-013, CTO-015`
