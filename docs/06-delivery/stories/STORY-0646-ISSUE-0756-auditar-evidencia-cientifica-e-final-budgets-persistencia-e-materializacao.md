# STORY-0646 / ISSUE-0756 — Auditar evidência científica e final: Budgets, persistência e materialização do mosaico relativo
...
- **TaskEnvelope:** `.codex/tasks/TASK-0646.json`

## História de usuário

Como operador geoespacial, preciso auditar evidência científica e final para “Budgets, persistência e materialização do mosaico relativo”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar evidência científica e final para a capacidade **Budgets, persistência e materialização do mosaico relativo**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/budgets-persistencia-e-materializacao-do-mosaico-relat/**`
## Fora de escopo
...
- `test_epic_103_aceite_happy_path`
- `test_epic_103_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-103` e o TaskEnvelope `TASK-0646`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0756-01, AC-ISSUE-0756-02, AC-ISSUE-0756-03, AC-ISSUE-0756-04`
