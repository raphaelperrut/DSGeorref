# STORY-0322 / ISSUE-0432 — Auditar evidência científica e final: seleção de GCPs por cobertura/qualidade/diversidade, exportando pontos usados e descartados
...
- **TaskEnvelope:** `.codex/tasks/TASK-0322.json`

## História de usuário

Como operador geoespacial, preciso auditar evidência científica e final para “seleção de GCPs por cobertura/qualidade/diversidade, exportando pontos usados e descartados”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar evidência científica e final para a capacidade **seleção de GCPs por cobertura/qualidade/diversidade, exportando pontos usados e descartados**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/selecao-de-gcps-por-cobertura-qualidade-diversidade-ex/**`
## Fora de escopo
...
- `test_epic_052_aceite_happy_path`
- `test_epic_052_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-052` e o TaskEnvelope `TASK-0322`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0432-01, AC-ISSUE-0432-02, AC-ISSUE-0432-03, AC-ISSUE-0432-04`
