# STORY-0699 / ISSUE-0809 — Slice 8/9 — Materializar a fundação executável: repositório privado, Project central/views/campos, labels, Issue Forms, templates, ruleset, checks e configuração reproduzível [REQ-SPRINT-001, REQ-TOOL, REQ-WORKER]
...
- **TaskEnvelope:** `.codex/tasks/TASK-0699.json`
...
Slice 8/9 concluído com contrato, implementação ou evidência compatível com o papel executor e todos os requisitos abaixo demonstrados.

## Escopo

- `tools/governance/repositorio-privado-project-central-views-campos-label/sprint-001-tool-worker-parte-8/**`
- `docs/03-engineering/contexts/engineering_governance/repositorio-privado-project-central-views-campos-label/sprint-001-tool-worker-parte-8/**`
## Fora de escopo
...
`REQ-SPRINT-001-010`, `REQ-TOOL-001`, `REQ-TOOL-002`, `REQ-TOOL-005`, `REQ-WORKER-002`, `REQ-WORKER-003`, `REQ-WORKER-004`, `REQ-WORKER-005`, `REQ-WORKER-006`, `REQ-WORKER-007`
...
- [ ] Cada requisito do slice possui evidência explícita: REQ-SPRINT-001-010, REQ-TOOL-001, REQ-TOOL-002, REQ-TOOL-005, REQ-WORKER-002, REQ-WORKER-003, REQ-WORKER-004, REQ-WORKER-005, REQ-WORKER-006, REQ-WORKER-007.
...
Leia `AGENTS.md`, o papel `.codex/roles/ROLE-003-tech-lead.md`, esta história e `TASK-0699`. Trabalhe somente nos paths permitidos, entregue apenas este slice e interrompa diante de qualquer condição de parada.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0809-01, AC-ISSUE-0809-02, AC-ISSUE-0809-03, AC-ISSUE-0809-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-001`, `ADR-003`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-012`, `ADR-018`, `ADR-020`, `ADR-035`, `ADR-037`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-001`, `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-012`, `ADR-018`, `ADR-020`, `ADR-035`, `ADR-037`
