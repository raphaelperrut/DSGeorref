# STORY-0481 / ISSUE-0591 — Definir SLO, runbook e controles operacionais: budgets de cardinalidade, sampling, retenção por sinal e dashboards de perda/overhead
...
- **TaskEnvelope:** `.codex/tasks/TASK-0481.json`

## História de usuário

Como administrador da instância, preciso definir slo, runbook e controles operacionais para “budgets de cardinalidade, sampling, retenção por sinal e dashboards de perda/overhead”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir SLO, runbook e controles operacionais para a capacidade **budgets de cardinalidade, sampling, retenção por sinal e dashboards de perda/overhead**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-077` e o TaskEnvelope `TASK-0481`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0591-01, AC-ISSUE-0591-02, AC-ISSUE-0591-03, AC-ISSUE-0591-04`
