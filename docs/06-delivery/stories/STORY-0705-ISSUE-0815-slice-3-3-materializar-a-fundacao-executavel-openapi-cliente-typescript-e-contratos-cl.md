# STORY-0705 / ISSUE-0815 — Slice 3/3 — Materializar a fundação executável: OpenAPI, cliente TypeScript e contratos CLI/jobs/eventos/artefatos/ProcessingPlan/QualityReport/FailureDiagnostic versionados [REQ-RUNTIME, REQ-TOOL, REQ-UPG]
...
- **TaskEnvelope:** `.codex/tasks/TASK-0705.json`
...
- `tools/governance/openapi-cliente-typescript-e-contratos-cli-jobs-evento/runtime-tool-upg-parte-3/**`
- `docs/03-engineering/contexts/engineering_governance/openapi-cliente-typescript-e-contratos-cli-jobs-evento/runtime-tool-upg-parte-3/**`
## Fora de escopo
...
`REQ-RUNTIME-006`, `REQ-RUNTIME-007`, `REQ-TOOL-005`, `REQ-UPG-005`
...
- [ ] Cada requisito do slice possui evidência explícita: REQ-RUNTIME-006, REQ-RUNTIME-007, REQ-TOOL-005, REQ-UPG-005.
...
- `test_runtime_decision_6`
- `test_runtime_decision_7`
...
Leia `AGENTS.md`, o papel `.codex/roles/ROLE-003-tech-lead.md`, esta história e `TASK-0705`. Trabalhe somente nos paths permitidos, entregue apenas este slice e interrompa diante de qualquer condição de parada.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0815-01, AC-ISSUE-0815-02, AC-ISSUE-0815-03, AC-ISSUE-0815-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-001`, `ADR-002`, `ADR-003`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-021`, `ADR-035`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-001`, `ADR-002`, `ADR-003`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-013`, `ADR-014`, `ADR-015`, `ADR-021`, `ADR-023`, `ADR-035`, `ADR-055`
