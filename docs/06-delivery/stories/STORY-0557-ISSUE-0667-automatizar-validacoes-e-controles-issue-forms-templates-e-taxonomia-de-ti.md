# STORY-0557 / ISSUE-0667 — Automatizar validações e controles: Issue Forms, templates e taxonomia de tipos com validação de campos obrigatórios
...
- **TaskEnvelope:** `.codex/tasks/TASK-0557.json`

## História de usuário

Como mantenedor de engenharia, preciso automatizar validações e controles para “Issue Forms, templates e taxonomia de tipos com validação de campos obrigatórios”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Automatizar validações e controles para a capacidade **Issue Forms, templates e taxonomia de tipos com validação de campos obrigatórios**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/fnd/issue-forms-templates-e-taxonomia-de-tipos-com-validac/**`
- `tools/quality/contexts/engineering_governance/issue-forms-templates-e-taxonomia-de-tipos-com-validac/**`
- `.github/workflows/issue-forms-templates-e-taxonomia-de-tipos-com-validac.yaml`
## Fora de escopo
...
- [ ] O resultado de “Issue Forms, templates e taxonomia de tipos com validação de campos obrigatórios” é observável por contrato, interface, artifact ou evidência executável.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-090` e o TaskEnvelope `TASK-0557`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0667-01, AC-ISSUE-0667-02, AC-ISSUE-0667-03, AC-ISSUE-0667-04`
