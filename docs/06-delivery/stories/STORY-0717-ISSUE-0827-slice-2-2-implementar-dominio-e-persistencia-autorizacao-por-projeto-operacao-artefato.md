# STORY-0717 / ISSUE-0827 — Slice 2/2 — Implementar domínio e persistência: autorização por projeto, operação, artefato e caminho [REQ-HW]
...
- **TaskEnvelope:** `.codex/tasks/TASK-0717.json`

## História de usuário

Como executor especializado, preciso entregar este slice limitado de requisitos para que a capacidade de **autorização por projeto, operação, artefato e caminho** avance sem mudança ampla ou inferência não documentada.
...
- `src/backend/dsgeorref/contexts/identity_access/application/autorizacao-por-projeto-operacao-artefato-e-caminho/hw-parte-2/**`
- `src/backend/dsgeorref/contexts/identity_access/adapters/autorizacao-por-projeto-operacao-artefato-e-caminho/hw-parte-2/**`
## Fora de escopo
...
- [ ] Cada requisito do slice possui evidência explícita: REQ-HW-001.
...
Leia `AGENTS.md`, o papel `.codex/roles/ROLE-004-backend.md`, esta história e `TASK-0717`. Trabalhe somente nos paths permitidos, entregue apenas este slice e interrompa diante de qualquer condição de parada.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0827-01, AC-ISSUE-0827-02, AC-ISSUE-0827-03, AC-ISSUE-0827-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-016`, `ADR-037`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-016`, `ADR-018`, `ADR-019`, `ADR-037`, `ADR-055`
