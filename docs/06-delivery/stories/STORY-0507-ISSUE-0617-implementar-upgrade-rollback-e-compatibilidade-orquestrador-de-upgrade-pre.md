# STORY-0507 / ISSUE-0617 — Implementar upgrade, rollback e compatibilidade: orquestrador de upgrade, preflight, migrations explícitas, health/smoke tests e rollback/restore
...
- **TaskEnvelope:** `.codex/tasks/TASK-0507.json`

## História de usuário

Como responsável por release, preciso implementar upgrade, rollback e compatibilidade para “orquestrador de upgrade, preflight, migrations explícitas, health/smoke tests e rollback/restore”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar upgrade, rollback e compatibilidade para a capacidade **orquestrador de upgrade, preflight, migrations explícitas, health/smoke tests e rollback/restore**, com saída versionada, testes e evidência no commit candidato.
...
- `test_epic_081_upgrade_roundtrip`
- `test_epic_081_upgrade_recovery`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-081` e o TaskEnvelope `TASK-0507`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0617-01, AC-ISSUE-0617-02, AC-ISSUE-0617-03, AC-ISSUE-0617-04`
