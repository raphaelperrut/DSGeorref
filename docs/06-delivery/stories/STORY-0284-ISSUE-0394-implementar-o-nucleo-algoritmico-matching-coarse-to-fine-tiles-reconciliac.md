# STORY-0284 / ISSUE-0394 — Implementar o núcleo algorítmico: matching coarse-to-fine, tiles, reconciliação de coordenadas e refinamento em resolução adequada
...
- **TaskEnvelope:** `.codex/tasks/TASK-0284.json`

## História de usuário

Como operador geoespacial, preciso implementar o núcleo algorítmico para “matching coarse-to-fine, tiles, reconciliação de coordenadas e refinamento em resolução adequada”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar o núcleo algorítmico para a capacidade **matching coarse-to-fine, tiles, reconciliação de coordenadas e refinamento em resolução adequada**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/geo/dsgeorref_geo/contexts/georeferencing/matching-coarse-to-fine-tiles-reconciliacao-de-coorden/**`
## Fora de escopo
...
- [ ] Os requisitos REQ-MAT-001 possuem evidência explícita no commit candidato.
...
- `test_pyramid_tile_coordinate_roundtrip_refinement`
- `test_epic_047_algoritmo`
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0394-01, AC-ISSUE-0394-02, AC-ISSUE-0394-03, AC-ISSUE-0394-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-044`
- **Conflito:** `Nenhum`
