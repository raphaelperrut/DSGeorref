# STORY-0195 / ISSUE-0305 — Executar testes de componente, acessibilidade e E2E: workspace OpenLayers, configuração, acompanhamento e revisão
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0195.json`

## História de usuário

Como operador geoespacial, preciso executar testes de componente, acessibilidade e e2e para “workspace OpenLayers, configuração, acompanhamento e revisão”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar testes de componente, acessibilidade e E2E para a capacidade **workspace OpenLayers, configuração, acompanhamento e revisão**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/web/workspace-openlayers-configuracao-acompanhamento-e-rev/**`
- `tools/quality/contexts/operator_experience/workspace-openlayers-configuracao-acompanhamento-e-rev/**`
- `.github/workflows/workspace-openlayers-configuracao-acompanhamento-e-rev.yaml`
## Fora de escopo
...
`STORY-0192`, `STORY-0193`, `STORY-0194`

## Critérios de aceitação

- [ ] O resultado de “workspace OpenLayers, configuração, acompanhamento e revisão” é observável por contrato, interface, artifact ou evidência executável.
...
- `test_epic_032_validacao_happy_path`
- `test_epic_032_validacao_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-032` e o TaskEnvelope `TASK-0195`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0305-01, AC-ISSUE-0305-02, AC-ISSUE-0305-03, AC-ISSUE-0305-04`
