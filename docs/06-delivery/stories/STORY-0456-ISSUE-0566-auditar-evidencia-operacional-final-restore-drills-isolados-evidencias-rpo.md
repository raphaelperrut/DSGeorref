# STORY-0456 / ISSUE-0566 — Auditar evidência operacional final: restore drills isolados, evidências, RPO/RTO e runbook executável
...
- **TaskEnvelope:** `.codex/tasks/TASK-0456.json`

## História de usuário

Como administrador da instância, preciso auditar evidência operacional final para “restore drills isolados, evidências, RPO/RTO e runbook executável”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar evidência operacional final para a capacidade **restore drills isolados, evidências, RPO/RTO e runbook executável**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/restore-drills-isolados-evidencias-rpo-rto-e-runbook-e/**`
## Fora de escopo
...
- `test_epic_072_aceite_happy_path`
- `test_epic_072_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-072` e o TaskEnvelope `TASK-0456`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0566-01, AC-ISSUE-0566-02, AC-ISSUE-0566-03, AC-ISSUE-0566-04`
