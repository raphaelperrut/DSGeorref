# STORY-0296 / ISSUE-0406 — Definir modelo, invariantes e contratos de dados: lineage normalizado, manifestos e bundle de reprodução sob demanda
...
- **TaskEnvelope:** `.codex/tasks/TASK-0296.json`

## História de usuário

Como operador geoespacial, preciso definir modelo, invariantes e contratos de dados para “lineage normalizado, manifestos e bundle de reprodução sob demanda”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir modelo, invariantes e contratos de dados para a capacidade **lineage normalizado, manifestos e bundle de reprodução sob demanda**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/artifact_provenance/dat/lineage-normalizado-manifestos-e-bundle-de-reproducao/**`
- `docs/02-architecture/design-reviews/lineage-normalizado-manifestos-e-bundle-de-reproducao/**`
## Fora de escopo
...
`REQ-EPIC-017`, `REQ-PROV-001`, `REQ-RET-001`
...
`STORY-0020`, `STORY-0061`, `STORY-0281`, `STORY-0390`, `STORY-0397`, `STORY-0417`
...
- [ ] Os requisitos REQ-EPIC-017, REQ-PROV-001, REQ-RET-001 possuem evidência explícita no commit candidato.
...
- `test_checkpoint_compatibility_invalidation_lineage`
- `test_manifest_lineage_reproduction_bundle`
- `test_retention_policy_protected_lineage_hold_dry_run`
- `test_epic_049_contrato`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-049` e o TaskEnvelope `TASK-0296`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0406-01, AC-ISSUE-0406-02, AC-ISSUE-0406-03, AC-ISSUE-0406-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-012`, `ADR-025`, `ADR-038`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-012`, `ADR-016`, `ADR-025`, `ADR-038`
...
|---|---|---|
| Dependências | 6 predecessores explícitos | PASS |
