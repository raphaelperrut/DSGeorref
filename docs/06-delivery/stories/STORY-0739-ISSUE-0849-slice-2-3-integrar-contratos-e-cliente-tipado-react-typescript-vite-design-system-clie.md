# STORY-0739 / ISSUE-0849 — Slice 2/3 — Integrar contratos e cliente tipado: React/TypeScript/Vite, design system, cliente OpenAPI, seletor visual, acessibilidade e E2E [REQ-RUN, REQ-RUNTIME]
...
- **TaskEnvelope:** `.codex/tasks/TASK-0739.json`
...
- `src/frontend/src/contexts/operator_experience/features/react-typescript-vite-design-system-cliente-openapi-se/run-runtime-parte-2/**`
## Fora de escopo
...
`REQ-RUN-002`, `REQ-RUN-003`, `REQ-RUN-004`, `REQ-RUN-005`, `REQ-RUN-006`, `REQ-RUN-007`, `REQ-RUN-008`, `REQ-RUN-009`, `REQ-RUN-010`, `REQ-RUNTIME-008`
...
- [ ] Cada requisito do slice possui evidência explícita: REQ-RUN-002, REQ-RUN-003, REQ-RUN-004, REQ-RUN-005, REQ-RUN-006, REQ-RUN-007, REQ-RUN-008, REQ-RUN-009, REQ-RUN-010, REQ-RUNTIME-008.
...
Leia `AGENTS.md`, o papel `.codex/roles/ROLE-005-frontend.md`, esta história e `TASK-0739`. Trabalhe somente nos paths permitidos, entregue apenas este slice e interrompa diante de qualquer condição de parada.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0849-01, AC-ISSUE-0849-02, AC-ISSUE-0849-03, AC-ISSUE-0849-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-013`, `ADR-014`, `ADR-017`, `ADR-040`, `ADR-045`, `ADR-055`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-013`, `ADR-014`, `ADR-015`, `ADR-017`, `ADR-040`, `ADR-045`, `ADR-055`
