# STORY-0627 / ISSUE-0737 — Preparar corpus, fixtures e representação tipada: Relative Mosaic Verifier e promotion lifecycle
...
- **TaskEnvelope:** `.codex/tasks/TASK-0627.json`

## História de usuário

Como operador geoespacial, preciso preparar corpus, fixtures e representação tipada para “Relative Mosaic Verifier e promotion lifecycle”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Preparar corpus, fixtures e representação tipada para a capacidade **Relative Mosaic Verifier e promotion lifecycle**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/geo/dsgeorref_geo/contexts/relative_mosaic/relative-mosaic-verifier-e-promotion-lifecycle/**`
## Fora de escopo
...
`REQ-RMV-002`, `REQ-RMV-003`, `REQ-RMV-004`
...
- [ ] Os requisitos REQ-RMV-002, REQ-RMV-003, REQ-RMV-004 possuem evidência explícita no commit candidato.
...
- `test_cycle_basis_budgeted_long_cycle_sampling_drift_percentiles_and_localization`
- `test_bridge_articulation_leverage_removal_sensitivity_and_component_split`
- `test_relative_component_promotion_lifecycle_and_no_image_acceptance_transfer`
- `test_epic_101_dados`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-101` e o TaskEnvelope `TASK-0627`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0737-01, AC-ISSUE-0737-02, AC-ISSUE-0737-03, AC-ISSUE-0737-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-050`
- **Conflito:** `Nenhum`
