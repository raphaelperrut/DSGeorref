# STORY-0501 / ISSUE-0611 — Implementar controles e enforcement: lockfiles, pins por digest/SHA, scanners, SBOM, assinatura OCI, attestations e verificador de release
...
- **TaskEnvelope:** `.codex/tasks/TASK-0501.json`

## História de usuário

Como administrador de segurança, preciso implementar controles e enforcement para “lockfiles, pins por digest/SHA, scanners, SBOM, assinatura OCI, attestations e verificador de release”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar controles e enforcement para a capacidade **lockfiles, pins por digest/SHA, scanners, SBOM, assinatura OCI, attestations e verificador de release**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/release_installation/application/lockfiles-pins-por-digest-sha-scanners-sbom-assinatura/**`
- `src/backend/dsgeorref/contexts/release_installation/adapters/lockfiles-pins-por-digest-sha-scanners-sbom-assinatura/**`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-080` e o TaskEnvelope `TASK-0501`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0611-01, AC-ISSUE-0611-02, AC-ISSUE-0611-03, AC-ISSUE-0611-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-016`, `ADR-018`, `ADR-019`, `ADR-024`
