# STORY-0716 / ISSUE-0826 — Slice 1/2 — Implementar domínio e persistência: autorização por projeto, operação, artefato e caminho [REQ-ACC, REQ-AUTH-IMPL]
...
- **TaskEnvelope:** `.codex/tasks/TASK-0716.json`
...
- `src/backend/dsgeorref/contexts/identity_access/application/autorizacao-por-projeto-operacao-artefato-e-caminho/acc-auth-impl-parte-1/**`
- `src/backend/dsgeorref/contexts/identity_access/adapters/autorizacao-por-projeto-operacao-artefato-e-caminho/acc-auth-impl-parte-1/**`
## Fora de escopo
...
Leia `AGENTS.md`, o papel `.codex/roles/ROLE-004-backend.md`, esta história e `TASK-0716`. Trabalhe somente nos paths permitidos, entregue apenas este slice e interrompa diante de qualquer condição de parada.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0826-01, AC-ISSUE-0826-02, AC-ISSUE-0826-03, AC-ISSUE-0826-04`
