# STORY-0543 / ISSUE-0653 — Executar instalação limpa e rehearsal: baseline operacional vertical privado com escopo da DELIVERY_PLAN e evidências do corpus controlado
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0543.json`

## História de usuário

Como responsável por release, preciso executar instalação limpa e rehearsal para “baseline operacional vertical privado com escopo da DELIVERY_PLAN e evidências do corpus controlado”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar instalação limpa e rehearsal para a capacidade **baseline operacional vertical privado com escopo da DELIVERY_PLAN e evidências do corpus controlado**, com saída versionada, testes e evidência no commit candidato.
...
`STORY-0540`, `STORY-0541`, `STORY-0542`
...
- `test_epic_087_ensaio_happy_path`
- `test_epic_087_ensaio_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-087` e o TaskEnvelope `TASK-0543`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0653-01, AC-ISSUE-0653-02, AC-ISSUE-0653-03, AC-ISSUE-0653-04`
