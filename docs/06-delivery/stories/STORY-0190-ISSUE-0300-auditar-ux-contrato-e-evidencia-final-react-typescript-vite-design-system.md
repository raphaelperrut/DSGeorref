# STORY-0190 / ISSUE-0300 — Auditar UX, contrato e evidência final: React/TypeScript/Vite, design system, cliente OpenAPI, seletor visual, acessibilidade e E2E
...
- **TaskEnvelope:** `.codex/tasks/TASK-0190.json`

## História de usuário

Como operador geoespacial, preciso auditar ux, contrato e evidência final para “React/TypeScript/Vite, design system, cliente OpenAPI, seletor visual, acessibilidade e E2E”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar UX, contrato e evidência final para a capacidade **React/TypeScript/Vite, design system, cliente OpenAPI, seletor visual, acessibilidade e E2E**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/react-typescript-vite-design-system-cliente-openapi-se/**`
## Fora de escopo
...
- `test_epic_031_aceite_happy_path`
- `test_epic_031_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-031` e o TaskEnvelope `TASK-0190`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0300-01, AC-ISSUE-0300-02, AC-ISSUE-0300-03, AC-ISSUE-0300-04`
