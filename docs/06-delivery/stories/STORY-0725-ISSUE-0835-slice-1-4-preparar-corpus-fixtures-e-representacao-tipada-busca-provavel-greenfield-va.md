# STORY-0725 / ISSUE-0835 — Slice 1/4 — Preparar corpus, fixtures e representação tipada: busca provável greenfield validada [REQ-AIE, REQ-CLASSICPROFILE]
...
- **TaskEnvelope:** `.codex/tasks/TASK-0725.json`
...
Slice 1/4 concluído com contrato, implementação ou evidência compatível com o papel executor e todos os requisitos abaixo demonstrados.

## Escopo

- `src/geo/dsgeorref_geo/contexts/reference_discovery/busca-provavel-greenfield-validada/aie-classicprofile-parte-1/**`
## Fora de escopo
...
`REQ-AIE-002`, `REQ-AIE-004`, `REQ-AIE-006`, `REQ-AIE-008`, `REQ-AIE-009`, `REQ-AIE-010`, `REQ-CLASSICPROFILE-001`, `REQ-CLASSICPROFILE-002`, `REQ-CLASSICPROFILE-003`, `REQ-CLASSICPROFILE-005`
...
- [ ] Cada requisito do slice possui evidência explícita: REQ-AIE-002, REQ-AIE-004, REQ-AIE-006, REQ-AIE-008, REQ-AIE-009, REQ-AIE-010, REQ-CLASSICPROFILE-001, REQ-CLASSICPROFILE-002, REQ-CLASSICPROFILE-003, REQ-CLASSICPROFILE-005.
...
Leia `AGENTS.md`, o papel `.codex/roles/ROLE-007-geoprocessamento.md`, esta história e `TASK-0725`. Trabalhe somente nos paths permitidos, entregue apenas este slice e interrompa diante de qualquer condição de parada.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0835-01, AC-ISSUE-0835-02, AC-ISSUE-0835-03, AC-ISSUE-0835-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-025`, `ADR-030`, `ADR-038`, `ADR-039`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-044`, `ADR-051`, `ADR-052`, `ADR-053`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-023`, `ADR-025`, `ADR-030`, `ADR-038`, `ADR-039`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-044`, `ADR-045`, `ADR-046`, `ADR-051`, `ADR-052`, `ADR-053`, `ADR-055`
