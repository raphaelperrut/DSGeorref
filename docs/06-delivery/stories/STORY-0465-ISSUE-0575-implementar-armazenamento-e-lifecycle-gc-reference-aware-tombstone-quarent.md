# STORY-0465 / ISSUE-0575 — Implementar armazenamento e lifecycle: GC reference-aware, tombstone, quarentena, período de graça e reconciliação
...
- **TaskEnvelope:** `.codex/tasks/TASK-0465.json`

## História de usuário

Como operador geoespacial, preciso implementar armazenamento e lifecycle para “GC reference-aware, tombstone, quarentena, período de graça e reconciliação”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar armazenamento e lifecycle para a capacidade **GC reference-aware, tombstone, quarentena, período de graça e reconciliação**, com saída versionada, testes e evidência no commit candidato.
...
- [ ] Integridade, atomicidade, hashes, locators e lifecycle aplicáveis são verificados.

## Testes obrigatórios

- `test_epic_074_armazenamento_roundtrip`
- `test_epic_074_armazenamento_recovery`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-074` e o TaskEnvelope `TASK-0465`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0575-01, AC-ISSUE-0575-02, AC-ISSUE-0575-03, AC-ISSUE-0575-04`
