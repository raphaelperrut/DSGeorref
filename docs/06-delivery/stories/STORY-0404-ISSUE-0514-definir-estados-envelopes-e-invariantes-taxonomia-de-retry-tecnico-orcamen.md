# STORY-0404 / ISSUE-0514 — Definir estados, envelopes e invariantes: taxonomia de retry técnico, orçamento, backoff, idempotência e PlanVariants algorítmicos
...
- **TaskEnvelope:** `.codex/tasks/TASK-0404.json`

## História de usuário

Como operador geoespacial, preciso definir estados, envelopes e invariantes para “taxonomia de retry técnico, orçamento, backoff, idempotência e PlanVariants algorítmicos”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir estados, envelopes e invariantes para a capacidade **taxonomia de retry técnico, orçamento, backoff, idempotência e PlanVariants algorítmicos**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/job_orchestration/job/taxonomia-de-retry-tecnico-orcamento-backoff-idempoten/**`
- `docs/02-architecture/design-reviews/taxonomia-de-retry-tecnico-orcamento-backoff-idempoten/**`
## Fora de escopo
...
- [ ] Os requisitos REQ-BEX-003, REQ-BEX-005 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-065` e o TaskEnvelope `TASK-0404`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0514-01, AC-ISSUE-0514-02, AC-ISSUE-0514-03, AC-ISSUE-0514-04`
