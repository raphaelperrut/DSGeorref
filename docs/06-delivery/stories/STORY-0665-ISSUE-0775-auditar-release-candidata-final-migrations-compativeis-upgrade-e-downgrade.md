# STORY-0665 / ISSUE-0775 — Auditar release candidata final: Migrations compatíveis, upgrade e downgrade seguro
...
- **TaskEnvelope:** `.codex/tasks/TASK-0665.json`

## História de usuário

Como responsável por release, preciso auditar release candidata final para “Migrations compatíveis, upgrade e downgrade seguro”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar release candidata final para a capacidade **Migrations compatíveis, upgrade e downgrade seguro**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/migrations-compativeis-upgrade-e-downgrade-seguro/**`
## Fora de escopo
...
- `test_epic_106_aceite_happy_path`
- `test_epic_106_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-106` e o TaskEnvelope `TASK-0665`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0775-01, AC-ISSUE-0775-02, AC-ISSUE-0775-03, AC-ISSUE-0775-04`
