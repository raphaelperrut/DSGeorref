# STORY-0178 / ISSUE-0288 — Definir contrato científico e invariantes: taxonomia versionada de falhas, evidências, remediações seguras e contratos de resultado por imagem
...
- **TaskEnvelope:** `.codex/tasks/TASK-0178.json`

## História de usuário

Como operador geoespacial, preciso definir contrato científico e invariantes para “taxonomia versionada de falhas, evidências, remediações seguras e contratos de resultado por imagem”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir contrato científico e invariantes para a capacidade **taxonomia versionada de falhas, evidências, remediações seguras e contratos de resultado por imagem**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/results_reporting/geo/taxonomia-versionada-de-falhas-evidencias-remediacoes/**`
- `docs/02-architecture/design-reviews/taxonomia-versionada-de-falhas-evidencias-remediacoes/**`
## Fora de escopo
...
- [ ] Os requisitos REQ-EPIC-016, REQ-EPIC-038 possuem evidência explícita no commit candidato.
...
- `test_retry_classification_budget_idempotency_no_quality_relaxation`
- `test_failure_taxonomy_evidence_remediation_versioning`
- `test_epic_030_contrato`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-030` e o TaskEnvelope `TASK-0178`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0288-01, AC-ISSUE-0288-02, AC-ISSUE-0288-03, AC-ISSUE-0288-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-002`, `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-038`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-002`, `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-038`
