# STORY-0440 / ISSUE-0550 — Implementar persistência e snapshots: snapshots imutáveis, regra de resultado vigente e comparação entre ciclos
...
- **TaskEnvelope:** `.codex/tasks/TASK-0440.json`

## História de usuário

Como revisor e auditor, preciso implementar persistência e snapshots para “snapshots imutáveis, regra de resultado vigente e comparação entre ciclos”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar persistência e snapshots para a capacidade **snapshots imutáveis, regra de resultado vigente e comparação entre ciclos**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/results_reporting/application/snapshots-imutaveis-regra-de-resultado-vigente-e-compa/**`
- `src/backend/dsgeorref/contexts/results_reporting/adapters/snapshots-imutaveis-regra-de-resultado-vigente-e-compa/**`
## Fora de escopo
...
- [ ] O resultado de “snapshots imutáveis, regra de resultado vigente e comparação entre ciclos” é observável por contrato, interface, artifact ou evidência executável.
...
- `test_epic_070_persistencia_roundtrip`
- `test_epic_070_persistencia_recovery`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-070` e o TaskEnvelope `TASK-0440`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0550-01, AC-ISSUE-0550-02, AC-ISSUE-0550-03, AC-ISSUE-0550-04`
