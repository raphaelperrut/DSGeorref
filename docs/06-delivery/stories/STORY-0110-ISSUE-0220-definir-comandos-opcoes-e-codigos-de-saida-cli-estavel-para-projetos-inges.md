# STORY-0110 / ISSUE-0220 — Definir comandos, opções e códigos de saída: CLI estável para projetos, ingestão, jobs e resultados
...
- **TaskEnvelope:** `.codex/tasks/TASK-0110.json`

## História de usuário

Como operador técnico, preciso definir comandos, opções e códigos de saída para “CLI estável para projetos, ingestão, jobs e resultados”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir comandos, opções e códigos de saída para a capacidade **CLI estável para projetos, ingestão, jobs e resultados**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/operator_experience/cli/cli-estavel-para-projetos-ingestao-jobs-e-resultados/**`
- `docs/02-architecture/design-reviews/cli-estavel-para-projetos-ingestao-jobs-e-resultados/**`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-020` e o TaskEnvelope `TASK-0110`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0220-01, AC-ISSUE-0220-02, AC-ISSUE-0220-03, AC-ISSUE-0220-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-015`, `ADR-016`, `ADR-044`
