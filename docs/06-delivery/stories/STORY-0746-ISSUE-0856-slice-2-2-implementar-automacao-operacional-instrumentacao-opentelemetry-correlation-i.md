# STORY-0746 / ISSUE-0856 — Slice 2/2 — Implementar automação operacional: instrumentação OpenTelemetry, correlation IDs, métricas, dashboards e alertas para API, RabbitMQ e workers [REQ-ARTLAYOUT, REQ-MET, REQ-WORKER]
...
- **TaskEnvelope:** `.codex/tasks/TASK-0746.json`
...
- `tests/ops/contexts/operations_audit/instrumentacao-opentelemetry-correlation-ids-metricas/artlayout-met-worker-parte-2/**`
- `tools/quality/contexts/operations_audit/instrumentacao-opentelemetry-correlation-ids-metricas/artlayout-met-worker-parte-2/**`
- `.github/workflows/instrumentacao-opentelemetry-correlation-ids-metricas-artlayout-met-wo.yaml`
## Fora de escopo
...
`REQ-ARTLAYOUT-008`, `REQ-ARTLAYOUT-009`, `REQ-MET-001`, `REQ-WORKER-003`
...
- [ ] Cada requisito do slice possui evidência explícita: REQ-ARTLAYOUT-008, REQ-ARTLAYOUT-009, REQ-MET-001, REQ-WORKER-003.
...
- `test_req_artlayout_008`
- `test_req_artlayout_009`
...
Leia `AGENTS.md`, o papel `.codex/roles/ROLE-009-devops.md`, esta história e `TASK-0746`. Trabalhe somente nos paths permitidos, entregue apenas este slice e interrompa diante de qualquer condição de parada.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0856-01, AC-ISSUE-0856-02, AC-ISSUE-0856-03, AC-ISSUE-0856-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-010`, `ADR-011`, `ADR-023`, `ADR-033`, `ADR-034`, `ADR-037`, `ADR-054`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-010`, `ADR-011`, `ADR-012`, `ADR-023`, `ADR-024`, `ADR-033`, `ADR-034`, `ADR-037`, `ADR-054`, `ADR-055`
