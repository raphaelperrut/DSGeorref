# STORY-0546 / ISSUE-0656 — Implementar experimento isolado: namespace experimental/labs, registry separado, ModelPacks isolados e bloqueio técnico de ArtifactSet aceito
...
- **Papel executor:** `IA`
- **TaskEnvelope:** `.codex/tasks/TASK-0546.json`

## História de usuário

Como mantenedor científico, preciso implementar experimento isolado para “namespace experimental/labs, registry separado, ModelPacks isolados e bloqueio técnico de ArtifactSet aceito”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar experimento isolado para a capacidade **namespace experimental/labs, registry separado, ModelPacks isolados e bloqueio técnico de ArtifactSet aceito**, com saída versionada, testes e evidência no commit candidato.
...
- [ ] Os requisitos REQ-EPIC-088 possuem evidência explícita no commit candidato.
- [ ] Estados de erro e caminhos fail-closed aplicáveis são testados, sem fallback silencioso.
- [ ] O experimento permanece isolado e não publica ArtifactSet aceito nem altera defaults.

## Testes obrigatórios

- `test_experimental_lab_disabled_and_cannot_publish_accepted_artifactset`
- `test_epic_088_experimento`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-006-ia.md`, este documento, o épico `EPIC-088` e o TaskEnvelope `TASK-0546`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0656-01, AC-ISSUE-0656-02, AC-ISSUE-0656-03, AC-ISSUE-0656-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-051`, `ADR-052`, `ADR-053`
- **Conflito:** `Nenhum`
