# STORY-0509 / ISSUE-0619 — Executar instalação limpa e rehearsal: orquestrador de upgrade, preflight, migrations explícitas, health/smoke tests e rollback/restore
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0509.json`

## História de usuário

Como responsável por release, preciso executar instalação limpa e rehearsal para “orquestrador de upgrade, preflight, migrations explícitas, health/smoke tests e rollback/restore”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar instalação limpa e rehearsal para a capacidade **orquestrador de upgrade, preflight, migrations explícitas, health/smoke tests e rollback/restore**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/rel/contexts/release_installation/orquestrador-de-upgrade-preflight-migrations-explicita/**`
- `tools/quality/contexts/release_installation/orquestrador-de-upgrade-preflight-migrations-explicita/**`
- `.github/workflows/orquestrador-de-upgrade-preflight-migrations-explicita.yaml`
## Fora de escopo
...
`STORY-0506`, `STORY-0507`, `STORY-0508`
...
- `test_epic_081_ensaio_happy_path`
- `test_epic_081_ensaio_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-081` e o TaskEnvelope `TASK-0509`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0619-01, AC-ISSUE-0619-02, AC-ISSUE-0619-03, AC-ISSUE-0619-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-016`
