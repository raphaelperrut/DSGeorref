# STORY-0603 / ISSUE-0713 — Executar benchmark, negativos e regressão científica: Grade, resolução e reamostragem
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0603.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “Grade, resolução e reamostragem”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **Grade, resolução e reamostragem**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/grade-resolucao-e-reamostragem/**`
- `tools/quality/contexts/georeferencing/grade-resolucao-e-reamostragem/**`
- `.github/workflows/grade-resolucao-e-reamostragem.yaml`
## Fora de escopo
...
`STORY-0599`, `STORY-0600`, `STORY-0601`, `STORY-0602`

## Critérios de aceitação

- [ ] O resultado de “Grade, resolução e reamostragem” é observável por contrato, interface, artifact ou evidência executável.
...
- `test_epic_097_benchmark_happy_path`
- `test_epic_097_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-097` e o TaskEnvelope `TASK-0603`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0713-01, AC-ISSUE-0713-02, AC-ISSUE-0713-03, AC-ISSUE-0713-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-049`
