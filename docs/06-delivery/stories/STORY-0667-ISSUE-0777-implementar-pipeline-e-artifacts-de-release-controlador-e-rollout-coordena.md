# STORY-0667 / ISSUE-0777 — Implementar pipeline e artifacts de release: Controlador e rollout coordenado de upgrades
...
- **TaskEnvelope:** `.codex/tasks/TASK-0667.json`

## História de usuário

Como responsável por release, preciso implementar pipeline e artifacts de release para “Controlador e rollout coordenado de upgrades”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar pipeline e artifacts de release para a capacidade **Controlador e rollout coordenado de upgrades**, com saída versionada, testes e evidência no commit candidato.
...
- [ ] Os requisitos REQ-UPG-003, REQ-UPG-005 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-107` e o TaskEnvelope `TASK-0667`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0777-01, AC-ISSUE-0777-02, AC-ISSUE-0777-03, AC-ISSUE-0777-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-033`, `ADR-034`, `ADR-035`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-026`, `ADR-033`, `ADR-034`, `ADR-035`
