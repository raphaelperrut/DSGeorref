# STORY-0387 / ISSUE-0497 — Implementar workspace e comparação: workspace visual assistido, CorrectionSets, nova tentativa, comparação e auditoria sem bloquear o ciclo automático
...
- **TaskEnvelope:** `.codex/tasks/TASK-0387.json`

## História de usuário

Como revisor geoespacial, preciso implementar workspace e comparação para “workspace visual assistido, CorrectionSets, nova tentativa, comparação e auditoria sem bloquear o ciclo automático”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar workspace e comparação para a capacidade **workspace visual assistido, CorrectionSets, nova tentativa, comparação e auditoria sem bloquear o ciclo automático**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/frontend/src/contexts/review_correction/features/workspace-visual-assistido-correctionsets-nova-tentati/**`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-005-frontend.md`, este documento, o épico `EPIC-062` e o TaskEnvelope `TASK-0387`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0497-01, AC-ISSUE-0497-02, AC-ISSUE-0497-03, AC-ISSUE-0497-04`
