# STORY-0377 / ISSUE-0487 — Executar benchmark, negativos e regressão científica: policy de aquisição no ProcessingPlan, preview, consentimento e bloqueio fail-closed de ativos pagos/ambíguos
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0377.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “policy de aquisição no ProcessingPlan, preview, consentimento e bloqueio fail-closed de ativos pagos/ambíguos”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **policy de aquisição no ProcessingPlan, preview, consentimento e bloqueio fail-closed de ativos pagos/ambíguos**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/policy-de-aquisicao-no-processingplan-preview-consenti/**`
- `tools/quality/contexts/reference_discovery/policy-de-aquisicao-no-processingplan-preview-consenti/**`
- `.github/workflows/policy-de-aquisicao-no-processingplan-preview-consenti.yaml`
## Fora de escopo
...
`STORY-0373`, `STORY-0374`, `STORY-0375`, `STORY-0376`

## Critérios de aceitação

- [ ] O resultado de “policy de aquisição no ProcessingPlan, preview, consentimento e bloqueio fail-closed de ativos pagos/ambíguos” é observável por contrato, interface, artifact ou evidência executável.
...
- `test_epic_060_benchmark_happy_path`
- `test_epic_060_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-060` e o TaskEnvelope `TASK-0377`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0487-01, AC-ISSUE-0487-02, AC-ISSUE-0487-03, AC-ISSUE-0487-04`
