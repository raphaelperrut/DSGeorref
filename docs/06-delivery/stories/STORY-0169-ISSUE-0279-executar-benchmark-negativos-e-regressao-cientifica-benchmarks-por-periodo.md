# STORY-0169 / ISSUE-0279 — Executar benchmark, negativos e regressão científica: benchmarks por período, sensor e perfil de qualidade
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0169.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “benchmarks por período, sensor e perfil de qualidade”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **benchmarks por período, sensor e perfil de qualidade**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/benchmarks-por-periodo-sensor-e-perfil-de-qualidade/**`
- `tools/quality/contexts/geometric_quality/benchmarks-por-periodo-sensor-e-perfil-de-qualidade/**`
- `.github/workflows/benchmarks-por-periodo-sensor-e-perfil-de-qualidade.yaml`
## Fora de escopo
...
`REQ-AIE-003`, `REQ-AIE-007`, `REQ-CLASSICPROFILE-008`, `REQ-SDR-003`, `REQ-SGVCAL-001`, `REQ-SGVCAL-008`
...
`STORY-0165`, `STORY-0166`, `STORY-0167`, `STORY-0168`

## Critérios de aceitação

- [ ] O resultado de “benchmarks por período, sensor e perfil de qualidade” é observável por contrato, interface, artifact ou evidência executável.
- [ ] Os requisitos REQ-AIE-003, REQ-AIE-007, REQ-CLASSICPROFILE-008, REQ-SDR-003, REQ-SGVCAL-001, REQ-SGVCAL-008 possuem evidência explícita no commit candidato.
...
- `test_epic_028_benchmark_happy_path`
- `test_epic_028_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-028` e o TaskEnvelope `TASK-0169`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0279-01, AC-ISSUE-0279-02, AC-ISSUE-0279-03, AC-ISSUE-0279-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-045`, `ADR-046`, `ADR-053`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-044`, `ADR-045`, `ADR-046`, `ADR-051`, `ADR-052`, `ADR-053`
...
- **Resultado:** `PASS`
- **Risk tier:** `CRITICAL`
- **Controles aplicáveis:** `CTO-001, CTO-003, CTO-004, CTO-005, CTO-006, CTO-007, CTO-008, CTO-012, CTO-013, CTO-015`
