# STORY-0564 / ISSUE-0674 — Validar evidência e realizar auditoria final: ruleset de main, checks únicos, CODEOWNERS, política de branches e prova de bypass auditado
...
- **TaskEnvelope:** `.codex/tasks/TASK-0564.json`

## História de usuário

Como mantenedor de engenharia, preciso validar evidência e realizar auditoria final para “ruleset de main, checks únicos, CODEOWNERS, política de branches e prova de bypass auditado”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Validar evidência e realizar auditoria final para a capacidade **ruleset de main, checks únicos, CODEOWNERS, política de branches e prova de bypass auditado**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/ruleset-de-main-checks-unicos-codeowners-politica-de-b/**`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-091` e o TaskEnvelope `TASK-0564`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0674-01, AC-ISSUE-0674-02, AC-ISSUE-0674-03, AC-ISSUE-0674-04`
