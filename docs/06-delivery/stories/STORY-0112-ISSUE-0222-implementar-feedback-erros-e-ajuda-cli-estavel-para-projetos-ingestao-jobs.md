# STORY-0112 / ISSUE-0222 — Implementar feedback, erros e ajuda: CLI estável para projetos, ingestão, jobs e resultados
...
- **TaskEnvelope:** `.codex/tasks/TASK-0112.json`

## História de usuário

Como operador técnico, preciso implementar feedback, erros e ajuda para “CLI estável para projetos, ingestão, jobs e resultados”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar feedback, erros e ajuda para a capacidade **CLI estável para projetos, ingestão, jobs e resultados**, com saída versionada, testes e evidência no commit candidato.
...
- [ ] Mensagens, ajuda, saída estruturada e códigos de saída são determinísticos.

## Testes obrigatórios

- `test_epic_020_experiencia`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-020` e o TaskEnvelope `TASK-0112`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0222-01, AC-ISSUE-0222-02, AC-ISSUE-0222-03, AC-ISSUE-0222-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-016`, `ADR-023`
