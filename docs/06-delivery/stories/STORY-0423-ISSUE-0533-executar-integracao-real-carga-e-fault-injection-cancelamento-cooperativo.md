# STORY-0423 / ISSUE-0533 — Executar integração real, carga e fault injection: cancelamento cooperativo, supervisão de subprocessos, contenção e reconciliação
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0423.json`

## História de usuário

Como operador geoespacial, preciso executar integração real, carga e fault injection para “cancelamento cooperativo, supervisão de subprocessos, contenção e reconciliação”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar integração real, carga e fault injection para a capacidade **cancelamento cooperativo, supervisão de subprocessos, contenção e reconciliação**, com saída versionada, testes e evidência no commit candidato.
...
`STORY-0419`, `STORY-0420`, `STORY-0421`, `STORY-0422`
...
- `test_epic_067_validacao_happy_path`
- `test_epic_067_validacao_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-067` e o TaskEnvelope `TASK-0423`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0533-01, AC-ISSUE-0533-02, AC-ISSUE-0533-03, AC-ISSUE-0533-04`
