# STORY-0319 / ISSUE-0429 — Integrar ao ProcessingPlan e pipeline: seleção de GCPs por cobertura/qualidade/diversidade, exportando pontos usados e descartados
...
- **TaskEnvelope:** `.codex/tasks/TASK-0319.json`

## História de usuário

Como operador geoespacial, preciso integrar ao processingplan e pipeline para “seleção de GCPs por cobertura/qualidade/diversidade, exportando pontos usados e descartados”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Integrar ao ProcessingPlan e pipeline para a capacidade **seleção de GCPs por cobertura/qualidade/diversidade, exportando pontos usados e descartados**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-052` e o TaskEnvelope `TASK-0319`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0429-01, AC-ISSUE-0429-02, AC-ISSUE-0429-03, AC-ISSUE-0429-04`
