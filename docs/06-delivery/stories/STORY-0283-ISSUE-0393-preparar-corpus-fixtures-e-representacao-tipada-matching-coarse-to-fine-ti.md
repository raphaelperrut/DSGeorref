# STORY-0283 / ISSUE-0393 — Preparar corpus, fixtures e representação tipada: matching coarse-to-fine, tiles, reconciliação de coordenadas e refinamento em resolução adequada
...
- **TaskEnvelope:** `.codex/tasks/TASK-0283.json`

## História de usuário

Como operador geoespacial, preciso preparar corpus, fixtures e representação tipada para “matching coarse-to-fine, tiles, reconciliação de coordenadas e refinamento em resolução adequada”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Preparar corpus, fixtures e representação tipada para a capacidade **matching coarse-to-fine, tiles, reconciliação de coordenadas e refinamento em resolução adequada**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-047` e o TaskEnvelope `TASK-0283`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0393-01, AC-ISSUE-0393-02, AC-ISSUE-0393-03, AC-ISSUE-0393-04`
