# STORY-0736 / ISSUE-0846 — Slice 2/3 — Preparar corpus, fixtures e representação tipada: benchmarks por período, sensor e perfil de qualidade [REQ-CLASSICPROFILE, REQ-SCP, REQ-SDR, REQ-SGVCAL]
...
- **TaskEnvelope:** `.codex/tasks/TASK-0736.json`
...
- `src/geo/dsgeorref_geo/contexts/geometric_quality/benchmarks-por-periodo-sensor-e-perfil-de-qualidade/classicprofile-scp-sdr-parte-2/**`
## Fora de escopo
...
`REQ-CLASSICPROFILE-005`, `REQ-CLASSICPROFILE-007`, `REQ-CLASSICPROFILE-009`, `REQ-SCP-001`, `REQ-SDR-001`, `REQ-SDR-004`, `REQ-SGVCAL-002`, `REQ-SGVCAL-003`, `REQ-SGVCAL-004`, `REQ-SGVCAL-005`
...
- [ ] Cada requisito do slice possui evidência explícita: REQ-CLASSICPROFILE-005, REQ-CLASSICPROFILE-007, REQ-CLASSICPROFILE-009, REQ-SCP-001, REQ-SDR-001, REQ-SDR-004, REQ-SGVCAL-002, REQ-SGVCAL-003, REQ-SGVCAL-004, REQ-SGVCAL-005.
...
- `test_cross_decade_corpus_and_no_temporal_hardcode`
...
Leia `AGENTS.md`, o papel `.codex/roles/ROLE-007-geoprocessamento.md`, esta história e `TASK-0736`. Trabalhe somente nos paths permitidos, entregue apenas este slice e interrompa diante de qualquer condição de parada.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0846-01, AC-ISSUE-0846-02, AC-ISSUE-0846-03, AC-ISSUE-0846-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-044`, `ADR-046`, `ADR-053`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-025`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-044`, `ADR-045`, `ADR-046`, `ADR-051`, `ADR-052`, `ADR-053`
