# STORY-0090 / ISSUE-0200 — Implementar modelo e application services: REST, SSE e polling de reconciliação com contratos versionados
...
- **TaskEnvelope:** `.codex/tasks/TASK-0090.json`

## História de usuário

Como operador geoespacial, preciso implementar modelo e application services para “REST, SSE e polling de reconciliação com contratos versionados”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar modelo e application services para a capacidade **REST, SSE e polling de reconciliação com contratos versionados**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/job_orchestration/application/rest-sse-e-polling-de-reconciliacao-com-contratos-vers/**`
- `src/backend/dsgeorref/contexts/job_orchestration/adapters/rest-sse-e-polling-de-reconciliacao-com-contratos-vers/**`
## Fora de escopo
...
- [ ] O resultado de “REST, SSE e polling de reconciliação com contratos versionados” é observável por contrato, interface, artifact ou evidência executável.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-017` e o TaskEnvelope `TASK-0090`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0200-01, AC-ISSUE-0200-02, AC-ISSUE-0200-03, AC-ISSUE-0200-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-016`, `ADR-018`, `ADR-019`
