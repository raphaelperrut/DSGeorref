# STORY-0555 / ISSUE-0665 — Definir escopo, contratos e invariantes: Issue Forms, templates e taxonomia de tipos com validação de campos obrigatórios
...
- **TaskEnvelope:** `.codex/tasks/TASK-0555.json`

## História de usuário

Como mantenedor de engenharia, preciso definir escopo, contratos e invariantes para “Issue Forms, templates e taxonomia de tipos com validação de campos obrigatórios”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir escopo, contratos e invariantes para a capacidade **Issue Forms, templates e taxonomia de tipos com validação de campos obrigatórios**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/engineering_governance/fnd/issue-forms-templates-e-taxonomia-de-tipos-com-validac/**`
- `docs/02-architecture/design-reviews/issue-forms-templates-e-taxonomia-de-tipos-com-validac/**`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-090` e o TaskEnvelope `TASK-0555`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0665-01, AC-ISSUE-0665-02, AC-ISSUE-0665-03, AC-ISSUE-0665-04`
