# STORY-0060 / ISSUE-0170 — Validar segurança, recuperação e concorrência: raízes de workspace, API de navegação segura, catálogo, hashes e lineage
...
- **TaskEnvelope:** `.codex/tasks/TASK-0060.json`

## História de usuário

Como operador geoespacial, preciso validar segurança, recuperação e concorrência para “raízes de workspace, API de navegação segura, catálogo, hashes e lineage”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Validar segurança, recuperação e concorrência para a capacidade **raízes de workspace, API de navegação segura, catálogo, hashes e lineage**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/project_workspace/adapters/security/raizes-de-workspace-api-de-navegacao-segura-catalogo-h/**`
- `tests/security/contexts/project_workspace/raizes-de-workspace-api-de-navegacao-segura-catalogo-h/**`
## Fora de escopo
...
`STORY-0057`, `STORY-0058`, `STORY-0059`
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0170-01, AC-ISSUE-0170-02, AC-ISSUE-0170-03, AC-ISSUE-0170-04`
- **Base de requisitos:** `DERIVED_CONTROL`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-030`, `ADR-031`, `ADR-032`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-012`, `ADR-013`, `ADR-014`, `ADR-015`, `ADR-016`, `ADR-023`, `ADR-025`, `ADR-026`, `ADR-030`, `ADR-031`, `ADR-032`, `ADR-055`
