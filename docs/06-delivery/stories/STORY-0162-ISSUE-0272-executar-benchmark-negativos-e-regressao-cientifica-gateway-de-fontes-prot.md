# STORY-0162 / ISSUE-0272 — Executar benchmark, negativos e regressão científica: gateway de fontes, proteção SSRF, estados de disponibilidade e bloqueio de compra
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0162.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “gateway de fontes, proteção SSRF, estados de disponibilidade e bloqueio de compra”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **gateway de fontes, proteção SSRF, estados de disponibilidade e bloqueio de compra**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/gateway-de-fontes-protecao-ssrf-estados-de-disponibili/**`
- `tools/quality/contexts/reference_discovery/gateway-de-fontes-protecao-ssrf-estados-de-disponibili/**`
- `.github/workflows/gateway-de-fontes-protecao-ssrf-estados-de-disponibili.yaml`
## Fora de escopo
...
`STORY-0158`, `STORY-0159`, `STORY-0160`, `STORY-0161`

## Critérios de aceitação

- [ ] O resultado de “gateway de fontes, proteção SSRF, estados de disponibilidade e bloqueio de compra” é observável por contrato, interface, artifact ou evidência executável.
...
- `test_epic_027_benchmark_happy_path`
- `test_epic_027_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-027` e o TaskEnvelope `TASK-0162`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0272-01, AC-ISSUE-0272-02, AC-ISSUE-0272-03, AC-ISSUE-0272-04`
