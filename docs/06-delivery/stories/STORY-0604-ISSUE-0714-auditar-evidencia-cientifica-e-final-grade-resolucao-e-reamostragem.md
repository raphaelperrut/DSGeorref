# STORY-0604 / ISSUE-0714 — Auditar evidência científica e final: Grade, resolução e reamostragem
...
- **TaskEnvelope:** `.codex/tasks/TASK-0604.json`

## História de usuário

Como operador geoespacial, preciso auditar evidência científica e final para “Grade, resolução e reamostragem”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar evidência científica e final para a capacidade **Grade, resolução e reamostragem**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/grade-resolucao-e-reamostragem/**`
## Fora de escopo
...
- `test_epic_097_aceite_happy_path`
- `test_epic_097_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-097` e o TaskEnvelope `TASK-0604`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0714-01, AC-ISSUE-0714-02, AC-ISSUE-0714-03, AC-ISSUE-0714-04`
