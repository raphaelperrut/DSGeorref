# STORY-0513 / ISSUE-0623 — Expor administração e fluxos de uso: preflight de hardware e ExecutionProfiles CPU/GPU/híbrido integrados ao Resource Governor
...
- **TaskEnvelope:** `.codex/tasks/TASK-0513.json`

## História de usuário

Como administrador da instância, preciso expor administração e fluxos de uso para “preflight de hardware e ExecutionProfiles CPU/GPU/híbrido integrados ao Resource Governor”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Expor administração e fluxos de uso para a capacidade **preflight de hardware e ExecutionProfiles CPU/GPU/híbrido integrados ao Resource Governor**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/frontend/src/contexts/operations_audit/features/preflight-de-hardware-e-executionprofiles-cpu-gpu-hibr/**`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-005-frontend.md`, este documento, o épico `EPIC-082` e o TaskEnvelope `TASK-0513`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0623-01, AC-ISSUE-0623-02, AC-ISSUE-0623-03, AC-ISSUE-0623-04`
