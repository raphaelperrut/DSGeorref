# STORY-0088 / ISSUE-0198 — Auditar evidência e integração final: retries, redelivery, cancelamento, retomada e idempotência
...
- **TaskEnvelope:** `.codex/tasks/TASK-0088.json`

## História de usuário

Como operador geoespacial, preciso auditar evidência e integração final para “retries, redelivery, cancelamento, retomada e idempotência”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar evidência e integração final para a capacidade **retries, redelivery, cancelamento, retomada e idempotência**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/retries-redelivery-cancelamento-retomada-e-idempotenci/**`
## Fora de escopo
...
- `test_epic_016_aceite_happy_path`
- `test_epic_016_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-016` e o TaskEnvelope `TASK-0088`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0198-01, AC-ISSUE-0198-02, AC-ISSUE-0198-03, AC-ISSUE-0198-04`
