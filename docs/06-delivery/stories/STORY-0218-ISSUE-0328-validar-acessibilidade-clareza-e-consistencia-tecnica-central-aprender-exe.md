# STORY-0218 / ISSUE-0328 — Validar acessibilidade, clareza e consistência técnica: central Aprender, exemplos visuais, projeto demonstrativo e ajuda contextual, incluindo Strong Geometric Verifier e interpretação de falhas
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0218.json`

## História de usuário

Como novo operador, preciso validar acessibilidade, clareza e consistência técnica para “central Aprender, exemplos visuais, projeto demonstrativo e ajuda contextual, incluindo Strong Geometric Verifier e interpretação de falhas”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Validar acessibilidade, clareza e consistência técnica para a capacidade **central Aprender, exemplos visuais, projeto demonstrativo e ajuda contextual, incluindo Strong Geometric Verifier e interpretação de falhas**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/edu/central-aprender-exemplos-visuais-projeto-demonstrativ/**`
- `tools/quality/contexts/operator_experience/central-aprender-exemplos-visuais-projeto-demonstrativ/**`
- `.github/workflows/central-aprender-exemplos-visuais-projeto-demonstrativ.yaml`
## Fora de escopo
...
`STORY-0216`, `STORY-0217`

## Critérios de aceitação

- [ ] O resultado de “central Aprender, exemplos visuais, projeto demonstrativo e ajuda contextual, incluindo Strong Geometric Verifier e interpretação de falhas” é observável por contrato, interface, artifact ou evidência executável.
...
- `test_epic_036_validacao_happy_path`
- `test_epic_036_validacao_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-036` e o TaskEnvelope `TASK-0218`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0328-01, AC-ISSUE-0328-02, AC-ISSUE-0328-03, AC-ISSUE-0328-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-014`
