# STORY-0231 / ISSUE-0341 — Auditar lineage e evidência final: métricas, heatmap amostrado e diagnóstico denso do Image Deformation Profile
...
- **TaskEnvelope:** `.codex/tasks/TASK-0231.json`

## História de usuário

Como revisor e auditor, preciso auditar lineage e evidência final para “métricas, heatmap amostrado e diagnóstico denso do Image Deformation Profile”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar lineage e evidência final para a capacidade **métricas, heatmap amostrado e diagnóstico denso do Image Deformation Profile**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/metricas-heatmap-amostrado-e-diagnostico-denso-do-imag/**`
## Fora de escopo
...
- `test_epic_038_aceite_happy_path`
- `test_epic_038_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-038` e o TaskEnvelope `TASK-0231`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0341-01, AC-ISSUE-0341-02, AC-ISSUE-0341-03, AC-ISSUE-0341-04`
