# STORY-0505 / ISSUE-0615 — Definir gate, versão e critérios de release: orquestrador de upgrade, preflight, migrations explícitas, health/smoke tests e rollback/restore
...
- **TaskEnvelope:** `.codex/tasks/TASK-0505.json`

## História de usuário

Como responsável por release, preciso definir gate, versão e critérios de release para “orquestrador de upgrade, preflight, migrations explícitas, health/smoke tests e rollback/restore”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir gate, versão e critérios de release para a capacidade **orquestrador de upgrade, preflight, migrations explícitas, health/smoke tests e rollback/restore**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/release_installation/application/orquestrador-de-upgrade-preflight-migrations-explicita/**`
## Fora de escopo
...
`STORY-0450`, `STORY-0456`, `STORY-0504`, `STORY-0260`

## Critérios de aceitação

- [ ] O resultado de “orquestrador de upgrade, preflight, migrations explícitas, health/smoke tests e rollback/restore” é observável por contrato, interface, artifact ou evidência executável.
- [ ] Os requisitos REQ-INS-001, REQ-UPG-001 possuem evidência explícita no commit candidato.
...
- `test_declarative_installation_plan_preflight_idempotent_resume_and_partial_state_diagnostics`
- `test_orchestrated_upgrade_preflight_migrations_rollback_restore`
- `test_epic_081_contrato`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-003-tech-lead.md`, este documento, o épico `EPIC-081` e o TaskEnvelope `TASK-0505`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0615-01, AC-ISSUE-0615-02, AC-ISSUE-0615-03, AC-ISSUE-0615-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-016`, `ADR-035`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-016`, `ADR-035`
