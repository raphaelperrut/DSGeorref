# STORY-0244 / ISSUE-0354 — Modelar ameaças e requisitos de controle: threat model validado, scanning e testes ofensivos
...
- **TaskEnvelope:** `.codex/tasks/TASK-0244.json`

## História de usuário

Como administrador de segurança, preciso modelar ameaças e requisitos de controle para “threat model validado, scanning e testes ofensivos”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Modelar ameaças e requisitos de controle para a capacidade **threat model validado, scanning e testes ofensivos**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/operations_audit/adapters/security/threat-model-validado-scanning-e-testes-ofensivos/**`
- `tests/security/contexts/operations_audit/threat-model-validado-scanning-e-testes-ofensivos/**`
## Fora de escopo
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0354-01, AC-ISSUE-0354-02, AC-ISSUE-0354-03, AC-ISSUE-0354-04`
