# STORY-0672 / ISSUE-0782 — Definir gate, versão e critérios de release: Instalador, bootstrap, readiness e suporte diagnóstico
...
- **TaskEnvelope:** `.codex/tasks/TASK-0672.json`

## História de usuário

Como responsável por release, preciso definir gate, versão e critérios de release para “Instalador, bootstrap, readiness e suporte diagnóstico”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir gate, versão e critérios de release para a capacidade **Instalador, bootstrap, readiness e suporte diagnóstico**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/release_installation/application/instalador-bootstrap-readiness-e-suporte-diagnostico/**`
## Fora de escopo
...
- [ ] Os requisitos REQ-INS-001, REQ-INS-003 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-003-tech-lead.md`, este documento, o épico `EPIC-108` e o TaskEnvelope `TASK-0672`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0782-01, AC-ISSUE-0782-02, AC-ISSUE-0782-03, AC-ISSUE-0782-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-016`, `ADR-034`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-016`, `ADR-034`
