# STORY-0621 / ISSUE-0731 — Implementar o núcleo algorítmico: Workspace e lifecycle de âncoras
...
- **TaskEnvelope:** `.codex/tasks/TASK-0621.json`

## História de usuário

Como operador geoespacial, preciso implementar o núcleo algorítmico para “Workspace e lifecycle de âncoras”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar o núcleo algorítmico para a capacidade **Workspace e lifecycle de âncoras**, com saída versionada, testes e evidência no commit candidato.
...
- [ ] Os requisitos REQ-ANC-005 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-100` e o TaskEnvelope `TASK-0621`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0731-01, AC-ISSUE-0731-02, AC-ISSUE-0731-03, AC-ISSUE-0731-04`
