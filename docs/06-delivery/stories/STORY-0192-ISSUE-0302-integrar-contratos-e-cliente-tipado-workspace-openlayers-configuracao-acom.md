# STORY-0192 / ISSUE-0302 — Integrar contratos e cliente tipado: workspace OpenLayers, configuração, acompanhamento e revisão
...
- **TaskEnvelope:** `.codex/tasks/TASK-0192.json`

## História de usuário

Como operador geoespacial, preciso integrar contratos e cliente tipado para “workspace OpenLayers, configuração, acompanhamento e revisão”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Integrar contratos e cliente tipado para a capacidade **workspace OpenLayers, configuração, acompanhamento e revisão**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/frontend/src/contexts/operator_experience/features/workspace-openlayers-configuracao-acompanhamento-e-rev/**`
## Fora de escopo
...
`REQ-MSK-003`, `REQ-MTD-001`, `REQ-UX-001`
...
- [ ] Os requisitos REQ-MSK-003, REQ-MTD-001, REQ-UX-001 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-005-frontend.md`, este documento, o épico `EPIC-032` e o TaskEnvelope `TASK-0192`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0302-01, AC-ISSUE-0302-02, AC-ISSUE-0302-03, AC-ISSUE-0302-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-014`, `ADR-040`, `ADR-055`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-014`, `ADR-040`, `ADR-055`
