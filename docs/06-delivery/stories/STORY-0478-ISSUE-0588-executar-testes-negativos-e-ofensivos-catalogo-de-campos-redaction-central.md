# STORY-0478 / ISSUE-0588 — Executar testes negativos e ofensivos: catálogo de campos, redaction centralizada, testes de vazamento e bundles de suporte sanitizados
...
- **TaskEnvelope:** `.codex/tasks/TASK-0478.json`

## História de usuário

Como administrador de segurança, preciso executar testes negativos e ofensivos para “catálogo de campos, redaction centralizada, testes de vazamento e bundles de suporte sanitizados”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar testes negativos e ofensivos para a capacidade **catálogo de campos, redaction centralizada, testes de vazamento e bundles de suporte sanitizados**, com saída versionada, testes e evidência no commit candidato.
...
- `test_epic_076_ofensivo_happy_path`
- `test_epic_076_ofensivo_negative_paths`
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0588-01, AC-ISSUE-0588-02, AC-ISSUE-0588-03, AC-ISSUE-0588-04`
