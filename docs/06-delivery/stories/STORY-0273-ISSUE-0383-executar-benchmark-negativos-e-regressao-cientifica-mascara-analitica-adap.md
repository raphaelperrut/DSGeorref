# STORY-0273 / ISSUE-0383 — Executar benchmark, negativos e regressão científica: máscara analítica adaptativa, preview/correção, área útil separada da saída e preservação de metadados marginais
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0273.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “máscara analítica adaptativa, preview/correção, área útil separada da saída e preservação de metadados marginais”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **máscara analítica adaptativa, preview/correção, área útil separada da saída e preservação de metadados marginais**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/mascara-analitica-adaptativa-preview-correcao-area-uti/**`
- `tools/quality/contexts/georeferencing/mascara-analitica-adaptativa-preview-correcao-area-uti/**`
- `.github/workflows/mascara-analitica-adaptativa-preview-correcao-area-uti.yaml`
## Fora de escopo
...
`STORY-0269`, `STORY-0270`, `STORY-0271`, `STORY-0272`

## Critérios de aceitação

- [ ] O resultado de “máscara analítica adaptativa, preview/correção, área útil separada da saída e preservação de metadados marginais” é observável por contrato, interface, artifact ou evidência executável.
...
- `test_epic_045_benchmark_happy_path`
- `test_epic_045_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-045` e o TaskEnvelope `TASK-0273`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0383-01, AC-ISSUE-0383-02, AC-ISSUE-0383-03, AC-ISSUE-0383-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-055`
