# STORY-0494 / ISSUE-0604 — Implementar automação operacional: ingress único, TLS, redes privadas, limites e testes de exposição de portas
...
- **TaskEnvelope:** `.codex/tasks/TASK-0494.json`

## História de usuário

Como administrador da instância, preciso implementar automação operacional para “ingress único, TLS, redes privadas, limites e testes de exposição de portas”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar automação operacional para a capacidade **ingress único, TLS, redes privadas, limites e testes de exposição de portas**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-079` e o TaskEnvelope `TASK-0494`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0604-01, AC-ISSUE-0604-02, AC-ISSUE-0604-03, AC-ISSUE-0604-04`
