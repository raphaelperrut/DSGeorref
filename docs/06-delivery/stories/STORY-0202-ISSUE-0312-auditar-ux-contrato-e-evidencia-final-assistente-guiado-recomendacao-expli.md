# STORY-0202 / ISSUE-0312 — Auditar UX, contrato e evidência final: assistente guiado, recomendação explicável, consentimentos e modo avançado
...
- **TaskEnvelope:** `.codex/tasks/TASK-0202.json`

## História de usuário

Como operador geoespacial, preciso auditar ux, contrato e evidência final para “assistente guiado, recomendação explicável, consentimentos e modo avançado”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar UX, contrato e evidência final para a capacidade **assistente guiado, recomendação explicável, consentimentos e modo avançado**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/assistente-guiado-recomendacao-explicavel-consentiment/**`
## Fora de escopo
...
- `test_epic_033_aceite_happy_path`
- `test_epic_033_aceite_negative_paths`
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0312-01, AC-ISSUE-0312-02, AC-ISSUE-0312-03, AC-ISSUE-0312-04`
