# STORY-0071 / ISSUE-0181 — Expor comandos, progresso e reconciliação: modelo de job e máquina de estados no PostgreSQL
...
- **TaskEnvelope:** `.codex/tasks/TASK-0071.json`

## História de usuário

Como operador geoespacial, preciso expor comandos, progresso e reconciliação para “modelo de job e máquina de estados no PostgreSQL”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Expor comandos, progresso e reconciliação para a capacidade **modelo de job e máquina de estados no PostgreSQL**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-014` e o TaskEnvelope `TASK-0071`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0181-01, AC-ISSUE-0181-02, AC-ISSUE-0181-03, AC-ISSUE-0181-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-012`, `ADR-015`, `ADR-016`, `ADR-018`, `ADR-019`, `ADR-020`, `ADR-023`
