# STORY-0076 / ISSUE-0186 — Implementar modelo e application services: runner direto e Celery/RabbitMQ sobre o mesmo núcleo
...
- **TaskEnvelope:** `.codex/tasks/TASK-0076.json`

## História de usuário

Como operador geoespacial, preciso implementar modelo e application services para “runner direto e Celery/RabbitMQ sobre o mesmo núcleo”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar modelo e application services para a capacidade **runner direto e Celery/RabbitMQ sobre o mesmo núcleo**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/job_orchestration/application/runner-direto-e-celery-rabbitmq-sobre-o-mesmo-nucleo/**`
- `src/backend/dsgeorref/contexts/job_orchestration/adapters/runner-direto-e-celery-rabbitmq-sobre-o-mesmo-nucleo/**`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-015` e o TaskEnvelope `TASK-0076`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0186-01, AC-ISSUE-0186-02, AC-ISSUE-0186-03, AC-ISSUE-0186-04`
