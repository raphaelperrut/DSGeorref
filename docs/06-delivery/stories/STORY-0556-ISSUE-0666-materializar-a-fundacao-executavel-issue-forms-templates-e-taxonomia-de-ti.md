# STORY-0556 / ISSUE-0666 — Materializar a fundação executável: Issue Forms, templates e taxonomia de tipos com validação de campos obrigatórios
...
- **TaskEnvelope:** `.codex/tasks/TASK-0556.json`

## História de usuário

Como mantenedor de engenharia, preciso materializar a fundação executável para “Issue Forms, templates e taxonomia de tipos com validação de campos obrigatórios”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Materializar a fundação executável para a capacidade **Issue Forms, templates e taxonomia de tipos com validação de campos obrigatórios**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tools/governance/issue-forms-templates-e-taxonomia-de-tipos-com-validac/**`
- `docs/03-engineering/contexts/engineering_governance/issue-forms-templates-e-taxonomia-de-tipos-com-validac/**`
## Fora de escopo
...
- [ ] Os requisitos REQ-GOV-002 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-003-tech-lead.md`, este documento, o épico `EPIC-090` e o TaskEnvelope `TASK-0556`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0666-01, AC-ISSUE-0666-02, AC-ISSUE-0666-03, AC-ISSUE-0666-04`
