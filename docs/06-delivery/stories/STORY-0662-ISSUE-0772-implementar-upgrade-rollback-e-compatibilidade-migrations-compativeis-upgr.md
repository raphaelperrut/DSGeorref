# STORY-0662 / ISSUE-0772 — Implementar upgrade, rollback e compatibilidade: Migrations compatíveis, upgrade e downgrade seguro
...
- **TaskEnvelope:** `.codex/tasks/TASK-0662.json`

## História de usuário

Como responsável por release, preciso implementar upgrade, rollback e compatibilidade para “Migrations compatíveis, upgrade e downgrade seguro”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar upgrade, rollback e compatibilidade para a capacidade **Migrations compatíveis, upgrade e downgrade seguro**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/rel/contexts/release_installation/migrations-compativeis-upgrade-e-downgrade-seguro/**`
- `tools/quality/contexts/release_installation/migrations-compativeis-upgrade-e-downgrade-seguro/**`
- `.github/workflows/migrations-compativeis-upgrade-e-downgrade-seguro.yaml`
## Fora de escopo
...
- [ ] O resultado de “Migrations compatíveis, upgrade e downgrade seguro” é observável por contrato, interface, artifact ou evidência executável.
- [ ] Os requisitos REQ-SCM-002, REQ-UPG-002 possuem evidência explícita no commit candidato.
...
- `test_expand_migrate_contract_chunked_backfill_resume_invariants_and_irreversibility`
- `test_singleton_upgrade_controller_lease_preflight_checkpoint_resume_and_split_brain_prevention`
- `test_epic_106_upgrade_roundtrip`
- `test_epic_106_upgrade_recovery`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-106` e o TaskEnvelope `TASK-0662`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0772-01, AC-ISSUE-0772-02, AC-ISSUE-0772-03, AC-ISSUE-0772-04`
