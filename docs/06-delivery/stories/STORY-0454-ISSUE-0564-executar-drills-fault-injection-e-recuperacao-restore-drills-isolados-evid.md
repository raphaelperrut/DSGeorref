# STORY-0454 / ISSUE-0564 — Executar drills, fault injection e recuperação: restore drills isolados, evidências, RPO/RTO e runbook executável
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0454.json`

## História de usuário

Como administrador da instância, preciso executar drills, fault injection e recuperação para “restore drills isolados, evidências, RPO/RTO e runbook executável”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar drills, fault injection e recuperação para a capacidade **restore drills isolados, evidências, RPO/RTO e runbook executável**, com saída versionada, testes e evidência no commit candidato.
...
- `test_epic_072_falhas_happy_path`
- `test_epic_072_falhas_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-072` e o TaskEnvelope `TASK-0454`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0564-01, AC-ISSUE-0564-02, AC-ISSUE-0564-03, AC-ISSUE-0564-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-025`, `ADR-027`
