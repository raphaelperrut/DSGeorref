# STORY-0522 / ISSUE-0632 — Definir jornada, estados e acessibilidade: UX guiada de IA, explicação do plano, capacidades instaladas/bloqueadas e laboratório separado
...
- **TaskEnvelope:** `.codex/tasks/TASK-0522.json`

## História de usuário

Como operador geoespacial, preciso definir jornada, estados e acessibilidade para “UX guiada de IA, explicação do plano, capacidades instaladas/bloqueadas e laboratório separado”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir jornada, estados e acessibilidade para a capacidade **UX guiada de IA, explicação do plano, capacidades instaladas/bloqueadas e laboratório separado**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `docs/01-product/capabilities/ux-guiada-de-ia-explicacao-do-plano-capacidades-instal/**`
## Fora de escopo
...
`STORY-0202`, `STORY-0177`, `STORY-0308`
...
- [ ] Os requisitos REQ-AI-016 possuem evidência explícita no commit candidato.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0632-01, AC-ISSUE-0632-02, AC-ISSUE-0632-03, AC-ISSUE-0632-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`
- **Conflito:** `Nenhum`
