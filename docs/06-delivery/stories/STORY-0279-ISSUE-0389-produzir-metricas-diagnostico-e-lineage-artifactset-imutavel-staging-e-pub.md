# STORY-0279 / ISSUE-0389 — Produzir métricas, diagnóstico e lineage: ArtifactSet imutável, staging e publicação atômica
...
- **TaskEnvelope:** `.codex/tasks/TASK-0279.json`

## História de usuário

Como operador geoespacial, preciso produzir métricas, diagnóstico e lineage para “ArtifactSet imutável, staging e publicação atômica”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Produzir métricas, diagnóstico e lineage para a capacidade **ArtifactSet imutável, staging e publicação atômica**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-046` e o TaskEnvelope `TASK-0279`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0389-01, AC-ISSUE-0389-02, AC-ISSUE-0389-03, AC-ISSUE-0389-04`
