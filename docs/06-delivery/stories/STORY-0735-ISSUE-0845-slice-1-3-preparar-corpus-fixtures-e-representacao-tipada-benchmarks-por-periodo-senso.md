# STORY-0735 / ISSUE-0845 — Slice 1/3 — Preparar corpus, fixtures e representação tipada: benchmarks por período, sensor e perfil de qualidade [REQ-AI, REQ-AIE, REQ-CLASSICPROFILE]
...
- **TaskEnvelope:** `.codex/tasks/TASK-0735.json`
...
- `src/geo/dsgeorref_geo/contexts/geometric_quality/benchmarks-por-periodo-sensor-e-perfil-de-qualidade/ai-aie-classicprofile-parte-1/**`
## Fora de escopo
...
`REQ-AI-012`, `REQ-AIE-002`, `REQ-AIE-004`, `REQ-AIE-006`, `REQ-AIE-008`, `REQ-AIE-009`, `REQ-AIE-010`, `REQ-CLASSICPROFILE-001`, `REQ-CLASSICPROFILE-002`, `REQ-CLASSICPROFILE-003`
...
- [ ] Cada requisito do slice possui evidência explícita: REQ-AI-012, REQ-AIE-002, REQ-AIE-004, REQ-AIE-006, REQ-AIE-008, REQ-AIE-009, REQ-AIE-010, REQ-CLASSICPROFILE-001, REQ-CLASSICPROFILE-002, REQ-CLASSICPROFILE-003.
...
Leia `AGENTS.md`, o papel `.codex/roles/ROLE-007-geoprocessamento.md`, esta história e `TASK-0735`. Trabalhe somente nos paths permitidos, entregue apenas este slice e interrompa diante de qualquer condição de parada.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0845-01, AC-ISSUE-0845-02, AC-ISSUE-0845-03, AC-ISSUE-0845-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-025`, `ADR-030`, `ADR-038`, `ADR-039`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-044`, `ADR-045`, `ADR-046`, `ADR-051`, `ADR-052`, `ADR-053`
