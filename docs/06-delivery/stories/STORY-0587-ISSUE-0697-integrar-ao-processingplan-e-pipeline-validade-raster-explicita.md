# STORY-0587 / ISSUE-0697 — Integrar ao ProcessingPlan e pipeline: Validade raster explícita
...
- **TaskEnvelope:** `.codex/tasks/TASK-0587.json`

## História de usuário

Como operador geoespacial, preciso integrar ao processingplan e pipeline para “Validade raster explícita”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Integrar ao ProcessingPlan e pipeline para a capacidade **Validade raster explícita**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-095` e o TaskEnvelope `TASK-0587`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0697-01, AC-ISSUE-0697-02, AC-ISSUE-0697-03, AC-ISSUE-0697-04`
