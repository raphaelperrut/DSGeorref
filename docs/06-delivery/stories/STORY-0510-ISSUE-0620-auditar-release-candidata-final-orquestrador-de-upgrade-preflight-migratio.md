# STORY-0510 / ISSUE-0620 — Auditar release candidata final: orquestrador de upgrade, preflight, migrations explícitas, health/smoke tests e rollback/restore
...
- **TaskEnvelope:** `.codex/tasks/TASK-0510.json`

## História de usuário

Como responsável por release, preciso auditar release candidata final para “orquestrador de upgrade, preflight, migrations explícitas, health/smoke tests e rollback/restore”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar release candidata final para a capacidade **orquestrador de upgrade, preflight, migrations explícitas, health/smoke tests e rollback/restore**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/orquestrador-de-upgrade-preflight-migrations-explicita/**`
## Fora de escopo
...
- `test_epic_081_aceite_happy_path`
- `test_epic_081_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-081` e o TaskEnvelope `TASK-0510`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0620-01, AC-ISSUE-0620-02, AC-ISSUE-0620-03, AC-ISSUE-0620-04`
