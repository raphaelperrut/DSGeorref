# STORY-0695 / ISSUE-0805 — Slice 4/9 — Materializar a fundação executável: repositório privado, Project central/views/campos, labels, Issue Forms, templates, ruleset, checks e configuração reproduzível [REQ-PLN, REQ-PRJ]
...
- **TaskEnvelope:** `.codex/tasks/TASK-0695.json`
...
Slice 4/9 concluído com contrato, implementação ou evidência compatível com o papel executor e todos os requisitos abaixo demonstrados.

## Escopo

- `tools/governance/repositorio-privado-project-central-views-campos-label/pln-prj-parte-4/**`
- `docs/03-engineering/contexts/engineering_governance/repositorio-privado-project-central-views-campos-label/pln-prj-parte-4/**`
## Fora de escopo
...
`REQ-PLN-005`, `REQ-PLN-006`, `REQ-PLN-007`, `REQ-PLN-008`, `REQ-PLN-010`, `REQ-PRJ-001`, `REQ-PRJ-002`, `REQ-PRJ-003`, `REQ-PRJ-005`, `REQ-PRJ-006`
...
- [ ] Cada requisito do slice possui evidência explícita: REQ-PLN-005, REQ-PLN-006, REQ-PLN-007, REQ-PLN-008, REQ-PLN-010, REQ-PRJ-001, REQ-PRJ-002, REQ-PRJ-003, REQ-PRJ-005, REQ-PRJ-006.
...
- `test_wip_class_limits_global_cap_and_emergency_reserve`
...
Leia `AGENTS.md`, o papel `.codex/roles/ROLE-003-tech-lead.md`, esta história e `TASK-0695`. Trabalhe somente nos paths permitidos, entregue apenas este slice e interrompa diante de qualquer condição de parada.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0805-01, AC-ISSUE-0805-02, AC-ISSUE-0805-03, AC-ISSUE-0805-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-012`, `ADR-016`, `ADR-022`, `ADR-043`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-012`, `ADR-016`, `ADR-022`, `ADR-025`, `ADR-043`, `ADR-055`
...
- **Resultado:** `PASS`
- **Risk tier:** `CRITICAL`
- **Controles aplicáveis:** `CTO-003, CTO-004, CTO-006, CTO-010, CTO-012, CTO-013, CTO-014, CTO-015`
