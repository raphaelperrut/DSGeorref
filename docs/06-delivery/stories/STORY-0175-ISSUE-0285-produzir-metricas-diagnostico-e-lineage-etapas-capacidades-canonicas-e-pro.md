# STORY-0175 / ISSUE-0285 — Produzir métricas, diagnóstico e lineage: etapas/capacidades canônicas e ProcessingPlan reproduzível
...
- **TaskEnvelope:** `.codex/tasks/TASK-0175.json`

## História de usuário

Como operador geoespacial, preciso produzir métricas, diagnóstico e lineage para “etapas/capacidades canônicas e ProcessingPlan reproduzível”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Produzir métricas, diagnóstico e lineage para a capacidade **etapas/capacidades canônicas e ProcessingPlan reproduzível**, com saída versionada, testes e evidência no commit candidato.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0285-01, AC-ISSUE-0285-02, AC-ISSUE-0285-03, AC-ISSUE-0285-04`
