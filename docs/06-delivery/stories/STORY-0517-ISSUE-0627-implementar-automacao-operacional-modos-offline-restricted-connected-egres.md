# STORY-0517 / ISSUE-0627 — Implementar automação operacional: modos offline/restricted/connected, egress enforcement, mirrors e testes air-gapped
...
- **TaskEnvelope:** `.codex/tasks/TASK-0517.json`

## História de usuário

Como administrador da instância, preciso implementar automação operacional para “modos offline/restricted/connected, egress enforcement, mirrors e testes air-gapped”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar automação operacional para a capacidade **modos offline/restricted/connected, egress enforcement, mirrors e testes air-gapped**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/ops/contexts/operations_audit/modos-offline-restricted-connected-egress-enforcement/**`
- `tools/quality/contexts/operations_audit/modos-offline-restricted-connected-egress-enforcement/**`
- `.github/workflows/modos-offline-restricted-connected-egress-enforcement.yaml`
## Fora de escopo
...
- [ ] O resultado de “modos offline/restricted/connected, egress enforcement, mirrors e testes air-gapped” é observável por contrato, interface, artifact ou evidência executável.
- [ ] Os requisitos REQ-OFF-001 possuem evidência explícita no commit candidato.
...
- `test_offline_zero_egress_restricted_allowlist_connected_audit`
- `test_epic_083_implementacao`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-083` e o TaskEnvelope `TASK-0517`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0627-01, AC-ISSUE-0627-02, AC-ISSUE-0627-03, AC-ISSUE-0627-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-033`, `ADR-034`, `ADR-052`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-010`, `ADR-011`, `ADR-033`, `ADR-034`, `ADR-052`
