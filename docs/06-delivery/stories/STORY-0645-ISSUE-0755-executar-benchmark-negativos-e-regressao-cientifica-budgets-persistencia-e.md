# STORY-0645 / ISSUE-0755 — Executar benchmark, negativos e regressão científica: Budgets, persistência e materialização do mosaico relativo
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0645.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “Budgets, persistência e materialização do mosaico relativo”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **Budgets, persistência e materialização do mosaico relativo**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/budgets-persistencia-e-materializacao-do-mosaico-relat/**`
- `tools/quality/contexts/relative_mosaic/budgets-persistencia-e-materializacao-do-mosaico-relat/**`
- `.github/workflows/budgets-persistencia-e-materializacao-do-mosaico-relat.yaml`
## Fora de escopo
...
`STORY-0641`, `STORY-0642`, `STORY-0643`, `STORY-0644`
...
- `test_epic_103_benchmark_happy_path`
- `test_epic_103_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-103` e o TaskEnvelope `TASK-0645`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0755-01, AC-ISSUE-0755-02, AC-ISSUE-0755-03, AC-ISSUE-0755-04`
