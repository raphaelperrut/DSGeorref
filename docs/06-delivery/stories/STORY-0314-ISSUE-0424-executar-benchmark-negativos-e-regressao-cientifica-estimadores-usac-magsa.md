# STORY-0314 / ISSUE-0424 — Executar benchmark, negativos e regressão científica: estimadores USAC_MAGSAC/RANSAC explícitos, calibração, proveniência e testes de compatibilidade
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0314.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “estimadores USAC_MAGSAC/RANSAC explícitos, calibração, proveniência e testes de compatibilidade”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **estimadores USAC_MAGSAC/RANSAC explícitos, calibração, proveniência e testes de compatibilidade**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/estimadores-usac-magsac-ransac-explicitos-calibracao-p/**`
- `tools/quality/contexts/georeferencing/estimadores-usac-magsac-ransac-explicitos-calibracao-p/**`
- `.github/workflows/estimadores-usac-magsac-ransac-explicitos-calibracao-p.yaml`
## Fora de escopo
...
`STORY-0310`, `STORY-0311`, `STORY-0312`, `STORY-0313`

## Critérios de aceitação

- [ ] O resultado de “estimadores USAC_MAGSAC/RANSAC explícitos, calibração, proveniência e testes de compatibilidade” é observável por contrato, interface, artifact ou evidência executável.
...
- `test_epic_051_benchmark_happy_path`
- `test_epic_051_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-051` e o TaskEnvelope `TASK-0314`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0424-01, AC-ISSUE-0424-02, AC-ISSUE-0424-03, AC-ISSUE-0424-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-045`
