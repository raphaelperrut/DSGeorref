# STORY-0595 / ISSUE-0705 — Produzir métricas, diagnóstico e lineage: Seletor e validador de CRS
...
- **TaskEnvelope:** `.codex/tasks/TASK-0595.json`

## História de usuário

Como operador geoespacial, preciso produzir métricas, diagnóstico e lineage para “Seletor e validador de CRS”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Produzir métricas, diagnóstico e lineage para a capacidade **Seletor e validador de CRS**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/geo/dsgeorref_geo/contexts/georeferencing/seletor-e-validador-de-crs/**`
## Fora de escopo
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0705-01, AC-ISSUE-0705-02, AC-ISSUE-0705-03, AC-ISSUE-0705-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-025`, `ADR-041`, `ADR-042`, `ADR-043`
