# STORY-0118 / ISSUE-0228 — Integrar ao ProcessingPlan e pipeline: corpus versionado com décadas e condições distintas
...
- **TaskEnvelope:** `.codex/tasks/TASK-0118.json`

## História de usuário

Como operador geoespacial, preciso integrar ao processingplan e pipeline para “corpus versionado com décadas e condições distintas”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Integrar ao ProcessingPlan e pipeline para a capacidade **corpus versionado com décadas e condições distintas**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-021` e o TaskEnvelope `TASK-0118`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0228-01, AC-ISSUE-0228-02, AC-ISSUE-0228-03, AC-ISSUE-0228-04`
