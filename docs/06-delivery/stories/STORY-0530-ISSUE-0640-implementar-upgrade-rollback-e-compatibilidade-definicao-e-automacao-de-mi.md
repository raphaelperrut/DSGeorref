# STORY-0530 / ISSUE-0640 — Implementar upgrade, rollback e compatibilidade: definição e automação de milestones internal/alpha/beta/1.0, evidências e gate de abertura do repositório
...
- **TaskEnvelope:** `.codex/tasks/TASK-0530.json`

## História de usuário

Como responsável por release, preciso implementar upgrade, rollback e compatibilidade para “definição e automação de milestones internal/alpha/beta/1.0, evidências e gate de abertura do repositório”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar upgrade, rollback e compatibilidade para a capacidade **definição e automação de milestones internal/alpha/beta/1.0, evidências e gate de abertura do repositório**, com saída versionada, testes e evidência no commit candidato.
...
- `test_epic_085_upgrade_roundtrip`
- `test_epic_085_upgrade_recovery`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-085` e o TaskEnvelope `TASK-0530`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0640-01, AC-ISSUE-0640-02, AC-ISSUE-0640-03, AC-ISSUE-0640-04`
