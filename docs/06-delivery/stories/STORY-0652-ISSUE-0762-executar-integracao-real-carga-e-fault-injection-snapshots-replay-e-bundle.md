# STORY-0652 / ISSUE-0762 — Executar integração real, carga e fault injection: Snapshots, replay e bundles do scheduler
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0652.json`

## História de usuário

Como operador geoespacial, preciso executar integração real, carga e fault injection para “Snapshots, replay e bundles do scheduler”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar integração real, carga e fault injection para a capacidade **Snapshots, replay e bundles do scheduler**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/job/snapshots-replay-e-bundles-do-scheduler/**`
- `tools/quality/contexts/job_orchestration/snapshots-replay-e-bundles-do-scheduler/**`
- `.github/workflows/snapshots-replay-e-bundles-do-scheduler.yaml`
## Fora de escopo
...
`STORY-0648`, `STORY-0649`, `STORY-0650`, `STORY-0651`

## Critérios de aceitação

- [ ] O resultado de “Snapshots, replay e bundles do scheduler” é observável por contrato, interface, artifact ou evidência executável.
- [ ] Os requisitos REQ-SRP-001 possuem evidência explícita no commit candidato.
...
- `test_scheduler_execution_snapshot_selective_immutable_redacted_and_versioned`
- `test_epic_104_validacao_happy_path`
- `test_epic_104_validacao_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-104` e o TaskEnvelope `TASK-0652`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0762-01, AC-ISSUE-0762-02, AC-ISSUE-0762-03, AC-ISSUE-0762-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-053`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-053`
...
- **Resultado:** `PASS`
- **Risk tier:** `HIGH`
- **Controles aplicáveis:** `CTO-001, CTO-002, CTO-003, CTO-004, CTO-005, CTO-006, CTO-007, CTO-008, CTO-009, CTO-012, CTO-013, CTO-015`
