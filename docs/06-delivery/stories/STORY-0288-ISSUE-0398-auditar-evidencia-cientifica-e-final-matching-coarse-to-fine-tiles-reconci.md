# STORY-0288 / ISSUE-0398 — Auditar evidência científica e final: matching coarse-to-fine, tiles, reconciliação de coordenadas e refinamento em resolução adequada
...
- **TaskEnvelope:** `.codex/tasks/TASK-0288.json`

## História de usuário

Como operador geoespacial, preciso auditar evidência científica e final para “matching coarse-to-fine, tiles, reconciliação de coordenadas e refinamento em resolução adequada”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar evidência científica e final para a capacidade **matching coarse-to-fine, tiles, reconciliação de coordenadas e refinamento em resolução adequada**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/matching-coarse-to-fine-tiles-reconciliacao-de-coorden/**`
## Fora de escopo
...
- `test_epic_047_aceite_happy_path`
- `test_epic_047_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-047` e o TaskEnvelope `TASK-0288`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0398-01, AC-ISSUE-0398-02, AC-ISSUE-0398-03, AC-ISSUE-0398-04`
