# STORY-0136 / ISSUE-0246 — Definir contrato científico e invariantes: Strong Geometric Verifier fail-closed para homografia projetiva, QualityProfiles e Image Deformation Profile
...
- **TaskEnvelope:** `.codex/tasks/TASK-0136.json`

## História de usuário

Como operador geoespacial, preciso definir contrato científico e invariantes para “Strong Geometric Verifier fail-closed para homografia projetiva, QualityProfiles e Image Deformation Profile”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir contrato científico e invariantes para a capacidade **Strong Geometric Verifier fail-closed para homografia projetiva, QualityProfiles e Image Deformation Profile**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/geometric_quality/geo/strong-geometric-verifier-fail-closed-para-homografia/**`
- `docs/02-architecture/design-reviews/strong-geometric-verifier-fail-closed-para-homografia/**`
## Fora de escopo
...
`REQ-AIE-001`, `REQ-AIE-005`, `REQ-FS1-001`, `REQ-FS1-004`, `REQ-QUAL-004`, `REQ-RMV-001`, `REQ-SDR-002`
...
- [ ] Os requisitos REQ-AIE-001, REQ-AIE-005, REQ-FS1-001, REQ-FS1-004, REQ-QUAL-004, REQ-RMV-001 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-024` e o TaskEnvelope `TASK-0136`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0246-01, AC-ISSUE-0246-02, AC-ISSUE-0246-03, AC-ISSUE-0246-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-038`, `ADR-044`, `ADR-046`, `ADR-050`, `ADR-051`, `ADR-053`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-015`, `ADR-038`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-044`, `ADR-045`, `ADR-046`, `ADR-048`, `ADR-049`, `ADR-050`, `ADR-051`, `ADR-052`, `ADR-053`
