# STORY-0458 / ISSUE-0568 — Implementar persistência e migrations: RetentionPolicy por classe/estado/dependência, holds e preview de impacto
...
- **TaskEnvelope:** `.codex/tasks/TASK-0458.json`

## História de usuário

Como operador geoespacial, preciso implementar persistência e migrations para “RetentionPolicy por classe/estado/dependência, holds e preview de impacto”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar persistência e migrations para a capacidade **RetentionPolicy por classe/estado/dependência, holds e preview de impacto**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/artifact_provenance/application/retentionpolicy-por-classe-estado-dependencia-holds-e/**`
- `src/backend/dsgeorref/contexts/artifact_provenance/adapters/retentionpolicy-por-classe-estado-dependencia-holds-e/**`
## Fora de escopo
...
- `test_epic_073_persistencia_roundtrip`
- `test_epic_073_persistencia_recovery`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-073` e o TaskEnvelope `TASK-0458`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0568-01, AC-ISSUE-0568-02, AC-ISSUE-0568-03, AC-ISSUE-0568-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-012`, `ADR-016`, `ADR-018`, `ADR-019`
