# STORY-0527 / ISSUE-0637 — Auditar UX, contrato e evidência final: UX guiada de IA, explicação do plano, capacidades instaladas/bloqueadas e laboratório separado
...
- **TaskEnvelope:** `.codex/tasks/TASK-0527.json`

## História de usuário

Como operador geoespacial, preciso auditar ux, contrato e evidência final para “UX guiada de IA, explicação do plano, capacidades instaladas/bloqueadas e laboratório separado”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar UX, contrato e evidência final para a capacidade **UX guiada de IA, explicação do plano, capacidades instaladas/bloqueadas e laboratório separado**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/ux-guiada-de-ia-explicacao-do-plano-capacidades-instal/**`
## Fora de escopo
...
- `test_epic_084_aceite_happy_path`
- `test_epic_084_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-084` e o TaskEnvelope `TASK-0527`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0637-01, AC-ISSUE-0637-02, AC-ISSUE-0637-03, AC-ISSUE-0637-04`
