# STORY-0067 / ISSUE-0177 — Executar QA e auditoria final: backup/restore consistente entre banco e arquivos
...
- **TaskEnvelope:** `.codex/tasks/TASK-0067.json`

## História de usuário

Como operador geoespacial, preciso executar qa e auditoria final para “backup/restore consistente entre banco e arquivos”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar QA e auditoria final para a capacidade **backup/restore consistente entre banco e arquivos**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/backup-restore-consistente-entre-banco-e-arquivos/**`
## Fora de escopo
...
- `test_epic_013_aceite_happy_path`
- `test_epic_013_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-013` e o TaskEnvelope `TASK-0067`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0177-01, AC-ISSUE-0177-02, AC-ISSUE-0177-03, AC-ISSUE-0177-04`
