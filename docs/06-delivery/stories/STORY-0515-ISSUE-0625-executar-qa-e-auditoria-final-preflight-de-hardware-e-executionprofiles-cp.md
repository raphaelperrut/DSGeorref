# STORY-0515 / ISSUE-0625 — Executar QA e auditoria final: preflight de hardware e ExecutionProfiles CPU/GPU/híbrido integrados ao Resource Governor
...
- **TaskEnvelope:** `.codex/tasks/TASK-0515.json`

## História de usuário

Como administrador da instância, preciso executar qa e auditoria final para “preflight de hardware e ExecutionProfiles CPU/GPU/híbrido integrados ao Resource Governor”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar QA e auditoria final para a capacidade **preflight de hardware e ExecutionProfiles CPU/GPU/híbrido integrados ao Resource Governor**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/preflight-de-hardware-e-executionprofiles-cpu-gpu-hibr/**`
## Fora de escopo
...
- `test_epic_082_aceite_happy_path`
- `test_epic_082_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-082` e o TaskEnvelope `TASK-0515`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0625-01, AC-ISSUE-0625-02, AC-ISSUE-0625-03, AC-ISSUE-0625-04`
