# STORY-0141 / ISSUE-0251 — Executar benchmark, negativos e regressão científica: Strong Geometric Verifier fail-closed para homografia projetiva, QualityProfiles e Image Deformation Profile
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0141.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “Strong Geometric Verifier fail-closed para homografia projetiva, QualityProfiles e Image Deformation Profile”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **Strong Geometric Verifier fail-closed para homografia projetiva, QualityProfiles e Image Deformation Profile**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/strong-geometric-verifier-fail-closed-para-homografia/**`
- `tools/quality/contexts/geometric_quality/strong-geometric-verifier-fail-closed-para-homografia/**`
- `.github/workflows/strong-geometric-verifier-fail-closed-para-homografia.yaml`
## Fora de escopo
...
`REQ-AIE-003`, `REQ-AIE-007`, `REQ-ANC-003`, `REQ-FS1-005`, `REQ-FS1-007`, `REQ-GCP-001`, `REQ-HOM-001`, `REQ-MOS-005`, `REQ-REF-002`
...
`STORY-0137`, `STORY-0138`, `STORY-0139`, `STORY-0140`

## Critérios de aceitação

- [ ] O resultado de “Strong Geometric Verifier fail-closed para homografia projetiva, QualityProfiles e Image Deformation Profile” é observável por contrato, interface, artifact ou evidência executável.
- [ ] Os requisitos REQ-AIE-003, REQ-AIE-007, REQ-ANC-003, REQ-FS1-005, REQ-FS1-007, REQ-GCP-001 possuem evidência explícita no commit candidato.
- [ ] Estados de erro e caminhos fail-closed aplicáveis são testados, sem fallback silencioso.
- [ ] Benchmark estratificado inclui negativos, holdout/regressão e budget de falso aceite aplicável.

## Testes obrigatórios

- `test_ai_escalation_decision_03`
- `test_ai_escalation_decision_07`
- `test_component_bootstrap_independent_gcps_homography_and_sgv`
- `test_first_functional_slice_decision_05`
- `test_epic_024_benchmark_happy_path`
- `test_epic_024_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-024` e o TaskEnvelope `TASK-0141`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0251-01, AC-ISSUE-0251-02, AC-ISSUE-0251-03, AC-ISSUE-0251-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-040`, `ADR-043`, `ADR-046`, `ADR-048`, `ADR-049`, `ADR-055`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-023`, `ADR-040`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-044`, `ADR-045`, `ADR-046`, `ADR-048`, `ADR-049`, `ADR-050`, `ADR-055`
