# STORY-0560 / ISSUE-0670 — Definir escopo, contratos e invariantes: ruleset de main, checks únicos, CODEOWNERS, política de branches e prova de bypass auditado
...
- **TaskEnvelope:** `.codex/tasks/TASK-0560.json`

## História de usuário

Como mantenedor de engenharia, preciso definir escopo, contratos e invariantes para “ruleset de main, checks únicos, CODEOWNERS, política de branches e prova de bypass auditado”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir escopo, contratos e invariantes para a capacidade **ruleset de main, checks únicos, CODEOWNERS, política de branches e prova de bypass auditado**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/engineering_governance/fnd/ruleset-de-main-checks-unicos-codeowners-politica-de-b/**`
- `docs/02-architecture/design-reviews/ruleset-de-main-checks-unicos-codeowners-politica-de-b/**`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-091` e o TaskEnvelope `TASK-0560`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0670-01, AC-ISSUE-0670-02, AC-ISSUE-0670-03, AC-ISSUE-0670-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-016`
