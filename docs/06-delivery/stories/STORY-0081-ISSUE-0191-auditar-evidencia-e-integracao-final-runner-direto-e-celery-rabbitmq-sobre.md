# STORY-0081 / ISSUE-0191 — Auditar evidência e integração final: runner direto e Celery/RabbitMQ sobre o mesmo núcleo
...
- **TaskEnvelope:** `.codex/tasks/TASK-0081.json`

## História de usuário

Como operador geoespacial, preciso auditar evidência e integração final para “runner direto e Celery/RabbitMQ sobre o mesmo núcleo”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar evidência e integração final para a capacidade **runner direto e Celery/RabbitMQ sobre o mesmo núcleo**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/runner-direto-e-celery-rabbitmq-sobre-o-mesmo-nucleo/**`
## Fora de escopo
...
- `test_epic_015_aceite_happy_path`
- `test_epic_015_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-015` e o TaskEnvelope `TASK-0081`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0191-01, AC-ISSUE-0191-02, AC-ISSUE-0191-03, AC-ISSUE-0191-04`
