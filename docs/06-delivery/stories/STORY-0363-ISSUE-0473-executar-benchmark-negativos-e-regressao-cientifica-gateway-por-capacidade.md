# STORY-0363 / ISSUE-0473 — Executar benchmark, negativos e regressão científica: gateway por capacidades, adapters STAC/API oficial, testes de contrato, allowlist, SSRF/egress e estados de licença/disponibilidade
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0363.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “gateway por capacidades, adapters STAC/API oficial, testes de contrato, allowlist, SSRF/egress e estados de licença/disponibilidade”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **gateway por capacidades, adapters STAC/API oficial, testes de contrato, allowlist, SSRF/egress e estados de licença/disponibilidade**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/gateway-por-capacidades-adapters-stac-api-oficial-test/**`
- `tools/quality/contexts/reference_discovery/gateway-por-capacidades-adapters-stac-api-oficial-test/**`
- `.github/workflows/gateway-por-capacidades-adapters-stac-api-oficial-test.yaml`
## Fora de escopo
...
`STORY-0359`, `STORY-0360`, `STORY-0361`, `STORY-0362`
...
- `test_epic_058_benchmark_happy_path`
- `test_epic_058_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-058` e o TaskEnvelope `TASK-0363`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0473-01, AC-ISSUE-0473-02, AC-ISSUE-0473-03, AC-ISSUE-0473-04`
- **Base de requisitos:** `DERIVED_CONTROL`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-012`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-047`, `ADR-049`
