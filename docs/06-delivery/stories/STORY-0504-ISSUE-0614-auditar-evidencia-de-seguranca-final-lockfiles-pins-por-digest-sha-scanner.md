# STORY-0504 / ISSUE-0614 — Auditar evidência de segurança final: lockfiles, pins por digest/SHA, scanners, SBOM, assinatura OCI, attestations e verificador de release
...
- **TaskEnvelope:** `.codex/tasks/TASK-0504.json`

## História de usuário

Como administrador de segurança, preciso auditar evidência de segurança final para “lockfiles, pins por digest/SHA, scanners, SBOM, assinatura OCI, attestations e verificador de release”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar evidência de segurança final para a capacidade **lockfiles, pins por digest/SHA, scanners, SBOM, assinatura OCI, attestations e verificador de release**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/lockfiles-pins-por-digest-sha-scanners-sbom-assinatura/**`
## Fora de escopo
...
- `test_epic_080_aceite_happy_path`
- `test_epic_080_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-080` e o TaskEnvelope `TASK-0504`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0614-01, AC-ISSUE-0614-02, AC-ISSUE-0614-03, AC-ISSUE-0614-04`
