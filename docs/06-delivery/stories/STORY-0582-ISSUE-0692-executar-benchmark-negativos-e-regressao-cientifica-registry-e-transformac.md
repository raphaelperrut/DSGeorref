# STORY-0582 / ISSUE-0692 — Executar benchmark, negativos e regressão científica: Registry e transformações de CRS
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0582.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “Registry e transformações de CRS”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **Registry e transformações de CRS**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/registry-e-transformacoes-de-crs/**`
- `tools/quality/contexts/georeferencing/registry-e-transformacoes-de-crs/**`
- `.github/workflows/registry-e-transformacoes-de-crs.yaml`
## Fora de escopo
...
`STORY-0578`, `STORY-0579`, `STORY-0580`, `STORY-0581`

## Critérios de aceitação

- [ ] O resultado de “Registry e transformações de CRS” é observável por contrato, interface, artifact ou evidência executável.
...
- `test_epic_094_benchmark_happy_path`
- `test_epic_094_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-094` e o TaskEnvelope `TASK-0582`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0692-01, AC-ISSUE-0692-02, AC-ISSUE-0692-03, AC-ISSUE-0692-04`
