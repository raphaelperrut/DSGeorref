# STORY-0266 / ISSUE-0376 — Executar benchmark, negativos e regressão científica: OutputProfile, COG canônico, preservação de resolução e validação da grade
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0266.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “OutputProfile, COG canônico, preservação de resolução e validação da grade”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **OutputProfile, COG canônico, preservação de resolução e validação da grade**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/outputprofile-cog-canonico-preservacao-de-resolucao-e/**`
- `tools/quality/contexts/georeferencing/outputprofile-cog-canonico-preservacao-de-resolucao-e/**`
- `.github/workflows/outputprofile-cog-canonico-preservacao-de-resolucao-e.yaml`
## Fora de escopo
...
`STORY-0262`, `STORY-0263`, `STORY-0264`, `STORY-0265`

## Critérios de aceitação

- [ ] O resultado de “OutputProfile, COG canônico, preservação de resolução e validação da grade” é observável por contrato, interface, artifact ou evidência executável.
...
- `test_epic_044_benchmark_happy_path`
- `test_epic_044_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-044` e o TaskEnvelope `TASK-0266`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0376-01, AC-ISSUE-0376-02, AC-ISSUE-0376-03, AC-ISSUE-0376-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-025`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-049`
