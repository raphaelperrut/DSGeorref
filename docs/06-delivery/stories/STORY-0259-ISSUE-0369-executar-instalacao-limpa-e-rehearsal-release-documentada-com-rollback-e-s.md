# STORY-0259 / ISSUE-0369 — Executar instalação limpa e rehearsal: release documentada com rollback e suporte
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0259.json`

## História de usuário

Como responsável por release, preciso executar instalação limpa e rehearsal para “release documentada com rollback e suporte”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar instalação limpa e rehearsal para a capacidade **release documentada com rollback e suporte**, com saída versionada, testes e evidência no commit candidato.
...
`STORY-0256`, `STORY-0257`, `STORY-0258`
...
- `test_epic_043_ensaio_happy_path`
- `test_epic_043_ensaio_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-043` e o TaskEnvelope `TASK-0259`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0369-01, AC-ISSUE-0369-02, AC-ISSUE-0369-03, AC-ISSUE-0369-04`
