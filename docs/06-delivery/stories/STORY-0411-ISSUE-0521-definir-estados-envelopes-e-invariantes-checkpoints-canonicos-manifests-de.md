# STORY-0411 / ISSUE-0521 — Definir estados, envelopes e invariantes: checkpoints canônicos, manifests de compatibilidade, retomada e lifecycle de intermediários
...
- **TaskEnvelope:** `.codex/tasks/TASK-0411.json`

## História de usuário

Como operador geoespacial, preciso definir estados, envelopes e invariantes para “checkpoints canônicos, manifests de compatibilidade, retomada e lifecycle de intermediários”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir estados, envelopes e invariantes para a capacidade **checkpoints canônicos, manifests de compatibilidade, retomada e lifecycle de intermediários**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/job_orchestration/job/checkpoints-canonicos-manifests-de-compatibilidade-ret/**`
- `docs/02-architecture/design-reviews/checkpoints-canonicos-manifests-de-compatibilidade-ret/**`
## Fora de escopo
...
`REQ-ANC-008`, `REQ-BEX-003`, `REQ-BEX-005`
...
- [ ] Os requisitos REQ-ANC-008, REQ-BEX-003, REQ-BEX-005 possuem evidência explícita no commit candidato.
...
- `test_immutable_anchorset_impact_preview_scoped_reoptimization_and_history`
- `test_batch_execution_decision_03`
- `test_batch_execution_decision_05`
- `test_epic_066_contrato`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-066` e o TaskEnvelope `TASK-0411`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0521-01, AC-ISSUE-0521-02, AC-ISSUE-0521-03, AC-ISSUE-0521-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-038`, `ADR-046`, `ADR-048`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-012`, `ADR-016`, `ADR-038`, `ADR-046`, `ADR-048`
