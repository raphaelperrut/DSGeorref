# STORY-0708 / ISSUE-0818 — Slice 1/4 — Materializar a fundação executável: migrations, CI, secret/dependency scan e telemetria mínima [REQ-AIE, REQ-BEX]
...
- **TaskEnvelope:** `.codex/tasks/TASK-0708.json`
...
- `tools/governance/migrations-ci-secret-dependency-scan-e-telemetria-mini/aie-bex-parte-1/**`
- `docs/03-engineering/contexts/engineering_governance/migrations-ci-secret-dependency-scan-e-telemetria-mini/aie-bex-parte-1/**`
## Fora de escopo
...
`REQ-AIE-002`, `REQ-AIE-003`, `REQ-AIE-004`, `REQ-AIE-006`, `REQ-AIE-007`, `REQ-AIE-008`, `REQ-AIE-009`, `REQ-AIE-010`, `REQ-BEX-002`, `REQ-BEX-004`
...
- [ ] Cada requisito do slice possui evidência explícita: REQ-AIE-002, REQ-AIE-003, REQ-AIE-004, REQ-AIE-006, REQ-AIE-007, REQ-AIE-008, REQ-AIE-009, REQ-AIE-010, REQ-BEX-002, REQ-BEX-004.
...
Leia `AGENTS.md`, o papel `.codex/roles/ROLE-003-tech-lead.md`, esta história e `TASK-0708`. Trabalhe somente nos paths permitidos, entregue apenas este slice e interrompa diante de qualquer condição de parada.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0818-01, AC-ISSUE-0818-02, AC-ISSUE-0818-03, AC-ISSUE-0818-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-012`, `ADR-030`, `ADR-038`, `ADR-039`, `ADR-046`, `ADR-051`, `ADR-052`, `ADR-053`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-012`, `ADR-018`, `ADR-023`, `ADR-024`, `ADR-026`, `ADR-030`, `ADR-038`, `ADR-039`, `ADR-046`, `ADR-051`, `ADR-052`, `ADR-053`
