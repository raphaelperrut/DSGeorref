# STORY-0113 / ISSUE-0223 — Executar testes de contrato e integração: CLI estável para projetos, ingestão, jobs e resultados
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0113.json`

## História de usuário

Como operador técnico, preciso executar testes de contrato e integração para “CLI estável para projetos, ingestão, jobs e resultados”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar testes de contrato e integração para a capacidade **CLI estável para projetos, ingestão, jobs e resultados**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/cli/cli-estavel-para-projetos-ingestao-jobs-e-resultados/**`
- `tools/quality/contexts/operator_experience/cli-estavel-para-projetos-ingestao-jobs-e-resultados/**`
- `.github/workflows/cli-estavel-para-projetos-ingestao-jobs-e-resultados.yaml`
## Fora de escopo
...
- `test_epic_020_validacao_happy_path`
- `test_epic_020_validacao_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-020` e o TaskEnvelope `TASK-0113`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0223-01, AC-ISSUE-0223-02, AC-ISSUE-0223-03, AC-ISSUE-0223-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-046`, `ADR-055`
