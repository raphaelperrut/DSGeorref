# STORY-0159 / ISSUE-0269 — Implementar o núcleo algorítmico: gateway de fontes, proteção SSRF, estados de disponibilidade e bloqueio de compra
...
- **TaskEnvelope:** `.codex/tasks/TASK-0159.json`

## História de usuário

Como operador geoespacial, preciso implementar o núcleo algorítmico para “gateway de fontes, proteção SSRF, estados de disponibilidade e bloqueio de compra”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar o núcleo algorítmico para a capacidade **gateway de fontes, proteção SSRF, estados de disponibilidade e bloqueio de compra**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-027` e o TaskEnvelope `TASK-0159`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0269-01, AC-ISSUE-0269-02, AC-ISSUE-0269-03, AC-ISSUE-0269-04`
