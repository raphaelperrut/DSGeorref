# STORY-0405 / ISSUE-0515 — Implementar modelo e application services: taxonomia de retry técnico, orçamento, backoff, idempotência e PlanVariants algorítmicos
...
- **TaskEnvelope:** `.codex/tasks/TASK-0405.json`

## História de usuário

Como operador geoespacial, preciso implementar modelo e application services para “taxonomia de retry técnico, orçamento, backoff, idempotência e PlanVariants algorítmicos”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar modelo e application services para a capacidade **taxonomia de retry técnico, orçamento, backoff, idempotência e PlanVariants algorítmicos**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/job_orchestration/application/taxonomia-de-retry-tecnico-orcamento-backoff-idempoten/**`
- `src/backend/dsgeorref/contexts/job_orchestration/adapters/taxonomia-de-retry-tecnico-orcamento-backoff-idempoten/**`
## Fora de escopo
...
- [ ] O resultado de “taxonomia de retry técnico, orçamento, backoff, idempotência e PlanVariants algorítmicos” é observável por contrato, interface, artifact ou evidência executável.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-065` e o TaskEnvelope `TASK-0405`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0515-01, AC-ISSUE-0515-02, AC-ISSUE-0515-03, AC-ISSUE-0515-04`
