# STORY-0185 / ISSUE-0295 — Definir jornada, estados e acessibilidade: React/TypeScript/Vite, design system, cliente OpenAPI, seletor visual, acessibilidade e E2E
...
- **TaskEnvelope:** `.codex/tasks/TASK-0185.json`

## História de usuário

Como operador geoespacial, preciso definir jornada, estados e acessibilidade para “React/TypeScript/Vite, design system, cliente OpenAPI, seletor visual, acessibilidade e E2E”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir jornada, estados e acessibilidade para a capacidade **React/TypeScript/Vite, design system, cliente OpenAPI, seletor visual, acessibilidade e E2E**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `docs/01-product/capabilities/react-typescript-vite-design-system-cliente-openapi-se/**`
## Fora de escopo
...
`REQ-FS-001`, `REQ-TOOL-008`, `REQ-TOOL-009`
...
`STORY-0020`, `STORY-0055`, `STORY-0095`
...
- [ ] Os requisitos REQ-FS-001, REQ-TOOL-008, REQ-TOOL-009 possuem evidência explícita no commit candidato.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0295-01, AC-ISSUE-0295-02, AC-ISSUE-0295-03, AC-ISSUE-0295-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-014`
- **Conflito:** `Nenhum`
