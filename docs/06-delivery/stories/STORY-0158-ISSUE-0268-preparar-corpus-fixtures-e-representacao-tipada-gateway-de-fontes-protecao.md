# STORY-0158 / ISSUE-0268 — Preparar corpus, fixtures e representação tipada: gateway de fontes, proteção SSRF, estados de disponibilidade e bloqueio de compra
...
- **TaskEnvelope:** `.codex/tasks/TASK-0158.json`

## História de usuário

Como operador geoespacial, preciso preparar corpus, fixtures e representação tipada para “gateway de fontes, proteção SSRF, estados de disponibilidade e bloqueio de compra”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Preparar corpus, fixtures e representação tipada para a capacidade **gateway de fontes, proteção SSRF, estados de disponibilidade e bloqueio de compra**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/geo/dsgeorref_geo/contexts/reference_discovery/gateway-de-fontes-protecao-ssrf-estados-de-disponibili/**`
## Fora de escopo
...
- [ ] Os requisitos REQ-SRC-001, REQ-SRC-002 possuem evidência explícita no commit candidato.
...
- `ssrf_provider_gateway`
- `test_free_download_only_and_purchase_blocked`
- `test_epic_027_dados`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-027` e o TaskEnvelope `TASK-0158`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0268-01, AC-ISSUE-0268-02, AC-ISSUE-0268-03, AC-ISSUE-0268-04`
