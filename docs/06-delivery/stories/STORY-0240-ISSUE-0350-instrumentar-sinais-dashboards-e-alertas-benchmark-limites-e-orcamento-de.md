# STORY-0240 / ISSUE-0350 — Instrumentar sinais, dashboards e alertas: benchmark, limites e orçamento de recursos
...
- **TaskEnvelope:** `.codex/tasks/TASK-0240.json`

## História de usuário

Como administrador da instância, preciso instrumentar sinais, dashboards e alertas para “benchmark, limites e orçamento de recursos”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Instrumentar sinais, dashboards e alertas para a capacidade **benchmark, limites e orçamento de recursos**, com saída versionada, testes e evidência no commit candidato.
...
`REQ-RES-001`, `REQ-SMO-001`, `REQ-SMO-003`
...
- [ ] Os requisitos REQ-RES-001, REQ-SMO-001, REQ-SMO-003 possuem evidência explícita no commit candidato.
...
- `test_resource_governor_admission_pressure_adaptation`
- `test_scheduler_low_cardinality_metrics_correlated_event_ledger_and_timeline`
- `test_class_slos_wait_starvation_stalled_jobs_gpu_lease_and_breaker_recovery_alerts`
- `test_epic_040_observabilidade`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-040` e o TaskEnvelope `TASK-0240`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0350-01, AC-ISSUE-0350-02, AC-ISSUE-0350-03, AC-ISSUE-0350-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-012`, `ADR-033`, `ADR-034`, `ADR-039`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-012`, `ADR-033`, `ADR-034`, `ADR-039`
