# STORY-0634 / ISSUE-0744 — Preparar corpus, fixtures e representação tipada: Relatórios, visualização e exports do mosaico relativo
...
- **TaskEnvelope:** `.codex/tasks/TASK-0634.json`

## História de usuário

Como operador geoespacial, preciso preparar corpus, fixtures e representação tipada para “Relatórios, visualização e exports do mosaico relativo”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Preparar corpus, fixtures e representação tipada para a capacidade **Relatórios, visualização e exports do mosaico relativo**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/geo/dsgeorref_geo/contexts/relative_mosaic/relatorios-visualizacao-e-exports-do-mosaico-relativo/**`
## Fora de escopo
...
`REQ-RMR-001`, `REQ-RMR-003`, `REQ-RMR-004`
...
- [ ] Os requisitos REQ-RMR-001, REQ-RMR-003, REQ-RMR-004 possuem evidência explícita no commit candidato.
...
- `test_layered_summary_technical_visual_reproducibility_export_profiles`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-102` e o TaskEnvelope `TASK-0634`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0744-01, AC-ISSUE-0744-02, AC-ISSUE-0744-03, AC-ISSUE-0744-04`
