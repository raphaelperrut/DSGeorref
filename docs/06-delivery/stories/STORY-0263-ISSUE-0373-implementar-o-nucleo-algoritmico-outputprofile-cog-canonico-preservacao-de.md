# STORY-0263 / ISSUE-0373 — Implementar o núcleo algorítmico: OutputProfile, COG canônico, preservação de resolução e validação da grade
...
- **TaskEnvelope:** `.codex/tasks/TASK-0263.json`

## História de usuário

Como operador geoespacial, preciso implementar o núcleo algorítmico para “OutputProfile, COG canônico, preservação de resolução e validação da grade”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar o núcleo algorítmico para a capacidade **OutputProfile, COG canônico, preservação de resolução e validação da grade**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-044` e o TaskEnvelope `TASK-0263`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0373-01, AC-ISSUE-0373-02, AC-ISSUE-0373-03, AC-ISSUE-0373-04`
