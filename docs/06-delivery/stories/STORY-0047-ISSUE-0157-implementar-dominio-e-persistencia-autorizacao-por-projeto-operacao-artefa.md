# STORY-0047 / ISSUE-0157 — Consolidar slices e liberar integração: autorização por projeto, operação, artefato e caminho
...
- **TaskEnvelope:** `.codex/tasks/TASK-0047.json`

## História de usuário

Como administrador da instância, preciso implementar domínio e persistência para “autorização por projeto, operação, artefato e caminho”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.
...
- `src/backend/dsgeorref/contexts/identity_access/application/autorizacao-por-projeto-operacao-artefato-e-caminho/consolidacao/**`
- `src/backend/dsgeorref/contexts/identity_access/adapters/autorizacao-por-projeto-operacao-artefato-e-caminho/consolidacao/**`
## Fora de escopo
...
- `test_story_0047_slice_consolidation`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-010` e o TaskEnvelope `TASK-0047`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0157-01, AC-ISSUE-0157-02, AC-ISSUE-0157-03, AC-ISSUE-0157-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-016`, `ADR-018`, `ADR-019`, `ADR-055`
