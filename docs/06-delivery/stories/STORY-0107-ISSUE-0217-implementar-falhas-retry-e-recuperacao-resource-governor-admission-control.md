# STORY-0107 / ISSUE-0217 — Automatizar testes de resiliência, retry e recuperação: Resource Governor, admission control e orçamento adaptativo de RAM/CPU/GPU/disco
...
- **TaskEnvelope:** `.codex/tasks/TASK-0107.json`

## História de usuário

Como operador geoespacial, preciso automatizar testes de resiliência, retry e recuperação para “Resource Governor, admission control e orçamento adaptativo de RAM/CPU/GPU/disco”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Automatizar testes de resiliência, retry e recuperação para a capacidade **Resource Governor, admission control e orçamento adaptativo de RAM/CPU/GPU/disco**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/job/resource-governor-admission-control-e-orcamento-adapta/**`
- `tools/quality/contexts/job_orchestration/resource-governor-admission-control-e-orcamento-adapta/**`
- `.github/workflows/resource-governor-admission-control-e-orcamento-adapta.yaml`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-019` e o TaskEnvelope `TASK-0107`. Trabalhe somente nos paths permitidos. Entregue o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0217-01, AC-ISSUE-0217-02, AC-ISSUE-0217-03, AC-ISSUE-0217-04`
