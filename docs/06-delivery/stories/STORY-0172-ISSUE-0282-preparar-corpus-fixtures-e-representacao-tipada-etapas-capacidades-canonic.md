# STORY-0172 / ISSUE-0282 — Preparar corpus, fixtures e representação tipada: etapas/capacidades canônicas e ProcessingPlan reproduzível
...
- **TaskEnvelope:** `.codex/tasks/TASK-0172.json`

## História de usuário

Como operador geoespacial, preciso preparar corpus, fixtures e representação tipada para “etapas/capacidades canônicas e ProcessingPlan reproduzível”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Preparar corpus, fixtures e representação tipada para a capacidade **etapas/capacidades canônicas e ProcessingPlan reproduzível**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/geo/dsgeorref_geo/contexts/processing_plan/etapas-capacidades-canonicas-e-processingplan-reproduz/**`
## Fora de escopo
...
`REQ-AI-008`, `REQ-AI-011`, `REQ-AI-014`
...
- [ ] Os requisitos REQ-AI-008, REQ-AI-011, REQ-AI-014 possuem evidência explícita no commit candidato.
...
- `test_guided_ai_plan_no_raw_seven_mode_confusion`
- `test_stage_precondition_budget_evidence_planner`
- `test_epic_029_dados`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-029` e o TaskEnvelope `TASK-0172`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0282-01, AC-ISSUE-0282-02, AC-ISSUE-0282-03, AC-ISSUE-0282-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-051`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-047`, `ADR-051`
