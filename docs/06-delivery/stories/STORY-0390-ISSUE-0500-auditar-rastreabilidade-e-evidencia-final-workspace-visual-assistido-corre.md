# STORY-0390 / ISSUE-0500 — Auditar rastreabilidade e evidência final: workspace visual assistido, CorrectionSets, nova tentativa, comparação e auditoria sem bloquear o ciclo automático
...
- **TaskEnvelope:** `.codex/tasks/TASK-0390.json`

## História de usuário

Como revisor geoespacial, preciso auditar rastreabilidade e evidência final para “workspace visual assistido, CorrectionSets, nova tentativa, comparação e auditoria sem bloquear o ciclo automático”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar rastreabilidade e evidência final para a capacidade **workspace visual assistido, CorrectionSets, nova tentativa, comparação e auditoria sem bloquear o ciclo automático**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/workspace-visual-assistido-correctionsets-nova-tentati/**`
## Fora de escopo
...
- `test_epic_062_aceite_happy_path`
- `test_epic_062_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-062` e o TaskEnvelope `TASK-0390`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0500-01, AC-ISSUE-0500-02, AC-ISSUE-0500-03, AC-ISSUE-0500-04`
