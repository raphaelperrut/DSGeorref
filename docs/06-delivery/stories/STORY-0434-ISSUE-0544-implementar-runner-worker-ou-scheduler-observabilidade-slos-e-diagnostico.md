# STORY-0434 / ISSUE-0544 — Implementar runner, worker ou scheduler: Observabilidade, SLOs e diagnóstico do scheduler
...
- **TaskEnvelope:** `.codex/tasks/TASK-0434.json`

## História de usuário

Como operador geoespacial, preciso implementar runner, worker ou scheduler para “Observabilidade, SLOs e diagnóstico do scheduler”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar runner, worker ou scheduler para a capacidade **Observabilidade, SLOs e diagnóstico do scheduler**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/job_orchestration/application/observabilidade-slos-e-diagnostico-do-scheduler/**`
- `src/backend/dsgeorref/contexts/job_orchestration/adapters/observabilidade-slos-e-diagnostico-do-scheduler/**`
## Fora de escopo
...
`REQ-BEX-007`, `REQ-BEX-008`, `REQ-BEX-009`, `REQ-SMO-001`, `REQ-SMO-002`, `REQ-SMO-003`
...
- [ ] O resultado de “Observabilidade, SLOs e diagnóstico do scheduler” é observável por contrato, interface, artifact ou evidência executável.
- [ ] Os requisitos REQ-BEX-007, REQ-BEX-008, REQ-BEX-009, REQ-SMO-001, REQ-SMO-002, REQ-SMO-003 possuem evidência explícita no commit candidato.
...
- `test_scheduler_low_cardinality_metrics_correlated_event_ledger_and_timeline`
- `test_epic_069_execucao`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-069` e o TaskEnvelope `TASK-0434`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0544-01, AC-ISSUE-0544-02, AC-ISSUE-0544-03, AC-ISSUE-0544-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-012`, `ADR-016`, `ADR-037`, `ADR-038`, `ADR-039`, `ADR-040`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-012`, `ADR-016`, `ADR-018`, `ADR-019`, `ADR-037`, `ADR-038`, `ADR-039`, `ADR-040`
