# STORY-0337 / ISSUE-0447 — Definir contrato científico e invariantes: recuperação progressiva de vizinhos com candidate budget, telemetria de recall e retry ampliado explícito
...
- **TaskEnvelope:** `.codex/tasks/TASK-0337.json`

## História de usuário

Como operador geoespacial, preciso definir contrato científico e invariantes para “recuperação progressiva de vizinhos com candidate budget, telemetria de recall e retry ampliado explícito”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir contrato científico e invariantes para a capacidade **recuperação progressiva de vizinhos com candidate budget, telemetria de recall e retry ampliado explícito**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/reference_discovery/geo/recuperacao-progressiva-de-vizinhos-com-candidate-budg/**`
- `docs/02-architecture/design-reviews/recuperacao-progressiva-de-vizinhos-com-candidate-budg/**`
## Fora de escopo
...
`STORY-0288`, `STORY-0308`, `STORY-0336`, `STORY-0109`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-055` e o TaskEnvelope `TASK-0337`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0447-01, AC-ISSUE-0447-02, AC-ISSUE-0447-03, AC-ISSUE-0447-04`
