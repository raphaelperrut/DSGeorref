# STORY-0486 / ISSUE-0596 — Auditar evidência operacional final: budgets de cardinalidade, sampling, retenção por sinal e dashboards de perda/overhead
...
- **TaskEnvelope:** `.codex/tasks/TASK-0486.json`

## História de usuário

Como administrador da instância, preciso auditar evidência operacional final para “budgets de cardinalidade, sampling, retenção por sinal e dashboards de perda/overhead”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar evidência operacional final para a capacidade **budgets de cardinalidade, sampling, retenção por sinal e dashboards de perda/overhead**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/budgets-de-cardinalidade-sampling-retencao-por-sinal-e/**`
## Fora de escopo
...
- `test_epic_077_aceite_happy_path`
- `test_epic_077_aceite_negative_paths`
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0596-01, AC-ISSUE-0596-02, AC-ISSUE-0596-03, AC-ISSUE-0596-04`
