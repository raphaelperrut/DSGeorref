# STORY-0447 / ISSUE-0557 — Implementar armazenamento e lifecycle: BackupSet coordenado, manifests, checksums, watermark e policies de inclusão
...
- **TaskEnvelope:** `.codex/tasks/TASK-0447.json`

## História de usuário

Como operador geoespacial, preciso implementar armazenamento e lifecycle para “BackupSet coordenado, manifests, checksums, watermark e policies de inclusão”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar armazenamento e lifecycle para a capacidade **BackupSet coordenado, manifests, checksums, watermark e policies de inclusão**, com saída versionada, testes e evidência no commit candidato.
...
- `test_epic_071_armazenamento_roundtrip`
- `test_epic_071_armazenamento_recovery`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-071` e o TaskEnvelope `TASK-0447`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0557-01, AC-ISSUE-0557-02, AC-ISSUE-0557-03, AC-ISSUE-0557-04`
