# STORY-0242 / ISSUE-0352 — Validar acesso, redaction e exposição: benchmark, limites e orçamento de recursos
...
- **TaskEnvelope:** `.codex/tasks/TASK-0242.json`

## História de usuário

Como administrador da instância, preciso validar acesso, redaction e exposição para “benchmark, limites e orçamento de recursos”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Validar acesso, redaction e exposição para a capacidade **benchmark, limites e orçamento de recursos**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/operations_audit/adapters/security/benchmark-limites-e-orcamento-de-recursos/**`
- `tests/security/contexts/operations_audit/benchmark-limites-e-orcamento-de-recursos/**`
## Fora de escopo
...
`STORY-0239`, `STORY-0240`, `STORY-0241`
...
- `test_epic_040_seguranca_happy_path`
- `test_epic_040_seguranca_negative_paths`
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0352-01, AC-ISSUE-0352-02, AC-ISSUE-0352-03, AC-ISSUE-0352-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-030`, `ADR-031`, `ADR-032`, `ADR-053`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-030`, `ADR-031`, `ADR-032`, `ADR-053`
