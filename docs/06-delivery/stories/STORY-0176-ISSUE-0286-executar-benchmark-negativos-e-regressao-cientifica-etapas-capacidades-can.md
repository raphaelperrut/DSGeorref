# STORY-0176 / ISSUE-0286 — Executar benchmark, negativos e regressão científica: etapas/capacidades canônicas e ProcessingPlan reproduzível
...
- **Sprint:** `SPRINT-005`
- **Domínio:** `GEO`
- **Bounded Context:** `BC-004 — Plano de Processamento e Workflow`
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0176.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “etapas/capacidades canônicas e ProcessingPlan reproduzível”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **etapas/capacidades canônicas e ProcessingPlan reproduzível**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/etapas-capacidades-canonicas-e-processingplan-reproduz/**`
- `tools/quality/contexts/processing_plan/etapas-capacidades-canonicas-e-processingplan-reproduz/**`
- `.github/workflows/etapas-capacidades-canonicas-e-processingplan-reproduz.yaml`
## Fora de escopo
...
`STORY-0172`, `STORY-0173`, `STORY-0174`, `STORY-0175`

## Critérios de aceitação

- [ ] O resultado de “etapas/capacidades canônicas e ProcessingPlan reproduzível” é observável por contrato, interface, artifact ou evidência executável.
...
- `test_epic_029_benchmark_happy_path`
- `test_epic_029_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-029` e o TaskEnvelope `TASK-0176`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Upstreams permitidos:** `BC-002, BC-003, BC-011`.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0286-01, AC-ISSUE-0286-02, AC-ISSUE-0286-03, AC-ISSUE-0286-04`
