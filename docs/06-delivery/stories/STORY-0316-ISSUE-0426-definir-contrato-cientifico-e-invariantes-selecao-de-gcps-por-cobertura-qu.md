# STORY-0316 / ISSUE-0426 — Definir contrato científico e invariantes: seleção de GCPs por cobertura/qualidade/diversidade, exportando pontos usados e descartados
...
- **TaskEnvelope:** `.codex/tasks/TASK-0316.json`

## História de usuário

Como operador geoespacial, preciso definir contrato científico e invariantes para “seleção de GCPs por cobertura/qualidade/diversidade, exportando pontos usados e descartados”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir contrato científico e invariantes para a capacidade **seleção de GCPs por cobertura/qualidade/diversidade, exportando pontos usados e descartados**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/georeferencing/geo/selecao-de-gcps-por-cobertura-qualidade-diversidade-ex/**`
- `docs/02-architecture/design-reviews/selecao-de-gcps-por-cobertura-qualidade-diversidade-ex/**`
## Fora de escopo
...
`STORY-0135`, `STORY-0274`, `STORY-0315`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-052` e o TaskEnvelope `TASK-0316`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0426-01, AC-ISSUE-0426-02, AC-ISSUE-0426-03, AC-ISSUE-0426-04`
