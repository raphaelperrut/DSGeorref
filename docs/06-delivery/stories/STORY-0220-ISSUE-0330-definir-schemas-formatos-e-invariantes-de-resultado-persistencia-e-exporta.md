# STORY-0220 / ISSUE-0330 — Definir schemas, formatos e invariantes de resultado: persistência e exportação escalável de resultados por imagem/lote, geometrias, manifestos e checksums
...
- **TaskEnvelope:** `.codex/tasks/TASK-0220.json`

## História de usuário

Como revisor e auditor, preciso definir schemas, formatos e invariantes de resultado para “persistência e exportação escalável de resultados por imagem/lote, geometrias, manifestos e checksums”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir schemas, formatos e invariantes de resultado para a capacidade **persistência e exportação escalável de resultados por imagem/lote, geometrias, manifestos e checksums**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/results_reporting/rep/persistencia-e-exportacao-escalavel-de-resultados-por/**`
- `docs/02-architecture/design-reviews/persistencia-e-exportacao-escalavel-de-resultados-por/**`
## Fora de escopo
...
`REQ-BEX-003`, `REQ-BEX-005`, `REQ-GCP-002`, `REQ-PROV-001`
...
`STORY-0061`, `STORY-0156`, `STORY-0184`, `STORY-0397`
...
- [ ] Os requisitos REQ-BEX-003, REQ-BEX-005, REQ-GCP-002, REQ-PROV-001 possuem evidência explícita no commit candidato.
...
- `test_gcp_lifecycle_roundtrip_exports_provenance`
- `test_manifest_lineage_reproduction_bundle`
- `test_epic_037_contrato`
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0330-01, AC-ISSUE-0330-02, AC-ISSUE-0330-03, AC-ISSUE-0330-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-025`, `ADR-038`, `ADR-046`, `ADR-048`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-012`, `ADR-014`, `ADR-016`, `ADR-025`, `ADR-038`, `ADR-046`, `ADR-048`
