# STORY-0138 / ISSUE-0248 — Implementar o núcleo algorítmico: Strong Geometric Verifier fail-closed para homografia projetiva, QualityProfiles e Image Deformation Profile
...
- **TaskEnvelope:** `.codex/tasks/TASK-0138.json`

## História de usuário

Como operador geoespacial, preciso implementar o núcleo algorítmico para “Strong Geometric Verifier fail-closed para homografia projetiva, QualityProfiles e Image Deformation Profile”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar o núcleo algorítmico para a capacidade **Strong Geometric Verifier fail-closed para homografia projetiva, QualityProfiles e Image Deformation Profile**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/geo/dsgeorref_geo/contexts/geometric_quality/strong-geometric-verifier-fail-closed-para-homografia/**`
## Fora de escopo
...
`REQ-ANC-002`, `REQ-FS1-006`, `REQ-MOS-003`, `REQ-QUAL-001`, `REQ-QUAL-002`, `REQ-REV-003`
...
- [ ] Os requisitos REQ-ANC-002, REQ-FS1-006, REQ-MOS-003, REQ-QUAL-001, REQ-QUAL-002, REQ-REV-003 possuem evidência explícita no commit candidato.
...
- `test_joint_anchored_per_image_homography_optimization_and_component_split`
- `test_first_functional_slice_decision_06`
- `test_global_relative_alignment_cycle_drift_foldover_and_weak_bridge_split`
- `test_fail_closed_missing_metric_and_critical_gate_rejection`
- `test_epic_024_algoritmo`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-024` e o TaskEnvelope `TASK-0138`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0248-01, AC-ISSUE-0248-02, AC-ISSUE-0248-03, AC-ISSUE-0248-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-045`, `ADR-046`, `ADR-048`, `ADR-049`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-023`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-044`, `ADR-045`, `ADR-046`, `ADR-048`, `ADR-049`, `ADR-050`, `ADR-055`
