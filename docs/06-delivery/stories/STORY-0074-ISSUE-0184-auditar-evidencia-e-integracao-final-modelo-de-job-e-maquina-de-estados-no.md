# STORY-0074 / ISSUE-0184 — Auditar evidência e integração final: modelo de job e máquina de estados no PostgreSQL
...
- **TaskEnvelope:** `.codex/tasks/TASK-0074.json`

## História de usuário

Como operador geoespacial, preciso auditar evidência e integração final para “modelo de job e máquina de estados no PostgreSQL”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar evidência e integração final para a capacidade **modelo de job e máquina de estados no PostgreSQL**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/modelo-de-job-e-maquina-de-estados-no-postgresql/**`
## Fora de escopo
...
- `test_epic_014_aceite_happy_path`
- `test_epic_014_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-014` e o TaskEnvelope `TASK-0074`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0184-01, AC-ISSUE-0184-02, AC-ISSUE-0184-03, AC-ISSUE-0184-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-018`, `ADR-019`, `ADR-020`, `ADR-023`
