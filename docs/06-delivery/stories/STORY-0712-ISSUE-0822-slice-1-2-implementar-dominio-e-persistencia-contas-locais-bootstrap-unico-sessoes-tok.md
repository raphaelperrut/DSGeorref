...
- **TaskEnvelope:** `.codex/tasks/TASK-0712.json`
...
- `src/backend/dsgeorref/contexts/identity_access/application/contas-locais-bootstrap-unico-sessoes-tokens-e-adapter/auth-impl-dbschema-parte-1/**`
- `src/backend/dsgeorref/contexts/identity_access/adapters/contas-locais-bootstrap-unico-sessoes-tokens-e-adapter/auth-impl-dbschema-parte-1/**`
## Fora de escopo
...
`REQ-AUTH-IMPL-001`, `REQ-AUTH-IMPL-002`, `REQ-AUTH-IMPL-003`, `REQ-AUTH-IMPL-004`, `REQ-AUTH-IMPL-005`, `REQ-AUTH-IMPL-006`, `REQ-AUTH-IMPL-008`, `REQ-AUTH-IMPL-009`, `REQ-AUTH-IMPL-010`, `REQ-DBSCHEMA-003`
...
- [ ] Cada requisito do slice possui evidência explícita: REQ-AUTH-IMPL-001, REQ-AUTH-IMPL-002, REQ-AUTH-IMPL-003, REQ-AUTH-IMPL-004, REQ-AUTH-IMPL-005, REQ-AUTH-IMPL-006, REQ-AUTH-IMPL-008, REQ-AUTH-IMPL-009, REQ-AUTH-IMPL-010, REQ-DBSCHEMA-003.
...
Leia `AGENTS.md`, o papel `.codex/roles/ROLE-004-backend.md`, esta história e `TASK-0712`. Trabalhe somente nos paths permitidos, entregue apenas este slice e interrompa diante de qualquer condição de parada.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0822-01, AC-ISSUE-0822-02, AC-ISSUE-0822-03, AC-ISSUE-0822-04`
