# STORY-0729 / ISSUE-0839 — Slice 1/3 — Preparar corpus, fixtures e representação tipada: Strong Geometric Verifier fail-closed para homografia projetiva, QualityProfiles e Image Deformation Profile [REQ-AIE, REQ-ANC, REQ-CRS, REQ-EPIC]
...
- **TaskEnvelope:** `.codex/tasks/TASK-0729.json`
...
- `src/geo/dsgeorref_geo/contexts/geometric_quality/strong-geometric-verifier-fail-closed-para-homografia/aie-anc-crs-parte-1/**`
## Fora de escopo
...
`REQ-AIE-002`, `REQ-AIE-004`, `REQ-AIE-006`, `REQ-AIE-008`, `REQ-AIE-009`, `REQ-AIE-010`, `REQ-ANC-006`, `REQ-ANC-007`, `REQ-CRS-003`, `REQ-EPIC-021`
...
- [ ] Cada requisito do slice possui evidência explícita: REQ-AIE-002, REQ-AIE-004, REQ-AIE-006, REQ-AIE-008, REQ-AIE-009, REQ-AIE-010, REQ-ANC-006, REQ-ANC-007, REQ-CRS-003, REQ-EPIC-021.
...
- `test_anchor_coverage_conditioning_diversity_marginal_gain_and_stop_rule`
- `test_anchor_uncertainty_robust_weighting_conflict_quarantine_and_split`
- `test_units_precision_tolerance_and_no_premature_rounding`
- `geo_regression_corpus_and_strong_geometric_verifier`
...
Leia `AGENTS.md`, o papel `.codex/roles/ROLE-007-geoprocessamento.md`, esta história e `TASK-0729`. Trabalhe somente nos paths permitidos, entregue apenas este slice e interrompa diante de qualquer condição de parada.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0839-01, AC-ISSUE-0839-02, AC-ISSUE-0839-03, AC-ISSUE-0839-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-030`, `ADR-038`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-049`, `ADR-051`, `ADR-052`, `ADR-053`, `ADR-055`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-023`, `ADR-030`, `ADR-038`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-044`, `ADR-045`, `ADR-046`, `ADR-048`, `ADR-049`, `ADR-050`, `ADR-051`, `ADR-052`, `ADR-053`, `ADR-055`
