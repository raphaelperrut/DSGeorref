# STORY-0658 / ISSUE-0768 — Validar segurança, recuperação e concorrência: Registry de schemas e compatibilidade de artifacts
...
- **TaskEnvelope:** `.codex/tasks/TASK-0658.json`

## História de usuário

Como operador geoespacial, preciso validar segurança, recuperação e concorrência para “Registry de schemas e compatibilidade de artifacts”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Validar segurança, recuperação e concorrência para a capacidade **Registry de schemas e compatibilidade de artifacts**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/artifact_provenance/adapters/security/registry-de-schemas-e-compatibilidade-de-artifacts/**`
- `tests/security/contexts/artifact_provenance/registry-de-schemas-e-compatibilidade-de-artifacts/**`
## Fora de escopo
...
`STORY-0655`, `STORY-0656`, `STORY-0657`
...
- [ ] Os requisitos REQ-UPG-005 possuem evidência explícita no commit candidato.
...
- `test_phased_rollout_limited_mixed_version_window_drain_and_long_job_pinning`
- `test_epic_105_resiliencia`
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0768-01, AC-ISSUE-0768-02, AC-ISSUE-0768-03, AC-ISSUE-0768-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-030`, `ADR-031`, `ADR-032`, `ADR-035`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-030`, `ADR-031`, `ADR-032`, `ADR-035`
