# STORY-0069 / ISSUE-0179 — Consolidar slices e liberar integração: modelo de job e máquina de estados no PostgreSQL
...
- **TaskEnvelope:** `.codex/tasks/TASK-0069.json`

## História de usuário

Como operador geoespacial, preciso implementar modelo e application services para “modelo de job e máquina de estados no PostgreSQL”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.
...
- `src/backend/dsgeorref/contexts/job_orchestration/application/modelo-de-job-e-maquina-de-estados-no-postgresql/consolidacao/**`
- `src/backend/dsgeorref/contexts/job_orchestration/adapters/modelo-de-job-e-maquina-de-estados-no-postgresql/consolidacao/**`
## Fora de escopo
...
- `test_story_0069_slice_consolidation`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-014` e o TaskEnvelope `TASK-0069`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0179-01, AC-ISSUE-0179-02, AC-ISSUE-0179-03, AC-ISSUE-0179-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-016`, `ADR-018`, `ADR-019`, `ADR-020`, `ADR-023`
