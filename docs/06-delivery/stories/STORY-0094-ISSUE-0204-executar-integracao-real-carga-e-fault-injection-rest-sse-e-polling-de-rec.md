# STORY-0094 / ISSUE-0204 — Executar integração real, carga e fault injection: REST, SSE e polling de reconciliação com contratos versionados
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0094.json`

## História de usuário

Como operador geoespacial, preciso executar integração real, carga e fault injection para “REST, SSE e polling de reconciliação com contratos versionados”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar integração real, carga e fault injection para a capacidade **REST, SSE e polling de reconciliação com contratos versionados**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/job/rest-sse-e-polling-de-reconciliacao-com-contratos-vers/**`
- `tools/quality/contexts/job_orchestration/rest-sse-e-polling-de-reconciliacao-com-contratos-vers/**`
- `.github/workflows/rest-sse-e-polling-de-reconciliacao-com-contratos-vers.yaml`
## Fora de escopo
...
`STORY-0090`, `STORY-0091`, `STORY-0092`, `STORY-0093`
...
- `test_epic_017_validacao_happy_path`
- `test_epic_017_validacao_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-017` e o TaskEnvelope `TASK-0094`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0204-01, AC-ISSUE-0204-02, AC-ISSUE-0204-03, AC-ISSUE-0204-04`
