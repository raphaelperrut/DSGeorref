# STORY-0487 / ISSUE-0597 — Modelar ameaças e requisitos de controle: contrato de secrets, setup, permissões, rotação, recuperação e adapters opcionais de vault
...
- **TaskEnvelope:** `.codex/tasks/TASK-0487.json`

## História de usuário

Como administrador de segurança, preciso modelar ameaças e requisitos de controle para “contrato de secrets, setup, permissões, rotação, recuperação e adapters opcionais de vault”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Modelar ameaças e requisitos de controle para a capacidade **contrato de secrets, setup, permissões, rotação, recuperação e adapters opcionais de vault**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/operations_audit/adapters/security/contrato-de-secrets-setup-permissoes-rotacao-recuperac/**`
- `tests/security/contexts/operations_audit/contrato-de-secrets-setup-permissoes-rotacao-recuperac/**`
## Fora de escopo
...
- [ ] Os requisitos REQ-EPIC-076 possuem evidência explícita no commit candidato.
...
- `test_secret_permissions_rotation_redaction_fail_closed`
- `test_epic_078_ameacas`
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0597-01, AC-ISSUE-0597-02, AC-ISSUE-0597-03, AC-ISSUE-0597-04`
