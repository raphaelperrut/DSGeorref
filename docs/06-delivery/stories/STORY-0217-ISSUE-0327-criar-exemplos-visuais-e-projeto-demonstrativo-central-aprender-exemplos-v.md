# STORY-0217 / ISSUE-0327 — Criar exemplos visuais e projeto demonstrativo: central Aprender, exemplos visuais, projeto demonstrativo e ajuda contextual, incluindo Strong Geometric Verifier e interpretação de falhas
...
- **TaskEnvelope:** `.codex/tasks/TASK-0217.json`

## História de usuário

Como novo operador, preciso criar exemplos visuais e projeto demonstrativo para “central Aprender, exemplos visuais, projeto demonstrativo e ajuda contextual, incluindo Strong Geometric Verifier e interpretação de falhas”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Criar exemplos visuais e projeto demonstrativo para a capacidade **central Aprender, exemplos visuais, projeto demonstrativo e ajuda contextual, incluindo Strong Geometric Verifier e interpretação de falhas**, com saída versionada, testes e evidência no commit candidato.
...
- [ ] Exemplos possuem dados licenciados, expected results e instruções reproduzíveis.

## Testes obrigatórios

- `test_epic_036_exemplos`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-005-frontend.md`, este documento, o épico `EPIC-036` e o TaskEnvelope `TASK-0217`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0327-01, AC-ISSUE-0327-02, AC-ISSUE-0327-03, AC-ISSUE-0327-04`
