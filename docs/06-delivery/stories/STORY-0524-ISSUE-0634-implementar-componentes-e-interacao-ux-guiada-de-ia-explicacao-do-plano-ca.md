# STORY-0524 / ISSUE-0634 — Implementar componentes e interação: UX guiada de IA, explicação do plano, capacidades instaladas/bloqueadas e laboratório separado
...
- **TaskEnvelope:** `.codex/tasks/TASK-0524.json`

## História de usuário

Como operador geoespacial, preciso implementar componentes e interação para “UX guiada de IA, explicação do plano, capacidades instaladas/bloqueadas e laboratório separado”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar componentes e interação para a capacidade **UX guiada de IA, explicação do plano, capacidades instaladas/bloqueadas e laboratório separado**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/frontend/src/contexts/operator_experience/features/ux-guiada-de-ia-explicacao-do-plano-capacidades-instal/**`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-005-frontend.md`, este documento, o épico `EPIC-084` e o TaskEnvelope `TASK-0524`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0634-01, AC-ISSUE-0634-02, AC-ISSUE-0634-03, AC-ISSUE-0634-04`
