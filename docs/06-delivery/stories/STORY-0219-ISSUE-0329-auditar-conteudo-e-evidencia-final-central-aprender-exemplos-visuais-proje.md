# STORY-0219 / ISSUE-0329 — Auditar conteúdo e evidência final: central Aprender, exemplos visuais, projeto demonstrativo e ajuda contextual, incluindo Strong Geometric Verifier e interpretação de falhas
...
- **TaskEnvelope:** `.codex/tasks/TASK-0219.json`

## História de usuário

Como novo operador, preciso auditar conteúdo e evidência final para “central Aprender, exemplos visuais, projeto demonstrativo e ajuda contextual, incluindo Strong Geometric Verifier e interpretação de falhas”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar conteúdo e evidência final para a capacidade **central Aprender, exemplos visuais, projeto demonstrativo e ajuda contextual, incluindo Strong Geometric Verifier e interpretação de falhas**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/central-aprender-exemplos-visuais-projeto-demonstrativ/**`
## Fora de escopo
...
- `test_epic_036_aceite_happy_path`
- `test_epic_036_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-036` e o TaskEnvelope `TASK-0219`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0329-01, AC-ISSUE-0329-02, AC-ISSUE-0329-03, AC-ISSUE-0329-04`
