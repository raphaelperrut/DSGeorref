# STORY-0616 / ISSUE-0726 — Produzir métricas, diagnóstico e lineage: Ancoragem e recuperação a partir do mosaico relativo
...
- **TaskEnvelope:** `.codex/tasks/TASK-0616.json`

## História de usuário

Como operador geoespacial, preciso produzir métricas, diagnóstico e lineage para “Ancoragem e recuperação a partir do mosaico relativo”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Produzir métricas, diagnóstico e lineage para a capacidade **Ancoragem e recuperação a partir do mosaico relativo**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-099` e o TaskEnvelope `TASK-0616`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0726-01, AC-ISSUE-0726-02, AC-ISSUE-0726-03, AC-ISSUE-0726-04`
