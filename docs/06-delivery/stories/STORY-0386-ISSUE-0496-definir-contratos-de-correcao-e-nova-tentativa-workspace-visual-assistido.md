# STORY-0386 / ISSUE-0496 — Definir contratos de correção e nova tentativa: workspace visual assistido, CorrectionSets, nova tentativa, comparação e auditoria sem bloquear o ciclo automático
...
- **TaskEnvelope:** `.codex/tasks/TASK-0386.json`

## História de usuário

Como revisor geoespacial, preciso definir contratos de correção e nova tentativa para “workspace visual assistido, CorrectionSets, nova tentativa, comparação e auditoria sem bloquear o ciclo automático”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir contratos de correção e nova tentativa para a capacidade **workspace visual assistido, CorrectionSets, nova tentativa, comparação e auditoria sem bloquear o ciclo automático**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/review_correction/rev/workspace-visual-assistido-correctionsets-nova-tentati/**`
- `docs/02-architecture/design-reviews/workspace-visual-assistido-correctionsets-nova-tentati/**`
## Fora de escopo
...
- [ ] Os requisitos REQ-REV-003 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-062` e o TaskEnvelope `TASK-0386`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0496-01, AC-ISSUE-0496-02, AC-ISSUE-0496-03, AC-ISSUE-0496-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-048`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-014`, `ADR-016`, `ADR-048`
