# STORY-0490 / ISSUE-0600 — Executar testes negativos e ofensivos: contrato de secrets, setup, permissões, rotação, recuperação e adapters opcionais de vault
...
- **TaskEnvelope:** `.codex/tasks/TASK-0490.json`

## História de usuário

Como administrador de segurança, preciso executar testes negativos e ofensivos para “contrato de secrets, setup, permissões, rotação, recuperação e adapters opcionais de vault”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar testes negativos e ofensivos para a capacidade **contrato de secrets, setup, permissões, rotação, recuperação e adapters opcionais de vault**, com saída versionada, testes e evidência no commit candidato.
...
- `test_epic_078_ofensivo_happy_path`
- `test_epic_078_ofensivo_negative_paths`
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0600-01, AC-ISSUE-0600-02, AC-ISSUE-0600-03, AC-ISSUE-0600-04`
