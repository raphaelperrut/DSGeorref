# STORY-0492 / ISSUE-0602 — Auditar evidência de segurança final: contrato de secrets, setup, permissões, rotação, recuperação e adapters opcionais de vault
...
- **TaskEnvelope:** `.codex/tasks/TASK-0492.json`

## História de usuário

Como administrador de segurança, preciso auditar evidência de segurança final para “contrato de secrets, setup, permissões, rotação, recuperação e adapters opcionais de vault”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar evidência de segurança final para a capacidade **contrato de secrets, setup, permissões, rotação, recuperação e adapters opcionais de vault**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/contrato-de-secrets-setup-permissoes-rotacao-recuperac/**`
## Fora de escopo
...
- `test_epic_078_aceite_happy_path`
- `test_epic_078_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-078` e o TaskEnvelope `TASK-0492`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0602-01, AC-ISSUE-0602-02, AC-ISSUE-0602-03, AC-ISSUE-0602-04`
