# STORY-0437 / ISSUE-0547 — Executar integração real, carga e fault injection: Observabilidade, SLOs e diagnóstico do scheduler
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0437.json`

## História de usuário

Como operador geoespacial, preciso executar integração real, carga e fault injection para “Observabilidade, SLOs e diagnóstico do scheduler”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar integração real, carga e fault injection para a capacidade **Observabilidade, SLOs e diagnóstico do scheduler**, com saída versionada, testes e evidência no commit candidato.
...
`STORY-0433`, `STORY-0434`, `STORY-0435`, `STORY-0436`
...
- `test_epic_069_validacao_happy_path`
- `test_epic_069_validacao_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-069` e o TaskEnvelope `TASK-0437`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0547-01, AC-ISSUE-0547-02, AC-ISSUE-0547-03, AC-ISSUE-0547-04`
