# STORY-0396 / ISSUE-0506 — Executar benchmark, negativos e regressão científica: modelo tipado/versionado de GCPs, lifecycle, proveniência e round-trip dos exports
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0396.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “modelo tipado/versionado de GCPs, lifecycle, proveniência e round-trip dos exports”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **modelo tipado/versionado de GCPs, lifecycle, proveniência e round-trip dos exports**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/modelo-tipado-versionado-de-gcps-lifecycle-provenienci/**`
- `tools/quality/contexts/review_correction/modelo-tipado-versionado-de-gcps-lifecycle-provenienci/**`
- `.github/workflows/modelo-tipado-versionado-de-gcps-lifecycle-provenienci.yaml`
## Fora de escopo
...
`STORY-0392`, `STORY-0393`, `STORY-0394`, `STORY-0395`
...
- `test_epic_063_benchmark_happy_path`
- `test_epic_063_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-063` e o TaskEnvelope `TASK-0396`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0506-01, AC-ISSUE-0506-02, AC-ISSUE-0506-03, AC-ISSUE-0506-04`
