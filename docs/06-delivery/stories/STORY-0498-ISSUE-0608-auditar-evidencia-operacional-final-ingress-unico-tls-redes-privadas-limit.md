# STORY-0498 / ISSUE-0608 — Auditar evidência operacional final: ingress único, TLS, redes privadas, limites e testes de exposição de portas
...
- **TaskEnvelope:** `.codex/tasks/TASK-0498.json`

## História de usuário

Como administrador da instância, preciso auditar evidência operacional final para “ingress único, TLS, redes privadas, limites e testes de exposição de portas”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar evidência operacional final para a capacidade **ingress único, TLS, redes privadas, limites e testes de exposição de portas**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/ingress-unico-tls-redes-privadas-limites-e-testes-de-e/**`
## Fora de escopo
...
- `test_epic_079_aceite_happy_path`
- `test_epic_079_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-079` e o TaskEnvelope `TASK-0498`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0608-01, AC-ISSUE-0608-02, AC-ISSUE-0608-03, AC-ISSUE-0608-04`
