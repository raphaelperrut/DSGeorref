# STORY-0198 / ISSUE-0308 — Integrar contratos e cliente tipado: assistente guiado, recomendação explicável, consentimentos e modo avançado
...
- **TaskEnvelope:** `.codex/tasks/TASK-0198.json`

## História de usuário

Como operador geoespacial, preciso integrar contratos e cliente tipado para “assistente guiado, recomendação explicável, consentimentos e modo avançado”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Integrar contratos e cliente tipado para a capacidade **assistente guiado, recomendação explicável, consentimentos e modo avançado**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/frontend/src/contexts/operator_experience/features/assistente-guiado-recomendacao-explicavel-consentiment/**`
## Fora de escopo
...
- [ ] Os requisitos REQ-SRC-004, REQ-UX-002 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-005-frontend.md`, este documento, o épico `EPIC-033` e o TaskEnvelope `TASK-0198`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0308-01, AC-ISSUE-0308-02, AC-ISSUE-0308-03, AC-ISSUE-0308-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-014`, `ADR-047`
- **Conflito:** `Nenhum`
