# STORY-0301 / ISSUE-0411 — Executar QA e auditoria final: lineage normalizado, manifestos e bundle de reprodução sob demanda
...
- **TaskEnvelope:** `.codex/tasks/TASK-0301.json`

## História de usuário

Como operador geoespacial, preciso executar qa e auditoria final para “lineage normalizado, manifestos e bundle de reprodução sob demanda”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar QA e auditoria final para a capacidade **lineage normalizado, manifestos e bundle de reprodução sob demanda**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/lineage-normalizado-manifestos-e-bundle-de-reproducao/**`
## Fora de escopo
...
- `test_epic_049_aceite_happy_path`
- `test_epic_049_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-049` e o TaskEnvelope `TASK-0301`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0411-01, AC-ISSUE-0411-02, AC-ISSUE-0411-03, AC-ISSUE-0411-04`
