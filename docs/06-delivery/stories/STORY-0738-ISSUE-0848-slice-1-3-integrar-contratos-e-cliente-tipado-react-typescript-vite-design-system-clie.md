# STORY-0738 / ISSUE-0848 — Slice 1/3 — Integrar contratos e cliente tipado: React/TypeScript/Vite, design system, cliente OpenAPI, seletor visual, acessibilidade e E2E [REQ-EPIC, REQ-FS1, REQ-RUN]
...
- **TaskEnvelope:** `.codex/tasks/TASK-0738.json`
...
- `src/frontend/src/contexts/operator_experience/features/react-typescript-vite-design-system-cliente-openapi-se/requirements-epic-fs1-run-parte-1/**`
## Fora de escopo
...
`REQ-EPIC-031`, `REQ-FS1-001`, `REQ-FS1-002`, `REQ-FS1-003`, `REQ-FS1-004`, `REQ-FS1-006`, `REQ-FS1-008`, `REQ-FS1-009`, `REQ-FS1-010`, `REQ-RUN-001`
...
- [ ] Cada requisito do slice possui evidência explícita: REQ-EPIC-031, REQ-FS1-001, REQ-FS1-002, REQ-FS1-003, REQ-FS1-004, REQ-FS1-006, REQ-FS1-008, REQ-FS1-009, REQ-FS1-010, REQ-RUN-001.
...
Leia `AGENTS.md`, o papel `.codex/roles/ROLE-005-frontend.md`, esta história e `TASK-0738`. Trabalhe somente nos paths permitidos, entregue apenas este slice e interrompa diante de qualquer condição de parada.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0848-01, AC-ISSUE-0848-02, AC-ISSUE-0848-03, AC-ISSUE-0848-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-013`, `ADR-014`, `ADR-015`, `ADR-023`, `ADR-040`, `ADR-044`, `ADR-045`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-013`, `ADR-014`, `ADR-015`, `ADR-023`, `ADR-040`, `ADR-044`, `ADR-045`, `ADR-055`
