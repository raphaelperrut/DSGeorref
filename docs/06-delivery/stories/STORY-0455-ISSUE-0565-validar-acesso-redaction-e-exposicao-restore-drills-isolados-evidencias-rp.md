# STORY-0455 / ISSUE-0565 — Validar acesso, redaction e exposição: restore drills isolados, evidências, RPO/RTO e runbook executável
...
- **TaskEnvelope:** `.codex/tasks/TASK-0455.json`

## História de usuário

Como administrador da instância, preciso validar acesso, redaction e exposição para “restore drills isolados, evidências, RPO/RTO e runbook executável”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Validar acesso, redaction e exposição para a capacidade **restore drills isolados, evidências, RPO/RTO e runbook executável**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/operations_audit/adapters/security/restore-drills-isolados-evidencias-rpo-rto-e-runbook-e/**`
- `tests/security/contexts/operations_audit/restore-drills-isolados-evidencias-rpo-rto-e-runbook-e/**`
## Fora de escopo
...
`STORY-0452`, `STORY-0453`, `STORY-0454`
...
- `test_epic_072_seguranca_happy_path`
- `test_epic_072_seguranca_negative_paths`
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0565-01, AC-ISSUE-0565-02, AC-ISSUE-0565-03, AC-ISSUE-0565-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-025`, `ADR-027`, `ADR-030`, `ADR-031`, `ADR-032`
