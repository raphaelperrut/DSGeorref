# STORY-0416 / ISSUE-0526 — Executar integração real, carga e fault injection: checkpoints canônicos, manifests de compatibilidade, retomada e lifecycle de intermediários
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0416.json`

## História de usuário

Como operador geoespacial, preciso executar integração real, carga e fault injection para “checkpoints canônicos, manifests de compatibilidade, retomada e lifecycle de intermediários”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar integração real, carga e fault injection para a capacidade **checkpoints canônicos, manifests de compatibilidade, retomada e lifecycle de intermediários**, com saída versionada, testes e evidência no commit candidato.
...
`STORY-0412`, `STORY-0413`, `STORY-0414`, `STORY-0415`
...
- `test_epic_066_validacao_happy_path`
- `test_epic_066_validacao_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-066` e o TaskEnvelope `TASK-0416`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0526-01, AC-ISSUE-0526-02, AC-ISSUE-0526-03, AC-ISSUE-0526-04`
