# STORY-0589 / ISSUE-0699 — Executar benchmark, negativos e regressão científica: Validade raster explícita
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0589.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “Validade raster explícita”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **Validade raster explícita**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/validade-raster-explicita/**`
- `tools/quality/contexts/georeferencing/validade-raster-explicita/**`
- `.github/workflows/validade-raster-explicita.yaml`
## Fora de escopo
...
`STORY-0585`, `STORY-0586`, `STORY-0587`, `STORY-0588`

## Critérios de aceitação

- [ ] O resultado de “Validade raster explícita” é observável por contrato, interface, artifact ou evidência executável.
...
- `test_epic_095_benchmark_happy_path`
- `test_epic_095_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-095` e o TaskEnvelope `TASK-0589`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0699-01, AC-ISSUE-0699-02, AC-ISSUE-0699-03, AC-ISSUE-0699-04`
