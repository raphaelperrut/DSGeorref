# STORY-0253 / ISSUE-0363 — Executar sanitização e revisão de segurança: licença, citação, sanitização e revisão externa concluídas
...
- **TaskEnvelope:** `.codex/tasks/TASK-0253.json`

## História de usuário

Como mantenedor do projeto, preciso executar sanitização e revisão de segurança para “licença, citação, sanitização e revisão externa concluídas”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar sanitização e revisão de segurança para a capacidade **licença, citação, sanitização e revisão externa concluídas**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/release_installation/adapters/security/licenca-citacao-sanitizacao-e-revisao-externa-concluid/**`
- `tests/security/contexts/release_installation/licenca-citacao-sanitizacao-e-revisao-externa-concluid/**`
## Fora de escopo
...
- [ ] Sanitização e revisão independente não encontram secrets, dados privados ou direitos ambíguos.

## Testes obrigatórios

- `test_epic_042_assurance_happy_path`
- `test_epic_042_assurance_negative_paths`
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0363-01, AC-ISSUE-0363-02, AC-ISSUE-0363-03, AC-ISSUE-0363-04`
