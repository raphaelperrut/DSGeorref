# STORY-0078 / ISSUE-0188 — Expor comandos, progresso e reconciliação: runner direto e Celery/RabbitMQ sobre o mesmo núcleo
...
- **TaskEnvelope:** `.codex/tasks/TASK-0078.json`

## História de usuário

Como operador geoespacial, preciso expor comandos, progresso e reconciliação para “runner direto e Celery/RabbitMQ sobre o mesmo núcleo”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Expor comandos, progresso e reconciliação para a capacidade **runner direto e Celery/RabbitMQ sobre o mesmo núcleo**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-015` e o TaskEnvelope `TASK-0078`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0188-01, AC-ISSUE-0188-02, AC-ISSUE-0188-03, AC-ISSUE-0188-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-014`, `ADR-016`, `ADR-018`, `ADR-019`
