# STORY-0592 / ISSUE-0702 — Preparar corpus, fixtures e representação tipada: Seletor e validador de CRS
...
- **TaskEnvelope:** `.codex/tasks/TASK-0592.json`

## História de usuário

Como operador geoespacial, preciso preparar corpus, fixtures e representação tipada para “Seletor e validador de CRS”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Preparar corpus, fixtures e representação tipada para a capacidade **Seletor e validador de CRS**, com saída versionada, testes e evidência no commit candidato.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0702-01, AC-ISSUE-0702-02, AC-ISSUE-0702-03, AC-ISSUE-0702-04`
