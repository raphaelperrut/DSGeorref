# STORY-0013 / ISSUE-0123 — Automatizar validações e controles: monorepo greenfield com CLI/API/Web mínimos e checks reproduzíveis
...
- **TaskEnvelope:** `.codex/tasks/TASK-0013.json`

## História de usuário

Como mantenedor de engenharia, preciso automatizar validações e controles para “monorepo greenfield com CLI/API/Web mínimos e checks reproduzíveis”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Automatizar validações e controles para a capacidade **monorepo greenfield com CLI/API/Web mínimos e checks reproduzíveis**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/fnd/monorepo-greenfield-com-cli-api-web-minimos-e-checks-r/**`
- `tools/quality/contexts/engineering_governance/monorepo-greenfield-com-cli-api-web-minimos-e-checks-r/**`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-003` e o TaskEnvelope `TASK-0013`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0123-01, AC-ISSUE-0123-02, AC-ISSUE-0123-03, AC-ISSUE-0123-04`
...
- **Resultado:** `PASS`
- **Risk tier:** `CRITICAL`
- **Controles aplicáveis:** `CTO-002, CTO-003, CTO-004, CTO-006, CTO-011, CTO-012, CTO-013, CTO-015`
