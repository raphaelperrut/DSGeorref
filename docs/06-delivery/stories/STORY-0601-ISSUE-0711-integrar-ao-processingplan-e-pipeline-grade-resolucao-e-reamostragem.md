# STORY-0601 / ISSUE-0711 — Integrar ao ProcessingPlan e pipeline: Grade, resolução e reamostragem
...
- **TaskEnvelope:** `.codex/tasks/TASK-0601.json`

## História de usuário

Como operador geoespacial, preciso integrar ao processingplan e pipeline para “Grade, resolução e reamostragem”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Integrar ao ProcessingPlan e pipeline para a capacidade **Grade, resolução e reamostragem**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-097` e o TaskEnvelope `TASK-0601`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0711-01, AC-ISSUE-0711-02, AC-ISSUE-0711-03, AC-ISSUE-0711-04`
