# STORY-0438 / ISSUE-0548 — Auditar evidência e integração final: Observabilidade, SLOs e diagnóstico do scheduler
...
- **TaskEnvelope:** `.codex/tasks/TASK-0438.json`

## História de usuário

Como operador geoespacial, preciso auditar evidência e integração final para “Observabilidade, SLOs e diagnóstico do scheduler”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar evidência e integração final para a capacidade **Observabilidade, SLOs e diagnóstico do scheduler**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/observabilidade-slos-e-diagnostico-do-scheduler/**`
## Fora de escopo
...
- `test_epic_069_aceite_happy_path`
- `test_epic_069_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-069` e o TaskEnvelope `TASK-0438`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0548-01, AC-ISSUE-0548-02, AC-ISSUE-0548-03, AC-ISSUE-0548-04`
