# STORY-0017 / ISSUE-0127 — Consolidar slices e liberar integração: OpenAPI, cliente TypeScript e contratos CLI/jobs/eventos/artefatos/ProcessingPlan/QualityReport/FailureDiagnostic versionados
...
- `tools/governance/openapi-cliente-typescript-e-contratos-cli-jobs-evento/consolidacao/**`
- `docs/03-engineering/contexts/engineering_governance/openapi-cliente-typescript-e-contratos-cli-jobs-evento/consolidacao/**`
## Fora de escopo
...
`STORY-0703`, `STORY-0704`, `STORY-0705`
...
- `test_story_0017_slice_consolidation`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-003-tech-lead.md`, este documento, o épico `EPIC-004` e o TaskEnvelope `TASK-0017`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0127-01, AC-ISSUE-0127-02, AC-ISSUE-0127-03, AC-ISSUE-0127-04`
