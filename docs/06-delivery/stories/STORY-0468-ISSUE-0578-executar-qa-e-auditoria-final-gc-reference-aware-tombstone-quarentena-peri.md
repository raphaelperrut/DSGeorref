# STORY-0468 / ISSUE-0578 — Executar QA e auditoria final: GC reference-aware, tombstone, quarentena, período de graça e reconciliação
...
- **TaskEnvelope:** `.codex/tasks/TASK-0468.json`

## História de usuário

Como operador geoespacial, preciso executar qa e auditoria final para “GC reference-aware, tombstone, quarentena, período de graça e reconciliação”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar QA e auditoria final para a capacidade **GC reference-aware, tombstone, quarentena, período de graça e reconciliação**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/gc-reference-aware-tombstone-quarentena-periodo-de-gra/**`
## Fora de escopo
...
- `test_epic_074_aceite_happy_path`
- `test_epic_074_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-074` e o TaskEnvelope `TASK-0468`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0578-01, AC-ISSUE-0578-02, AC-ISSUE-0578-03, AC-ISSUE-0578-04`
