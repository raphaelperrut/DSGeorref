# STORY-0042 / ISSUE-0152 — Consolidar slices e liberar integração: usuários e papéis da instância
...
- **TaskEnvelope:** `.codex/tasks/TASK-0042.json`

## História de usuário

Como administrador da instância, preciso implementar domínio e persistência para “usuários e papéis da instância”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.
...
- `src/backend/dsgeorref/contexts/identity_access/application/usuarios-e-papeis-da-instancia/consolidacao/**`
- `src/backend/dsgeorref/contexts/identity_access/adapters/usuarios-e-papeis-da-instancia/consolidacao/**`
## Fora de escopo
...
- `test_story_0042_slice_consolidation`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-009` e o TaskEnvelope `TASK-0042`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0152-01, AC-ISSUE-0152-02, AC-ISSUE-0152-03, AC-ISSUE-0152-04`
