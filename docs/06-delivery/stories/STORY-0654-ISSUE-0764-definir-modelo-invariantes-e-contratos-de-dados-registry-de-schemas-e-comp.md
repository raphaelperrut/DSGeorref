# STORY-0654 / ISSUE-0764 — Definir modelo, invariantes e contratos de dados: Registry de schemas e compatibilidade de artifacts
...
- **TaskEnvelope:** `.codex/tasks/TASK-0654.json`

## História de usuário

Como operador geoespacial, preciso definir modelo, invariantes e contratos de dados para “Registry de schemas e compatibilidade de artifacts”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir modelo, invariantes e contratos de dados para a capacidade **Registry de schemas e compatibilidade de artifacts**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/artifact_provenance/dat/registry-de-schemas-e-compatibilidade-de-artifacts/**`
- `docs/02-architecture/design-reviews/registry-de-schemas-e-compatibilidade-de-artifacts/**`
## Fora de escopo
...
- [ ] Os requisitos REQ-SCM-001, REQ-UPG-004 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-105` e o TaskEnvelope `TASK-0654`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0764-01, AC-ISSUE-0764-02, AC-ISSUE-0764-03, AC-ISSUE-0764-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-035`, `ADR-053`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-016`, `ADR-035`, `ADR-053`
