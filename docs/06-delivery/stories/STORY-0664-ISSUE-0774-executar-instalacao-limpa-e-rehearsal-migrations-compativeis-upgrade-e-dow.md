# STORY-0664 / ISSUE-0774 — Executar instalação limpa e rehearsal: Migrations compatíveis, upgrade e downgrade seguro
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0664.json`

## História de usuário

Como responsável por release, preciso executar instalação limpa e rehearsal para “Migrations compatíveis, upgrade e downgrade seguro”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar instalação limpa e rehearsal para a capacidade **Migrations compatíveis, upgrade e downgrade seguro**, com saída versionada, testes e evidência no commit candidato.
...
`STORY-0661`, `STORY-0662`, `STORY-0663`
...
- `test_epic_106_ensaio_happy_path`
- `test_epic_106_ensaio_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-106` e o TaskEnvelope `TASK-0664`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0774-01, AC-ISSUE-0774-02, AC-ISSUE-0774-03, AC-ISSUE-0774-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-026`
