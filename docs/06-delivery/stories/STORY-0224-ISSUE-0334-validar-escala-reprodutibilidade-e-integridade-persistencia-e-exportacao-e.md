# STORY-0224 / ISSUE-0334 — Validar escala, reprodutibilidade e integridade: persistência e exportação escalável de resultados por imagem/lote, geometrias, manifestos e checksums
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0224.json`

## História de usuário

Como revisor e auditor, preciso validar escala, reprodutibilidade e integridade para “persistência e exportação escalável de resultados por imagem/lote, geometrias, manifestos e checksums”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Validar escala, reprodutibilidade e integridade para a capacidade **persistência e exportação escalável de resultados por imagem/lote, geometrias, manifestos e checksums**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/rep/persistencia-e-exportacao-escalavel-de-resultados-por/**`
- `tools/quality/contexts/results_reporting/persistencia-e-exportacao-escalavel-de-resultados-por/**`
- `.github/workflows/persistencia-e-exportacao-escalavel-de-resultados-por.yaml`
## Fora de escopo
...
`STORY-0221`, `STORY-0222`, `STORY-0223`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-037` e o TaskEnvelope `TASK-0224`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0334-01, AC-ISSUE-0334-02, AC-ISSUE-0334-03, AC-ISSUE-0334-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-025`
