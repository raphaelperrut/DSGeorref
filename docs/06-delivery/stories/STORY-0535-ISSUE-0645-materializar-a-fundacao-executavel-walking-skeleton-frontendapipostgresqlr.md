# STORY-0535 / ISSUE-0645 — Consolidar slices e liberar integração: walking skeleton frontend→API→PostgreSQL→RabbitMQ/Celery→worker→artefato diagnóstico, executável e testado ponta a ponta
...
- **TaskEnvelope:** `.codex/tasks/TASK-0535.json`

## História de usuário

Como mantenedor de engenharia, preciso materializar a fundação executável para “walking skeleton frontend→API→PostgreSQL→RabbitMQ/Celery→worker→artefato diagnóstico, executável e testado ponta a ponta”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.
...
- `tools/governance/walking-skeleton-frontendapipostgresqlrabbitmq-celeryw/consolidacao/**`
- `docs/03-engineering/contexts/engineering_governance/walking-skeleton-frontendapipostgresqlrabbitmq-celeryw/consolidacao/**`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-003-tech-lead.md`, este documento, o épico `EPIC-086` e o TaskEnvelope `TASK-0535`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0645-01, AC-ISSUE-0645-02, AC-ISSUE-0645-03, AC-ISSUE-0645-04`
