# STORY-0570 / ISSUE-0680 — Definir contrato científico e invariantes: contratos de CRS, espaços de coordenadas, ordem de eixos, precisão/unidades e validade raster
...
- **TaskEnvelope:** `.codex/tasks/TASK-0570.json`

## História de usuário

Como operador geoespacial, preciso definir contrato científico e invariantes para “contratos de CRS, espaços de coordenadas, ordem de eixos, precisão/unidades e validade raster”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir contrato científico e invariantes para a capacidade **contratos de CRS, espaços de coordenadas, ordem de eixos, precisão/unidades e validade raster**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/georeferencing/geo/contratos-de-crs-espacos-de-coordenadas-ordem-de-eixos/**`
- `docs/02-architecture/design-reviews/contratos-de-crs-espacos-de-coordenadas-ordem-de-eixos/**`
## Fora de escopo
...
`REQ-CRS-001`, `REQ-CRS-002`, `REQ-CRS-004`
...
`STORY-0569`, `STORY-0267`, `STORY-0288`, `STORY-0397`
...
- [ ] Os requisitos REQ-CRS-001, REQ-CRS-002, REQ-CRS-004 possuem evidência explícita no commit candidato.
...
- `test_pixel_reference_target_discovery_coordinate_roundtrip`
- `test_explicit_axis_order_and_adapter_normalization`
- `test_aoi_aware_working_crs_selection_distortion_and_explanation`
- `test_epic_093_contrato`
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0680-01, AC-ISSUE-0680-02, AC-ISSUE-0680-03, AC-ISSUE-0680-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-041`
- **Conflito:** `Nenhum`
