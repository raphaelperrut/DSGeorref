# STORY-0550 / ISSUE-0660 — Implementar pipeline e artifacts de release: release train internal/alpha/beta/1.0, automação de evidências e gate de abertura pública
...
- **TaskEnvelope:** `.codex/tasks/TASK-0550.json`

## História de usuário

Como responsável por release, preciso implementar pipeline e artifacts de release para “release train internal/alpha/beta/1.0, automação de evidências e gate de abertura pública”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar pipeline e artifacts de release para a capacidade **release train internal/alpha/beta/1.0, automação de evidências e gate de abertura pública**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/rel/contexts/release_installation/release-train-internal-alpha-beta-1-0-automacao-de-evi/**`
- `tools/quality/contexts/release_installation/release-train-internal-alpha-beta-1-0-automacao-de-evi/**`
- `.github/workflows/release-train-internal-alpha-beta-1-0-automacao-de-evi.yaml`
## Fora de escopo
...
- [ ] O resultado de “release train internal/alpha/beta/1.0, automação de evidências e gate de abertura pública” é observável por contrato, interface, artifact ou evidência executável.
- [ ] Os requisitos REQ-EPIC-043, REQ-PUB-004 possuem evidência explícita no commit candidato.
...
- `test_release_train_visibility_license_sanitization_and_beta_gate`
- `test_citation_cff_codemeta_authors_notices_release_digest_and_doi_consistency`
- `test_epic_089_automacao`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-089` e o TaskEnvelope `TASK-0550`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0660-01, AC-ISSUE-0660-02, AC-ISSUE-0660-03, AC-ISSUE-0660-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-033`, `ADR-034`, `ADR-037`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-033`, `ADR-034`, `ADR-037`
...
- **Resultado:** `PASS`
- **Risk tier:** `CRITICAL`
- **Controles aplicáveis:** `CTO-001, CTO-002, CTO-003, CTO-004, CTO-005, CTO-006, CTO-008, CTO-009, CTO-010, CTO-012, CTO-013, CTO-015`
