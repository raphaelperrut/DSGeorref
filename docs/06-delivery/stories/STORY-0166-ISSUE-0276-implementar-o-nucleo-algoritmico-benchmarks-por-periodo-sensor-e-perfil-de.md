# STORY-0166 / ISSUE-0276 — Implementar o núcleo algorítmico: benchmarks por período, sensor e perfil de qualidade
...
- **TaskEnvelope:** `.codex/tasks/TASK-0166.json`

## História de usuário

Como operador geoespacial, preciso implementar o núcleo algorítmico para “benchmarks por período, sensor e perfil de qualidade”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar o núcleo algorítmico para a capacidade **benchmarks por período, sensor e perfil de qualidade**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/geo/dsgeorref_geo/contexts/geometric_quality/benchmarks-por-periodo-sensor-e-perfil-de-qualidade/**`
## Fora de escopo
...
`REQ-CLASSICPROFILE-006`, `REQ-CLASSICPROFILE-010`
...
- [ ] Os requisitos REQ-CLASSICPROFILE-006, REQ-CLASSICPROFILE-010 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-028` e o TaskEnvelope `TASK-0166`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0276-01, AC-ISSUE-0276-02, AC-ISSUE-0276-03, AC-ISSUE-0276-04`
