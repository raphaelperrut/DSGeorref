# STORY-0715 / ISSUE-0825 — Slice 2/2 — Implementar domínio e persistência: usuários e papéis da instância [REQ-ID]
...
- **TaskEnvelope:** `.codex/tasks/TASK-0715.json`
...
- `src/backend/dsgeorref/contexts/identity_access/application/usuarios-e-papeis-da-instancia/id-parte-2/**`
- `src/backend/dsgeorref/contexts/identity_access/adapters/usuarios-e-papeis-da-instancia/id-parte-2/**`
## Fora de escopo
...
- [ ] Cada requisito do slice possui evidência explícita: REQ-ID-002.
...
Leia `AGENTS.md`, o papel `.codex/roles/ROLE-004-backend.md`, esta história e `TASK-0715`. Trabalhe somente nos paths permitidos, entregue apenas este slice e interrompa diante de qualquer condição de parada.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0825-01, AC-ISSUE-0825-02, AC-ISSUE-0825-03, AC-ISSUE-0825-04`
