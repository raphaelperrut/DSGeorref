# STORY-0607 / ISSUE-0717 — Implementar o núcleo algorítmico: Mosaico relativo de recuperação
...
- **TaskEnvelope:** `.codex/tasks/TASK-0607.json`

## História de usuário

Como operador geoespacial, preciso implementar o núcleo algorítmico para “Mosaico relativo de recuperação”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar o núcleo algorítmico para a capacidade **Mosaico relativo de recuperação**, com saída versionada, testes e evidência no commit candidato.
...
`REQ-MOS-001`, `REQ-MOS-003`, `REQ-RMQ-003`
...
- [ ] Os requisitos REQ-MOS-001, REQ-MOS-003, REQ-RMQ-003 possuem evidência explícita no commit candidato.
...
- `test_relative_mosaic_is_optional_post_batch_and_non_blocking`
- `test_global_relative_alignment_cycle_drift_foldover_and_weak_bridge_split`
- `test_virtual_canonical_preview_and_on_demand_tiled_materialization`
- `test_epic_098_algoritmo`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-098` e o TaskEnvelope `TASK-0607`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0717-01, AC-ISSUE-0717-02, AC-ISSUE-0717-03, AC-ISSUE-0717-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-036`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-049`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-036`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-044`, `ADR-049`, `ADR-050`
