# STORY-0115 / ISSUE-0225 — Definir contrato científico e invariantes: corpus versionado com décadas e condições distintas
...
- **TaskEnvelope:** `.codex/tasks/TASK-0115.json`

## História de usuário

Como operador geoespacial, preciso definir contrato científico e invariantes para “corpus versionado com décadas e condições distintas”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir contrato científico e invariantes para a capacidade **corpus versionado com décadas e condições distintas**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/geometric_quality/geo/corpus-versionado-com-decadas-e-condicoes-distintas/**`
- `docs/02-architecture/design-reviews/corpus-versionado-com-decadas-e-condicoes-distintas/**`
## Fora de escopo
...
`REQ-DBSCHEMA-005`, `REQ-FS1-001`, `REQ-FS1-004`, `REQ-NATIVE-002`
...
- [ ] Os requisitos REQ-DBSCHEMA-005, REQ-FS1-001, REQ-FS1-004, REQ-NATIVE-002 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-021` e o TaskEnvelope `TASK-0115`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0225-01, AC-ISSUE-0225-02, AC-ISSUE-0225-03, AC-ISSUE-0225-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-041`, `ADR-044`
- **Conflito:** `Nenhum`
