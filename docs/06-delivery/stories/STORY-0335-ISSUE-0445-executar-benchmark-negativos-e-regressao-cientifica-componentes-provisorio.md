# STORY-0335 / ISSUE-0445 — Executar benchmark, negativos e regressão científica: componentes provisórios multimodais, scores versionados, preview e correção sem equivalência com prova geométrica
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0335.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “componentes provisórios multimodais, scores versionados, preview e correção sem equivalência com prova geométrica”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **componentes provisórios multimodais, scores versionados, preview e correção sem equivalência com prova geométrica**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/componentes-provisorios-multimodais-scores-versionados/**`
- `tools/quality/contexts/reference_discovery/componentes-provisorios-multimodais-scores-versionados/**`
- `.github/workflows/componentes-provisorios-multimodais-scores-versionados.yaml`
## Fora de escopo
...
`STORY-0331`, `STORY-0332`, `STORY-0333`, `STORY-0334`
...
- `test_epic_054_benchmark_happy_path`
- `test_epic_054_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-054` e o TaskEnvelope `TASK-0335`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0445-01, AC-ISSUE-0445-02, AC-ISSUE-0445-03, AC-ISSUE-0445-04`
