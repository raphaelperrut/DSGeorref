# STORY-0477 / ISSUE-0587 — Implementar controles e enforcement: catálogo de campos, redaction centralizada, testes de vazamento e bundles de suporte sanitizados
...
- **TaskEnvelope:** `.codex/tasks/TASK-0477.json`

## História de usuário

Como administrador de segurança, preciso implementar controles e enforcement para “catálogo de campos, redaction centralizada, testes de vazamento e bundles de suporte sanitizados”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar controles e enforcement para a capacidade **catálogo de campos, redaction centralizada, testes de vazamento e bundles de suporte sanitizados**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/operations_audit/application/catalogo-de-campos-redaction-centralizada-testes-de-va/**`
- `src/backend/dsgeorref/contexts/operations_audit/adapters/catalogo-de-campos-redaction-centralizada-testes-de-va/**`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-076` e o TaskEnvelope `TASK-0477`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0587-01, AC-ISSUE-0587-02, AC-ISSUE-0587-03, AC-ISSUE-0587-04`
