# STORY-0731 / ISSUE-0841 — Slice 3/3 — Preparar corpus, fixtures e representação tipada: Strong Geometric Verifier fail-closed para homografia projetiva, QualityProfiles e Image Deformation Profile [REQ-RMV]
...
- **TaskEnvelope:** `.codex/tasks/TASK-0731.json`
...
- `src/geo/dsgeorref_geo/contexts/geometric_quality/strong-geometric-verifier-fail-closed-para-homografia/rmv-parte-3/**`
## Fora de escopo
...
- [ ] Cada requisito do slice possui evidência explícita: REQ-RMV-002.
...
Leia `AGENTS.md`, o papel `.codex/roles/ROLE-007-geoprocessamento.md`, esta história e `TASK-0731`. Trabalhe somente nos paths permitidos, entregue apenas este slice e interrompa diante de qualquer condição de parada.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0841-01, AC-ISSUE-0841-02, AC-ISSUE-0841-03, AC-ISSUE-0841-04`
