# STORY-0287 / ISSUE-0397 — Executar benchmark, negativos e regressão científica: matching coarse-to-fine, tiles, reconciliação de coordenadas e refinamento em resolução adequada
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0287.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “matching coarse-to-fine, tiles, reconciliação de coordenadas e refinamento em resolução adequada”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **matching coarse-to-fine, tiles, reconciliação de coordenadas e refinamento em resolução adequada**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/matching-coarse-to-fine-tiles-reconciliacao-de-coorden/**`
- `tools/quality/contexts/georeferencing/matching-coarse-to-fine-tiles-reconciliacao-de-coorden/**`
- `.github/workflows/matching-coarse-to-fine-tiles-reconciliacao-de-coorden.yaml`
## Fora de escopo
...
`STORY-0283`, `STORY-0284`, `STORY-0285`, `STORY-0286`

## Critérios de aceitação

- [ ] O resultado de “matching coarse-to-fine, tiles, reconciliação de coordenadas e refinamento em resolução adequada” é observável por contrato, interface, artifact ou evidência executável.
...
- `test_epic_047_benchmark_happy_path`
- `test_epic_047_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-047` e o TaskEnvelope `TASK-0287`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0397-01, AC-ISSUE-0397-02, AC-ISSUE-0397-03, AC-ISSUE-0397-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-044`
