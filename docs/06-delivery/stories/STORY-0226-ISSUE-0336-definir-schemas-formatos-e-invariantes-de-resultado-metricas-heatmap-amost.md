# STORY-0226 / ISSUE-0336 — Definir schemas, formatos e invariantes de resultado: métricas, heatmap amostrado e diagnóstico denso do Image Deformation Profile
...
- **TaskEnvelope:** `.codex/tasks/TASK-0226.json`

## História de usuário

Como revisor e auditor, preciso definir schemas, formatos e invariantes de resultado para “métricas, heatmap amostrado e diagnóstico denso do Image Deformation Profile”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir schemas, formatos e invariantes de resultado para a capacidade **métricas, heatmap amostrado e diagnóstico denso do Image Deformation Profile**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/geometric_quality/rep/metricas-heatmap-amostrado-e-diagnostico-denso-do-imag/**`
- `docs/02-architecture/design-reviews/metricas-heatmap-amostrado-e-diagnostico-denso-do-imag/**`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-038` e o TaskEnvelope `TASK-0226`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0336-01, AC-ISSUE-0336-02, AC-ISSUE-0336-03, AC-ISSUE-0336-04`
