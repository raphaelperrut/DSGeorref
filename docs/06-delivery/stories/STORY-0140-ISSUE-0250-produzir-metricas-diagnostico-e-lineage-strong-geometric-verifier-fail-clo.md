# STORY-0140 / ISSUE-0250 — Produzir métricas, diagnóstico e lineage: Strong Geometric Verifier fail-closed para homografia projetiva, QualityProfiles e Image Deformation Profile
...
- **TaskEnvelope:** `.codex/tasks/TASK-0140.json`

## História de usuário

Como operador geoespacial, preciso produzir métricas, diagnóstico e lineage para “Strong Geometric Verifier fail-closed para homografia projetiva, QualityProfiles e Image Deformation Profile”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Produzir métricas, diagnóstico e lineage para a capacidade **Strong Geometric Verifier fail-closed para homografia projetiva, QualityProfiles e Image Deformation Profile**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-024` e o TaskEnvelope `TASK-0140`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0250-01, AC-ISSUE-0250-02, AC-ISSUE-0250-03, AC-ISSUE-0250-04`
