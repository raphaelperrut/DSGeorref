# STORY-0295 / ISSUE-0405 — Auditar evidência científica e final: extração opcional de metadados marginais com confiança, revisão e lineage
...
- **TaskEnvelope:** `.codex/tasks/TASK-0295.json`

## História de usuário

Como operador geoespacial, preciso auditar evidência científica e final para “extração opcional de metadados marginais com confiança, revisão e lineage”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar evidência científica e final para a capacidade **extração opcional de metadados marginais com confiança, revisão e lineage**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/extracao-opcional-de-metadados-marginais-com-confianca/**`
## Fora de escopo
...
- `test_epic_048_aceite_happy_path`
- `test_epic_048_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-048` e o TaskEnvelope `TASK-0295`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0405-01, AC-ISSUE-0405-02, AC-ISSUE-0405-03, AC-ISSUE-0405-04`
