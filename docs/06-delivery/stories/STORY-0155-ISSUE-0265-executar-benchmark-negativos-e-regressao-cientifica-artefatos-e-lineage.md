# STORY-0155 / ISSUE-0265 — Executar benchmark, negativos e regressão científica: artefatos e lineage
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0155.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “artefatos e lineage”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **artefatos e lineage**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/artefatos-e-lineage/**`
- `tools/quality/contexts/artifact_provenance/artefatos-e-lineage/**`
- `.github/workflows/artefatos-e-lineage.yaml`
## Fora de escopo
...
`STORY-0151`, `STORY-0152`, `STORY-0153`, `STORY-0154`
...
- `test_epic_026_benchmark_happy_path`
- `test_epic_026_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-026` e o TaskEnvelope `TASK-0155`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0265-01, AC-ISSUE-0265-02, AC-ISSUE-0265-03, AC-ISSUE-0265-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-023`, `ADR-024`, `ADR-025`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-044`, `ADR-045`, `ADR-046`, `ADR-055`
