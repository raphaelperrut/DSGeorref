# STORY-0197 / ISSUE-0307 — Definir jornada, estados e acessibilidade: assistente guiado, recomendação explicável, consentimentos e modo avançado
...
- **TaskEnvelope:** `.codex/tasks/TASK-0197.json`

## História de usuário

Como operador geoespacial, preciso definir jornada, estados e acessibilidade para “assistente guiado, recomendação explicável, consentimentos e modo avançado”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir jornada, estados e acessibilidade para a capacidade **assistente guiado, recomendação explicável, consentimentos e modo avançado**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `docs/01-product/capabilities/assistente-guiado-recomendacao-explicavel-consentiment/**`
## Fora de escopo
...
`STORY-0177`, `STORY-0190`, `STORY-0371`
...
- [ ] Os requisitos REQ-AI-011 possuem evidência explícita no commit candidato.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0307-01, AC-ISSUE-0307-02, AC-ISSUE-0307-03, AC-ISSUE-0307-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-051`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-014`, `ADR-051`
