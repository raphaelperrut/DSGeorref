# STORY-0519 / ISSUE-0629 — Executar drills, fault injection e recuperação: modos offline/restricted/connected, egress enforcement, mirrors e testes air-gapped
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0519.json`

## História de usuário

Como administrador da instância, preciso executar drills, fault injection e recuperação para “modos offline/restricted/connected, egress enforcement, mirrors e testes air-gapped”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar drills, fault injection e recuperação para a capacidade **modos offline/restricted/connected, egress enforcement, mirrors e testes air-gapped**, com saída versionada, testes e evidência no commit candidato.
...
- `test_epic_083_falhas_happy_path`
- `test_epic_083_falhas_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-083` e o TaskEnvelope `TASK-0519`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0629-01, AC-ISSUE-0629-02, AC-ISSUE-0629-03, AC-ISSUE-0629-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`
