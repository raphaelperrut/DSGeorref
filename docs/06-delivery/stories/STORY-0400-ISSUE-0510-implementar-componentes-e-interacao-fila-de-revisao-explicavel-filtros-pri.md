# STORY-0400 / ISSUE-0510 — Implementar componentes e interação: fila de revisão explicável, filtros, priorização, impacto em descendentes e operações em lote permitidas
...
- **TaskEnvelope:** `.codex/tasks/TASK-0400.json`

## História de usuário

Como operador geoespacial, preciso implementar componentes e interação para “fila de revisão explicável, filtros, priorização, impacto em descendentes e operações em lote permitidas”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar componentes e interação para a capacidade **fila de revisão explicável, filtros, priorização, impacto em descendentes e operações em lote permitidas**, com saída versionada, testes e evidência no commit candidato.
...
- [ ] Componentes consomem cliente gerado e não acessam persistência ou broker diretamente.

## Testes obrigatórios

- `test_epic_064_interface`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-005-frontend.md`, este documento, o épico `EPIC-064` e o TaskEnvelope `TASK-0400`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0510-01, AC-ISSUE-0510-02, AC-ISSUE-0510-03, AC-ISSUE-0510-04`
