# STORY-0372 / ISSUE-0482 — Definir contrato científico e invariantes: policy de aquisição no ProcessingPlan, preview, consentimento e bloqueio fail-closed de ativos pagos/ambíguos
...
- **TaskEnvelope:** `.codex/tasks/TASK-0372.json`

## História de usuário

Como operador geoespacial, preciso definir contrato científico e invariantes para “policy de aquisição no ProcessingPlan, preview, consentimento e bloqueio fail-closed de ativos pagos/ambíguos”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir contrato científico e invariantes para a capacidade **policy de aquisição no ProcessingPlan, preview, consentimento e bloqueio fail-closed de ativos pagos/ambíguos**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/reference_discovery/geo/policy-de-aquisicao-no-processingplan-preview-consenti/**`
- `docs/02-architecture/design-reviews/policy-de-aquisicao-no-processingplan-preview-consenti/**`
## Fora de escopo
...
`STORY-0364`, `STORY-0371`, `STORY-0177`
...
- [ ] Os requisitos REQ-PUB-003, REQ-SRC-005 possuem evidência explícita no commit candidato.
...
- `test_free_acquisition_policy_states_fail_closed_paid_ambiguous`
- `test_epic_060_contrato`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-060` e o TaskEnvelope `TASK-0372`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0482-01, AC-ISSUE-0482-02, AC-ISSUE-0482-03, AC-ISSUE-0482-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-012`, `ADR-047`
- **Conflito:** `Nenhum`
