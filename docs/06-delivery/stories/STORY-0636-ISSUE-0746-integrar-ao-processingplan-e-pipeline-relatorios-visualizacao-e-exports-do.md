# STORY-0636 / ISSUE-0746 — Integrar ao ProcessingPlan e pipeline: Relatórios, visualização e exports do mosaico relativo
...
- **TaskEnvelope:** `.codex/tasks/TASK-0636.json`

## História de usuário

Como operador geoespacial, preciso integrar ao processingplan e pipeline para “Relatórios, visualização e exports do mosaico relativo”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Integrar ao ProcessingPlan e pipeline para a capacidade **Relatórios, visualização e exports do mosaico relativo**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-102` e o TaskEnvelope `TASK-0636`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0746-01, AC-ISSUE-0746-02, AC-ISSUE-0746-03, AC-ISSUE-0746-04`
