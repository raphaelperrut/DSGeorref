# STORY-0461 / ISSUE-0571 — Validar segurança, recuperação e concorrência: RetentionPolicy por classe/estado/dependência, holds e preview de impacto
...
- **TaskEnvelope:** `.codex/tasks/TASK-0461.json`

## História de usuário

Como operador geoespacial, preciso validar segurança, recuperação e concorrência para “RetentionPolicy por classe/estado/dependência, holds e preview de impacto”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Validar segurança, recuperação e concorrência para a capacidade **RetentionPolicy por classe/estado/dependência, holds e preview de impacto**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/artifact_provenance/adapters/security/retentionpolicy-por-classe-estado-dependencia-holds-e/**`
- `tests/security/contexts/artifact_provenance/retentionpolicy-por-classe-estado-dependencia-holds-e/**`
## Fora de escopo
...
`STORY-0458`, `STORY-0459`, `STORY-0460`
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0571-01, AC-ISSUE-0571-02, AC-ISSUE-0571-03, AC-ISSUE-0571-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-012`, `ADR-016`, `ADR-030`, `ADR-031`, `ADR-032`
