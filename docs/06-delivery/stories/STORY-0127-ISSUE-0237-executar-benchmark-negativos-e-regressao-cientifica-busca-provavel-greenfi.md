# STORY-0127 / ISSUE-0237 — Executar benchmark, negativos e regressão científica: busca provável greenfield validada
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0127.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “busca provável greenfield validada”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **busca provável greenfield validada**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/busca-provavel-greenfield-validada/**`
- `tools/quality/contexts/reference_discovery/busca-provavel-greenfield-validada/**`
- `.github/workflows/busca-provavel-greenfield-validada.yaml`
## Fora de escopo
...
`REQ-AIE-003`, `REQ-AIE-007`, `REQ-CLASSICPROFILE-008`, `REQ-FS1-005`, `REQ-FS1-007`, `REQ-SGVCAL-001`, `REQ-SGVCAL-008`
...
`STORY-0123`, `STORY-0124`, `STORY-0125`, `STORY-0126`
...
- [ ] Os requisitos REQ-AIE-003, REQ-AIE-007, REQ-CLASSICPROFILE-008, REQ-FS1-005, REQ-FS1-007, REQ-SGVCAL-001 possuem evidência explícita no commit candidato.
...
- `test_epic_022_benchmark_happy_path`
- `test_epic_022_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-022` e o TaskEnvelope `TASK-0127`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0237-01, AC-ISSUE-0237-02, AC-ISSUE-0237-03, AC-ISSUE-0237-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-045`, `ADR-046`, `ADR-055`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-044`, `ADR-045`, `ADR-046`, `ADR-055`
