# STORY-0724 / ISSUE-0834 — Slice 2/2 — Preparar corpus, fixtures e representação tipada: corpus versionado com décadas e condições distintas [REQ-NATIVE, REQ-SCP]
...
- **TaskEnvelope:** `.codex/tasks/TASK-0724.json`
...
- `src/geo/dsgeorref_geo/contexts/geometric_quality/corpus-versionado-com-decadas-e-condicoes-distintas/native-scp-parte-2/**`
## Fora de escopo
...
`REQ-NATIVE-008`, `REQ-NATIVE-009`, `REQ-NATIVE-010`, `REQ-SCP-001`
...
- [ ] Cada requisito do slice possui evidência explícita: REQ-NATIVE-008, REQ-NATIVE-009, REQ-NATIVE-010, REQ-SCP-001.
...
Leia `AGENTS.md`, o papel `.codex/roles/ROLE-007-geoprocessamento.md`, esta história e `TASK-0724`. Trabalhe somente nos paths permitidos, entregue apenas este slice e interrompa diante de qualquer condição de parada.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0834-01, AC-ISSUE-0834-02, AC-ISSUE-0834-03, AC-ISSUE-0834-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-053`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-023`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-044`, `ADR-045`, `ADR-046`, `ADR-053`, `ADR-055`
