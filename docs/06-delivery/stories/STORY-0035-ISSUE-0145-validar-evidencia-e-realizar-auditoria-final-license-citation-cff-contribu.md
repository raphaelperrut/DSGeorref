# STORY-0035 / ISSUE-0145 — Validar evidência e realizar auditoria final: LICENSE, CITATION.cff, contribuição, DCO/CLA e gate de publicação definidos
...
- **TaskEnvelope:** `.codex/tasks/TASK-0035.json`

## História de usuário

Como mantenedor de engenharia, preciso validar evidência e realizar auditoria final para “LICENSE, CITATION.cff, contribuição, DCO/CLA e gate de publicação definidos”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Validar evidência e realizar auditoria final para a capacidade **LICENSE, CITATION.cff, contribuição, DCO/CLA e gate de publicação definidos**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/license-citation-cff-contribuicao-dco-cla-e-gate-de-pu/**`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-007` e o TaskEnvelope `TASK-0035`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0145-01, AC-ISSUE-0145-02, AC-ISSUE-0145-03, AC-ISSUE-0145-04`
