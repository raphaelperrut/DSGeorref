# STORY-0591 / ISSUE-0701 — Definir contrato científico e invariantes: Seletor e validador de CRS
...
- **TaskEnvelope:** `.codex/tasks/TASK-0591.json`

## História de usuário

Como operador geoespacial, preciso definir contrato científico e invariantes para “Seletor e validador de CRS”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir contrato científico e invariantes para a capacidade **Seletor e validador de CRS**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/georeferencing/geo/seletor-e-validador-de-crs/**`
- `docs/02-architecture/design-reviews/seletor-e-validador-de-crs/**`
## Fora de escopo
...
`REQ-CRS-004`, `REQ-CRS-005`, `REQ-CRS-006`, `REQ-CRS-007`
...
- [ ] O resultado de “Seletor e validador de CRS” é observável por contrato, interface, artifact ou evidência executável.
- [ ] Os requisitos REQ-CRS-004, REQ-CRS-005, REQ-CRS-006, REQ-CRS-007 possuem evidência explícita no commit candidato.
...
- `test_technical_canonical_output_and_optional_web_derivative_lineage`
- `test_web_service_capability_crs_negotiation_and_actual_response_validation`
- `test_epic_096_contrato`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-096` e o TaskEnvelope `TASK-0591`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0701-01, AC-ISSUE-0701-02, AC-ISSUE-0701-03, AC-ISSUE-0701-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-025`, `ADR-034`, `ADR-041`
- **Conflito:** `Nenhum`
