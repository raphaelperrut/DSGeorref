# STORY-0516 / ISSUE-0626 — Definir SLO, runbook e controles operacionais: modos offline/restricted/connected, egress enforcement, mirrors e testes air-gapped
...
- **TaskEnvelope:** `.codex/tasks/TASK-0516.json`

## História de usuário

Como administrador da instância, preciso definir slo, runbook e controles operacionais para “modos offline/restricted/connected, egress enforcement, mirrors e testes air-gapped”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir SLO, runbook e controles operacionais para a capacidade **modos offline/restricted/connected, egress enforcement, mirrors e testes air-gapped**, com saída versionada, testes e evidência no commit candidato.
...
`STORY-0498`, `STORY-0364`, `STORY-0504`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-083` e o TaskEnvelope `TASK-0516`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0626-01, AC-ISSUE-0626-02, AC-ISSUE-0626-03, AC-ISSUE-0626-04`
- **Base de requisitos:** `DERIVED_CONTROL`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-010`, `ADR-011`, `ADR-033`, `ADR-034`
- **Conflito:** `Nenhum`
