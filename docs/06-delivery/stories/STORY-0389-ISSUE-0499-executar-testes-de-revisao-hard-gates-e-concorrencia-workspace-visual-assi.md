# STORY-0389 / ISSUE-0499 — Executar testes de revisão, hard gates e concorrência: workspace visual assistido, CorrectionSets, nova tentativa, comparação e auditoria sem bloquear o ciclo automático
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0389.json`

## História de usuário

Como revisor geoespacial, preciso executar testes de revisão, hard gates e concorrência para “workspace visual assistido, CorrectionSets, nova tentativa, comparação e auditoria sem bloquear o ciclo automático”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar testes de revisão, hard gates e concorrência para a capacidade **workspace visual assistido, CorrectionSets, nova tentativa, comparação e auditoria sem bloquear o ciclo automático**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/rev/workspace-visual-assistido-correctionsets-nova-tentati/**`
- `tools/quality/contexts/review_correction/workspace-visual-assistido-correctionsets-nova-tentati/**`
- `.github/workflows/workspace-visual-assistido-correctionsets-nova-tentati.yaml`
## Fora de escopo
...
- `test_epic_062_validacao_happy_path`
- `test_epic_062_validacao_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-062` e o TaskEnvelope `TASK-0389`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0499-01, AC-ISSUE-0499-02, AC-ISSUE-0499-03, AC-ISSUE-0499-04`
