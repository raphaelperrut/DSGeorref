# STORY-0474 / ISSUE-0584 — Auditar evidência operacional final: canal append-only de auditoria, particionamento, digests, consulta e exportação assinada opcional
...
- **TaskEnvelope:** `.codex/tasks/TASK-0474.json`

## História de usuário

Como administrador da instância, preciso auditar evidência operacional final para “canal append-only de auditoria, particionamento, digests, consulta e exportação assinada opcional”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar evidência operacional final para a capacidade **canal append-only de auditoria, particionamento, digests, consulta e exportação assinada opcional**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/canal-append-only-de-auditoria-particionamento-digests/**`
## Fora de escopo
...
- `test_epic_075_aceite_happy_path`
- `test_epic_075_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-075` e o TaskEnvelope `TASK-0474`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0584-01, AC-ISSUE-0584-02, AC-ISSUE-0584-03, AC-ISSUE-0584-04`
