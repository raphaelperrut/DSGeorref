# STORY-0605 / ISSUE-0715 — Definir contrato científico e invariantes: Mosaico relativo de recuperação
...
- **TaskEnvelope:** `.codex/tasks/TASK-0605.json`

## História de usuário

Como operador geoespacial, preciso definir contrato científico e invariantes para “Mosaico relativo de recuperação”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir contrato científico e invariantes para a capacidade **Mosaico relativo de recuperação**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/relative_mosaic/geo/mosaico-relativo-de-recuperacao/**`
- `docs/02-architecture/design-reviews/mosaico-relativo-de-recuperacao/**`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-098` e o TaskEnvelope `TASK-0605`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0715-01, AC-ISSUE-0715-02, AC-ISSUE-0715-03, AC-ISSUE-0715-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-044`, `ADR-049`, `ADR-050`
