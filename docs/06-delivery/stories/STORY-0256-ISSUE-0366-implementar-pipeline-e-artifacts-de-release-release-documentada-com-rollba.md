# STORY-0256 / ISSUE-0366 — Implementar pipeline e artifacts de release: release documentada com rollback e suporte
...
- **TaskEnvelope:** `.codex/tasks/TASK-0256.json`

## História de usuário

Como responsável por release, preciso implementar pipeline e artifacts de release para “release documentada com rollback e suporte”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar pipeline e artifacts de release para a capacidade **release documentada com rollback e suporte**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/rel/contexts/release_installation/release-documentada-com-rollback-e-suporte/**`
- `tools/quality/contexts/release_installation/release-documentada-com-rollback-e-suporte/**`
- `.github/workflows/release-documentada-com-rollback-e-suporte.yaml`
## Fora de escopo
...
`REQ-SRG-003`, `REQ-TOOL-008`, `REQ-TOOL-010`
...
- [ ] O resultado de “release documentada com rollback e suporte” é observável por contrato, interface, artifact ou evidência executável.
- [ ] Os requisitos REQ-SRG-003, REQ-TOOL-008, REQ-TOOL-010 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-043` e o TaskEnvelope `TASK-0256`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0366-01, AC-ISSUE-0366-02, AC-ISSUE-0366-03, AC-ISSUE-0366-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-001`, `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-014`, `ADR-033`, `ADR-034`, `ADR-053`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-001`, `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-014`, `ADR-033`, `ADR-034`, `ADR-053`
...
- **Resultado:** `PASS`
- **Risk tier:** `CRITICAL`
- **Controles aplicáveis:** `CTO-001, CTO-002, CTO-003, CTO-004, CTO-005, CTO-006, CTO-007, CTO-008, CTO-010, CTO-012, CTO-013, CTO-015`
