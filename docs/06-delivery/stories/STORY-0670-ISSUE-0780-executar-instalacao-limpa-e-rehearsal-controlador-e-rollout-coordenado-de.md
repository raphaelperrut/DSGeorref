# STORY-0670 / ISSUE-0780 — Executar instalação limpa e rehearsal: Controlador e rollout coordenado de upgrades
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0670.json`

## História de usuário

Como responsável por release, preciso executar instalação limpa e rehearsal para “Controlador e rollout coordenado de upgrades”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar instalação limpa e rehearsal para a capacidade **Controlador e rollout coordenado de upgrades**, com saída versionada, testes e evidência no commit candidato.
...
`STORY-0667`, `STORY-0668`, `STORY-0669`
...
- `test_epic_107_ensaio_happy_path`
- `test_epic_107_ensaio_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-107` e o TaskEnvelope `TASK-0670`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0780-01, AC-ISSUE-0780-02, AC-ISSUE-0780-03, AC-ISSUE-0780-04`
