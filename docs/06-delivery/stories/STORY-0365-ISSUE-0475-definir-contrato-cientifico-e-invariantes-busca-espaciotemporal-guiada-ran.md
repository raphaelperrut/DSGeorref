# STORY-0365 / ISSUE-0475 — Definir contrato científico e invariantes: busca espaciotemporal guiada, ranking explicável, incerteza e expansão limitada por orçamento
...
- **TaskEnvelope:** `.codex/tasks/TASK-0365.json`

## História de usuário

Como operador geoespacial, preciso definir contrato científico e invariantes para “busca espaciotemporal guiada, ranking explicável, incerteza e expansão limitada por orçamento”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir contrato científico e invariantes para a capacidade **busca espaciotemporal guiada, ranking explicável, incerteza e expansão limitada por orçamento**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/reference_discovery/geo/busca-espaciotemporal-guiada-ranking-explicavel-incert/**`
- `docs/02-architecture/design-reviews/busca-espaciotemporal-guiada-ranking-explicavel-incert/**`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-059` e o TaskEnvelope `TASK-0365`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0475-01, AC-ISSUE-0475-02, AC-ISSUE-0475-03, AC-ISSUE-0475-04`
