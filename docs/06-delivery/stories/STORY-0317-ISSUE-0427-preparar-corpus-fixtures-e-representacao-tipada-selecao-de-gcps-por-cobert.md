# STORY-0317 / ISSUE-0427 — Preparar corpus, fixtures e representação tipada: seleção de GCPs por cobertura/qualidade/diversidade, exportando pontos usados e descartados
...
- **TaskEnvelope:** `.codex/tasks/TASK-0317.json`

## História de usuário

Como operador geoespacial, preciso preparar corpus, fixtures e representação tipada para “seleção de GCPs por cobertura/qualidade/diversidade, exportando pontos usados e descartados”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Preparar corpus, fixtures e representação tipada para a capacidade **seleção de GCPs por cobertura/qualidade/diversidade, exportando pontos usados e descartados**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-052` e o TaskEnvelope `TASK-0317`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0427-01, AC-ISSUE-0427-02, AC-ISSUE-0427-03, AC-ISSUE-0427-04`
