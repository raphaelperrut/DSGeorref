# STORY-0495 / ISSUE-0605 — Instrumentar sinais, dashboards e alertas: ingress único, TLS, redes privadas, limites e testes de exposição de portas
...
- **TaskEnvelope:** `.codex/tasks/TASK-0495.json`

## História de usuário

Como administrador da instância, preciso instrumentar sinais, dashboards e alertas para “ingress único, TLS, redes privadas, limites e testes de exposição de portas”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Instrumentar sinais, dashboards e alertas para a capacidade **ingress único, TLS, redes privadas, limites e testes de exposição de portas**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/ops/contexts/operations_audit/ingress-unico-tls-redes-privadas-limites-e-testes-de-e/**`
- `tools/quality/contexts/operations_audit/ingress-unico-tls-redes-privadas-limites-e-testes-de-e/**`
- `.github/workflows/ingress-unico-tls-redes-privadas-limites-e-testes-de-e.yaml`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-079` e o TaskEnvelope `TASK-0495`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0605-01, AC-ISSUE-0605-02, AC-ISSUE-0605-03, AC-ISSUE-0605-04`
