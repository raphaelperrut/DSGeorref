# STORY-0123 / ISSUE-0233 — Consolidar slices e liberar integração: busca provável greenfield validada
...
- **TaskEnvelope:** `.codex/tasks/TASK-0123.json`

## História de usuário

Como operador geoespacial, preciso preparar corpus, fixtures e representação tipada para “busca provável greenfield validada”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.
...
- `src/geo/dsgeorref_geo/contexts/reference_discovery/busca-provavel-greenfield-validada/consolidacao/**`
## Fora de escopo
...
`STORY-0725`, `STORY-0726`, `STORY-0727`, `STORY-0728`
...
- `test_story_0123_slice_consolidation`
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0233-01, AC-ISSUE-0233-02, AC-ISSUE-0233-03, AC-ISSUE-0233-04`
