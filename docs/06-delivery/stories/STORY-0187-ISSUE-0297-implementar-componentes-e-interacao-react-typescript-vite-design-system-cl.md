# STORY-0187 / ISSUE-0297 — Implementar componentes e interação: React/TypeScript/Vite, design system, cliente OpenAPI, seletor visual, acessibilidade e E2E
...
- **TaskEnvelope:** `.codex/tasks/TASK-0187.json`

## História de usuário

Como operador geoespacial, preciso implementar componentes e interação para “React/TypeScript/Vite, design system, cliente OpenAPI, seletor visual, acessibilidade e E2E”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar componentes e interação para a capacidade **React/TypeScript/Vite, design system, cliente OpenAPI, seletor visual, acessibilidade e E2E**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/frontend/src/contexts/operator_experience/features/react-typescript-vite-design-system-cliente-openapi-se/**`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-005-frontend.md`, este documento, o épico `EPIC-031` e o TaskEnvelope `TASK-0187`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0297-01, AC-ISSUE-0297-02, AC-ISSUE-0297-03, AC-ISSUE-0297-04`
