# STORY-0233 / ISSUE-0343 — Consolidar slices e liberar integração: instrumentação OpenTelemetry, correlation IDs, métricas, dashboards e alertas para API, RabbitMQ e workers
...
- **TaskEnvelope:** `.codex/tasks/TASK-0233.json`

## História de usuário

Como administrador da instância, preciso implementar automação operacional para “instrumentação OpenTelemetry, correlation IDs, métricas, dashboards e alertas para API, RabbitMQ e workers”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.
...
- `tests/ops/contexts/operations_audit/instrumentacao-opentelemetry-correlation-ids-metricas/consolidacao/**`
- `tools/quality/contexts/operations_audit/instrumentacao-opentelemetry-correlation-ids-metricas/consolidacao/**`
- `.github/workflows/instrumentacao-opentelemetry-correlation-ids-metricas-consolidacao.yaml`
## Fora de escopo
...
- `test_story_0233_slice_consolidation`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-039` e o TaskEnvelope `TASK-0233`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0343-01, AC-ISSUE-0343-02, AC-ISSUE-0343-03, AC-ISSUE-0343-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-010`, `ADR-011`, `ADR-012`, `ADR-033`, `ADR-034`
