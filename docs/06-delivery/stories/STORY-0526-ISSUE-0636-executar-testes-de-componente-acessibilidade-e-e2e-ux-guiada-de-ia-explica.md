# STORY-0526 / ISSUE-0636 — Executar testes de componente, acessibilidade e E2E: UX guiada de IA, explicação do plano, capacidades instaladas/bloqueadas e laboratório separado
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0526.json`

## História de usuário

Como operador geoespacial, preciso executar testes de componente, acessibilidade e e2e para “UX guiada de IA, explicação do plano, capacidades instaladas/bloqueadas e laboratório separado”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar testes de componente, acessibilidade e E2E para a capacidade **UX guiada de IA, explicação do plano, capacidades instaladas/bloqueadas e laboratório separado**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/web/ux-guiada-de-ia-explicacao-do-plano-capacidades-instal/**`
- `tools/quality/contexts/operator_experience/ux-guiada-de-ia-explicacao-do-plano-capacidades-instal/**`
- `.github/workflows/ux-guiada-de-ia-explicacao-do-plano-capacidades-instal.yaml`
## Fora de escopo
...
`STORY-0523`, `STORY-0524`, `STORY-0525`

## Critérios de aceitação

- [ ] O resultado de “UX guiada de IA, explicação do plano, capacidades instaladas/bloqueadas e laboratório separado” é observável por contrato, interface, artifact ou evidência executável.
...
- `test_epic_084_validacao_happy_path`
- `test_epic_084_validacao_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-084` e o TaskEnvelope `TASK-0526`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0636-01, AC-ISSUE-0636-02, AC-ISSUE-0636-03, AC-ISSUE-0636-04`
