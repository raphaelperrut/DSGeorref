# STORY-0108 / ISSUE-0218 — Executar integração real, carga e fault injection: Resource Governor, admission control e orçamento adaptativo de RAM/CPU/GPU/disco
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0108.json`

## História de usuário

Como operador geoespacial, preciso executar integração real, carga e fault injection para “Resource Governor, admission control e orçamento adaptativo de RAM/CPU/GPU/disco”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar integração real, carga e fault injection para a capacidade **Resource Governor, admission control e orçamento adaptativo de RAM/CPU/GPU/disco**, com saída versionada, testes e evidência no commit candidato.
...
`STORY-0104`, `STORY-0105`, `STORY-0106`, `STORY-0107`
...
- `test_epic_019_validacao_happy_path`
- `test_epic_019_validacao_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-019` e o TaskEnvelope `TASK-0108`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0218-01, AC-ISSUE-0218-02, AC-ISSUE-0218-03, AC-ISSUE-0218-04`
