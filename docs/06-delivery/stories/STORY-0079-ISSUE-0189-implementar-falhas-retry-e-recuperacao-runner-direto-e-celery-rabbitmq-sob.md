# STORY-0079 / ISSUE-0189 — Automatizar testes de resiliência, retry e recuperação: runner direto e Celery/RabbitMQ sobre o mesmo núcleo
...
- **TaskEnvelope:** `.codex/tasks/TASK-0079.json`

## História de usuário

Como operador geoespacial, preciso automatizar testes de resiliência, retry e recuperação para “runner direto e Celery/RabbitMQ sobre o mesmo núcleo”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Automatizar testes de resiliência, retry e recuperação para a capacidade **runner direto e Celery/RabbitMQ sobre o mesmo núcleo**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/job/runner-direto-e-celery-rabbitmq-sobre-o-mesmo-nucleo/**`
- `tools/quality/contexts/job_orchestration/runner-direto-e-celery-rabbitmq-sobre-o-mesmo-nucleo/**`
- `.github/workflows/runner-direto-e-celery-rabbitmq-sobre-o-mesmo-nucleo.yaml`
## Fora de escopo
...
- [ ] O resultado de “runner direto e Celery/RabbitMQ sobre o mesmo núcleo” é observável por contrato, interface, artifact ou evidência executável.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-015` e o TaskEnvelope `TASK-0079`. Trabalhe somente nos paths permitidos. Entregue o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0189-01, AC-ISSUE-0189-02, AC-ISSUE-0189-03, AC-ISSUE-0189-04`
