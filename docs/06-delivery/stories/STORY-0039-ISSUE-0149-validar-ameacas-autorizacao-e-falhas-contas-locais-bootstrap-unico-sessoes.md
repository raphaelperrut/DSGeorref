# STORY-0039 / ISSUE-0149 — Validar ameaças, autorização e falhas: contas locais, bootstrap único, sessões, tokens e adapter OIDC
...
- **TaskEnvelope:** `.codex/tasks/TASK-0039.json`

## História de usuário

Como administrador da instância, preciso validar ameaças, autorização e falhas para “contas locais, bootstrap único, sessões, tokens e adapter OIDC”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Validar ameaças, autorização e falhas para a capacidade **contas locais, bootstrap único, sessões, tokens e adapter OIDC**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/identity_access/adapters/security/contas-locais-bootstrap-unico-sessoes-tokens-e-adapter/**`
- `tests/security/contexts/identity_access/contas-locais-bootstrap-unico-sessoes-tokens-e-adapter/**`
## Fora de escopo
...
- [ ] Os requisitos REQ-EPIC-076, REQ-INS-002 possuem evidência explícita no commit candidato.
...
- `test_epic_008_seguranca_happy_path`
- `test_epic_008_seguranca_negative_paths`
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0149-01, AC-ISSUE-0149-02, AC-ISSUE-0149-03, AC-ISSUE-0149-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-030`, `ADR-031`, `ADR-032`, `ADR-034`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-030`, `ADR-031`, `ADR-032`, `ADR-034`
