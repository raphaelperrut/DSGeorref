# STORY-0171 / ISSUE-0281 — Definir contrato científico e invariantes: etapas/capacidades canônicas e ProcessingPlan reproduzível
...
- **TaskEnvelope:** `.codex/tasks/TASK-0171.json`

## História de usuário

Como operador geoespacial, preciso definir contrato científico e invariantes para “etapas/capacidades canônicas e ProcessingPlan reproduzível”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir contrato científico e invariantes para a capacidade **etapas/capacidades canônicas e ProcessingPlan reproduzível**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/processing_plan/geo/etapas-capacidades-canonicas-e-processingplan-reproduz/**`
- `docs/02-architecture/design-reviews/etapas-capacidades-canonicas-e-processingplan-reproduz/**`
## Fora de escopo
...
`STORY-0020`, `STORY-0030`, `STORY-0121`
...
- [ ] Os requisitos REQ-SRC-005, REQ-UX-002 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-029` e o TaskEnvelope `TASK-0171`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0281-01, AC-ISSUE-0281-02, AC-ISSUE-0281-03, AC-ISSUE-0281-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-014`, `ADR-047`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-014`, `ADR-047`
