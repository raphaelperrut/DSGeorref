# STORY-0128 / ISSUE-0238 — Auditar evidência científica e final: busca provável greenfield validada
...
- **TaskEnvelope:** `.codex/tasks/TASK-0128.json`

## História de usuário

Como operador geoespacial, preciso auditar evidência científica e final para “busca provável greenfield validada”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar evidência científica e final para a capacidade **busca provável greenfield validada**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/busca-provavel-greenfield-validada/**`
## Fora de escopo
...
- `test_epic_022_aceite_happy_path`
- `test_epic_022_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-022` e o TaskEnvelope `TASK-0128`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0238-01, AC-ISSUE-0238-02, AC-ISSUE-0238-03, AC-ISSUE-0238-04`
