# STORY-0678 / ISSUE-0788 — Definir critérios jurídicos e de publicação: Licenciamento, contribuição, rights manifests e citação
...
- **TaskEnvelope:** `.codex/tasks/TASK-0678.json`

## História de usuário

Como mantenedor do projeto, preciso definir critérios jurídicos e de publicação para “Licenciamento, contribuição, rights manifests e citação”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir critérios jurídicos e de publicação para a capacidade **Licenciamento, contribuição, rights manifests e citação**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `docs/01-product/capabilities/licenciamento-contribuicao-rights-manifests-e-citacao/**`
## Fora de escopo
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0788-01, AC-ISSUE-0788-02, AC-ISSUE-0788-03, AC-ISSUE-0788-04`
