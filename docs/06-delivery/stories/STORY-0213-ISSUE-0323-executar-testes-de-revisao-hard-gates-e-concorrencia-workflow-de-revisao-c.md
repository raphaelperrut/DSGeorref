# STORY-0213 / ISSUE-0323 — Executar testes de revisão, hard gates e concorrência: workflow de revisão com gates revisáveis, hard gates imutáveis, checklist e auditoria
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0213.json`

## História de usuário

Como revisor geoespacial, preciso executar testes de revisão, hard gates e concorrência para “workflow de revisão com gates revisáveis, hard gates imutáveis, checklist e auditoria”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar testes de revisão, hard gates e concorrência para a capacidade **workflow de revisão com gates revisáveis, hard gates imutáveis, checklist e auditoria**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/rev/workflow-de-revisao-com-gates-revisaveis-hard-gates-im/**`
- `tools/quality/contexts/review_correction/workflow-de-revisao-com-gates-revisaveis-hard-gates-im/**`
- `.github/workflows/workflow-de-revisao-com-gates-revisaveis-hard-gates-im.yaml`
## Fora de escopo
...
`STORY-0210`, `STORY-0211`, `STORY-0212`
...
- `test_epic_035_validacao_happy_path`
- `test_epic_035_validacao_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-035` e o TaskEnvelope `TASK-0213`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0323-01, AC-ISSUE-0323-02, AC-ISSUE-0323-03, AC-ISSUE-0323-04`
