# STORY-0596 / ISSUE-0706 — Executar benchmark, negativos e regressão científica: Seletor e validador de CRS
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0596.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “Seletor e validador de CRS”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **Seletor e validador de CRS**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/seletor-e-validador-de-crs/**`
- `tools/quality/contexts/georeferencing/seletor-e-validador-de-crs/**`
- `.github/workflows/seletor-e-validador-de-crs.yaml`
## Fora de escopo
...
`STORY-0592`, `STORY-0593`, `STORY-0594`, `STORY-0595`
...
- `test_epic_096_benchmark_happy_path`
- `test_epic_096_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-096` e o TaskEnvelope `TASK-0596`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0706-01, AC-ISSUE-0706-02, AC-ISSUE-0706-03, AC-ISSUE-0706-04`
