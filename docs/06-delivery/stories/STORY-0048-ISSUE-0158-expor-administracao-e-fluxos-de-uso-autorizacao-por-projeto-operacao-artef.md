# STORY-0048 / ISSUE-0158 — Expor administração e fluxos de uso: autorização por projeto, operação, artefato e caminho
...
- **TaskEnvelope:** `.codex/tasks/TASK-0048.json`

## História de usuário

Como administrador da instância, preciso expor administração e fluxos de uso para “autorização por projeto, operação, artefato e caminho”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Expor administração e fluxos de uso para a capacidade **autorização por projeto, operação, artefato e caminho**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/frontend/src/contexts/identity_access/features/autorizacao-por-projeto-operacao-artefato-e-caminho/**`
## Fora de escopo
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0158-01, AC-ISSUE-0158-02, AC-ISSUE-0158-03, AC-ISSUE-0158-04`
- **Base de requisitos:** `DERIVED_CONTROL`
- **ADRs governantes:** `ADR-003`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-014`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-014`, `ADR-016`, `ADR-055`
