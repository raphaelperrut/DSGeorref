# STORY-0499 / ISSUE-0609 — Modelar ameaças e requisitos de controle: lockfiles, pins por digest/SHA, scanners, SBOM, assinatura OCI, attestations e verificador de release
...
- **TaskEnvelope:** `.codex/tasks/TASK-0499.json`

## História de usuário

Como administrador de segurança, preciso modelar ameaças e requisitos de controle para “lockfiles, pins por digest/SHA, scanners, SBOM, assinatura OCI, attestations e verificador de release”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Modelar ameaças e requisitos de controle para a capacidade **lockfiles, pins por digest/SHA, scanners, SBOM, assinatura OCI, attestations e verificador de release**, com saída versionada, testes e evidência no commit candidato.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0609-01, AC-ISSUE-0609-02, AC-ISSUE-0609-03, AC-ISSUE-0609-04`
