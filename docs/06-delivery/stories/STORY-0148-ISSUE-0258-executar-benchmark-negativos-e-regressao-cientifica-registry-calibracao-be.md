# STORY-0148 / ISSUE-0258 — Executar benchmark, negativos e regressão científica: registry, calibração, benchmark e lifecycle de QualityProfiles oficiais/customizados
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0148.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “registry, calibração, benchmark e lifecycle de QualityProfiles oficiais/customizados”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **registry, calibração, benchmark e lifecycle de QualityProfiles oficiais/customizados**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/registry-calibracao-benchmark-e-lifecycle-de-qualitypr/**`
- `tools/quality/contexts/geometric_quality/registry-calibracao-benchmark-e-lifecycle-de-qualitypr/**`
- `.github/workflows/registry-calibracao-benchmark-e-lifecycle-de-qualitypr.yaml`
## Fora de escopo
...
`STORY-0144`, `STORY-0145`, `STORY-0146`, `STORY-0147`

## Critérios de aceitação

- [ ] O resultado de “registry, calibração, benchmark e lifecycle de QualityProfiles oficiais/customizados” é observável por contrato, interface, artifact ou evidência executável.
...
- `test_epic_025_benchmark_happy_path`
- `test_epic_025_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-025` e o TaskEnvelope `TASK-0148`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0258-01, AC-ISSUE-0258-02, AC-ISSUE-0258-03, AC-ISSUE-0258-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-046`
