# STORY-0449 / ISSUE-0559 — Validar segurança, recuperação e concorrência: BackupSet coordenado, manifests, checksums, watermark e policies de inclusão
...
- **TaskEnvelope:** `.codex/tasks/TASK-0449.json`

## História de usuário

Como operador geoespacial, preciso validar segurança, recuperação e concorrência para “BackupSet coordenado, manifests, checksums, watermark e policies de inclusão”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Validar segurança, recuperação e concorrência para a capacidade **BackupSet coordenado, manifests, checksums, watermark e policies de inclusão**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/artifact_provenance/adapters/security/backupset-coordenado-manifests-checksums-watermark-e-p/**`
- `tests/security/contexts/artifact_provenance/backupset-coordenado-manifests-checksums-watermark-e-p/**`
## Fora de escopo
...
`STORY-0446`, `STORY-0447`, `STORY-0448`
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0559-01, AC-ISSUE-0559-02, AC-ISSUE-0559-03, AC-ISSUE-0559-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-025`, `ADR-030`, `ADR-031`, `ADR-032`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-018`, `ADR-025`, `ADR-030`, `ADR-031`, `ADR-032`
