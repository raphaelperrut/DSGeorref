# STORY-0056 / ISSUE-0166 — Definir modelo, invariantes e contratos de dados: raízes de workspace, API de navegação segura, catálogo, hashes e lineage
...
- **TaskEnvelope:** `.codex/tasks/TASK-0056.json`

## História de usuário

Como operador geoespacial, preciso definir modelo, invariantes e contratos de dados para “raízes de workspace, API de navegação segura, catálogo, hashes e lineage”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir modelo, invariantes e contratos de dados para a capacidade **raízes de workspace, API de navegação segura, catálogo, hashes e lineage**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/project_workspace/dat/raizes-de-workspace-api-de-navegacao-segura-catalogo-h/**`
- `docs/02-architecture/design-reviews/raizes-de-workspace-api-de-navegacao-segura-catalogo-h/**`
## Fora de escopo
...
`REQ-DBSCHEMA-001`, `REQ-DBSCHEMA-005`, `REQ-DBSCHEMA-007`, `REQ-DBSCHEMA-008`, `REQ-RUN-001`, `REQ-RUN-006`, `REQ-RUN-008`, `REQ-RUN-010`, `REQ-RUNTIME-005`
...
- [ ] Os requisitos REQ-DBSCHEMA-001, REQ-DBSCHEMA-005, REQ-DBSCHEMA-007, REQ-DBSCHEMA-008, REQ-RUN-001, REQ-RUN-006 possuem evidência explícita no commit candidato.
...
- `test_req_dbschema_001`
- `test_req_dbschema_005`
- `test_req_dbschema_007`
- `test_req_dbschema_008`
- `test_epic_012_contrato`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-012` e o TaskEnvelope `TASK-0056`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0166-01, AC-ISSUE-0166-02, AC-ISSUE-0166-03, AC-ISSUE-0166-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-013`, `ADR-015`, `ADR-017`, `ADR-019`, `ADR-040`, `ADR-041`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-012`, `ADR-013`, `ADR-014`, `ADR-015`, `ADR-016`, `ADR-017`, `ADR-019`, `ADR-023`, `ADR-025`, `ADR-026`, `ADR-040`, `ADR-041`, `ADR-055`
