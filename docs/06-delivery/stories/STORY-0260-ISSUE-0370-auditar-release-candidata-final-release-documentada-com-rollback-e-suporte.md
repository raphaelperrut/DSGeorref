# STORY-0260 / ISSUE-0370 — Auditar release candidata final: release documentada com rollback e suporte
...
- **TaskEnvelope:** `.codex/tasks/TASK-0260.json`

## História de usuário

Como responsável por release, preciso auditar release candidata final para “release documentada com rollback e suporte”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar release candidata final para a capacidade **release documentada com rollback e suporte**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/release-documentada-com-rollback-e-suporte/**`
## Fora de escopo
...
- `test_epic_043_aceite_happy_path`
- `test_epic_043_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-043` e o TaskEnvelope `TASK-0260`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0370-01, AC-ISSUE-0370-02, AC-ISSUE-0370-03, AC-ISSUE-0370-04`
