# STORY-0624 / ISSUE-0734 — Executar benchmark, negativos e regressão científica: Workspace e lifecycle de âncoras
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0624.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “Workspace e lifecycle de âncoras”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **Workspace e lifecycle de âncoras**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/workspace-e-lifecycle-de-ancoras/**`
- `tools/quality/contexts/relative_mosaic/workspace-e-lifecycle-de-ancoras/**`
- `.github/workflows/workspace-e-lifecycle-de-ancoras.yaml`
## Fora de escopo
...
`STORY-0620`, `STORY-0621`, `STORY-0622`, `STORY-0623`

## Critérios de aceitação

- [ ] O resultado de “Workspace e lifecycle de âncoras” é observável por contrato, interface, artifact ou evidência executável.
...
- `test_epic_100_benchmark_happy_path`
- `test_epic_100_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-100` e o TaskEnvelope `TASK-0624`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0734-01, AC-ISSUE-0734-02, AC-ISSUE-0734-03, AC-ISSUE-0734-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-048`, `ADR-049`
