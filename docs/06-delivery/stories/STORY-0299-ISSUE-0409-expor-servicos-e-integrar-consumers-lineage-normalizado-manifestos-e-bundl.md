# STORY-0299 / ISSUE-0409 — Expor serviços e integrar consumers: lineage normalizado, manifestos e bundle de reprodução sob demanda
...
- **TaskEnvelope:** `.codex/tasks/TASK-0299.json`

## História de usuário

Como operador geoespacial, preciso expor serviços e integrar consumers para “lineage normalizado, manifestos e bundle de reprodução sob demanda”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Expor serviços e integrar consumers para a capacidade **lineage normalizado, manifestos e bundle de reprodução sob demanda**, com saída versionada, testes e evidência no commit candidato.
...
- [ ] Os requisitos REQ-EPIC-070, REQ-REV-003 possuem evidência explícita no commit candidato.
...
- `test_correctionset_new_attempt_full_sgv_immutable_history`
- `test_epic_049_integracao`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-049` e o TaskEnvelope `TASK-0299`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0409-01, AC-ISSUE-0409-02, AC-ISSUE-0409-03, AC-ISSUE-0409-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-002`, `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-016`, `ADR-048`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-002`, `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-012`, `ADR-016`, `ADR-018`, `ADR-019`, `ADR-025`, `ADR-048`
