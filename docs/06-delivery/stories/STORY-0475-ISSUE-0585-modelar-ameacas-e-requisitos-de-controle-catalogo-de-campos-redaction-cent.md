# STORY-0475 / ISSUE-0585 — Modelar ameaças e requisitos de controle: catálogo de campos, redaction centralizada, testes de vazamento e bundles de suporte sanitizados
...
- **TaskEnvelope:** `.codex/tasks/TASK-0475.json`

## História de usuário

Como administrador de segurança, preciso modelar ameaças e requisitos de controle para “catálogo de campos, redaction centralizada, testes de vazamento e bundles de suporte sanitizados”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Modelar ameaças e requisitos de controle para a capacidade **catálogo de campos, redaction centralizada, testes de vazamento e bundles de suporte sanitizados**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/operations_audit/adapters/security/catalogo-de-campos-redaction-centralizada-testes-de-va/**`
- `tests/security/contexts/operations_audit/catalogo-de-campos-redaction-centralizada-testes-de-va/**`
## Fora de escopo
...
`REQ-INS-002`, `REQ-LOG-001`, `REQ-RUNTIME-009`
...
`STORY-0025`, `STORY-0237`, `STORY-0474`

## Critérios de aceitação

- [ ] O resultado de “catálogo de campos, redaction centralizada, testes de vazamento e bundles de suporte sanitizados” é observável por contrato, interface, artifact ou evidência executável.
- [ ] Os requisitos REQ-INS-002, REQ-LOG-001, REQ-RUNTIME-009 possuem evidência explícita no commit candidato.
- [ ] Estados de erro e caminhos fail-closed aplicáveis são testados, sem fallback silencioso.
- [ ] Threat model identifica ativos, trust boundaries, atacantes e controles verificáveis.

## Testes obrigatórios

- `test_one_time_bootstrap_no_default_credentials_secret_generation_expiry_and_recovery`
- `test_log_redaction_and_support_bundle_fail_closed`
- `test_runtime_decision_9`
- `test_epic_076_ameacas`
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0585-01, AC-ISSUE-0585-02, AC-ISSUE-0585-03, AC-ISSUE-0585-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-030`, `ADR-031`, `ADR-032`, `ADR-034`, `ADR-055`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-030`, `ADR-031`, `ADR-032`, `ADR-034`, `ADR-055`
