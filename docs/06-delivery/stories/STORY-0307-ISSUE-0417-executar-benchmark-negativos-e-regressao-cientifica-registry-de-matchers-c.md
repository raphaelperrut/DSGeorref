# STORY-0307 / ISSUE-0417 — Executar benchmark, negativos e regressão científica: registry de matchers clássicos/IA, escalonamento explicável, licenças, manifests e benchmark
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0307.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “registry de matchers clássicos/IA, escalonamento explicável, licenças, manifests e benchmark”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **registry de matchers clássicos/IA, escalonamento explicável, licenças, manifests e benchmark**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/registry-de-matchers-classicos-ia-escalonamento-explic/**`
- `tools/quality/contexts/ai_recovery/registry-de-matchers-classicos-ia-escalonamento-explic/**`
- `.github/workflows/registry-de-matchers-classicos-ia-escalonamento-explic.yaml`
## Fora de escopo
...
`REQ-AI-001`, `REQ-AIE-003`, `REQ-AIE-007`, `REQ-MCH-001`, `REQ-SDR-003`
...
`STORY-0303`, `STORY-0304`, `STORY-0305`, `STORY-0306`

## Critérios de aceitação

- [ ] O resultado de “registry de matchers clássicos/IA, escalonamento explicável, licenças, manifests e benchmark” é observável por contrato, interface, artifact ou evidência executável.
- [ ] Os requisitos REQ-AI-001, REQ-AIE-003, REQ-AIE-007, REQ-MCH-001, REQ-SDR-003 possuem evidência explícita no commit candidato.
...
- `test_hybrid_matcher_escalation_provenance_no_ai_installation`
- `test_epic_050_benchmark_happy_path`
- `test_epic_050_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-050` e o TaskEnvelope `TASK-0307`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0417-01, AC-ISSUE-0417-02, AC-ISSUE-0417-03, AC-ISSUE-0417-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-017`, `ADR-046`, `ADR-053`, `ADR-055`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-017`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-046`, `ADR-051`, `ADR-052`, `ADR-053`, `ADR-055`
