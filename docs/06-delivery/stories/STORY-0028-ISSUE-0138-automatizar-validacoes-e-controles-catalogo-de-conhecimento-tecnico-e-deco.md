# STORY-0028 / ISSUE-0138 — Automatizar validações e controles: catálogo de conhecimento técnico e decomposição das capacidades de processamento
...
- **TaskEnvelope:** `.codex/tasks/TASK-0028.json`

## História de usuário

Como mantenedor de engenharia, preciso automatizar validações e controles para “catálogo de conhecimento técnico e decomposição das capacidades de processamento”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Automatizar validações e controles para a capacidade **catálogo de conhecimento técnico e decomposição das capacidades de processamento**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/fnd/catalogo-de-conhecimento-tecnico-e-decomposicao-das-ca/**`
- `tools/quality/contexts/engineering_governance/catalogo-de-conhecimento-tecnico-e-decomposicao-das-ca/**`
- `.github/workflows/catalogo-de-conhecimento-tecnico-e-decomposicao-das-ca.yaml`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-006` e o TaskEnvelope `TASK-0028`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0138-01, AC-ISSUE-0138-02, AC-ISSUE-0138-03, AC-ISSUE-0138-04`
