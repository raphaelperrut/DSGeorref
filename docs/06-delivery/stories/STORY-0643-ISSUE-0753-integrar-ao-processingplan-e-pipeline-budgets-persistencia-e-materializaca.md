# STORY-0643 / ISSUE-0753 — Integrar ao ProcessingPlan e pipeline: Budgets, persistência e materialização do mosaico relativo
...
- **TaskEnvelope:** `.codex/tasks/TASK-0643.json`

## História de usuário

Como operador geoespacial, preciso integrar ao processingplan e pipeline para “Budgets, persistência e materialização do mosaico relativo”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Integrar ao ProcessingPlan e pipeline para a capacidade **Budgets, persistência e materialização do mosaico relativo**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-103` e o TaskEnvelope `TASK-0643`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0753-01, AC-ISSUE-0753-02, AC-ISSUE-0753-03, AC-ISSUE-0753-04`
