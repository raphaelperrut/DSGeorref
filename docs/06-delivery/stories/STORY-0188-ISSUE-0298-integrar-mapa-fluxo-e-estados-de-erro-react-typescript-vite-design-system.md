# STORY-0188 / ISSUE-0298 — Integrar mapa, fluxo e estados de erro: React/TypeScript/Vite, design system, cliente OpenAPI, seletor visual, acessibilidade e E2E
...
- **TaskEnvelope:** `.codex/tasks/TASK-0188.json`

## História de usuário

Como operador geoespacial, preciso integrar mapa, fluxo e estados de erro para “React/TypeScript/Vite, design system, cliente OpenAPI, seletor visual, acessibilidade e E2E”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Integrar mapa, fluxo e estados de erro para a capacidade **React/TypeScript/Vite, design system, cliente OpenAPI, seletor visual, acessibilidade e E2E**, com saída versionada, testes e evidência no commit candidato.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0298-01, AC-ISSUE-0298-02, AC-ISSUE-0298-03, AC-ISSUE-0298-04`
