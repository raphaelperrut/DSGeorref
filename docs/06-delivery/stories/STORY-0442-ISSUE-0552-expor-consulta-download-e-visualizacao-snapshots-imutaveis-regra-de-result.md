# STORY-0442 / ISSUE-0552 — Expor consulta, download e visualização: snapshots imutáveis, regra de resultado vigente e comparação entre ciclos
...
- **TaskEnvelope:** `.codex/tasks/TASK-0442.json`

## História de usuário

Como revisor e auditor, preciso expor consulta, download e visualização para “snapshots imutáveis, regra de resultado vigente e comparação entre ciclos”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Expor consulta, download e visualização para a capacidade **snapshots imutáveis, regra de resultado vigente e comparação entre ciclos**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/frontend/src/contexts/results_reporting/features/snapshots-imutaveis-regra-de-resultado-vigente-e-compa/**`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-005-frontend.md`, este documento, o épico `EPIC-070` e o TaskEnvelope `TASK-0442`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0552-01, AC-ISSUE-0552-02, AC-ISSUE-0552-03, AC-ISSUE-0552-04`
