# STORY-0508 / ISSUE-0618 — Gerar evidências, SBOM e attestations: orquestrador de upgrade, preflight, migrations explícitas, health/smoke tests e rollback/restore
...
- **TaskEnvelope:** `.codex/tasks/TASK-0508.json`

## História de usuário

Como responsável por release, preciso gerar evidências, sbom e attestations para “orquestrador de upgrade, preflight, migrations explícitas, health/smoke tests e rollback/restore”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Gerar evidências, SBOM e attestations para a capacidade **orquestrador de upgrade, preflight, migrations explícitas, health/smoke tests e rollback/restore**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/release_installation/adapters/security/orquestrador-de-upgrade-preflight-migrations-explicita/**`
- `tests/security/contexts/release_installation/orquestrador-de-upgrade-preflight-migrations-explicita/**`
## Fora de escopo
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0618-01, AC-ISSUE-0618-02, AC-ISSUE-0618-03, AC-ISSUE-0618-04`
