# STORY-0068 / ISSUE-0178 — Definir estados, envelopes e invariantes: modelo de job e máquina de estados no PostgreSQL
...
- **TaskEnvelope:** `.codex/tasks/TASK-0068.json`

## História de usuário

Como operador geoespacial, preciso definir estados, envelopes e invariantes para “modelo de job e máquina de estados no PostgreSQL”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir estados, envelopes e invariantes para a capacidade **modelo de job e máquina de estados no PostgreSQL**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/job_orchestration/job/modelo-de-job-e-maquina-de-estados-no-postgresql/**`
- `docs/02-architecture/design-reviews/modelo-de-job-e-maquina-de-estados-no-postgresql/**`
## Fora de escopo
...
`REQ-AIE-001`, `REQ-AIE-005`, `REQ-DBSCHEMA-008`, `REQ-FS1-001`, `REQ-FS1-004`, `REQ-WORKER-001`, `REQ-WORKER-010`
...
- [ ] Os requisitos REQ-AIE-001, REQ-AIE-005, REQ-DBSCHEMA-008, REQ-FS1-001, REQ-FS1-004, REQ-WORKER-001 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-014` e o TaskEnvelope `TASK-0068`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0178-01, AC-ISSUE-0178-02, AC-ISSUE-0178-03, AC-ISSUE-0178-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-019`, `ADR-034`, `ADR-038`, `ADR-044`, `ADR-051`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-012`, `ADR-015`, `ADR-016`, `ADR-018`, `ADR-019`, `ADR-020`, `ADR-023`, `ADR-034`, `ADR-038`, `ADR-044`, `ADR-051`, `ADR-052`, `ADR-053`
