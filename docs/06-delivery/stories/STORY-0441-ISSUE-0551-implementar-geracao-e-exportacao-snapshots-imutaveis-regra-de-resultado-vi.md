# STORY-0441 / ISSUE-0551 — Implementar geração e exportação: snapshots imutáveis, regra de resultado vigente e comparação entre ciclos
...
- **TaskEnvelope:** `.codex/tasks/TASK-0441.json`

## História de usuário

Como revisor e auditor, preciso implementar geração e exportação para “snapshots imutáveis, regra de resultado vigente e comparação entre ciclos”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar geração e exportação para a capacidade **snapshots imutáveis, regra de resultado vigente e comparação entre ciclos**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-070` e o TaskEnvelope `TASK-0441`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0551-01, AC-ISSUE-0551-02, AC-ISSUE-0551-03, AC-ISSUE-0551-04`
