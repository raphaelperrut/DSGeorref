# STORY-0427 / ISSUE-0537 — Implementar runner, worker ou scheduler: Concorrência, escalonamento e isolamento
...
- **TaskEnvelope:** `.codex/tasks/TASK-0427.json`

## História de usuário

Como operador geoespacial, preciso implementar runner, worker ou scheduler para “Concorrência, escalonamento e isolamento”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar runner, worker ou scheduler para a capacidade **Concorrência, escalonamento e isolamento**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/job_orchestration/application/concorrencia-escalonamento-e-isolamento/**`
- `src/backend/dsgeorref/contexts/job_orchestration/adapters/concorrencia-escalonamento-e-isolamento/**`
## Fora de escopo
...
`REQ-BEX-007`, `REQ-BEX-008`, `REQ-BEX-009`, `REQ-SCH-001`, `REQ-SCH-003`
...
- [ ] O resultado de “Concorrência, escalonamento e isolamento” é observável por contrato, interface, artifact ou evidência executável.
- [ ] Os requisitos REQ-BEX-007, REQ-BEX-008, REQ-BEX-009, REQ-SCH-001, REQ-SCH-003 possuem evidência explícita no commit candidato.
...
- `test_class_aware_weighted_fair_scheduler_aging_and_no_starvation`
- `test_epic_068_execucao`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-068` e o TaskEnvelope `TASK-0427`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0537-01, AC-ISSUE-0537-02, AC-ISSUE-0537-03, AC-ISSUE-0537-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-012`, `ADR-016`, `ADR-037`, `ADR-038`, `ADR-040`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-012`, `ADR-016`, `ADR-018`, `ADR-019`, `ADR-037`, `ADR-038`, `ADR-040`
