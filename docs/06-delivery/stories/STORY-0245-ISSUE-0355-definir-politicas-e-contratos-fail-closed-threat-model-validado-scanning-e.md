# STORY-0245 / ISSUE-0355 — Consolidar slices e liberar integração: threat model validado, scanning e testes ofensivos
...
- **TaskEnvelope:** `.codex/tasks/TASK-0245.json`

## História de usuário

Como administrador de segurança, preciso definir políticas e contratos fail-closed para “threat model validado, scanning e testes ofensivos”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.
...
- `contracts/contexts/operations_audit/sec/threat-model-validado-scanning-e-testes-ofensivos/consolidacao/**`
- `docs/02-architecture/design-reviews/threat-model-validado-scanning-e-testes-ofensivos/consolidacao/**`
## Fora de escopo
...
`STORY-0747`, `STORY-0748`, `STORY-0749`
...
- `test_story_0245_slice_consolidation`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-041` e o TaskEnvelope `TASK-0245`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0355-01, AC-ISSUE-0355-02, AC-ISSUE-0355-03, AC-ISSUE-0355-04`
