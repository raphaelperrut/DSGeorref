# STORY-0420 / ISSUE-0530 — Implementar runner, worker ou scheduler: cancelamento cooperativo, supervisão de subprocessos, contenção e reconciliação
...
- **TaskEnvelope:** `.codex/tasks/TASK-0420.json`

## História de usuário

Como operador geoespacial, preciso implementar runner, worker ou scheduler para “cancelamento cooperativo, supervisão de subprocessos, contenção e reconciliação”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar runner, worker ou scheduler para a capacidade **cancelamento cooperativo, supervisão de subprocessos, contenção e reconciliação**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-067` e o TaskEnvelope `TASK-0420`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0530-01, AC-ISSUE-0530-02, AC-ISSUE-0530-03, AC-ISSUE-0530-04`
