# STORY-0680 / ISSUE-0790 — Automatizar verificações de publicação: Licenciamento, contribuição, rights manifests e citação
...
- **TaskEnvelope:** `.codex/tasks/TASK-0680.json`

## História de usuário

Como mantenedor do projeto, preciso automatizar verificações de publicação para “Licenciamento, contribuição, rights manifests e citação”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Automatizar verificações de publicação para a capacidade **Licenciamento, contribuição, rights manifests e citação**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/pub/licenciamento-contribuicao-rights-manifests-e-citacao/**`
- `tools/quality/contexts/release_installation/licenciamento-contribuicao-rights-manifests-e-citacao/**`
- `.github/workflows/licenciamento-contribuicao-rights-manifests-e-citacao.yaml`
## Fora de escopo
...
- [ ] O resultado de “Licenciamento, contribuição, rights manifests e citação” é observável por contrato, interface, artifact ou evidência executável.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-109` e o TaskEnvelope `TASK-0680`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0790-01, AC-ISSUE-0790-02, AC-ISSUE-0790-03, AC-ISSUE-0790-04`
