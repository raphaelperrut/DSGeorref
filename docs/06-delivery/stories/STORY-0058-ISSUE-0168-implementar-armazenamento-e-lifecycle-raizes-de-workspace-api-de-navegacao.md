# STORY-0058 / ISSUE-0168 — Implementar armazenamento e lifecycle: raízes de workspace, API de navegação segura, catálogo, hashes e lineage
...
- **TaskEnvelope:** `.codex/tasks/TASK-0058.json`

## História de usuário

Como operador geoespacial, preciso implementar armazenamento e lifecycle para “raízes de workspace, API de navegação segura, catálogo, hashes e lineage”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar armazenamento e lifecycle para a capacidade **raízes de workspace, API de navegação segura, catálogo, hashes e lineage**, com saída versionada, testes e evidência no commit candidato.
...
- `test_epic_012_armazenamento_roundtrip`
- `test_epic_012_armazenamento_recovery`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-012` e o TaskEnvelope `TASK-0058`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0168-01, AC-ISSUE-0168-02, AC-ISSUE-0168-03, AC-ISSUE-0168-04`
