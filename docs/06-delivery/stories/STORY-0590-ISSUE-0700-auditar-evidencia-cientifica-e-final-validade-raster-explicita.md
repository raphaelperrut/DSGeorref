# STORY-0590 / ISSUE-0700 — Auditar evidência científica e final: Validade raster explícita
...
- **TaskEnvelope:** `.codex/tasks/TASK-0590.json`

## História de usuário

Como operador geoespacial, preciso auditar evidência científica e final para “Validade raster explícita”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar evidência científica e final para a capacidade **Validade raster explícita**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/validade-raster-explicita/**`
## Fora de escopo
...
- `test_epic_095_aceite_happy_path`
- `test_epic_095_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-095` e o TaskEnvelope `TASK-0590`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0700-01, AC-ISSUE-0700-02, AC-ISSUE-0700-03, AC-ISSUE-0700-04`
