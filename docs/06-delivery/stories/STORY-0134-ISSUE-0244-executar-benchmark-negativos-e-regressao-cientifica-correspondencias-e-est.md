# STORY-0134 / ISSUE-0244 — Executar benchmark, negativos e regressão científica: correspondências e estimação robusta da homografia projetiva validadas
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0134.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “correspondências e estimação robusta da homografia projetiva validadas”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **correspondências e estimação robusta da homografia projetiva validadas**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/correspondencias-e-estimacao-robusta-da-homografia-pro/**`
- `tools/quality/contexts/georeferencing/correspondencias-e-estimacao-robusta-da-homografia-pro/**`
- `.github/workflows/correspondencias-e-estimacao-robusta-da-homografia-pro.yaml`
## Fora de escopo
...
`REQ-FS1-005`, `REQ-FS1-007`, `REQ-HOM-001`, `REQ-MCH-001`
...
`STORY-0130`, `STORY-0131`, `STORY-0132`, `STORY-0133`

## Critérios de aceitação

- [ ] O resultado de “correspondências e estimação robusta da homografia projetiva validadas” é observável por contrato, interface, artifact ou evidência executável.
- [ ] Os requisitos REQ-FS1-005, REQ-FS1-007, REQ-HOM-001, REQ-MCH-001 possuem evidência explícita no commit candidato.
...
- `test_projective_homography_only_no_hidden_fallback`
- `test_hybrid_matcher_escalation_provenance_no_ai_installation`
- `test_epic_023_benchmark_happy_path`
- `test_epic_023_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-023` e o TaskEnvelope `TASK-0134`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0244-01, AC-ISSUE-0244-02, AC-ISSUE-0244-03, AC-ISSUE-0244-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-043`, `ADR-046`, `ADR-055`
- **Conflito:** `Nenhum`
