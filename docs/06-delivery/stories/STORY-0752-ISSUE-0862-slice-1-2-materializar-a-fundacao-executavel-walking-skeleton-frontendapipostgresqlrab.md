# STORY-0752 / ISSUE-0862 — Slice 1/2 — Materializar a fundação executável: walking skeleton frontend→API→PostgreSQL→RabbitMQ/Celery→worker→artefato diagnóstico, executável e testado ponta a ponta [REQ-DEL, REQ-ISM, REQ-SPRINT-001]
...
- **TaskEnvelope:** `.codex/tasks/TASK-0752.json`
...
- `tools/governance/walking-skeleton-frontendapipostgresqlrabbitmq-celeryw/del-ism-sprint-001-parte-1/**`
- `docs/03-engineering/contexts/engineering_governance/walking-skeleton-frontendapipostgresqlrabbitmq-celeryw/del-ism-sprint-001-parte-1/**`
## Fora de escopo
...
`REQ-DEL-001`, `REQ-DEL-002`, `REQ-ISM-003`, `REQ-SPRINT-001-001`, `REQ-SPRINT-001-002`, `REQ-SPRINT-001-003`, `REQ-SPRINT-001-005`, `REQ-SPRINT-001-006`, `REQ-SPRINT-001-007`, `REQ-SPRINT-001-008`
...
- [ ] Cada requisito do slice possui evidência explícita: REQ-DEL-001, REQ-DEL-002, REQ-ISM-003, REQ-SPRINT-001-001, REQ-SPRINT-001-002, REQ-SPRINT-001-003, REQ-SPRINT-001-005, REQ-SPRINT-001-006, REQ-SPRINT-001-007, REQ-SPRINT-001-008.
...
Leia `AGENTS.md`, o papel `.codex/roles/ROLE-003-tech-lead.md`, esta história e `TASK-0752`. Trabalhe somente nos paths permitidos, entregue apenas este slice e interrompa diante de qualquer condição de parada.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0862-01, AC-ISSUE-0862-02, AC-ISSUE-0862-03, AC-ISSUE-0862-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-012`, `ADR-014`, `ADR-057`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-012`, `ADR-014`, `ADR-057`
