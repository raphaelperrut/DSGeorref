# STORY-0484 / ISSUE-0594 — Executar drills, fault injection e recuperação: budgets de cardinalidade, sampling, retenção por sinal e dashboards de perda/overhead
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0484.json`

## História de usuário

Como administrador da instância, preciso executar drills, fault injection e recuperação para “budgets de cardinalidade, sampling, retenção por sinal e dashboards de perda/overhead”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar drills, fault injection e recuperação para a capacidade **budgets de cardinalidade, sampling, retenção por sinal e dashboards de perda/overhead**, com saída versionada, testes e evidência no commit candidato.
...
- `test_epic_077_falhas_happy_path`
- `test_epic_077_falhas_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-077` e o TaskEnvelope `TASK-0484`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0594-01, AC-ISSUE-0594-02, AC-ISSUE-0594-03, AC-ISSUE-0594-04`
