# STORY-0545 / ISSUE-0655 — Definir hipótese, isolamento e critérios de promoção: namespace experimental/labs, registry separado, ModelPacks isolados e bloqueio técnico de ArtifactSet aceito
...
- **Papel executor:** `IA`
- **TaskEnvelope:** `.codex/tasks/TASK-0545.json`

## História de usuário

Como mantenedor científico, preciso definir hipótese, isolamento e critérios de promoção para “namespace experimental/labs, registry separado, ModelPacks isolados e bloqueio técnico de ArtifactSet aceito”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir hipótese, isolamento e critérios de promoção para a capacidade **namespace experimental/labs, registry separado, ModelPacks isolados e bloqueio técnico de ArtifactSet aceito**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/ai/dsgeorref_ai/contexts/ai_recovery/namespace-experimental-labs-registry-separado-modelpac/**`
## Fora de escopo
...
`STORY-0308`, `STORY-0504`, `STORY-0281`

## Critérios de aceitação

- [ ] O resultado de “namespace experimental/labs, registry separado, ModelPacks isolados e bloqueio técnico de ArtifactSet aceito” é observável por contrato, interface, artifact ou evidência executável.
...
- [ ] Hipótese, baseline, métrica, budget e critério de abandono são definidos antes da execução.

## Testes obrigatórios

- `test_epic_088_hipotese`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-006-ia.md`, este documento, o épico `EPIC-088` e o TaskEnvelope `TASK-0545`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Atributos de qualidade dominantes:** `reprodutibilidade`, `explicabilidade`, `segurança de modelos`
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0655-01, AC-ISSUE-0655-02, AC-ISSUE-0655-03, AC-ISSUE-0655-04`
- **Base de requisitos:** `DERIVED_CONTROL`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-051`, `ADR-052`, `ADR-053`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-051`, `ADR-052`, `ADR-053`
