# STORY-0657 / ISSUE-0767 — Expor serviços e integrar consumers: Registry de schemas e compatibilidade de artifacts
...
- **TaskEnvelope:** `.codex/tasks/TASK-0657.json`

## História de usuário

Como operador geoespacial, preciso expor serviços e integrar consumers para “Registry de schemas e compatibilidade de artifacts”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Expor serviços e integrar consumers para a capacidade **Registry de schemas e compatibilidade de artifacts**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-105` e o TaskEnvelope `TASK-0657`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0767-01, AC-ISSUE-0767-02, AC-ISSUE-0767-03, AC-ISSUE-0767-04`
