# STORY-0606 / ISSUE-0716 — Preparar corpus, fixtures e representação tipada: Mosaico relativo de recuperação
...
- **TaskEnvelope:** `.codex/tasks/TASK-0606.json`

## História de usuário

Como operador geoespacial, preciso preparar corpus, fixtures e representação tipada para “Mosaico relativo de recuperação”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Preparar corpus, fixtures e representação tipada para a capacidade **Mosaico relativo de recuperação**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/geo/dsgeorref_geo/contexts/relative_mosaic/mosaico-relativo-de-recuperacao/**`
## Fora de escopo
...
`REQ-MOS-002`, `REQ-MOS-004`, `REQ-MOS-006`, `REQ-RMR-004`
...
- [ ] Os requisitos REQ-MOS-002, REQ-MOS-004, REQ-MOS-006, REQ-RMR-004 possuem evidência explícita no commit candidato.
...
- `test_budgeted_neighbor_graph_disconnected_components_and_singletons`
- `test_out_of_core_pair_tile_rendering_ram_disk_quotas_and_resume`
- `test_overlap_source_stack_seamline_analytical_preview_blend_and_provenance`
- `test_hierarchical_tile_region_provenance_and_dense_on_demand_limits`
- `test_epic_098_dados`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-098` e o TaskEnvelope `TASK-0606`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0716-01, AC-ISSUE-0716-02, AC-ISSUE-0716-03, AC-ISSUE-0716-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-040`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-044`, `ADR-049`, `ADR-050`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-040`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-044`, `ADR-049`, `ADR-050`
...
- **Resultado:** `PASS`
- **Risk tier:** `HIGH`
- **Controles aplicáveis:** `CTO-001, CTO-003, CTO-004, CTO-005, CTO-006, CTO-007, CTO-008, CTO-009, CTO-010, CTO-012, CTO-013, CTO-015`
