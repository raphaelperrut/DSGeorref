# STORY-0514 / ISSUE-0624 — Validar ameaças, autorização e falhas: preflight de hardware e ExecutionProfiles CPU/GPU/híbrido integrados ao Resource Governor
...
- **TaskEnvelope:** `.codex/tasks/TASK-0514.json`

## História de usuário

Como administrador da instância, preciso validar ameaças, autorização e falhas para “preflight de hardware e ExecutionProfiles CPU/GPU/híbrido integrados ao Resource Governor”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Validar ameaças, autorização e falhas para a capacidade **preflight de hardware e ExecutionProfiles CPU/GPU/híbrido integrados ao Resource Governor**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/operations_audit/adapters/security/preflight-de-hardware-e-executionprofiles-cpu-gpu-hibr/**`
- `tests/security/contexts/operations_audit/preflight-de-hardware-e-executionprofiles-cpu-gpu-hibr/**`
## Fora de escopo
...
- `test_epic_082_seguranca_happy_path`
- `test_epic_082_seguranca_negative_paths`
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0624-01, AC-ISSUE-0624-02, AC-ISSUE-0624-03, AC-ISSUE-0624-04`
