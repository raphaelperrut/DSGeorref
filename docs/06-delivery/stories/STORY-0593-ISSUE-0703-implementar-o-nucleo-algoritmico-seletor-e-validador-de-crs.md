# STORY-0593 / ISSUE-0703 — Implementar o núcleo algorítmico: Seletor e validador de CRS
...
- **TaskEnvelope:** `.codex/tasks/TASK-0593.json`

## História de usuário

Como operador geoespacial, preciso implementar o núcleo algorítmico para “Seletor e validador de CRS”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar o núcleo algorítmico para a capacidade **Seletor e validador de CRS**, com saída versionada, testes e evidência no commit candidato.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0703-01, AC-ISSUE-0703-02, AC-ISSUE-0703-03, AC-ISSUE-0703-04`
