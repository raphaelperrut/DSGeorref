# STORY-0719 / ISSUE-0829 — Slice 2/3 — Implementar persistência e migrations: raízes de workspace, API de navegação segura, catálogo, hashes e lineage [REQ-PRV, REQ-RUN, REQ-SCM, REQ-TOOL]
...
- **TaskEnvelope:** `.codex/tasks/TASK-0719.json`
...
- `src/backend/dsgeorref/contexts/project_workspace/application/raizes-de-workspace-api-de-navegacao-segura-catalogo-h/prv-run-scm-parte-2/**`
- `src/backend/dsgeorref/contexts/project_workspace/adapters/raizes-de-workspace-api-de-navegacao-segura-catalogo-h/prv-run-scm-parte-2/**`
## Fora de escopo
...
`REQ-PRV-001`, `REQ-RUN-002`, `REQ-RUN-003`, `REQ-RUN-004`, `REQ-RUN-005`, `REQ-RUN-007`, `REQ-RUN-009`, `REQ-SCM-002`, `REQ-TOOL-004`, `REQ-TOOL-005`
...
- [ ] Cada requisito do slice possui evidência explícita: REQ-PRV-001, REQ-RUN-002, REQ-RUN-003, REQ-RUN-004, REQ-RUN-005, REQ-RUN-007, REQ-RUN-009, REQ-SCM-002, REQ-TOOL-004, REQ-TOOL-005.
...
Leia `AGENTS.md`, o papel `.codex/roles/ROLE-004-backend.md`, esta história e `TASK-0719`. Trabalhe somente nos paths permitidos, entregue apenas este slice e interrompa diante de qualquer condição de parada.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0829-01, AC-ISSUE-0829-02, AC-ISSUE-0829-03, AC-ISSUE-0829-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-001`, `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-016`, `ADR-018`, `ADR-026`, `ADR-040`, `ADR-045`, `ADR-055`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-001`, `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-012`, `ADR-013`, `ADR-014`, `ADR-015`, `ADR-016`, `ADR-018`, `ADR-019`, `ADR-020`, `ADR-023`, `ADR-025`, `ADR-026`, `ADR-040`, `ADR-045`, `ADR-055`
