# STORY-0436 / ISSUE-0546 — Automatizar testes de resiliência, retry e recuperação: Observabilidade, SLOs e diagnóstico do scheduler
...
- **TaskEnvelope:** `.codex/tasks/TASK-0436.json`

## História de usuário

Como operador geoespacial, preciso automatizar testes de resiliência, retry e recuperação para “Observabilidade, SLOs e diagnóstico do scheduler”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Automatizar testes de resiliência, retry e recuperação para a capacidade **Observabilidade, SLOs e diagnóstico do scheduler**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/job/observabilidade-slos-e-diagnostico-do-scheduler/**`
- `tools/quality/contexts/job_orchestration/observabilidade-slos-e-diagnostico-do-scheduler/**`
- `.github/workflows/observabilidade-slos-e-diagnostico-do-scheduler.yaml`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-069` e o TaskEnvelope `TASK-0436`. Trabalhe somente nos paths permitidos. Entregue o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0546-01, AC-ISSUE-0546-02, AC-ISSUE-0546-03, AC-ISSUE-0546-04`
