# STORY-0393 / ISSUE-0503 — Implementar o núcleo algorítmico: modelo tipado/versionado de GCPs, lifecycle, proveniência e round-trip dos exports
...
- **TaskEnvelope:** `.codex/tasks/TASK-0393.json`

## História de usuário

Como operador geoespacial, preciso implementar o núcleo algorítmico para “modelo tipado/versionado de GCPs, lifecycle, proveniência e round-trip dos exports”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar o núcleo algorítmico para a capacidade **modelo tipado/versionado de GCPs, lifecycle, proveniência e round-trip dos exports**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-063` e o TaskEnvelope `TASK-0393`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0503-01, AC-ISSUE-0503-02, AC-ISSUE-0503-03, AC-ISSUE-0503-04`
