# STORY-0679 / ISSUE-0789 — Materializar notices, citação e manifests: Licenciamento, contribuição, rights manifests e citação
...
- **TaskEnvelope:** `.codex/tasks/TASK-0679.json`

## História de usuário

Como mantenedor do projeto, preciso materializar notices, citação e manifests para “Licenciamento, contribuição, rights manifests e citação”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Materializar notices, citação e manifests para a capacidade **Licenciamento, contribuição, rights manifests e citação**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/release_installation/application/licenciamento-contribuicao-rights-manifests-e-citacao/**`
## Fora de escopo
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0789-01, AC-ISSUE-0789-02, AC-ISSUE-0789-03, AC-ISSUE-0789-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-016`
