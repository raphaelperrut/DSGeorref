# STORY-0246 / ISSUE-0356 — Implementar controles e enforcement: threat model validado, scanning e testes ofensivos
...
- **TaskEnvelope:** `.codex/tasks/TASK-0246.json`

## História de usuário

Como administrador de segurança, preciso implementar controles e enforcement para “threat model validado, scanning e testes ofensivos”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar controles e enforcement para a capacidade **threat model validado, scanning e testes ofensivos**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/operations_audit/application/threat-model-validado-scanning-e-testes-ofensivos/**`
- `src/backend/dsgeorref/contexts/operations_audit/adapters/threat-model-validado-scanning-e-testes-ofensivos/**`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-041` e o TaskEnvelope `TASK-0246`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0356-01, AC-ISSUE-0356-02, AC-ISSUE-0356-03, AC-ISSUE-0356-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-016`, `ADR-018`, `ADR-019`, `ADR-023`
