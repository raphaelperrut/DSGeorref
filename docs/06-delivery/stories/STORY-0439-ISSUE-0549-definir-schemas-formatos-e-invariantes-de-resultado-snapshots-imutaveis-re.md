# STORY-0439 / ISSUE-0549 — Definir schemas, formatos e invariantes de resultado: snapshots imutáveis, regra de resultado vigente e comparação entre ciclos
...
- **TaskEnvelope:** `.codex/tasks/TASK-0439.json`

## História de usuário

Como revisor e auditor, preciso definir schemas, formatos e invariantes de resultado para “snapshots imutáveis, regra de resultado vigente e comparação entre ciclos”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir schemas, formatos e invariantes de resultado para a capacidade **snapshots imutáveis, regra de resultado vigente e comparação entre ciclos**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/results_reporting/rep/snapshots-imutaveis-regra-de-resultado-vigente-e-compa/**`
- `docs/02-architecture/design-reviews/snapshots-imutaveis-regra-de-resultado-vigente-e-compa/**`
## Fora de escopo
...
`STORY-0225`, `STORY-0301`, `STORY-0390`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-070` e o TaskEnvelope `TASK-0439`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0549-01, AC-ISSUE-0549-02, AC-ISSUE-0549-03, AC-ISSUE-0549-04`
