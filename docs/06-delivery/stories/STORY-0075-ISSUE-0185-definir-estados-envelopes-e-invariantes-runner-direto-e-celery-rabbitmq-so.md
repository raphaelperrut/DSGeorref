# STORY-0075 / ISSUE-0185 — Definir estados, envelopes e invariantes: runner direto e Celery/RabbitMQ sobre o mesmo núcleo
...
- **TaskEnvelope:** `.codex/tasks/TASK-0075.json`

## História de usuário

Como operador geoespacial, preciso definir estados, envelopes e invariantes para “runner direto e Celery/RabbitMQ sobre o mesmo núcleo”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir estados, envelopes e invariantes para a capacidade **runner direto e Celery/RabbitMQ sobre o mesmo núcleo**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/job_orchestration/job/runner-direto-e-celery-rabbitmq-sobre-o-mesmo-nucleo/**`
- `docs/02-architecture/design-reviews/runner-direto-e-celery-rabbitmq-sobre-o-mesmo-nucleo/**`
## Fora de escopo
...
- [ ] Os requisitos REQ-EPIC-015, REQ-TOP-001 possuem evidência explícita no commit candidato.
...
- `test_small_messages_duplicate_redelivery_authoritative_state`
- `cli_api_semantic_contract`
- `test_epic_015_contrato`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-015` e o TaskEnvelope `TASK-0075`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0185-01, AC-ISSUE-0185-02, AC-ISSUE-0185-03, AC-ISSUE-0185-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-014`, `ADR-018`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-014`, `ADR-016`, `ADR-018`
