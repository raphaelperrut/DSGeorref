# STORY-0125 / ISSUE-0235 — Integrar ao ProcessingPlan e pipeline: busca provável greenfield validada
...
- **TaskEnvelope:** `.codex/tasks/TASK-0125.json`

## História de usuário

Como operador geoespacial, preciso integrar ao processingplan e pipeline para “busca provável greenfield validada”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Integrar ao ProcessingPlan e pipeline para a capacidade **busca provável greenfield validada**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-022` e o TaskEnvelope `TASK-0125`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0235-01, AC-ISSUE-0235-02, AC-ISSUE-0235-03, AC-ISSUE-0235-04`
