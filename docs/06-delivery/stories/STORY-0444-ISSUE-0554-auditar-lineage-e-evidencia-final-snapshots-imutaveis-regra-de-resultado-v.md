# STORY-0444 / ISSUE-0554 — Auditar lineage e evidência final: snapshots imutáveis, regra de resultado vigente e comparação entre ciclos
...
- **TaskEnvelope:** `.codex/tasks/TASK-0444.json`

## História de usuário

Como revisor e auditor, preciso auditar lineage e evidência final para “snapshots imutáveis, regra de resultado vigente e comparação entre ciclos”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar lineage e evidência final para a capacidade **snapshots imutáveis, regra de resultado vigente e comparação entre ciclos**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/snapshots-imutaveis-regra-de-resultado-vigente-e-compa/**`
## Fora de escopo
...
- `test_epic_070_aceite_happy_path`
- `test_epic_070_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-070` e o TaskEnvelope `TASK-0444`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0554-01, AC-ISSUE-0554-02, AC-ISSUE-0554-03, AC-ISSUE-0554-04`
