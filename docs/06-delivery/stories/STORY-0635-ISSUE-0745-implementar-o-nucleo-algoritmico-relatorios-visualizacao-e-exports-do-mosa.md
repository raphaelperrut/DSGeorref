# STORY-0635 / ISSUE-0745 — Implementar o núcleo algorítmico: Relatórios, visualização e exports do mosaico relativo
...
- **TaskEnvelope:** `.codex/tasks/TASK-0635.json`

## História de usuário

Como operador geoespacial, preciso implementar o núcleo algorítmico para “Relatórios, visualização e exports do mosaico relativo”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar o núcleo algorítmico para a capacidade **Relatórios, visualização e exports do mosaico relativo**, com saída versionada, testes e evidência no commit candidato.
...
- [ ] Os requisitos REQ-RMR-002 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-102` e o TaskEnvelope `TASK-0635`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0745-01, AC-ISSUE-0745-02, AC-ISSUE-0745-03, AC-ISSUE-0745-04`
