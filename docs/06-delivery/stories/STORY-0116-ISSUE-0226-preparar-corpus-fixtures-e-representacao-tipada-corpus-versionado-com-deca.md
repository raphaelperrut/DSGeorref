# STORY-0116 / ISSUE-0226 — Consolidar slices e liberar integração: corpus versionado com décadas e condições distintas
...
- **TaskEnvelope:** `.codex/tasks/TASK-0116.json`

## História de usuário

Como operador geoespacial, preciso preparar corpus, fixtures e representação tipada para “corpus versionado com décadas e condições distintas”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.
...
- `src/geo/dsgeorref_geo/contexts/geometric_quality/corpus-versionado-com-decadas-e-condicoes-distintas/consolidacao/**`
## Fora de escopo
...
- `test_story_0116_slice_consolidation`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-021` e o TaskEnvelope `TASK-0116`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0226-01, AC-ISSUE-0226-02, AC-ISSUE-0226-03, AC-ISSUE-0226-04`
