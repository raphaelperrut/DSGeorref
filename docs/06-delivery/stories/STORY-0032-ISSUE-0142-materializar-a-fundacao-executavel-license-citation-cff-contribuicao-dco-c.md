# STORY-0032 / ISSUE-0142 — Materializar a fundação executável: LICENSE, CITATION.cff, contribuição, DCO/CLA e gate de publicação definidos
...
- **TaskEnvelope:** `.codex/tasks/TASK-0032.json`

## História de usuário

Como mantenedor de engenharia, preciso materializar a fundação executável para “LICENSE, CITATION.cff, contribuição, DCO/CLA e gate de publicação definidos”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Materializar a fundação executável para a capacidade **LICENSE, CITATION.cff, contribuição, DCO/CLA e gate de publicação definidos**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tools/governance/license-citation-cff-contribuicao-dco-cla-e-gate-de-pu/**`
- `docs/03-engineering/contexts/engineering_governance/license-citation-cff-contribuicao-dco-cla-e-gate-de-pu/**`
## Fora de escopo
...
`REQ-CIT-001`, `REQ-EPIC-042`, `REQ-OSS-001`, `REQ-PUB-002`
...
- [ ] O resultado de “LICENSE, CITATION.cff, contribuição, DCO/CLA e gate de publicação definidos” é observável por contrato, interface, artifact ou evidência executável.
- [ ] Os requisitos REQ-CIT-001, REQ-EPIC-042, REQ-OSS-001, REQ-PUB-002 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-003-tech-lead.md`, este documento, o épico `EPIC-007` e o TaskEnvelope `TASK-0032`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0142-01, AC-ISSUE-0142-02, AC-ISSUE-0142-03, AC-ISSUE-0142-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-002`, `ADR-003`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-037`, `ADR-056`, `ADR-057`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-002`, `ADR-003`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-037`, `ADR-056`, `ADR-057`
