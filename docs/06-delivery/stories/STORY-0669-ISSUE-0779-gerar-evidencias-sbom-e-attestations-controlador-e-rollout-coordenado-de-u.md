# STORY-0669 / ISSUE-0779 — Gerar evidências, SBOM e attestations: Controlador e rollout coordenado de upgrades
...
- **TaskEnvelope:** `.codex/tasks/TASK-0669.json`

## História de usuário

Como responsável por release, preciso gerar evidências, sbom e attestations para “Controlador e rollout coordenado de upgrades”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Gerar evidências, SBOM e attestations para a capacidade **Controlador e rollout coordenado de upgrades**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/release_installation/adapters/security/controlador-e-rollout-coordenado-de-upgrades/**`
- `tests/security/contexts/release_installation/controlador-e-rollout-coordenado-de-upgrades/**`
## Fora de escopo
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0779-01, AC-ISSUE-0779-02, AC-ISSUE-0779-03, AC-ISSUE-0779-04`
