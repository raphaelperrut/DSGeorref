# STORY-0238 / ISSUE-0348 — Definir SLO, runbook e controles operacionais: benchmark, limites e orçamento de recursos
...
- **TaskEnvelope:** `.codex/tasks/TASK-0238.json`

## História de usuário

Como administrador da instância, preciso definir slo, runbook e controles operacionais para “benchmark, limites e orçamento de recursos”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir SLO, runbook e controles operacionais para a capacidade **benchmark, limites e orçamento de recursos**, com saída versionada, testes e evidência no commit candidato.
...
`STORY-0142`, `STORY-0237`, `STORY-0431`, `STORY-0438`
...
- [ ] Os requisitos REQ-OUT-001, REQ-SCH-004 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-040` e o TaskEnvelope `TASK-0238`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0348-01, AC-ISSUE-0348-02, AC-ISSUE-0348-03, AC-ISSUE-0348-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-010`, `ADR-011`, `ADR-033`, `ADR-034`, `ADR-039`, `ADR-042`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-010`, `ADR-011`, `ADR-012`, `ADR-033`, `ADR-034`, `ADR-039`, `ADR-042`
