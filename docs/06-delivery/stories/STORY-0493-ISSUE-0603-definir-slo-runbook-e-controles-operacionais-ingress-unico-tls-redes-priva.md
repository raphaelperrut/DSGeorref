# STORY-0493 / ISSUE-0603 — Definir SLO, runbook e controles operacionais: ingress único, TLS, redes privadas, limites e testes de exposição de portas
...
- **TaskEnvelope:** `.codex/tasks/TASK-0493.json`

## História de usuário

Como administrador da instância, preciso definir slo, runbook e controles operacionais para “ingress único, TLS, redes privadas, limites e testes de exposição de portas”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir SLO, runbook e controles operacionais para a capacidade **ingress único, TLS, redes privadas, limites e testes de exposição de portas**, com saída versionada, testes e evidência no commit candidato.
...
`STORY-0015`, `STORY-0040`, `STORY-0492`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-079` e o TaskEnvelope `TASK-0493`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0603-01, AC-ISSUE-0603-02, AC-ISSUE-0603-03, AC-ISSUE-0603-04`
