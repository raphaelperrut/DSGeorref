# STORY-0600 / ISSUE-0710 — Implementar o núcleo algorítmico: Grade, resolução e reamostragem
...
- **TaskEnvelope:** `.codex/tasks/TASK-0600.json`

## História de usuário

Como operador geoespacial, preciso implementar o núcleo algorítmico para “Grade, resolução e reamostragem”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar o núcleo algorítmico para a capacidade **Grade, resolução e reamostragem**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-097` e o TaskEnvelope `TASK-0600`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0710-01, AC-ISSUE-0710-02, AC-ISSUE-0710-03, AC-ISSUE-0710-04`
