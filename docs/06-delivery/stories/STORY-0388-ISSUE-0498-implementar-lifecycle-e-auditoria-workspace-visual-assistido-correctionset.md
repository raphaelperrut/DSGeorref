# STORY-0388 / ISSUE-0498 — Implementar lifecycle e auditoria: workspace visual assistido, CorrectionSets, nova tentativa, comparação e auditoria sem bloquear o ciclo automático
...
- **TaskEnvelope:** `.codex/tasks/TASK-0388.json`

## História de usuário

Como revisor geoespacial, preciso implementar lifecycle e auditoria para “workspace visual assistido, CorrectionSets, nova tentativa, comparação e auditoria sem bloquear o ciclo automático”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar lifecycle e auditoria para a capacidade **workspace visual assistido, CorrectionSets, nova tentativa, comparação e auditoria sem bloquear o ciclo automático**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/review_correction/application/workspace-visual-assistido-correctionsets-nova-tentati/**`
- `src/backend/dsgeorref/contexts/review_correction/adapters/workspace-visual-assistido-correctionsets-nova-tentati/**`
## Fora de escopo
...
- [ ] Os requisitos REQ-REV-004 possuem evidência explícita no commit candidato.
...
- `test_review_queue_explainable_priority_no_bulk_approval`
- `test_epic_062_backend`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-062` e o TaskEnvelope `TASK-0388`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0498-01, AC-ISSUE-0498-02, AC-ISSUE-0498-03, AC-ISSUE-0498-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-016`, `ADR-048`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-016`, `ADR-018`, `ADR-019`, `ADR-048`
