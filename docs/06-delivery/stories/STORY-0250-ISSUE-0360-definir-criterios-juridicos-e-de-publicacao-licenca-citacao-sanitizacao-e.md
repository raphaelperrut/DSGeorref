# STORY-0250 / ISSUE-0360 — Definir critérios jurídicos e de publicação: licença, citação, sanitização e revisão externa concluídas
...
- **TaskEnvelope:** `.codex/tasks/TASK-0250.json`

## História de usuário

Como mantenedor do projeto, preciso definir critérios jurídicos e de publicação para “licença, citação, sanitização e revisão externa concluídas”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir critérios jurídicos e de publicação para a capacidade **licença, citação, sanitização e revisão externa concluídas**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `docs/01-product/capabilities/licenca-citacao-sanitizacao-e-revisao-externa-concluid/**`
## Fora de escopo
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0360-01, AC-ISSUE-0360-02, AC-ISSUE-0360-03, AC-ISSUE-0360-04`
