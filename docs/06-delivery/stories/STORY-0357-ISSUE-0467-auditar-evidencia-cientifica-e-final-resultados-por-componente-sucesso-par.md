# STORY-0357 / ISSUE-0467 — Auditar evidência científica e final: resultados por componente, sucesso parcial explícito, retry por subconjunto e UX de componentes não resolvidos
...
- **TaskEnvelope:** `.codex/tasks/TASK-0357.json`

## História de usuário

Como operador geoespacial, preciso auditar evidência científica e final para “resultados por componente, sucesso parcial explícito, retry por subconjunto e UX de componentes não resolvidos”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar evidência científica e final para a capacidade **resultados por componente, sucesso parcial explícito, retry por subconjunto e UX de componentes não resolvidos**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/resultados-por-componente-sucesso-parcial-explicito-re/**`
## Fora de escopo
...
- `test_epic_057_aceite_happy_path`
- `test_epic_057_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-057` e o TaskEnvelope `TASK-0357`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0467-01, AC-ISSUE-0467-02, AC-ISSUE-0467-03, AC-ISSUE-0467-04`
