# STORY-0342 / ISSUE-0452 — Executar benchmark, negativos e regressão científica: recuperação progressiva de vizinhos com candidate budget, telemetria de recall e retry ampliado explícito
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0342.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “recuperação progressiva de vizinhos com candidate budget, telemetria de recall e retry ampliado explícito”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **recuperação progressiva de vizinhos com candidate budget, telemetria de recall e retry ampliado explícito**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/recuperacao-progressiva-de-vizinhos-com-candidate-budg/**`
- `tools/quality/contexts/reference_discovery/recuperacao-progressiva-de-vizinhos-com-candidate-budg/**`
- `.github/workflows/recuperacao-progressiva-de-vizinhos-com-candidate-budg.yaml`
## Fora de escopo
...
`STORY-0338`, `STORY-0339`, `STORY-0340`, `STORY-0341`

## Critérios de aceitação

- [ ] O resultado de “recuperação progressiva de vizinhos com candidate budget, telemetria de recall e retry ampliado explícito” é observável por contrato, interface, artifact ou evidência executável.
...
- `test_epic_055_benchmark_happy_path`
- `test_epic_055_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-055` e o TaskEnvelope `TASK-0342`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0452-01, AC-ISSUE-0452-02, AC-ISSUE-0452-03, AC-ISSUE-0452-04`
