# STORY-0612 / ISSUE-0722 — Definir contrato científico e invariantes: Ancoragem e recuperação a partir do mosaico relativo
...
- **TaskEnvelope:** `.codex/tasks/TASK-0612.json`

## História de usuário

Como operador geoespacial, preciso definir contrato científico e invariantes para “Ancoragem e recuperação a partir do mosaico relativo”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir contrato científico e invariantes para a capacidade **Ancoragem e recuperação a partir do mosaico relativo**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/relative_mosaic/geo/ancoragem-e-recuperacao-a-partir-do-mosaico-relativo/**`
- `docs/02-architecture/design-reviews/ancoragem-e-recuperacao-a-partir-do-mosaico-relativo/**`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-099` e o TaskEnvelope `TASK-0612`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0722-01, AC-ISSUE-0722-02, AC-ISSUE-0722-03, AC-ISSUE-0722-04`
