# STORY-0661 / ISSUE-0771 — Implementar pipeline e artifacts de release: Migrations compatíveis, upgrade e downgrade seguro
...
- **TaskEnvelope:** `.codex/tasks/TASK-0661.json`

## História de usuário

Como responsável por release, preciso implementar pipeline e artifacts de release para “Migrations compatíveis, upgrade e downgrade seguro”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar pipeline e artifacts de release para a capacidade **Migrations compatíveis, upgrade e downgrade seguro**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-106` e o TaskEnvelope `TASK-0661`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0771-01, AC-ISSUE-0771-02, AC-ISSUE-0771-03, AC-ISSUE-0771-04`
