# STORY-0098 / ISSUE-0208 — Implementar runner, worker ou scheduler: batch hierárquico, chunking, backpressure, checkpoints e retomada para lotes usuais de 40–300 imagens
...
- **TaskEnvelope:** `.codex/tasks/TASK-0098.json`

## História de usuário

Como operador geoespacial, preciso implementar runner, worker ou scheduler para “batch hierárquico, chunking, backpressure, checkpoints e retomada para lotes usuais de 40–300 imagens”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar runner, worker ou scheduler para a capacidade **batch hierárquico, chunking, backpressure, checkpoints e retomada para lotes usuais de 40–300 imagens**, com saída versionada, testes e evidência no commit candidato.
...
`REQ-BEX-007`, `REQ-BEX-008`, `REQ-BEX-009`, `REQ-EPIC-018`
...
- [ ] Os requisitos REQ-BEX-007, REQ-BEX-008, REQ-BEX-009, REQ-EPIC-018 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-018` e o TaskEnvelope `TASK-0098`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0208-01, AC-ISSUE-0208-02, AC-ISSUE-0208-03, AC-ISSUE-0208-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-016`, `ADR-037`, `ADR-038`, `ADR-040`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-016`, `ADR-018`, `ADR-019`, `ADR-037`, `ADR-038`, `ADR-040`
