# STORY-0479 / ISSUE-0589 — Instrumentar detecção, resposta e runbook: catálogo de campos, redaction centralizada, testes de vazamento e bundles de suporte sanitizados
...
- **TaskEnvelope:** `.codex/tasks/TASK-0479.json`

## História de usuário

Como administrador de segurança, preciso instrumentar detecção, resposta e runbook para “catálogo de campos, redaction centralizada, testes de vazamento e bundles de suporte sanitizados”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Instrumentar detecção, resposta e runbook para a capacidade **catálogo de campos, redaction centralizada, testes de vazamento e bundles de suporte sanitizados**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/sec/catalogo-de-campos-redaction-centralizada-testes-de-va/**`
- `tools/quality/contexts/operations_audit/catalogo-de-campos-redaction-centralizada-testes-de-va/**`
- `.github/workflows/catalogo-de-campos-redaction-centralizada-testes-de-va.yaml`
## Fora de escopo
...
`STORY-0476`, `STORY-0477`, `STORY-0478`
...
- [ ] Alertas e runbook indicam owner, diagnóstico, contenção e recuperação.

## Testes obrigatórios

- `test_epic_076_operacao`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-076` e o TaskEnvelope `TASK-0479`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0589-01, AC-ISSUE-0589-02, AC-ISSUE-0589-03, AC-ISSUE-0589-04`
