# STORY-0430 / ISSUE-0540 — Executar integração real, carga e fault injection: Concorrência, escalonamento e isolamento
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0430.json`

## História de usuário

Como operador geoespacial, preciso executar integração real, carga e fault injection para “Concorrência, escalonamento e isolamento”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar integração real, carga e fault injection para a capacidade **Concorrência, escalonamento e isolamento**, com saída versionada, testes e evidência no commit candidato.
...
`STORY-0426`, `STORY-0427`, `STORY-0428`, `STORY-0429`
...
- `test_epic_068_validacao_happy_path`
- `test_epic_068_validacao_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-068` e o TaskEnvelope `TASK-0430`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0540-01, AC-ISSUE-0540-02, AC-ISSUE-0540-03, AC-ISSUE-0540-04`
