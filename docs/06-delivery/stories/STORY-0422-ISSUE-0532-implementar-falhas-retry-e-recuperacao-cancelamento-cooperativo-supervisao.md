# STORY-0422 / ISSUE-0532 — Automatizar testes de resiliência, retry e recuperação: cancelamento cooperativo, supervisão de subprocessos, contenção e reconciliação
...
- **TaskEnvelope:** `.codex/tasks/TASK-0422.json`

## História de usuário

Como operador geoespacial, preciso automatizar testes de resiliência, retry e recuperação para “cancelamento cooperativo, supervisão de subprocessos, contenção e reconciliação”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Automatizar testes de resiliência, retry e recuperação para a capacidade **cancelamento cooperativo, supervisão de subprocessos, contenção e reconciliação**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/job/cancelamento-cooperativo-supervisao-de-subprocessos-co/**`
- `tools/quality/contexts/job_orchestration/cancelamento-cooperativo-supervisao-de-subprocessos-co/**`
- `.github/workflows/cancelamento-cooperativo-supervisao-de-subprocessos-co.yaml`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-067` e o TaskEnvelope `TASK-0422`. Trabalhe somente nos paths permitidos. Entregue o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0532-01, AC-ISSUE-0532-02, AC-ISSUE-0532-03, AC-ISSUE-0532-04`
