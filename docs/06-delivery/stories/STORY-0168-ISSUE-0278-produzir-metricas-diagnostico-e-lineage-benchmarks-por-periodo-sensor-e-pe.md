# STORY-0168 / ISSUE-0278 — Produzir métricas, diagnóstico e lineage: benchmarks por período, sensor e perfil de qualidade
...
- **TaskEnvelope:** `.codex/tasks/TASK-0168.json`

## História de usuário

Como operador geoespacial, preciso produzir métricas, diagnóstico e lineage para “benchmarks por período, sensor e perfil de qualidade”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Produzir métricas, diagnóstico e lineage para a capacidade **benchmarks por período, sensor e perfil de qualidade**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-028` e o TaskEnvelope `TASK-0168`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0278-01, AC-ISSUE-0278-02, AC-ISSUE-0278-03, AC-ISSUE-0278-04`
