# STORY-0227 / ISSUE-0337 — Implementar persistência e snapshots: métricas, heatmap amostrado e diagnóstico denso do Image Deformation Profile
...
- **TaskEnvelope:** `.codex/tasks/TASK-0227.json`

## História de usuário

Como revisor e auditor, preciso implementar persistência e snapshots para “métricas, heatmap amostrado e diagnóstico denso do Image Deformation Profile”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar persistência e snapshots para a capacidade **métricas, heatmap amostrado e diagnóstico denso do Image Deformation Profile**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/geometric_quality/application/metricas-heatmap-amostrado-e-diagnostico-denso-do-imag/**`
- `src/backend/dsgeorref/contexts/geometric_quality/adapters/metricas-heatmap-amostrado-e-diagnostico-denso-do-imag/**`
## Fora de escopo
...
- [ ] O resultado de “métricas, heatmap amostrado e diagnóstico denso do Image Deformation Profile” é observável por contrato, interface, artifact ou evidência executável.
- [ ] Os requisitos REQ-QUAL-005 possuem evidência explícita no commit candidato.
...
- `test_epic_038_persistencia_roundtrip`
- `test_epic_038_persistencia_recovery`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-038` e o TaskEnvelope `TASK-0227`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0337-01, AC-ISSUE-0337-02, AC-ISSUE-0337-03, AC-ISSUE-0337-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-016`, `ADR-046`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-016`, `ADR-046`
