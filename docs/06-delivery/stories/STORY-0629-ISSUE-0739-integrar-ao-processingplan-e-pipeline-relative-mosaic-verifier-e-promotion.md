# STORY-0629 / ISSUE-0739 — Integrar ao ProcessingPlan e pipeline: Relative Mosaic Verifier e promotion lifecycle
...
- **TaskEnvelope:** `.codex/tasks/TASK-0629.json`

## História de usuário

Como operador geoespacial, preciso integrar ao processingplan e pipeline para “Relative Mosaic Verifier e promotion lifecycle”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Integrar ao ProcessingPlan e pipeline para a capacidade **Relative Mosaic Verifier e promotion lifecycle**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-101` e o TaskEnvelope `TASK-0629`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0739-01, AC-ISSUE-0739-02, AC-ISSUE-0739-03, AC-ISSUE-0739-04`
