# STORY-0290 / ISSUE-0400 — Preparar corpus, fixtures e representação tipada: extração opcional de metadados marginais com confiança, revisão e lineage
...
- **TaskEnvelope:** `.codex/tasks/TASK-0290.json`

## História de usuário

Como operador geoespacial, preciso preparar corpus, fixtures e representação tipada para “extração opcional de metadados marginais com confiança, revisão e lineage”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Preparar corpus, fixtures e representação tipada para a capacidade **extração opcional de metadados marginais com confiança, revisão e lineage**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/geo/dsgeorref_geo/contexts/georeferencing/extracao-opcional-de-metadados-marginais-com-confianca/**`
## Fora de escopo
...
- [ ] Os requisitos REQ-MTD-001 possuem evidência explícita no commit candidato.
...
- `test_optional_metadata_extraction_no_geometry_side_effect`
- `test_epic_048_dados`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-048` e o TaskEnvelope `TASK-0290`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0400-01, AC-ISSUE-0400-02, AC-ISSUE-0400-03, AC-ISSUE-0400-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-040`, `ADR-041`, `ADR-042`, `ADR-043`
