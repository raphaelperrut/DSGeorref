# STORY-0321 / ISSUE-0431 — Executar benchmark, negativos e regressão científica: seleção de GCPs por cobertura/qualidade/diversidade, exportando pontos usados e descartados
...
- **Sprint:** `SPRINT-006`
- **Domínio:** `GEO`
- **Bounded Context:** `BC-006 — Georreferenciamento`
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0321.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “seleção de GCPs por cobertura/qualidade/diversidade, exportando pontos usados e descartados”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **seleção de GCPs por cobertura/qualidade/diversidade, exportando pontos usados e descartados**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/selecao-de-gcps-por-cobertura-qualidade-diversidade-ex/**`
- `tools/quality/contexts/georeferencing/selecao-de-gcps-por-cobertura-qualidade-diversidade-ex/**`
- `.github/workflows/selecao-de-gcps-por-cobertura-qualidade-diversidade-ex.yaml`
## Fora de escopo
...
`STORY-0317`, `STORY-0318`, `STORY-0319`, `STORY-0320`

## Critérios de aceitação

- [ ] O resultado de “seleção de GCPs por cobertura/qualidade/diversidade, exportando pontos usados e descartados” é observável por contrato, interface, artifact ou evidência executável.
- [ ] Os requisitos REQ-GCP-001 possuem evidência explícita no commit candidato.
...
- `test_spatial_gcp_balance_discard_reasons_conditioning`
- `test_epic_052_benchmark_happy_path`
- `test_epic_052_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-052` e o TaskEnvelope `TASK-0321`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Upstreams permitidos:** `BC-004, BC-005, BC-010, BC-011`.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0431-01, AC-ISSUE-0431-02, AC-ISSUE-0431-03, AC-ISSUE-0431-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-048`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **Risk tier:** `HIGH`
- **Controles aplicáveis:** `CTO-001, CTO-003, CTO-004, CTO-005, CTO-006, CTO-007, CTO-008, CTO-012, CTO-013, CTO-014, CTO-015`
