# STORY-0482 / ISSUE-0592 — Implementar automação operacional: budgets de cardinalidade, sampling, retenção por sinal e dashboards de perda/overhead
...
- **TaskEnvelope:** `.codex/tasks/TASK-0482.json`

## História de usuário

Como administrador da instância, preciso implementar automação operacional para “budgets de cardinalidade, sampling, retenção por sinal e dashboards de perda/overhead”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar automação operacional para a capacidade **budgets de cardinalidade, sampling, retenção por sinal e dashboards de perda/overhead**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/ops/contexts/operations_audit/budgets-de-cardinalidade-sampling-retencao-por-sinal-e/**`
- `tools/quality/contexts/operations_audit/budgets-de-cardinalidade-sampling-retencao-por-sinal-e/**`
- `.github/workflows/budgets-de-cardinalidade-sampling-retencao-por-sinal-e.yaml`
## Fora de escopo
...
- [ ] O resultado de “budgets de cardinalidade, sampling, retenção por sinal e dashboards de perda/overhead” é observável por contrato, interface, artifact ou evidência executável.
- [ ] Os requisitos REQ-MET-001 possuem evidência explícita no commit candidato.
...
- `test_metric_cardinality_budget_and_signal_retention`
- `test_epic_077_implementacao`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-077` e o TaskEnvelope `TASK-0482`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0592-01, AC-ISSUE-0592-02, AC-ISSUE-0592-03, AC-ISSUE-0592-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-033`, `ADR-034`, `ADR-054`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-033`, `ADR-034`, `ADR-054`
...
- **Resultado:** `PASS`
- **Risk tier:** `CRITICAL`
- **Controles aplicáveis:** `CTO-001, CTO-002, CTO-003, CTO-004, CTO-005, CTO-006, CTO-008, CTO-010, CTO-012, CTO-013, CTO-014, CTO-015`
