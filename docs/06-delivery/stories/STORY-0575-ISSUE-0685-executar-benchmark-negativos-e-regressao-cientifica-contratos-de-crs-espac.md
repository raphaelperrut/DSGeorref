# STORY-0575 / ISSUE-0685 — Executar benchmark, negativos e regressão científica: contratos de CRS, espaços de coordenadas, ordem de eixos, precisão/unidades e validade raster
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0575.json`

## História de usuário

Como operador geoespacial, preciso executar benchmark, negativos e regressão científica para “contratos de CRS, espaços de coordenadas, ordem de eixos, precisão/unidades e validade raster”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar benchmark, negativos e regressão científica para a capacidade **contratos de CRS, espaços de coordenadas, ordem de eixos, precisão/unidades e validade raster**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/geo/contratos-de-crs-espacos-de-coordenadas-ordem-de-eixos/**`
- `tools/quality/contexts/georeferencing/contratos-de-crs-espacos-de-coordenadas-ordem-de-eixos/**`
- `.github/workflows/contratos-de-crs-espacos-de-coordenadas-ordem-de-eixos.yaml`
## Fora de escopo
...
`STORY-0571`, `STORY-0572`, `STORY-0573`, `STORY-0574`

## Critérios de aceitação

- [ ] O resultado de “contratos de CRS, espaços de coordenadas, ordem de eixos, precisão/unidades e validade raster” é observável por contrato, interface, artifact ou evidência executável.
...
- `test_epic_093_benchmark_happy_path`
- `test_epic_093_benchmark_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-093` e o TaskEnvelope `TASK-0575`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0685-01, AC-ISSUE-0685-02, AC-ISSUE-0685-03, AC-ISSUE-0685-04`
