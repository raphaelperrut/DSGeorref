# STORY-0277 / ISSUE-0387 — Implementar o núcleo algorítmico: ArtifactSet imutável, staging e publicação atômica
...
- **TaskEnvelope:** `.codex/tasks/TASK-0277.json`

## História de usuário

Como operador geoespacial, preciso implementar o núcleo algorítmico para “ArtifactSet imutável, staging e publicação atômica”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar o núcleo algorítmico para a capacidade **ArtifactSet imutável, staging e publicação atômica**, com saída versionada, testes e evidência no commit candidato.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0387-01, AC-ISSUE-0387-02, AC-ISSUE-0387-03, AC-ISSUE-0387-04`
