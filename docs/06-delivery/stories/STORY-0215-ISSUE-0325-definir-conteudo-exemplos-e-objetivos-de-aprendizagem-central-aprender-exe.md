# STORY-0215 / ISSUE-0325 — Definir conteúdo, exemplos e objetivos de aprendizagem: central Aprender, exemplos visuais, projeto demonstrativo e ajuda contextual, incluindo Strong Geometric Verifier e interpretação de falhas
...
- **TaskEnvelope:** `.codex/tasks/TASK-0215.json`

## História de usuário

Como novo operador, preciso definir conteúdo, exemplos e objetivos de aprendizagem para “central Aprender, exemplos visuais, projeto demonstrativo e ajuda contextual, incluindo Strong Geometric Verifier e interpretação de falhas”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir conteúdo, exemplos e objetivos de aprendizagem para a capacidade **central Aprender, exemplos visuais, projeto demonstrativo e ajuda contextual, incluindo Strong Geometric Verifier e interpretação de falhas**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `docs/01-product/capabilities/central-aprender-exemplos-visuais-projeto-demonstrativ/**`
## Fora de escopo
...
`STORY-0190`, `STORY-0202`, `STORY-0184`
...
- [ ] Conteúdo referencia comportamento vigente e não promete capacidade não implementada.

## Testes obrigatórios

- `test_epic_036_conteudo`
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0325-01, AC-ISSUE-0325-02, AC-ISSUE-0325-03, AC-ISSUE-0325-04`
