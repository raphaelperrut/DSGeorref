# STORY-0025 / ISSUE-0135 — Validar evidência e realizar auditoria final: migrations, CI, secret/dependency scan e telemetria mínima
...
- **TaskEnvelope:** `.codex/tasks/TASK-0025.json`

## História de usuário

Como mantenedor de engenharia, preciso validar evidência e realizar auditoria final para “migrations, CI, secret/dependency scan e telemetria mínima”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Validar evidência e realizar auditoria final para a capacidade **migrations, CI, secret/dependency scan e telemetria mínima**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/migrations-ci-secret-dependency-scan-e-telemetria-mini/**`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-005` e o TaskEnvelope `TASK-0025`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0135-01, AC-ISSUE-0135-02, AC-ISSUE-0135-03, AC-ISSUE-0135-04`
