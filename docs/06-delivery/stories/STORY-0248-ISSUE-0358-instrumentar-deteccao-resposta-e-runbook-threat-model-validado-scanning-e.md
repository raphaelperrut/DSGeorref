# STORY-0248 / ISSUE-0358 — Instrumentar detecção, resposta e runbook: threat model validado, scanning e testes ofensivos
...
- **TaskEnvelope:** `.codex/tasks/TASK-0248.json`

## História de usuário

Como administrador de segurança, preciso instrumentar detecção, resposta e runbook para “threat model validado, scanning e testes ofensivos”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Instrumentar detecção, resposta e runbook para a capacidade **threat model validado, scanning e testes ofensivos**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/sec/threat-model-validado-scanning-e-testes-ofensivos/**`
- `tools/quality/contexts/operations_audit/threat-model-validado-scanning-e-testes-ofensivos/**`
- `.github/workflows/threat-model-validado-scanning-e-testes-ofensivos.yaml`
## Fora de escopo
...
`STORY-0245`, `STORY-0246`, `STORY-0247`

## Critérios de aceitação

- [ ] O resultado de “threat model validado, scanning e testes ofensivos” é observável por contrato, interface, artifact ou evidência executável.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-041` e o TaskEnvelope `TASK-0248`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0358-01, AC-ISSUE-0358-02, AC-ISSUE-0358-03, AC-ISSUE-0358-04`
