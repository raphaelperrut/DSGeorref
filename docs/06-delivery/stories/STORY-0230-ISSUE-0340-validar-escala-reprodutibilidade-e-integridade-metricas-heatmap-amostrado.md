# STORY-0230 / ISSUE-0340 — Validar escala, reprodutibilidade e integridade: métricas, heatmap amostrado e diagnóstico denso do Image Deformation Profile
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0230.json`

## História de usuário

Como revisor e auditor, preciso validar escala, reprodutibilidade e integridade para “métricas, heatmap amostrado e diagnóstico denso do Image Deformation Profile”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Validar escala, reprodutibilidade e integridade para a capacidade **métricas, heatmap amostrado e diagnóstico denso do Image Deformation Profile**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/rep/metricas-heatmap-amostrado-e-diagnostico-denso-do-imag/**`
- `tools/quality/contexts/geometric_quality/metricas-heatmap-amostrado-e-diagnostico-denso-do-imag/**`
- `.github/workflows/metricas-heatmap-amostrado-e-diagnostico-denso-do-imag.yaml`
## Fora de escopo
...
`STORY-0227`, `STORY-0228`, `STORY-0229`
...
- [ ] Limites, memória, tempo, concorrência e integridade são medidos em corpus representativo.

## Testes obrigatórios

- `test_epic_038_escala`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-038` e o TaskEnvelope `TASK-0230`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0340-01, AC-ISSUE-0340-02, AC-ISSUE-0340-03, AC-ISSUE-0340-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-046`
