# STORY-0409 / ISSUE-0519 — Executar integração real, carga e fault injection: taxonomia de retry técnico, orçamento, backoff, idempotência e PlanVariants algorítmicos
...
- **Papel executor:** `QA`
- **TaskEnvelope:** `.codex/tasks/TASK-0409.json`

## História de usuário

Como operador geoespacial, preciso executar integração real, carga e fault injection para “taxonomia de retry técnico, orçamento, backoff, idempotência e PlanVariants algorítmicos”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Executar integração real, carga e fault injection para a capacidade **taxonomia de retry técnico, orçamento, backoff, idempotência e PlanVariants algorítmicos**, com saída versionada, testes e evidência no commit candidato.
...
`STORY-0405`, `STORY-0406`, `STORY-0407`, `STORY-0408`
...
- `test_epic_065_validacao_happy_path`
- `test_epic_065_validacao_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-008-qa.md`, este documento, o épico `EPIC-065` e o TaskEnvelope `TASK-0409`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0519-01, AC-ISSUE-0519-02, AC-ISSUE-0519-03, AC-ISSUE-0519-04`
