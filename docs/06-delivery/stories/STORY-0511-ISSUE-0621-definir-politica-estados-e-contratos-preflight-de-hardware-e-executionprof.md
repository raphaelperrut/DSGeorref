# STORY-0511 / ISSUE-0621 — Definir política, estados e contratos: preflight de hardware e ExecutionProfiles CPU/GPU/híbrido integrados ao Resource Governor
...
- **TaskEnvelope:** `.codex/tasks/TASK-0511.json`

## História de usuário

Como administrador da instância, preciso definir política, estados e contratos para “preflight de hardware e ExecutionProfiles CPU/GPU/híbrido integrados ao Resource Governor”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir política, estados e contratos para a capacidade **preflight de hardware e ExecutionProfiles CPU/GPU/híbrido integrados ao Resource Governor**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/operations_audit/plt/preflight-de-hardware-e-executionprofiles-cpu-gpu-hibr/**`
- `docs/02-architecture/design-reviews/preflight-de-hardware-e-executionprofiles-cpu-gpu-hibr/**`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-002-arquiteto.md`, este documento, o épico `EPIC-082` e o TaskEnvelope `TASK-0511`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0621-01, AC-ISSUE-0621-02, AC-ISSUE-0621-03, AC-ISSUE-0621-04`
