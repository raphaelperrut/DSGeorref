# STORY-0229 / ISSUE-0339 — Expor consulta, download e visualização: métricas, heatmap amostrado e diagnóstico denso do Image Deformation Profile
...
- **TaskEnvelope:** `.codex/tasks/TASK-0229.json`

## História de usuário

Como revisor e auditor, preciso expor consulta, download e visualização para “métricas, heatmap amostrado e diagnóstico denso do Image Deformation Profile”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Expor consulta, download e visualização para a capacidade **métricas, heatmap amostrado e diagnóstico denso do Image Deformation Profile**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/frontend/src/contexts/geometric_quality/features/metricas-heatmap-amostrado-e-diagnostico-denso-do-imag/**`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-005-frontend.md`, este documento, o épico `EPIC-038` e o TaskEnvelope `TASK-0229`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0339-01, AC-ISSUE-0339-02, AC-ISSUE-0339-03, AC-ISSUE-0339-04`
