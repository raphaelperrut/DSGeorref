# STORY-0093 / ISSUE-0203 — Automatizar testes de resiliência, retry e recuperação: REST, SSE e polling de reconciliação com contratos versionados
...
- **TaskEnvelope:** `.codex/tasks/TASK-0093.json`

## História de usuário

Como operador geoespacial, preciso automatizar testes de resiliência, retry e recuperação para “REST, SSE e polling de reconciliação com contratos versionados”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Automatizar testes de resiliência, retry e recuperação para a capacidade **REST, SSE e polling de reconciliação com contratos versionados**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-017` e o TaskEnvelope `TASK-0093`. Trabalhe somente nos paths permitidos. Entregue o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0203-01, AC-ISSUE-0203-02, AC-ISSUE-0203-03, AC-ISSUE-0203-04`
