# STORY-0228 / ISSUE-0338 — Implementar geração e exportação: métricas, heatmap amostrado e diagnóstico denso do Image Deformation Profile
...
- **TaskEnvelope:** `.codex/tasks/TASK-0228.json`

## História de usuário

Como revisor e auditor, preciso implementar geração e exportação para “métricas, heatmap amostrado e diagnóstico denso do Image Deformation Profile”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar geração e exportação para a capacidade **métricas, heatmap amostrado e diagnóstico denso do Image Deformation Profile**, com saída versionada, testes e evidência no commit candidato.
...
- [ ] Export é determinístico, validado e contém manifest, checksums e lineage aplicáveis.

## Testes obrigatórios

- `test_epic_038_exportacao`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-038` e o TaskEnvelope `TASK-0228`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0338-01, AC-ISSUE-0338-02, AC-ISSUE-0338-03, AC-ISSUE-0338-04`
...
- **Resultado:** `PASS`
- **Risk tier:** `CRITICAL`
- **Controles aplicáveis:** `CTO-001, CTO-002, CTO-003, CTO-004, CTO-005, CTO-006, CTO-007, CTO-008, CTO-012, CTO-013, CTO-015`
