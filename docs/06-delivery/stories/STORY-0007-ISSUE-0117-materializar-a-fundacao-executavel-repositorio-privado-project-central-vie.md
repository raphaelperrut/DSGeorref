# STORY-0007 / ISSUE-0117 — Consolidar slices e liberar integração: repositório privado, Project central/views/campos, labels, Issue Forms, templates, ruleset, checks e configuração reproduzível
...
- **TaskEnvelope:** `.codex/tasks/TASK-0007.json`

## História de usuário

Como mantenedor de engenharia, preciso materializar a fundação executável para “repositório privado, Project central/views/campos, labels, Issue Forms, templates, ruleset, checks e configuração reproduzível”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.
...
- `tools/governance/repositorio-privado-project-central-views-campos-label/consolidacao/**`
- `docs/03-engineering/contexts/engineering_governance/repositorio-privado-project-central-views-campos-label/consolidacao/**`
## Fora de escopo
...
`STORY-0692`, `STORY-0693`, `STORY-0694`, `STORY-0695`, `STORY-0696`, `STORY-0697`, `STORY-0698`, `STORY-0699`, `STORY-0700`
...
- `test_story_0007_slice_consolidation`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-003-tech-lead.md`, este documento, o épico `EPIC-002` e o TaskEnvelope `TASK-0007`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0117-01, AC-ISSUE-0117-02, AC-ISSUE-0117-03, AC-ISSUE-0117-04`
...
|---|---|---|
| Dependências | 9 predecessores explícitos | PASS |
