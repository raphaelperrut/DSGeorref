# STORY-0408 / ISSUE-0518 — Automatizar testes de resiliência, retry e recuperação: taxonomia de retry técnico, orçamento, backoff, idempotência e PlanVariants algorítmicos
...
- **TaskEnvelope:** `.codex/tasks/TASK-0408.json`

## História de usuário

Como operador geoespacial, preciso automatizar testes de resiliência, retry e recuperação para “taxonomia de retry técnico, orçamento, backoff, idempotência e PlanVariants algorítmicos”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Automatizar testes de resiliência, retry e recuperação para a capacidade **taxonomia de retry técnico, orçamento, backoff, idempotência e PlanVariants algorítmicos**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `tests/job/taxonomia-de-retry-tecnico-orcamento-backoff-idempoten/**`
- `tools/quality/contexts/job_orchestration/taxonomia-de-retry-tecnico-orcamento-backoff-idempoten/**`
- `.github/workflows/taxonomia-de-retry-tecnico-orcamento-backoff-idempoten.yaml`
## Fora de escopo
...
Leia `AGENTS.md`, `.codex/roles/ROLE-009-devops.md`, este documento, o épico `EPIC-065` e o TaskEnvelope `TASK-0408`. Trabalhe somente nos paths permitidos. Entregue o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0518-01, AC-ISSUE-0518-02, AC-ISSUE-0518-03, AC-ISSUE-0518-04`
