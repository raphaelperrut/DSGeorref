# STORY-0091 / ISSUE-0201 — Implementar runner, worker ou scheduler: REST, SSE e polling de reconciliação com contratos versionados
...
- **TaskEnvelope:** `.codex/tasks/TASK-0091.json`

## História de usuário

Como operador geoespacial, preciso implementar runner, worker ou scheduler para “REST, SSE e polling de reconciliação com contratos versionados”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar runner, worker ou scheduler para a capacidade **REST, SSE e polling de reconciliação com contratos versionados**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-017` e o TaskEnvelope `TASK-0091`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0201-01, AC-ISSUE-0201-02, AC-ISSUE-0201-03, AC-ISSUE-0201-04`
