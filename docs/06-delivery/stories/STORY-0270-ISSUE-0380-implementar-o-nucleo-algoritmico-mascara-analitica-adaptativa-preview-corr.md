# STORY-0270 / ISSUE-0380 — Implementar o núcleo algorítmico: máscara analítica adaptativa, preview/correção, área útil separada da saída e preservação de metadados marginais
...
- **TaskEnvelope:** `.codex/tasks/TASK-0270.json`

## História de usuário

Como operador geoespacial, preciso implementar o núcleo algorítmico para “máscara analítica adaptativa, preview/correção, área útil separada da saída e preservação de metadados marginais”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar o núcleo algorítmico para a capacidade **máscara analítica adaptativa, preview/correção, área útil separada da saída e preservação de metadados marginais**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-045` e o TaskEnvelope `TASK-0270`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0380-01, AC-ISSUE-0380-02, AC-ISSUE-0380-03, AC-ISSUE-0380-04`
