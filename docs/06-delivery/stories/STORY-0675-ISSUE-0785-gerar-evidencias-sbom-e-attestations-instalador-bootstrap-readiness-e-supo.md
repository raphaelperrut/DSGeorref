# STORY-0675 / ISSUE-0785 — Gerar evidências, SBOM e attestations: Instalador, bootstrap, readiness e suporte diagnóstico
...
- **TaskEnvelope:** `.codex/tasks/TASK-0675.json`

## História de usuário

Como responsável por release, preciso gerar evidências, sbom e attestations para “Instalador, bootstrap, readiness e suporte diagnóstico”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Gerar evidências, SBOM e attestations para a capacidade **Instalador, bootstrap, readiness e suporte diagnóstico**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/release_installation/adapters/security/instalador-bootstrap-readiness-e-suporte-diagnostico/**`
- `tests/security/contexts/release_installation/instalador-bootstrap-readiness-e-suporte-diagnostico/**`
## Fora de escopo
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0785-01, AC-ISSUE-0785-02, AC-ISSUE-0785-03, AC-ISSUE-0785-04`
