# STORY-0641 / ISSUE-0751 — Preparar corpus, fixtures e representação tipada: Budgets, persistência e materialização do mosaico relativo
...
- **TaskEnvelope:** `.codex/tasks/TASK-0641.json`

## História de usuário

Como operador geoespacial, preciso preparar corpus, fixtures e representação tipada para “Budgets, persistência e materialização do mosaico relativo”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Preparar corpus, fixtures e representação tipada para a capacidade **Budgets, persistência e materialização do mosaico relativo**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/geo/dsgeorref_geo/contexts/relative_mosaic/budgets-persistencia-e-materializacao-do-mosaico-relat/**`
## Fora de escopo
...
`REQ-RMQ-001`, `REQ-RMQ-002`, `REQ-RMQ-004`
...
- [ ] O resultado de “Budgets, persistência e materialização do mosaico relativo” é observável por contrato, interface, artifact ou evidência executável.
- [ ] Os requisitos REQ-RMQ-001, REQ-RMQ-002, REQ-RMQ-004 possuem evidência explícita no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-007-geoprocessamento.md`, este documento, o épico `EPIC-103` e o TaskEnvelope `TASK-0641`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0751-01, AC-ISSUE-0751-02, AC-ISSUE-0751-03, AC-ISSUE-0751-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-036`, `ADR-039`, `ADR-041`, `ADR-042`, `ADR-043`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-036`, `ADR-039`, `ADR-041`, `ADR-042`, `ADR-043`
