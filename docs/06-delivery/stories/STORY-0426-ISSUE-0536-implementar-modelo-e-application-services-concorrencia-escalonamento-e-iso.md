# STORY-0426 / ISSUE-0536 — Implementar modelo e application services: Concorrência, escalonamento e isolamento
...
- **TaskEnvelope:** `.codex/tasks/TASK-0426.json`

## História de usuário

Como operador geoespacial, preciso implementar modelo e application services para “Concorrência, escalonamento e isolamento”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar modelo e application services para a capacidade **Concorrência, escalonamento e isolamento**, com saída versionada, testes e evidência no commit candidato.
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-068` e o TaskEnvelope `TASK-0426`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0536-01, AC-ISSUE-0536-02, AC-ISSUE-0536-03, AC-ISSUE-0536-04`
