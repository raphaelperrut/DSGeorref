# STORY-0268 / ISSUE-0378 — Definir contrato científico e invariantes: máscara analítica adaptativa, preview/correção, área útil separada da saída e preservação de metadados marginais
...
- **TaskEnvelope:** `.codex/tasks/TASK-0268.json`

## História de usuário

Como operador geoespacial, preciso definir contrato científico e invariantes para “máscara analítica adaptativa, preview/correção, área útil separada da saída e preservação de metadados marginais”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir contrato científico e invariantes para a capacidade **máscara analítica adaptativa, preview/correção, área útil separada da saída e preservação de metadados marginais**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/georeferencing/geo/mascara-analitica-adaptativa-preview-correcao-area-uti/**`
- `docs/02-architecture/design-reviews/mascara-analitica-adaptativa-preview-correcao-area-uti/**`
## Fora de escopo
...
`STORY-0121`, `STORY-0135`, `STORY-0267`
...
- [ ] Os requisitos REQ-MSK-003 possuem evidência explícita no commit candidato.
...
- `test_adaptive_mask_preview_correction_versioning`
- `test_epic_045_contrato`
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0378-01, AC-ISSUE-0378-02, AC-ISSUE-0378-03, AC-ISSUE-0378-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-055`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-055`
