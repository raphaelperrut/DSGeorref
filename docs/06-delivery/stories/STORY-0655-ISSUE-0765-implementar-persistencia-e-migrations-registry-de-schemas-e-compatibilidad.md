# STORY-0655 / ISSUE-0765 — Implementar persistência e migrations: Registry de schemas e compatibilidade de artifacts
...
- **TaskEnvelope:** `.codex/tasks/TASK-0655.json`

## História de usuário

Como operador geoespacial, preciso implementar persistência e migrations para “Registry de schemas e compatibilidade de artifacts”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Implementar persistência e migrations para a capacidade **Registry de schemas e compatibilidade de artifacts**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/artifact_provenance/application/registry-de-schemas-e-compatibilidade-de-artifacts/**`
- `src/backend/dsgeorref/contexts/artifact_provenance/adapters/registry-de-schemas-e-compatibilidade-de-artifacts/**`
## Fora de escopo
...
- [ ] O resultado de “Registry de schemas e compatibilidade de artifacts” é observável por contrato, interface, artifact ou evidência executável.
- [ ] Os requisitos REQ-SCM-003 possuem evidência explícita no commit candidato.
...
- `test_epic_105_persistencia_roundtrip`
- `test_epic_105_persistencia_recovery`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-004-backend.md`, este documento, o épico `EPIC-105` e o TaskEnvelope `TASK-0655`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0765-01, AC-ISSUE-0765-02, AC-ISSUE-0765-03, AC-ISSUE-0765-04`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-016`, `ADR-018`, `ADR-019`, `ADR-053`
