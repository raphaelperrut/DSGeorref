# STORY-0552 / ISSUE-0662 — Gerar evidências, SBOM e attestations: release train internal/alpha/beta/1.0, automação de evidências e gate de abertura pública
...
- **TaskEnvelope:** `.codex/tasks/TASK-0552.json`

## História de usuário

Como responsável por release, preciso gerar evidências, sbom e attestations para “release train internal/alpha/beta/1.0, automação de evidências e gate de abertura pública”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Gerar evidências, SBOM e attestations para a capacidade **release train internal/alpha/beta/1.0, automação de evidências e gate de abertura pública**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `src/backend/dsgeorref/contexts/release_installation/adapters/security/release-train-internal-alpha-beta-1-0-automacao-de-evi/**`
- `tests/security/contexts/release_installation/release-train-internal-alpha-beta-1-0-automacao-de-evi/**`
## Fora de escopo
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0662-01, AC-ISSUE-0662-02, AC-ISSUE-0662-03, AC-ISSUE-0662-04`
