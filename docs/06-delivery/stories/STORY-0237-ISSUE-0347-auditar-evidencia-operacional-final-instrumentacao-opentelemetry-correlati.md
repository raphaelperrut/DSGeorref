# STORY-0237 / ISSUE-0347 — Auditar evidência operacional final: instrumentação OpenTelemetry, correlation IDs, métricas, dashboards e alertas para API, RabbitMQ e workers
...
- **TaskEnvelope:** `.codex/tasks/TASK-0237.json`

## História de usuário

Como administrador da instância, preciso auditar evidência operacional final para “instrumentação OpenTelemetry, correlation IDs, métricas, dashboards e alertas para API, RabbitMQ e workers”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar evidência operacional final para a capacidade **instrumentação OpenTelemetry, correlation IDs, métricas, dashboards e alertas para API, RabbitMQ e workers**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/instrumentacao-opentelemetry-correlation-ids-metricas/**`
## Fora de escopo
...
- `test_epic_039_aceite_happy_path`
- `test_epic_039_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-039` e o TaskEnvelope `TASK-0237`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0347-01, AC-ISSUE-0347-02, AC-ISSUE-0347-03, AC-ISSUE-0347-04`
