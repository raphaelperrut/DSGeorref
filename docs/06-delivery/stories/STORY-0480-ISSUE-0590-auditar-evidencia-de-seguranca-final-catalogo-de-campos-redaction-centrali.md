# STORY-0480 / ISSUE-0590 — Auditar evidência de segurança final: catálogo de campos, redaction centralizada, testes de vazamento e bundles de suporte sanitizados
...
- **TaskEnvelope:** `.codex/tasks/TASK-0480.json`

## História de usuário

Como administrador de segurança, preciso auditar evidência de segurança final para “catálogo de campos, redaction centralizada, testes de vazamento e bundles de suporte sanitizados”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar evidência de segurança final para a capacidade **catálogo de campos, redaction centralizada, testes de vazamento e bundles de suporte sanitizados**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/catalogo-de-campos-redaction-centralizada-testes-de-va/**`
## Fora de escopo
...
- `test_epic_076_aceite_happy_path`
- `test_epic_076_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-076` e o TaskEnvelope `TASK-0480`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0590-01, AC-ISSUE-0590-02, AC-ISSUE-0590-03, AC-ISSUE-0590-04`
