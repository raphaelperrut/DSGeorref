# STORY-0225 / ISSUE-0335 — Auditar lineage e evidência final: persistência e exportação escalável de resultados por imagem/lote, geometrias, manifestos e checksums
...
- **TaskEnvelope:** `.codex/tasks/TASK-0225.json`

## História de usuário

Como revisor e auditor, preciso auditar lineage e evidência final para “persistência e exportação escalável de resultados por imagem/lote, geometrias, manifestos e checksums”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Auditar lineage e evidência final para a capacidade **persistência e exportação escalável de resultados por imagem/lote, geometrias, manifestos e checksums**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `evidence/reviews/persistencia-e-exportacao-escalavel-de-resultados-por/**`
## Fora de escopo
...
- `test_epic_037_aceite_happy_path`
- `test_epic_037_aceite_negative_paths`
...
Leia `AGENTS.md`, `.codex/roles/ROLE-011-reviewer.md`, este documento, o épico `EPIC-037` e o TaskEnvelope `TASK-0225`. Trabalhe somente nos paths permitidos. Implemente o menor incremento que satisfaça todos os critérios, execute os testes, registre evidências e interrompa quando qualquer condição de parada ocorrer.
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0335-01, AC-ISSUE-0335-02, AC-ISSUE-0335-03, AC-ISSUE-0335-04`
