# STORY-0500 / ISSUE-0610 — Definir políticas e contratos fail-closed: lockfiles, pins por digest/SHA, scanners, SBOM, assinatura OCI, attestations e verificador de release
...
- **TaskEnvelope:** `.codex/tasks/TASK-0500.json`

## História de usuário

Como administrador de segurança, preciso definir políticas e contratos fail-closed para “lockfiles, pins por digest/SHA, scanners, SBOM, assinatura OCI, attestations e verificador de release”, para que o resultado do épico seja implementável, verificável e integrável sem violar seus contratos.

## Resultado verificável

Definir políticas e contratos fail-closed para a capacidade **lockfiles, pins por digest/SHA, scanners, SBOM, assinatura OCI, attestations e verificador de release**, com saída versionada, testes e evidência no commit candidato.

## Escopo

- `contracts/contexts/release_installation/sec/lockfiles-pins-por-digest-sha-scanners-sbom-assinatura/**`
- `docs/02-architecture/design-reviews/lockfiles-pins-por-digest-sha-scanners-sbom-assinatura/**`
## Fora de escopo
...
`REQ-AI-006`, `REQ-AI-015`, `REQ-EPIC-042`, `REQ-INS-004`, `REQ-SUP-001`
...
- [ ] O resultado de “lockfiles, pins por digest/SHA, scanners, SBOM, assinatura OCI, attestations e verificador de release” é observável por contrato, interface, artifact ou evidência executável.
- [ ] Os requisitos REQ-AI-006, REQ-AI-015, REQ-EPIC-042, REQ-INS-004, REQ-SUP-001 possuem evidência explícita no commit candidato.
...
- `test_modelpack_signature_license_hash_offline_import`
- `test_inference_only_runtime_no_training_or_weight_mutation`
- `test_layered_spdx_reuse_license_notices_dependency_and_asset_compatibility`
- `test_sanitized_local_support_bundle_no_exfiltration_and_repair_dry_run`
- `test_epic_080_contrato`
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0610-01, AC-ISSUE-0610-02, AC-ISSUE-0610-03, AC-ISSUE-0610-04`
- **Base de requisitos:** `MIXED`
- **ADRs governantes:** `ADR-002`, `ADR-003`, `ADR-004`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-024`, `ADR-033`, `ADR-034`, `ADR-052`
- **Conflito:** `Nenhum`
...
- **Resultado:** `PASS`
- **ADRs aplicáveis:** `ADR-002`, `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-016`, `ADR-024`, `ADR-033`, `ADR-034`, `ADR-052`
