# ISSUE-0030 — taxonomia versionada de falhas, evidências, remediações seguras e contratos de resultado por imagem
...
Como equipe de entrega do DSGeorref, precisamos taxonomia versionada de falhas, evidências, remediações seguras e contratos de resultado por imagem, para que a capacidade de produto vinculada seja entregue com qualidade verificável e integração controlada.

## Critérios de aceitação

- [ ] O resultado de produto de `EPIC-030` é demonstravelmente satisfeito.
...
- `STORY-0178` / `ISSUE-0288` — `Arquiteto` — Definir contrato científico e invariantes: taxonomia versionada de falhas, evidências, remediações seguras e contratos de resultado por imagem
- `STORY-0179` / `ISSUE-0289` — `Geoprocessamento` — Preparar corpus, fixtures e representação tipada: taxonomia versionada de falhas, evidências, remediações seguras e contratos de resultado por imagem
- `STORY-0180` / `ISSUE-0290` — `Geoprocessamento` — Implementar o núcleo algorítmico: taxonomia versionada de falhas, evidências, remediações seguras e contratos de resultado por imagem
- `STORY-0181` / `ISSUE-0291` — `Geoprocessamento` — Integrar ao ProcessingPlan e pipeline: taxonomia versionada de falhas, evidências, remediações seguras e contratos de resultado por imagem
- `STORY-0182` / `ISSUE-0292` — `Geoprocessamento` — Produzir métricas, diagnóstico e lineage: taxonomia versionada de falhas, evidências, remediações seguras e contratos de resultado por imagem
- `STORY-0183` / `ISSUE-0293` — `QA` — Executar benchmark, negativos e regressão científica: taxonomia versionada de falhas, evidências, remediações seguras e contratos de resultado por imagem
- `STORY-0184` / `ISSUE-0294` — `Reviewer` — Auditar evidência científica e final: taxonomia versionada de falhas, evidências, remediações seguras e contratos de resultado por imagem
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0030-01, AC-ISSUE-0030-02, AC-ISSUE-0030-03, AC-ISSUE-0030-04, AC-ISSUE-0030-05, AC-ISSUE-0030-06`
- **Requisitos do épico:** `3`
- **ADRs governantes:** `ADR-002`, `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-038`, `ADR-041`, `ADR-042`, `ADR-043`
- **Conflito:** `Nenhum`
