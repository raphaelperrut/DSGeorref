# ISSUE-0047 — matching coarse-to-fine, tiles, reconciliação de coordenadas e refinamento em resolução adequada
...
Como equipe de entrega do DSGeorref, precisamos matching coarse-to-fine, tiles, reconciliação de coordenadas e refinamento em resolução adequada, para que a capacidade de produto vinculada seja entregue com qualidade verificável e integração controlada.

## Critérios de aceitação

- [ ] O resultado de produto de `EPIC-047` é demonstravelmente satisfeito.
...
- `STORY-0282` / `ISSUE-0392` — `Arquiteto` — Definir contrato científico e invariantes: matching coarse-to-fine, tiles, reconciliação de coordenadas e refinamento em resolução adequada
- `STORY-0283` / `ISSUE-0393` — `Geoprocessamento` — Preparar corpus, fixtures e representação tipada: matching coarse-to-fine, tiles, reconciliação de coordenadas e refinamento em resolução adequada
- `STORY-0284` / `ISSUE-0394` — `Geoprocessamento` — Implementar o núcleo algorítmico: matching coarse-to-fine, tiles, reconciliação de coordenadas e refinamento em resolução adequada
- `STORY-0285` / `ISSUE-0395` — `Geoprocessamento` — Integrar ao ProcessingPlan e pipeline: matching coarse-to-fine, tiles, reconciliação de coordenadas e refinamento em resolução adequada
- `STORY-0286` / `ISSUE-0396` — `Geoprocessamento` — Produzir métricas, diagnóstico e lineage: matching coarse-to-fine, tiles, reconciliação de coordenadas e refinamento em resolução adequada
- `STORY-0287` / `ISSUE-0397` — `QA` — Executar benchmark, negativos e regressão científica: matching coarse-to-fine, tiles, reconciliação de coordenadas e refinamento em resolução adequada
- `STORY-0288` / `ISSUE-0398` — `Reviewer` — Auditar evidência científica e final: matching coarse-to-fine, tiles, reconciliação de coordenadas e refinamento em resolução adequada
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0047-01, AC-ISSUE-0047-02, AC-ISSUE-0047-03, AC-ISSUE-0047-04, AC-ISSUE-0047-05, AC-ISSUE-0047-06`
- **Requisitos do épico:** `1`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-044`
- **Conflito:** `Nenhum`
