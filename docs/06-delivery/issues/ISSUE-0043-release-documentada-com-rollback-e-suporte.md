# ISSUE-0043 — release documentada com rollback e suporte
...
Como equipe de entrega do DSGeorref, precisamos release documentada com rollback e suporte, para que a capacidade de produto vinculada seja entregue com qualidade verificável e integração controlada.

## Critérios de aceitação

- [ ] O resultado de produto de `EPIC-043` é demonstravelmente satisfeito.
...
- `STORY-0255` / `ISSUE-0365` — `Tech Lead` — Definir gate, versão e critérios de release: release documentada com rollback e suporte
- `STORY-0256` / `ISSUE-0366` — `DevOps` — Implementar pipeline e artifacts de release: release documentada com rollback e suporte
- `STORY-0257` / `ISSUE-0367` — `DevOps` — Implementar upgrade, rollback e compatibilidade: release documentada com rollback e suporte
- `STORY-0258` / `ISSUE-0368` — `Security` — Gerar evidências, SBOM e attestations: release documentada com rollback e suporte
- `STORY-0259` / `ISSUE-0369` — `QA` — Executar instalação limpa e rehearsal: release documentada com rollback e suporte
- `STORY-0260` / `ISSUE-0370` — `Reviewer` — Auditar release candidata final: release documentada com rollback e suporte
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0043-01, AC-ISSUE-0043-02, AC-ISSUE-0043-03, AC-ISSUE-0043-04, AC-ISSUE-0043-05, AC-ISSUE-0043-06`
- **Requisitos do épico:** `4`
- **ADRs governantes:** `ADR-001`, `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-010`, `ADR-011`, `ADR-014`, `ADR-016`, `ADR-030`, `ADR-031`, `ADR-032`, `ADR-033`, `ADR-034`, `ADR-053`
- **Conflito:** `Nenhum`
