# ISSUE-0020 — CLI estável para projetos, ingestão, jobs e resultados
...
Como equipe de entrega do DSGeorref, precisamos CLI estável para projetos, ingestão, jobs e resultados, para que a capacidade de produto vinculada seja entregue com qualidade verificável e integração controlada.

## Critérios de aceitação

- [ ] O resultado de produto de `EPIC-020` é demonstravelmente satisfeito.
...
- `STORY-0110` / `ISSUE-0220` — `Arquiteto` — Definir comandos, opções e códigos de saída: CLI estável para projetos, ingestão, jobs e resultados
- `STORY-0111` / `ISSUE-0221` — `Backend` — Implementar adapter CLI sobre o núcleo: CLI estável para projetos, ingestão, jobs e resultados
- `STORY-0112` / `ISSUE-0222` — `Backend` — Implementar feedback, erros e ajuda: CLI estável para projetos, ingestão, jobs e resultados
- `STORY-0113` / `ISSUE-0223` — `QA` — Executar testes de contrato e integração: CLI estável para projetos, ingestão, jobs e resultados
- `STORY-0114` / `ISSUE-0224` — `Reviewer` — Auditar compatibilidade e evidência final: CLI estável para projetos, ingestão, jobs e resultados
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0020-01, AC-ISSUE-0020-02, AC-ISSUE-0020-03, AC-ISSUE-0020-04, AC-ISSUE-0020-05, AC-ISSUE-0020-06`
- **Requisitos do épico:** `10`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-015`, `ADR-016`, `ADR-023`, `ADR-040`, `ADR-044`, `ADR-045`, `ADR-046`, `ADR-055`
- **Conflito:** `Nenhum`
