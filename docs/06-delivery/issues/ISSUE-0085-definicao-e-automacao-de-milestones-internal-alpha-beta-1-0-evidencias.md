# ISSUE-0085 — definição e automação de milestones internal/alpha/beta/1.0, evidências e gate de abertura do repositório
...
Como equipe de entrega do DSGeorref, precisamos definição e automação de milestones internal/alpha/beta/1.0, evidências e gate de abertura do repositório, para que a capacidade de produto vinculada seja entregue com qualidade verificável e integração controlada.

## Critérios de aceitação

- [ ] O resultado de produto de `EPIC-085` é demonstravelmente satisfeito.
...
- `STORY-0528` / `ISSUE-0638` — `Tech Lead` — Definir gate, versão e critérios de release: definição e automação de milestones internal/alpha/beta/1.0, evidências e gate de abertura do repositório
- `STORY-0529` / `ISSUE-0639` — `DevOps` — Implementar pipeline e artifacts de release: definição e automação de milestones internal/alpha/beta/1.0, evidências e gate de abertura do repositório
- `STORY-0530` / `ISSUE-0640` — `DevOps` — Implementar upgrade, rollback e compatibilidade: definição e automação de milestones internal/alpha/beta/1.0, evidências e gate de abertura do repositório
- `STORY-0531` / `ISSUE-0641` — `Security` — Gerar evidências, SBOM e attestations: definição e automação de milestones internal/alpha/beta/1.0, evidências e gate de abertura do repositório
- `STORY-0532` / `ISSUE-0642` — `QA` — Executar instalação limpa e rehearsal: definição e automação de milestones internal/alpha/beta/1.0, evidências e gate de abertura do repositório
- `STORY-0533` / `ISSUE-0643` — `Reviewer` — Auditar release candidata final: definição e automação de milestones internal/alpha/beta/1.0, evidências e gate de abertura do repositório
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0085-01, AC-ISSUE-0085-02, AC-ISSUE-0085-03, AC-ISSUE-0085-04, AC-ISSUE-0085-05, AC-ISSUE-0085-06`
