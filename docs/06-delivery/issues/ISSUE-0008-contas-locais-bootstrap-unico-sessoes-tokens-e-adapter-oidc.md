...
Como equipe de entrega do DSGeorref, precisamos contas locais, bootstrap único, sessões, tokens e adapter OIDC, para que a capacidade de produto vinculada seja entregue com qualidade verificável e integração controlada.

## Critérios de aceitação

- [ ] O resultado de produto de `EPIC-008` é demonstravelmente satisfeito.
...
- `STORY-0036` / `ISSUE-0146` — `Arquiteto` — Definir política, estados e contratos: contas locais, bootstrap único, sessões, tokens e adapter OIDC
- `STORY-0037` / `ISSUE-0147` — `Backend` — Consolidar slices e liberar integração: contas locais, bootstrap único, sessões, tokens e adapter OIDC
- `STORY-0038` / `ISSUE-0148` — `Frontend` — Expor administração e fluxos de uso: contas locais, bootstrap único, sessões, tokens e adapter OIDC
- `STORY-0039` / `ISSUE-0149` — `Security` — Validar ameaças, autorização e falhas: contas locais, bootstrap único, sessões, tokens e adapter OIDC
- `STORY-0040` / `ISSUE-0150` — `Reviewer` — Executar QA e auditoria final: contas locais, bootstrap único, sessões, tokens e adapter OIDC
- `STORY-0712` / `ISSUE-0822` — `Backend` — Slice 1/2 — Implementar domínio e persistência: contas locais, bootstrap único, sessões, tokens e adapter OIDC [REQ-AUTH-IMPL, REQ-DBSCHEMA]
- `STORY-0713` / `ISSUE-0823` — `Backend` — Slice 2/2 — Implementar domínio e persistência: contas locais, bootstrap único, sessões, tokens e adapter OIDC [REQ-ID]
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0008-01, AC-ISSUE-0008-02, AC-ISSUE-0008-03, AC-ISSUE-0008-04, AC-ISSUE-0008-05, AC-ISSUE-0008-06`
- **Requisitos do épico:** `15`
- **ADRs governantes:** `ADR-003`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-014`, `ADR-016`, `ADR-028`, `ADR-029`, `ADR-030`, `ADR-031`, `ADR-032`, `ADR-034`, `ADR-043`, `ADR-055`
- **Conflito:** `Nenhum`
