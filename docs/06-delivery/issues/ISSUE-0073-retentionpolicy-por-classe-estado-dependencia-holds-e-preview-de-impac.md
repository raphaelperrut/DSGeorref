# ISSUE-0073 — RetentionPolicy por classe/estado/dependência, holds e preview de impacto
...
Como equipe de entrega do DSGeorref, precisamos RetentionPolicy por classe/estado/dependência, holds e preview de impacto, para que a capacidade de produto vinculada seja entregue com qualidade verificável e integração controlada.

## Critérios de aceitação

- [ ] O resultado de produto de `EPIC-073` é demonstravelmente satisfeito.
...
- `STORY-0457` / `ISSUE-0567` — `Arquiteto` — Definir modelo, invariantes e contratos de dados: RetentionPolicy por classe/estado/dependência, holds e preview de impacto
- `STORY-0458` / `ISSUE-0568` — `Backend` — Implementar persistência e migrations: RetentionPolicy por classe/estado/dependência, holds e preview de impacto
- `STORY-0459` / `ISSUE-0569` — `Backend` — Implementar armazenamento e lifecycle: RetentionPolicy por classe/estado/dependência, holds e preview de impacto
- `STORY-0460` / `ISSUE-0570` — `Backend` — Expor serviços e integrar consumers: RetentionPolicy por classe/estado/dependência, holds e preview de impacto
- `STORY-0461` / `ISSUE-0571` — `Security` — Validar segurança, recuperação e concorrência: RetentionPolicy por classe/estado/dependência, holds e preview de impacto
- `STORY-0462` / `ISSUE-0572` — `Reviewer` — Executar QA e auditoria final: RetentionPolicy por classe/estado/dependência, holds e preview de impacto
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0073-01, AC-ISSUE-0073-02, AC-ISSUE-0073-03, AC-ISSUE-0073-04, AC-ISSUE-0073-05, AC-ISSUE-0073-06`
- **Requisitos do épico:** `3`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-012`, `ADR-016`, `ADR-030`, `ADR-031`, `ADR-032`, `ADR-053`
- **Conflito:** `Nenhum`
