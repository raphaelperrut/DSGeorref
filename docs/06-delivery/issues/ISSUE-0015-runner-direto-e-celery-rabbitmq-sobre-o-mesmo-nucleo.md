# ISSUE-0015 — runner direto e Celery/RabbitMQ sobre o mesmo núcleo
...
Como equipe de entrega do DSGeorref, precisamos runner direto e Celery/RabbitMQ sobre o mesmo núcleo, para que a capacidade de produto vinculada seja entregue com qualidade verificável e integração controlada.

## Critérios de aceitação

- [ ] O resultado de produto de `EPIC-015` é demonstravelmente satisfeito.
...
- `STORY-0075` / `ISSUE-0185` — `Arquiteto` — Definir estados, envelopes e invariantes: runner direto e Celery/RabbitMQ sobre o mesmo núcleo
- `STORY-0076` / `ISSUE-0186` — `Backend` — Implementar modelo e application services: runner direto e Celery/RabbitMQ sobre o mesmo núcleo
- `STORY-0077` / `ISSUE-0187` — `Backend` — Implementar runner, worker ou scheduler: runner direto e Celery/RabbitMQ sobre o mesmo núcleo
- `STORY-0078` / `ISSUE-0188` — `Backend` — Expor comandos, progresso e reconciliação: runner direto e Celery/RabbitMQ sobre o mesmo núcleo
- `STORY-0079` / `ISSUE-0189` — `DevOps` — Automatizar testes de resiliência, retry e recuperação: runner direto e Celery/RabbitMQ sobre o mesmo núcleo
- `STORY-0080` / `ISSUE-0190` — `QA` — Executar integração real, carga e fault injection: runner direto e Celery/RabbitMQ sobre o mesmo núcleo
- `STORY-0081` / `ISSUE-0191` — `Reviewer` — Auditar evidência e integração final: runner direto e Celery/RabbitMQ sobre o mesmo núcleo
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0015-01, AC-ISSUE-0015-02, AC-ISSUE-0015-03, AC-ISSUE-0015-04, AC-ISSUE-0015-05, AC-ISSUE-0015-06`
- **Requisitos do épico:** `2`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-010`, `ADR-011`, `ADR-014`, `ADR-016`, `ADR-018`, `ADR-033`, `ADR-034`
- **Conflito:** `Nenhum`
