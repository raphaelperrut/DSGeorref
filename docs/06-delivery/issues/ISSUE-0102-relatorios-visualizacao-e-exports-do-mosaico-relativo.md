# ISSUE-0102 — Relatórios, visualização e exports do mosaico relativo
...
Como equipe de entrega do DSGeorref, precisamos Relatórios, visualização e exports do mosaico relativo, para que a capacidade de produto vinculada seja entregue com qualidade verificável e integração controlada.

## Critérios de aceitação

- [ ] O resultado de produto de `EPIC-102` é demonstravelmente satisfeito.
...
- `STORY-0633` / `ISSUE-0743` — `Arquiteto` — Definir contrato científico e invariantes: Relatórios, visualização e exports do mosaico relativo
- `STORY-0634` / `ISSUE-0744` — `Geoprocessamento` — Preparar corpus, fixtures e representação tipada: Relatórios, visualização e exports do mosaico relativo
- `STORY-0635` / `ISSUE-0745` — `Geoprocessamento` — Implementar o núcleo algorítmico: Relatórios, visualização e exports do mosaico relativo
- `STORY-0636` / `ISSUE-0746` — `Geoprocessamento` — Integrar ao ProcessingPlan e pipeline: Relatórios, visualização e exports do mosaico relativo
- `STORY-0637` / `ISSUE-0747` — `Geoprocessamento` — Produzir métricas, diagnóstico e lineage: Relatórios, visualização e exports do mosaico relativo
- `STORY-0638` / `ISSUE-0748` — `QA` — Executar benchmark, negativos e regressão científica: Relatórios, visualização e exports do mosaico relativo
- `STORY-0639` / `ISSUE-0749` — `Reviewer` — Auditar evidência científica e final: Relatórios, visualização e exports do mosaico relativo
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0102-01, AC-ISSUE-0102-02, AC-ISSUE-0102-03, AC-ISSUE-0102-04, AC-ISSUE-0102-05, AC-ISSUE-0102-06`
- **Requisitos do épico:** `4`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-050`
- **Conflito:** `Nenhum`
