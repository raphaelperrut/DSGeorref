# ISSUE-0066 — checkpoints canônicos, manifests de compatibilidade, retomada e lifecycle de intermediários
...
Como equipe de entrega do DSGeorref, precisamos checkpoints canônicos, manifests de compatibilidade, retomada e lifecycle de intermediários, para que a capacidade de produto vinculada seja entregue com qualidade verificável e integração controlada.

## Critérios de aceitação

- [ ] O resultado de produto de `EPIC-066` é demonstravelmente satisfeito.
...
- `STORY-0411` / `ISSUE-0521` — `Arquiteto` — Definir estados, envelopes e invariantes: checkpoints canônicos, manifests de compatibilidade, retomada e lifecycle de intermediários
- `STORY-0412` / `ISSUE-0522` — `Backend` — Implementar modelo e application services: checkpoints canônicos, manifests de compatibilidade, retomada e lifecycle de intermediários
- `STORY-0413` / `ISSUE-0523` — `Backend` — Implementar runner, worker ou scheduler: checkpoints canônicos, manifests de compatibilidade, retomada e lifecycle de intermediários
- `STORY-0414` / `ISSUE-0524` — `Backend` — Expor comandos, progresso e reconciliação: checkpoints canônicos, manifests de compatibilidade, retomada e lifecycle de intermediários
- `STORY-0415` / `ISSUE-0525` — `DevOps` — Automatizar testes de resiliência, retry e recuperação: checkpoints canônicos, manifests de compatibilidade, retomada e lifecycle de intermediários
- `STORY-0416` / `ISSUE-0526` — `QA` — Executar integração real, carga e fault injection: checkpoints canônicos, manifests de compatibilidade, retomada e lifecycle de intermediários
- `STORY-0417` / `ISSUE-0527` — `Reviewer` — Auditar evidência e integração final: checkpoints canônicos, manifests de compatibilidade, retomada e lifecycle de intermediários
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0066-01, AC-ISSUE-0066-02, AC-ISSUE-0066-03, AC-ISSUE-0066-04, AC-ISSUE-0066-05, AC-ISSUE-0066-06`
- **Requisitos do épico:** `11`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-010`, `ADR-011`, `ADR-012`, `ADR-016`, `ADR-033`, `ADR-034`, `ADR-037`, `ADR-038`, `ADR-039`, `ADR-040`, `ADR-046`, `ADR-048`
- **Conflito:** `Nenhum`
