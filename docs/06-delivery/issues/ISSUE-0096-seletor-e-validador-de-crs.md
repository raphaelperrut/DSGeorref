# ISSUE-0096 — Seletor e validador de CRS
...
Como equipe de entrega do DSGeorref, precisamos Seletor e validador de CRS, para que a capacidade de produto vinculada seja entregue com qualidade verificável e integração controlada.

## Critérios de aceitação

- [ ] O resultado de produto de `EPIC-096` é demonstravelmente satisfeito.
...
- `STORY-0591` / `ISSUE-0701` — `Arquiteto` — Definir contrato científico e invariantes: Seletor e validador de CRS
- `STORY-0592` / `ISSUE-0702` — `Geoprocessamento` — Preparar corpus, fixtures e representação tipada: Seletor e validador de CRS
- `STORY-0593` / `ISSUE-0703` — `Geoprocessamento` — Implementar o núcleo algorítmico: Seletor e validador de CRS
- `STORY-0594` / `ISSUE-0704` — `Geoprocessamento` — Integrar ao ProcessingPlan e pipeline: Seletor e validador de CRS
- `STORY-0595` / `ISSUE-0705` — `Geoprocessamento` — Produzir métricas, diagnóstico e lineage: Seletor e validador de CRS
- `STORY-0596` / `ISSUE-0706` — `QA` — Executar benchmark, negativos e regressão científica: Seletor e validador de CRS
- `STORY-0597` / `ISSUE-0707` — `Reviewer` — Auditar evidência científica e final: Seletor e validador de CRS
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0096-01, AC-ISSUE-0096-02, AC-ISSUE-0096-03, AC-ISSUE-0096-04, AC-ISSUE-0096-05, AC-ISSUE-0096-06`
- **Requisitos do épico:** `4`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-025`, `ADR-034`, `ADR-041`, `ADR-042`, `ADR-043`
- **Conflito:** `Nenhum`
