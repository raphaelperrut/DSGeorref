# ISSUE-0009 — usuários e papéis da instância
...
Como equipe de entrega do DSGeorref, precisamos usuários e papéis da instância, para que a capacidade de produto vinculada seja entregue com qualidade verificável e integração controlada.

## Critérios de aceitação

- [ ] O resultado de produto de `EPIC-009` é demonstravelmente satisfeito.
...
- `STORY-0041` / `ISSUE-0151` — `Arquiteto` — Definir política, estados e contratos: usuários e papéis da instância
- `STORY-0042` / `ISSUE-0152` — `Backend` — Consolidar slices e liberar integração: usuários e papéis da instância
- `STORY-0043` / `ISSUE-0153` — `Frontend` — Expor administração e fluxos de uso: usuários e papéis da instância
- `STORY-0044` / `ISSUE-0154` — `Security` — Validar ameaças, autorização e falhas: usuários e papéis da instância
- `STORY-0045` / `ISSUE-0155` — `Reviewer` — Executar QA e auditoria final: usuários e papéis da instância
- `STORY-0714` / `ISSUE-0824` — `Backend` — Slice 1/2 — Implementar domínio e persistência: usuários e papéis da instância [REQ-ACC, REQ-AUTH-IMPL]
- `STORY-0715` / `ISSUE-0825` — `Backend` — Slice 2/2 — Implementar domínio e persistência: usuários e papéis da instância [REQ-ID]
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0009-01, AC-ISSUE-0009-02, AC-ISSUE-0009-03, AC-ISSUE-0009-04, AC-ISSUE-0009-05, AC-ISSUE-0009-06`
- **Requisitos do épico:** `12`
- **ADRs governantes:** `ADR-003`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-014`, `ADR-016`, `ADR-028`, `ADR-029`, `ADR-030`, `ADR-031`, `ADR-032`, `ADR-043`, `ADR-055`
- **Conflito:** `Nenhum`
