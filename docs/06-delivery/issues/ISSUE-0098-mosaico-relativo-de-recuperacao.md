# ISSUE-0098 — Mosaico relativo de recuperação
...
Como equipe de entrega do DSGeorref, precisamos Mosaico relativo de recuperação, para que a capacidade de produto vinculada seja entregue com qualidade verificável e integração controlada.

## Critérios de aceitação

- [ ] O resultado de produto de `EPIC-098` é demonstravelmente satisfeito.
...
- `STORY-0605` / `ISSUE-0715` — `Arquiteto` — Definir contrato científico e invariantes: Mosaico relativo de recuperação
- `STORY-0606` / `ISSUE-0716` — `Geoprocessamento` — Preparar corpus, fixtures e representação tipada: Mosaico relativo de recuperação
- `STORY-0607` / `ISSUE-0717` — `Geoprocessamento` — Implementar o núcleo algorítmico: Mosaico relativo de recuperação
- `STORY-0608` / `ISSUE-0718` — `Geoprocessamento` — Integrar ao ProcessingPlan e pipeline: Mosaico relativo de recuperação
- `STORY-0609` / `ISSUE-0719` — `Geoprocessamento` — Produzir métricas, diagnóstico e lineage: Mosaico relativo de recuperação
- `STORY-0610` / `ISSUE-0720` — `QA` — Executar benchmark, negativos e regressão científica: Mosaico relativo de recuperação
- `STORY-0611` / `ISSUE-0721` — `Reviewer` — Auditar evidência científica e final: Mosaico relativo de recuperação
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0098-01, AC-ISSUE-0098-02, AC-ISSUE-0098-03, AC-ISSUE-0098-04, AC-ISSUE-0098-05, AC-ISSUE-0098-06`
- **Requisitos do épico:** `8`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-036`, `ADR-040`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-044`, `ADR-049`, `ADR-050`
- **Conflito:** `Nenhum`
