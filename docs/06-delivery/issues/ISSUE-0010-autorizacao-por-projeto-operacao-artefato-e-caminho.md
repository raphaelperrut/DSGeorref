# ISSUE-0010 — autorização por projeto, operação, artefato e caminho
...
Como equipe de entrega do DSGeorref, precisamos autorização por projeto, operação, artefato e caminho, para que a capacidade de produto vinculada seja entregue com qualidade verificável e integração controlada.

## Critérios de aceitação

- [ ] O resultado de produto de `EPIC-010` é demonstravelmente satisfeito.
...
- `STORY-0046` / `ISSUE-0156` — `Arquiteto` — Definir política, estados e contratos: autorização por projeto, operação, artefato e caminho
- `STORY-0047` / `ISSUE-0157` — `Backend` — Consolidar slices e liberar integração: autorização por projeto, operação, artefato e caminho
- `STORY-0048` / `ISSUE-0158` — `Frontend` — Expor administração e fluxos de uso: autorização por projeto, operação, artefato e caminho
- `STORY-0049` / `ISSUE-0159` — `Security` — Validar ameaças, autorização e falhas: autorização por projeto, operação, artefato e caminho
- `STORY-0050` / `ISSUE-0160` — `Reviewer` — Executar QA e auditoria final: autorização por projeto, operação, artefato e caminho
- `STORY-0716` / `ISSUE-0826` — `Backend` — Slice 1/2 — Implementar domínio e persistência: autorização por projeto, operação, artefato e caminho [REQ-ACC, REQ-AUTH-IMPL]
- `STORY-0717` / `ISSUE-0827` — `Backend` — Slice 2/2 — Implementar domínio e persistência: autorização por projeto, operação, artefato e caminho [REQ-HW]
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0010-01, AC-ISSUE-0010-02, AC-ISSUE-0010-03, AC-ISSUE-0010-04, AC-ISSUE-0010-05, AC-ISSUE-0010-06`
- **Requisitos do épico:** `12`
- **ADRs governantes:** `ADR-003`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-014`, `ADR-016`, `ADR-028`, `ADR-029`, `ADR-030`, `ADR-031`, `ADR-032`, `ADR-037`, `ADR-043`, `ADR-055`
- **Conflito:** `Nenhum`
