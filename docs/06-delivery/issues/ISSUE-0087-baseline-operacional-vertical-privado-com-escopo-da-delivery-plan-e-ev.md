# ISSUE-0087 — baseline operacional vertical privado com escopo da DELIVERY_PLAN e evidências do corpus controlado
...
Como equipe de entrega do DSGeorref, precisamos baseline operacional vertical privado com escopo da DELIVERY_PLAN e evidências do corpus controlado, para que a capacidade de produto vinculada seja entregue com qualidade verificável e integração controlada.

## Critérios de aceitação

- [ ] O resultado de produto de `EPIC-087` é demonstravelmente satisfeito.
...
- `STORY-0539` / `ISSUE-0649` — `Tech Lead` — Definir gate, versão e critérios de release: baseline operacional vertical privado com escopo da DELIVERY_PLAN e evidências do corpus controlado
- `STORY-0540` / `ISSUE-0650` — `DevOps` — Implementar pipeline e artifacts de release: baseline operacional vertical privado com escopo da DELIVERY_PLAN e evidências do corpus controlado
- `STORY-0541` / `ISSUE-0651` — `DevOps` — Implementar upgrade, rollback e compatibilidade: baseline operacional vertical privado com escopo da DELIVERY_PLAN e evidências do corpus controlado
- `STORY-0542` / `ISSUE-0652` — `Security` — Gerar evidências, SBOM e attestations: baseline operacional vertical privado com escopo da DELIVERY_PLAN e evidências do corpus controlado
- `STORY-0543` / `ISSUE-0653` — `QA` — Executar instalação limpa e rehearsal: baseline operacional vertical privado com escopo da DELIVERY_PLAN e evidências do corpus controlado
- `STORY-0544` / `ISSUE-0654` — `Reviewer` — Auditar release candidata final: baseline operacional vertical privado com escopo da DELIVERY_PLAN e evidências do corpus controlado
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0087-01, AC-ISSUE-0087-02, AC-ISSUE-0087-03, AC-ISSUE-0087-04, AC-ISSUE-0087-05, AC-ISSUE-0087-06`
- **Requisitos do épico:** `1`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-009`, `ADR-010`, `ADR-011`, `ADR-016`, `ADR-030`, `ADR-031`, `ADR-032`, `ADR-033`, `ADR-034`, `ADR-057`
- **Conflito:** `Nenhum`
