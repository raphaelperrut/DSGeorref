# ISSUE-0060 — policy de aquisição no ProcessingPlan, preview, consentimento e bloqueio fail-closed de ativos pagos/ambíguos
...
Como equipe de entrega do DSGeorref, precisamos policy de aquisição no ProcessingPlan, preview, consentimento e bloqueio fail-closed de ativos pagos/ambíguos, para que a capacidade de produto vinculada seja entregue com qualidade verificável e integração controlada.

## Critérios de aceitação

- [ ] O resultado de produto de `EPIC-060` é demonstravelmente satisfeito.
...
- `STORY-0372` / `ISSUE-0482` — `Arquiteto` — Definir contrato científico e invariantes: policy de aquisição no ProcessingPlan, preview, consentimento e bloqueio fail-closed de ativos pagos/ambíguos
- `STORY-0373` / `ISSUE-0483` — `Geoprocessamento` — Preparar corpus, fixtures e representação tipada: policy de aquisição no ProcessingPlan, preview, consentimento e bloqueio fail-closed de ativos pagos/ambíguos
- `STORY-0374` / `ISSUE-0484` — `Geoprocessamento` — Implementar o núcleo algorítmico: policy de aquisição no ProcessingPlan, preview, consentimento e bloqueio fail-closed de ativos pagos/ambíguos
- `STORY-0375` / `ISSUE-0485` — `Geoprocessamento` — Integrar ao ProcessingPlan e pipeline: policy de aquisição no ProcessingPlan, preview, consentimento e bloqueio fail-closed de ativos pagos/ambíguos
- `STORY-0376` / `ISSUE-0486` — `Geoprocessamento` — Produzir métricas, diagnóstico e lineage: policy de aquisição no ProcessingPlan, preview, consentimento e bloqueio fail-closed de ativos pagos/ambíguos
- `STORY-0377` / `ISSUE-0487` — `QA` — Executar benchmark, negativos e regressão científica: policy de aquisição no ProcessingPlan, preview, consentimento e bloqueio fail-closed de ativos pagos/ambíguos
- `STORY-0378` / `ISSUE-0488` — `Reviewer` — Auditar evidência científica e final: policy de aquisição no ProcessingPlan, preview, consentimento e bloqueio fail-closed de ativos pagos/ambíguos
...
- **Resultado:** `PASS`
- **Critérios rastreados:** `AC-ISSUE-0060-01, AC-ISSUE-0060-02, AC-ISSUE-0060-03, AC-ISSUE-0060-04, AC-ISSUE-0060-05, AC-ISSUE-0060-06`
- **Requisitos do épico:** `2`
- **ADRs governantes:** `ADR-003`, `ADR-004`, `ADR-005`, `ADR-006`, `ADR-007`, `ADR-008`, `ADR-010`, `ADR-011`, `ADR-012`, `ADR-041`, `ADR-042`, `ADR-043`, `ADR-047`
- **Conflito:** `Nenhum`
