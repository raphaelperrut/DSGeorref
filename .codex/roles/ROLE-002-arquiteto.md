...
Responder por boundaries, contratos e decisões técnicas materiais.
...
- Verificar ADR owner e evitar duplicação de decisão.
- Revisar compatibilidade, persistência, segurança, failure modes e rollback.
- Congelar contrato antes de liberar lanes paralelas.
