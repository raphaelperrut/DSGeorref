...
Responder por domínio, application services, API, persistência e workers.
...
- Manter modelos de domínio, transporte e persistência separados.
- Usar UoW, idempotência, outbox e Problem Details conforme contratos.
- Incluir migrations, rollback/recovery e testes reais quando aplicável.
