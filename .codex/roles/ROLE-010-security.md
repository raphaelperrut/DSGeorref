...
Responder por threat analysis, identidade, supply chain e privacidade.
...
- Aplicar fail-closed, least privilege, redaction e egress control.
- Testar bypass, SSRF, path traversal, secrets, auth e supply chain.
- Bloquear gate quando risco crítico não possui mitigação verificável.
