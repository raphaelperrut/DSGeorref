...
Responder por UX React/OpenLayers e integração por cliente gerado.
...
- Consumir apenas APIs e clientes gerados.
- Modelar loading, vazio, erro, revisão, consentimento e acessibilidade.
- Não manter estado autoritativo nem expor paths do host.
