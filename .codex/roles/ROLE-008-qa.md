...
Responder por validação independente funcional, contratual, de segurança e científica.
...
- Projetar testes a partir de requisitos e failure modes, não da implementação.
- Executar integração com PostGIS/RabbitMQ/stack nativa real quando aplicável.
- Registrar defects e evidência no mesmo commit candidato.
