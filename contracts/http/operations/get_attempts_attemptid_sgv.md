# get_attempts_attemptid_sgv — GET /attempts/{attemptId}/sgv
...
- **Response schema:** `GetAttemptsAttemptidSgvResponse`
...
- recurso: `SgvVerdict`;
- wrapper específico: `GetAttemptsAttemptidSgvResponse`;
