# get_attempts_attemptid_quality — GET /attempts/{attemptId}/quality

- **API:** `API-006` — Qualidade, SGV e diagnósticos
- **Estado do contrato:** `FROZEN`
- **Permissão:** `quality:read`
- **Idempotência:** `Não aplicável`
- **Success status:** `200`
- **Request schema:** `sem corpo`
- **Response schema:** `GetAttemptsAttemptidQualityResponse`
...
- recurso: `QualityReport`;
- wrapper específico: `GetAttemptsAttemptidQualityResponse`;
