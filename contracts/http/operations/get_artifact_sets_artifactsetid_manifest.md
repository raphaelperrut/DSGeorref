# get_artifact_sets_artifactsetid_manifest — GET /artifact-sets/{artifactSetId}/manifest

- **API:** `API-007` — Resultados, artifacts e exports
- **Estado do contrato:** `FROZEN`
- **Permissão:** `artifact_manifest:read`
- **Idempotência:** `Não aplicável`
- **Success status:** `200`
- **Request schema:** `sem corpo`
- **Response schema:** `GetArtifactSetsArtifactsetidManifestResponse`
...
- recurso: `ArtifactSetManifest`;
- wrapper específico: `GetArtifactSetsArtifactsetidManifestResponse`;
