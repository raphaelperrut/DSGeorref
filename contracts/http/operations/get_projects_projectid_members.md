# get_projects_projectid_members — GET /projects/{projectId}/members

- **API:** `API-002` — Projetos, usuários e autorização
- **Estado do contrato:** `FROZEN`
- **Permissão:** `project_member:list`
- **Idempotência:** `Não aplicável`
- **Success status:** `200`
- **Request schema:** `sem corpo`
- **Response schema:** `GetProjectsProjectidMembersResponse`
...
- wrapper específico: `GetProjectsProjectidMembersResponse`;
