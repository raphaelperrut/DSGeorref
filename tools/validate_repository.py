...
expected={'adrs':57,'components':18,'modules':18,'sprints':12,'epics':110,'parent_issues':110,'stories':758,'tasks':758,'requirements':376}
...
if len(issue_rows)!=868: errors.append(f'ISSUE_INDEX expected 868, found {len(issue_rows)}')
if len(story_rows)!=758: errors.append(f'STORY_INDEX expected 758, found {len(story_rows)}')
...
if len(issue_rr_rows)!=868: errors.append(f'Phase B issue review expected 868, found {len(issue_rr_rows)}')
