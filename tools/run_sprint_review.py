...
if len(matrix)!=871:errors.append(f'Phase F matrix expected 871, found {len(matrix)}')
...
print('SPRINT REVIEW PASS');print('sprints: 12');print('issues: 871');print('stories: 761');print('matrix rows:',len(matrix))
