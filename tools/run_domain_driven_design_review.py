...
for rel,key,count in [("docs/06-delivery/EPIC_INDEX.csv","epic_id",110),("docs/06-delivery/STORY_INDEX.csv","story_id",761),("docs/06-delivery/ISSUE_INDEX.csv","issue_id",871),("docs/01-product/REQUIREMENT_INDEX.csv","requirement_id",376)]:
    rr=rows(rel)
